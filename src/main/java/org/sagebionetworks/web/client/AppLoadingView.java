...
public class AppLoadingView extends PopupPanel {
	...
	public AppLoadingView() {
		/**
		 * DO NOT ADD THIS TO THE MAIN IMAGE BUNGLE! This is shown while the image bundle is being
		 * download to the browser so putting it in the bundle defeats the whole purpose of this image.
		 */
