...
public interface ChallengeClient extends RemoteService {
	...
	PaginatedResults<Evaluation> getAvailableEvaluations(Set<String> targetEvaluationIds)
	...
	ChallengeTeamPagedResults getChallengeTeams(String userId, String challengeId, Integer limit,
			Integer offset) throws RestServiceException;

	UserProfilePagedResults getChallengeParticipants(boolean affiliated, String challengeId,
	...
	TeamSubmissionEligibility getTeamSubmissionEligibility(String evaluationId, String teamId)
			throws RestServiceException;
