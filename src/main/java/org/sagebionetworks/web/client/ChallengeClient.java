...
public interface ChallengeClient extends RemoteService {
  ...
  List<Team> getSubmissionTeams(String userId, String challengeId)
    throws RestServiceException;

  ChallengeTeam registerChallengeTeam(ChallengeTeam challengeTeam)
    throws RestServiceException;

  void unregisterChallengeTeam(String challengeTeamId)
    throws RestServiceException;

  ChallengeTeam updateRegisteredChallengeTeam(ChallengeTeam challengeTeam)
    throws RestServiceException;

  ChallengeTeamPagedResults getChallengeTeams(
    String userId,
    String challengeId,
    Integer limit,
    Integer offset
  ...
  UserProfilePagedResults getChallengeParticipants(
    boolean affiliated,
    String challengeId,
    Integer limit,
    Integer offset
  ...
  Challenge getChallengeForProject(String projectId)
    throws RestServiceException;

  List<Team> getRegistratableTeams(String userId, String challengeId)
    throws RestServiceException;

  Set<String> getChallengeEvaluationIds(String challengeId)
    throws RestServiceException;
  ...
  Set<String> getProjectEvaluationIds(String projectId)
    throws RestServiceException;
  ...
  void requestToCancelSubmission(String submissionId)
    throws RestServiceException;
}
