...
public interface ChallengeClientAsync {
	void getAvailableEvaluations(AsyncCallback<PaginatedResults<Evaluation>> callback)
			throws RestServiceException;

	void getAvailableEvaluations(Set<String> targetEvaluationIds,
			AsyncCallback<PaginatedResults<Evaluation>> callback) throws RestServiceException;
	 ...
	 * @param callback
	 */
	void createIndividualSubmission(Submission submission, String etag, String hostPageBaseURL,
			AsyncCallback<Submission> callback) throws RestServiceException;

	void createTeamSubmission(Submission submission, String etag, String memberStateHash,
			String hostPageBaseURL, AsyncCallback<Submission> callback) throws RestServiceException;

	void getSubmissionTeams(String userId, String challengeId,
			AsyncCallback<List<Team>> submissionTeams);
	...
	void updateRegisteredChallengeTeam(ChallengeTeam challengeTeam,
			AsyncCallback<ChallengeTeam> callback);

	void getChallengeTeams(String userId, String challengeId, Integer limit, Integer offset,
			AsyncCallback<ChallengeTeamPagedResults> callback);

	void getChallengeParticipants(boolean affiliated, String challengeId, Integer limit,
			Integer offset, AsyncCallback<UserProfilePagedResults> callback);
	...
	void getTeamSubmissionEligibility(String evaluationId, String teamId,
