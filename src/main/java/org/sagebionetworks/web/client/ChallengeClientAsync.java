...
public interface ChallengeClientAsync {
  void getSharableEvaluations(
    String entityId,
    AsyncCallback<List<Evaluation>> asyncCallback
  );
   ...
   * @param callback
   */
  void createIndividualSubmission(
  ...
  void getSubmissionTeams(
    String userId,
    String challengeId,
    AsyncCallback<List<Team>> submissionTeams
  );

  void registerChallengeTeam(
    ChallengeTeam challengeTeam,
    AsyncCallback<ChallengeTeam> callback
  );

  void unregisterChallengeTeam(
    String challengeTeamId,
    AsyncCallback<Void> callback
  );

  void updateRegisteredChallengeTeam(
    ChallengeTeam challengeTeam,
    AsyncCallback<ChallengeTeam> callback
  );

  void getChallengeTeams(
    String userId,
    String challengeId,
    Integer limit,
    Integer offset,
  ...
  void getChallengeParticipants(
    boolean affiliated,
    String challengeId,
    Integer limit,
    Integer offset,
    AsyncCallback<UserProfilePagedResults> callback
  );

  void getChallengeForProject(
    String projectId,
    AsyncCallback<Challenge> callback
  );

  void getRegistratableTeams(
    String userId,
    String challengeId,
    AsyncCallback<List<Team>> callback
  );

  void getUserEvaluationPermissions(
    String evalId,
  ...
  void updateEvaluationAcl(
    AccessControlList acl,
    AsyncCallback<AccessControlList> callback
  );

  void getChallengeEvaluationIds(
    String challengeId,
    AsyncCallback<Set<String>> callback
  );

  void getTeamSubmissionEligibility(
    String evaluationId,
    String teamId,
  ...
  void requestToCancelSubmission(
    String submissionId,
    AsyncCallback<Void> callback
  );
}
