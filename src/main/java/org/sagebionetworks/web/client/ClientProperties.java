...
public class ClientProperties {
	...
	public static final String CLIENT_R_EXAMPLE_CODE_URL = "#!Synapse:syn1834618";
	public static final String CLIENT_PYTHON_API_URL = "#!Synapse:syn1768504";
	public static final String CLIENT_PYTHON_EXAMPLE_CODE_URL = "#!Synapse:syn1768504";
	public static final String CLIENT_CL_API_URL = "#!Synapse:syn1768504";
	public static final String CLIENT_CL_EXAMPLE_CODE_URL = "#!Synapse:syn1768504";
