...
public class ClientProperties {
	...
	public static final String[] IMAGE_CONTENT_TYPES = new String[] {"image/bmp", "image/pjpeg",
			"image/jpeg", "image/jpg", "image/jpe", "image/gif", "image/png", "image/svg+xml"};
	public static final HashSet<String> IMAGE_CONTENT_TYPES_SET =
			new HashSet<String>(Arrays.asList(IMAGE_CONTENT_TYPES));

	public static final String[] TABLE_CONTENT_TYPES =
			new String[] {"application/vnd.ms-excel", "text/csv", "text/tab-separated-values",
					"text/plain", "text/txt", "text", "text/", "text/tsv"};
	...
	public static final HashSet<String> CODE_EXTENSIONS_SET =
			new HashSet<String>(Arrays.asList(CODE_EXTENSIONS));


	public static final double BASE = 1024, KB = BASE, MB = KB * BASE, GB = MB * BASE, TB = GB * BASE;

	/**
	 * Sometimes we are forced to use a table to center an image in a fixed space. This is the third
	 * option from:
	 * http://stackoverflow.com/questions/388180/how-to-make-an-image-center-vertically-horizontally-inside-a-bigger-div
	 * It should only be used when the first two options are not an option. Place your image between
	 * the start and end.
	 */
	...
	public static final WebResource SYNAPSE_REACT_COMPONENTS_JS =
			new WebResource("js/SRC/synapse-react-client.production.min.js");
	public static final WebResource PROP_TYPES_JS =
			new WebResource("https://unpkg.com/prop-types@15.6.2/prop-types.min.js");
	public static final WebResource REACT_MEASURE_JS =
			new WebResource("https://unpkg.com/react-measure@2.2.2/dist/index.umd.js");
	public static final WebResource REACT_TOOLTIP_JS =
			new WebResource("https://unpkg.com/react-tooltip@3.9.2/standalone/react-tooltip.min.js");
	...
	public static void fixResourceToCdnEndpoint(WebResource resource, String cdnEndpoint) {
		...
		if (cdnEndpoint != null && !currentUrl.startsWith(cdnEndpoint)
