...
public class ClientProperties {
  ...
  public static final HashSet<String> CODE_EXTENSIONS_SET = new HashSet<String>(
    Arrays.asList(CODE_EXTENSIONS)
  );

  public static final double BASE = 1024, KB = BASE, MB = KB * BASE, GB =
    MB * BASE, TB = GB * BASE;
   ...
   * It should only be used when the first two options are not an option. Place your image between the
   * start and end.
   */
  ...
  public static void fixResourceToCdnEndpoint(
    ...
    if (
      cdnEndpoint != null &&
      !currentUrl.startsWith(cdnEndpoint) &&
