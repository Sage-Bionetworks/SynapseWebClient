...
public class ContentTypeUtils {
  ...
  public static boolean isCSV(String contentType) {
    return (
      contentType != null && contentType.toLowerCase().startsWith("text/csv")
    );
  }
  ...
  public static boolean isTAB(String contentType) {
    return (
      ...
      contentType
        .toLowerCase()
        .startsWith(WebConstants.TEXT_TAB_SEPARATED_VALUES)
    );
  }
  ...
  public static String fixDefaultContentType(String type, String fileName) {
    ...
    if (type == null || type.trim().length() == 0) {
      if (
        ...
        lowercaseFilename.endsWith(".tsv") || lowercaseFilename.endsWith(".tab")
      ) {
