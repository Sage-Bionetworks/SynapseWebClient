...
public interface DataAccessClientAsync {
	...
	void updateResearchProject(ResearchProject researchProject,
	...
	void submitDataAccessRequest(CreateSubmissionRequest dataAccessRequest, Long arId,
			AsyncCallback<Void> asyncCallback);

	void getAccessRequirement(Long requirementId, AsyncCallback<AccessRequirement> callback);

	void getDataAccessSubmissions(Long accessRequirementId, String nextPageToken,
	...
	void getAccessRequirementStatus(String accessRequirementId,
			AsyncCallback<AccessRequirementStatus> callback);
	...
	void getAccessRequirementStatus(BatchAccessApprovalInfoRequest request,
			AsyncCallback<BatchAccessApprovalInfoResponse> callback);

	void listAccessorGroup(AccessorGroupRequest request,
			AsyncCallback<AccessorGroupResponse> asyncCallback);

	void revokeGroup(String accessRequirementId, String submitterId, AsyncCallback<Void> callback);

	void convertAccessRequirement(AccessRequirementConversionRequest request,
