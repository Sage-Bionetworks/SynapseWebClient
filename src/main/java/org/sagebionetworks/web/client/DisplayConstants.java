...
public class DisplayConstants {
	...
	public static final String ENTITY_DESCRIPTION_FORMATTING_TIPS_HTML = "<div style=\"margin-left:20px\"><br><br>" +
																		...
																		"<h3>Images</h3><p>To insert an image attachment into the description (at the current cursor position), click the Insert Image button.</p><p>Inline:</p><pre><code>![alt text](/path/img.jpg)</code></pre></p><br>" +
