...
public class DisplayConstants {
	...
	public static final String ERROR_RESTORING_TRASH_PARENT_NOT_FOUND = "An error occured in restoring this entity from the trash. Perhaps the original parent is also in the trash or deleted?";
