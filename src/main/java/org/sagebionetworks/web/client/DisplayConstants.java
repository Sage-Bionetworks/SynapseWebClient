...
public class DisplayConstants {
	...
	public static final String ERROR_ALL_FIELDS_REQUIRED =
			"All fields must first be properly fill in.";
	...
	public static final String TEXT_LINK_FAILED =
			"An error occurred while creating the link. Please check the URL and try again.";
	...
	public static final String WARNING_TEAM_NAME_EXISTS =
			"Sorry, a team with that name already exists. Please try another name.";
	...
	public static final String TEST_MODE_WARNING =
			"<h5>Alpha Test Mode</h5>This mode is for alpha testing features only. Please note that the <a target=\"blank\" href=\"https://github.com/Sage-Bionetworks/SynapseWebClient\"> developers</a> do not guarantee an absence of errors, "
	...
	public static final String INVALID_SHINY_SITE =
			" is not a valid Site URL. Please contact us at " + ClientProperties.HELP_EMAIL_ADDRESS
					+ " if you would like your Server added to our white list.";
