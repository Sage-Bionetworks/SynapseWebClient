...
public class EventHandlerUtils {
	 ...
	 * @return
	 */
	public static HandlerRegistration addEventListener(final String eventType, final Element el,
			org.sagebionetworks.web.client.utils.JavaScriptCallback c) {
	 ...
	 */
	public final static native void _addEventListener(String eventType, Element el,
			JavaScriptObject fn) /*-{
	 ...
	 * @return The js function
	 */
	public final static native void _removeEventListener(String eventType, Element el,
			JavaScriptObject fn) /*-{
	 ...
	 */
	public final static native JavaScriptObject _wrapCallback(
			final org.sagebionetworks.web.client.utils.JavaScriptCallback c) /*-{
