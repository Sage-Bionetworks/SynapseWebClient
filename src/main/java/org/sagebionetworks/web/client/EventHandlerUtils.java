...
public class EventHandlerUtils {
   ...
   * @return
   */
  public static HandlerRegistration addEventListener(
  ...
  public static final native Element getWnd() /*-{
		return $wnd;
	}-*/;
   ...
   */
  public static final native void _addEventListener(
    String eventType,
    Element el,
    JavaScriptObject fn
  ) /*-{
   ...
   * @return The js function
   */
  public static final native void _removeEventListener(
    String eventType,
    Element el,
    JavaScriptObject fn
  ) /*-{
   ...
   */
  public static final native JavaScriptObject _wrapCallback(
