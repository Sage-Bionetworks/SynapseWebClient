...
public class GWTWrapperImpl implements GWTWrapper {
	...
	private final static RegExp PRINICPAL_UNIQUENESS_REPLACE_PATTERN =
	...
	/**
	 * Get the string that will be used for a uniqueness check for alias names. Only lower case
	 * letters and numbers contribute to the uniqueness of a principal name. All other characters
	 * (-,., ,_) are ignored.
	 * 
	 * @param inputName
	 * @return
