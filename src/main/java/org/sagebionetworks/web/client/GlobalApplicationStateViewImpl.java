...
public class GlobalApplicationStateViewImpl implements GlobalApplicationStateView {
	...
	public void showVersionOutOfDateGlobalMessage() {
		DisplayUtils.showError(
				DisplayConstants.NEW_VERSION_AVAILABLE + DisplayConstants.NEW_VERSION_INSTRUCTIONS,
				UNLIMITED_TIME);
		preloadNewVersion();
	}
	...
	private final static native void _initSRCEndpoints(String repoEndpoint,
