...
import org.sagebionetworks.web.client.widget.ClientsHelpImpl;
...
import org.sagebionetworks.web.client.widget.entity.editor.ExternalImageConfigViewImpl;
...
public class PortalGinModule extends AbstractGinModule {
	...
	protected void configure() {
		...
		bind(ExternalImageConfigView.class).to(ExternalImageConfigViewImpl.class);
		...
		bind(ClientsHelp.class).to(ClientsHelpImpl.class);
	}
}
