...
import org.sagebionetworks.web.client.widget.entity.renderer.BacktickWidgetView;
import org.sagebionetworks.web.client.widget.entity.renderer.BacktickWidgetViewImpl;
...
import org.sagebionetworks.web.client.widget.entity.renderer.UnderscoreWidgetView;
import org.sagebionetworks.web.client.widget.entity.renderer.UnderscoreWidgetViewImpl;
...
public class PortalGinModule extends AbstractGinModule {
	...
	protected void configure() {
		...
		// UI Widget Renderers
		bind(UnderscoreWidgetView.class).to(UnderscoreWidgetViewImpl.class);
		bind(BacktickWidgetView.class).to(BacktickWidgetViewImpl.class);
