...
public class PortalGinModule extends AbstractGinModule {
	...
	protected void configure() {
		...
		bind(PresignedAndFileHandleURLAsyncHandler.class)
				.to(PresignedAndFileHandleURLAsyncHandlerImpl.class).in(Singleton.class);
		...
		bind(UserGroupHeaderFromAliasAsyncHandler.class)
				.to(UserGroupHeaderFromAliasAsyncHandlerImpl.class).in(Singleton.class);
		...
		bind(CreateResearchProjectWizardStep1View.class)
				.to(CreateResearchProjectWizardStep1ViewImpl.class);
		bind(CreateDataAccessSubmissionWizardStep2View.class)
				.to(CreateDataAccessSubmissionWizardStep2ViewImpl.class);
