...
public interface SynapseClientAsync {
	...
	void createOrUpdateAccessRequirement(AccessRequirement arEW, AsyncCallback<AccessRequirement> callback);
	...
	void restoreV2WikiPage(String ownerId, String ownerType, String wikiId, Long versionToUpdate, AsyncCallback<V2WikiPage> callback);
	...
	void getV2WikiHistory(WikiPageKey key, Long limit, Long offset, AsyncCallback<PaginatedResults<V2WikiHistorySnapshot>> callback);
	...
	void getTeamsBySearch(String searchTerm, Integer limit, Integer offset, AsyncCallback<PaginatedResults<Team>> callback);
	...
	void submitCertificationQuizResponse(QuizResponse response, AsyncCallback<PassingRecord> callback);
	...
	void addTeamMember(String userGroupId, String teamId, String message, String hostPageBaseURL, AsyncCallback<Void> callback);
