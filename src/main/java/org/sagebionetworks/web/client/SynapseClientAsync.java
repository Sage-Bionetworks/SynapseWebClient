...
public interface SynapseClientAsync {
	...
	void completeUpload(String daemonId, String entityId, String parentEntityId, boolean isRestricted,AsyncCallback<String> callback) throws RestServiceException;
