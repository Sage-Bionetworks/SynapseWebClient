...
public class SynapseJavascriptClient {
  ...
  public static final String RESTRICTION_INFORMATION =
    "/restrictionInformation";
  public static final String USER_PROFILE_PATH = "/userProfile";
  public static final String USER_GROUP_HEADER_BY_ALIAS =
    "/userGroupHeaders/aliases";
  public static final String USER_GROUP_HEADER_BATCH_PATH =
    "/userGroupHeaders/batch?ids=";
  ...
  private String getNrgrSynapseGlueEndpoint() {
    return synapseProperties.getSynapseProperty(
      NRGR_SYNAPSE_GLUE_ENDPOINT_PROPERTY
    );
  }
  ...
  private String getSynapseVersionInfo() {
    if (synapseVersionInfo == null) {
      synapseVersionInfo =
        synapseProperties.getSynapseProperty(SYNAPSE_VERSION_KEY);
    }
  ...
  private Request doDelete(String url, AsyncCallback callback) {
    ...
    return sendRequest(
      ...
      null,
      OBJECT_TYPE.None,
      INITIAL_RETRY_REQUEST_DELAY_MS,
      canCancel,
      callback
    );
  }

  private Request doGet(
    String url,
  ...
  public Request doGetString(
    ...
    String accessToken = forceAnonymous
      ? null
      : authController.getCurrentUserAccessToken();
  ...
  private Request doPostOrPut(
    RequestBuilder.Method method,
    String url,
    JSONEntity requestObject,
    OBJECT_TYPE responseType,
    boolean canCancel,
    AsyncCallback callback
  ) {
  ...
  private Request sendRequest(
    final RequestBuilderWrapper requestBuilder,
    final String requestData,
    final OBJECT_TYPE responseType,
            ...
            if (statusCode > 199 && statusCode < 300) {
              try {
                ...
                if (OBJECT_TYPE.None.equals(responseType)) {
                  ...
                  OBJECT_TYPE.AsyncResponse.equals(responseType) &&
                  statusCode == 202
                ) {
                  JSONObjectAdapter jsonObject = jsonObjectAdapter.createNew(
                    response.getText()
                  );
                  // SWC-4114: remove requestBody, attempted construction can result in a json object adapter
                  // exception in PartialRow
                  ...
                  throw new ResultNotReadyException(
                    (AsynchronousJobStatus) responseObject
                  );
                } else {
                  JSONObjectAdapter jsonObject = jsonObjectAdapter.createNew(
                    response.getText()
                  ...
                  responseObject =
                    jsFactory.newInstance(responseType, jsonObject);
                }
                if (callback != null) {
              ...
              if (
                statusCode == TOO_MANY_REQUESTS_STATUS_CODE || statusCode == 0
              ) {
                ...
                try {
                  ...
                  if (jsonObject.has("errorCode")) {
                    responseCode =
                      ErrorResponseCode.valueOf(
                        jsonObject.get("errorCode").toString()
                      );
                  }
                } catch (Exception e) {
                  jsniUtils.consoleError(
                    "Unable to get reason/code for error: " + e.getMessage()
                  );
                }
                onError(
                  request,
                  getException(statusCode, responseText, responseCode)
                );
              }
            }
          }
  ...
  public static RestServiceException getException(
    int statusCode,
    String reasonStr,
  ...
  public FluentFuture<EntityBundle> getEntityBundle(
    String entityId,
    EntityBundleRequest request
  ) {
    return getFuture(cb ->
      getEntityBundleForVersion(entityId, null, request, cb)
    );
  }
          ...
          if (!latestEntityBundle.equals(cachedBundle)) {
            if (cachedBundle != null) {
              jsniUtils.consoleLog(
                "Cache out of date. Updating cache and calling onSuccess() again: " +
                entityId
              );
            }
  ...
  public void getEntityBundleForVersion(
    String entityId,
    Long versionNumber,
    EntityBundleRequest request,
    final AsyncCallback<EntityBundle> callback
  ...
  public FluentFuture<DoiAssociation> getDoiAssociation(
    String objectId,
  ...
  public FluentFuture<Doi> getDoi(
    String objectId,
    ObjectType objectType,
    Optional<Long> objectVersion
  ) {
    String url =
      getRepoServiceUrl() +
      DOI +
  ...
  public void getVersionOfV2WikiPageAsV1(
    final WikiPageKey key,
    ...
    if (key.getWikiPageId() == null) {
      AsyncCallback<String> wikiPageIdKeyCallback = new AsyncCallback<String>() {
        ...
        public void onSuccess(String wikiPageIdKey) {
          ...
          getVersionOfV2WikiPageAsV1WithWikiPageId(
            key,
            versionNumber,
            callback
          );
  ...
  private void getV2WikiPageWithPageId(
    WikiPageKey key,
    Long versionNumber,
    final AsyncCallback<V2WikiPage> callback
  ) {
  ...
  public void getRootWikiPageKey(
    ...
    AsyncCallback<org.sagebionetworks.repo.model.dao.WikiPageKey> wikiPageKeyCallback = new AsyncCallback<org.sagebionetworks.repo.model.dao.WikiPageKey>() {
      ...
      public void onSuccess(
        org.sagebionetworks.repo.model.dao.WikiPageKey wikiPageKey
      ) {
  ...
  private void getVersionOfV2WikiPageAsV1WithWikiPageId(
    WikiPageKey key,
    Long versionNumber,
    final AsyncCallback<WikiPage> callback
  ) {
  ...
  public void getWikiAttachmentFileHandles(
    WikiPageKey key,
    Long versionNumber,
  ...
  public void getUserGroupHeadersByPrefix(
    String prefix,
    TypeFilter type,
    long limit,
    long offset,
    ...
    doGet(
      builder.toString(),
      OBJECT_TYPE.UserGroupHeaderResponsePage,
      callback
    );
  }
  ...
  public void listUserProfiles(
    List<String> userIds,
    final AsyncCallback<List> callback
  ) {
  ...
  private void listUserProfilesFromUserIds(
    List<Long> userIds,
    final AsyncCallback<List> callback
  ) {
    String url = getRepoServiceUrl() + USER_PROFILE_PATH;
  ...
  public FluentFuture<Challenge> getChallengeForProject(String projectId) {
    String url =
      getRepoServiceUrl() + ENTITY + "/" + projectId + "/" + CHALLENGE;
  ...
  public void getUserBundle(
    ...
    String url =
      getRepoServiceUrl() + USER + "/" + principalId + BUNDLE_MASK_PATH + mask;
  ...
  public void getUserGroupHeadersById(
    ...
    String url =
      getRepoServiceUrl() + USER_GROUP_HEADER_BATCH_PATH + listToString(ids);
  ...
  public void getEntityForVersion(
    String entityId,
    Long versionNumber,
    AsyncCallback<Entity> callback
  ) {
  ...
  public void isEntityRefCollectionView(
    String projectId,
    AsyncCallback<Boolean> callback
  ) {
    EntityChildrenRequest request = getEntityChildrenRequest(
  ...
  private EntityChildrenRequest getEntityChildrenRequest(
    String parentId,
    EntityType... types
  ) {
  ...
  public void getForumByProjectId(
    String projectId,
    AsyncCallback<Forum> callback
  ) {
  ...
  public void getThreadUrl(String messageKey, AsyncCallback<String> callback) {
    String url =
      getRepoServiceUrl() + THREAD + URL + "?messageKey=" + messageKey;
    doGet(url, OBJECT_TYPE.MessageURL, callback);
  }

  public void getReplyUrl(String messageKey, AsyncCallback<String> callback) {
    String url =
      getRepoServiceUrl() + REPLY + URL + "?messageKey=" + messageKey;
    doGet(url, OBJECT_TYPE.MessageURL, callback);
  }

  public void getThreadCountForForum(
    String forumId,
  ...
  public void getReplyCountForThread(
    String threadId,
    DiscussionFilter filter,
    AsyncCallback<Long> callback
  ) {
  ...
  public void getFileHandleAndUrlBatch(
   ...
   */
  public void getTemporaryFileHandleURL(
    String fileHandleId,
    AsyncCallback<String> callback
  ) {
    String url =
      getFileServiceUrl() + FILE_HANDLE + fileHandleId + "/url?redirect=false";
    doGetString(url, false, callback);
  }

  public String getProfilePicturePreviewURL(
    String profileId,
    boolean redirect
  ) {
    return (
      ...
      "/" +
      profileId +
      "/image/preview?redirect=" +
      redirect
    );
  }

  public void getTeamPicturePreviewURL(
    String teamId,
    AsyncCallback<String> callback
  ) {
    String url =
      ...
      "/" +
      teamId +
      "/icon/preview?redirect=false";
    doGetString(url, false, callback);
  }

  public void getEntityHeaderBatch(
  ...
  public void getEntityHeaderBatchFromReferences(
    List<Reference> list,
    AsyncCallback<ArrayList<EntityHeader>> callback
  ) {
  ...
  public FluentFuture<MembershipInvitation> getMembershipInvitation(
    ...
    String url =
      ...
      "/" +
      token.getMembershipInvitationId();
    return getFuture(cb ->
      doPost(url, token, OBJECT_TYPE.MembershipInvitation, true, cb)
    );
  }
  ...
  public FluentFuture<InviteeVerificationSignedToken> getInviteeVerificationSignedToken(
    ...
    return getFuture(cb ->
      doGet(url, OBJECT_TYPE.InviteeVerificationSignedToken, cb)
    );
  }

  public FluentFuture<Void> updateInviteeId(
    InviteeVerificationSignedToken token
  ) {
    String url =
      getRepoServiceUrl() +
      MEMBERSHIP_INVITATION +
  ...
  public void deleteMembershipInvitation(
    String id,
  ...
  public void createMembershipInvitation(
    MembershipInvitation invitation,
    AsyncCallback<MembershipInvitation> callback
  ) {
  ...
  public void getTeamMembershipStatus(
    String teamId,
    String principalId,
  ...
  public void updateV2WikiOrderHint(
    WikiPageKey key,
    V2WikiOrderHint toUpdate,
  ...
  public void getV2WikiOrderHint(
    WikiPageKey key,
    AsyncCallback<V2WikiOrderHint> callback
  ) {
    String url =
  ...
  public FluentFuture<List<ColumnModel>> getDefaultColumnsForView(
    int viewTypeMask
  ) {
    String url =
      getRepoServiceUrl() +
    ...
    return getFuture(cb ->
      doGet(
        url,
        OBJECT_TYPE.ListWrapperColumnModel,
        APPLICATION_JSON_CHARSET_UTF8,
        authController.getCurrentUserAccessToken(),
        canCancel,
        cb
  ...
  public FluentFuture<PaginatedTeamIds> getUserTeams(
    ...
    String urlBuilder =
      ...
      "/id?" +
      ASCENDING_PARAM +
      Boolean.toString(isAscendingOrder) +
      "&sort=TEAM_NAME";
    if (nextPageToken != null) {
  ...
  public FluentFuture<List<Team>> listTeams(List<String> teamIds) {
    ...
    return getFuture(cb ->
      doPost(url, idList, OBJECT_TYPE.ListWrapperTeam, true, cb)
    );
  }
  ...
  public void getProjectsForTeam(
    String teamId,
    int limit,
    String nextPageToken,
    ProjectListSortColumn sortBy,
  ...
  public void getAsynchJobResults(
    AsynchType type,
    String jobId,
  ...
  public void startAsynchJob(
    ...
    doPost(
      getEndpoint(type) + url,
      request,
      OBJECT_TYPE.AsyncJobId,
      false,
      callback
    );
  }

  public void getEntitiesGeneratedBy(
    String activityId,
    Integer limit,
    Integer offset,
  ...
  public void createActivityAndLinkToEntity(
    Activity activity,
    Entity entity,
    AsyncCallback<Entity> callback
  ) {
  ...
  public void updateActivity(
    ...
    String url =
      getRepoServiceUrl() + ACTIVITY_URI_PATH + "/" + activity.getId();
    doPut(url, activity, OBJECT_TYPE.Activity, callback);
  }

  public void getActivityForEntityVersion(
    String entityId,
    Long versionNumber,
    AsyncCallback<Activity> callback
  ) {
  ...
  public void getMultipartPresignedUrlBatch(
    ...
    doPost(
      url,
      request,
      OBJECT_TYPE.BatchPresignedUploadUrlResponse,
      false,
      callback
    );
  }

  public void addPartToMultipartUpload(
    String uploadId,
    int partNumber,
    String partMD5Hex,
  ...
  public void completeMultipartUpload(
    ...
    String url =
      getFileServiceUrl() + "/file/multipart/" + uploadId + "/complete";
    doPut(url, null, OBJECT_TYPE.MultipartUploadStatus, callback);
  }

  public void getOpenMembershipRequestCount(
    String teamId,
    AsyncCallback<Long> callback
  ) {
    String url =
  ...
  public void getPrincipalAlias(
    PrincipalAliasRequest request,
  ...
  public void unbindOAuthProvidersUserId(
    ...
    String url =
      ...
      "&" +
      "alias=" +
      gwt.encodeQueryString(alias);
    doDelete(url, callback);
  }

  public void lookupChild(
    String entityName,
  ...
  public void getAccessRequirement(
  ...
  public void getDataAccessSubmissions(
    String requirementId,
    String accessorId,
    String nextPageToken,
    ...
    boolean isAscending,
    AsyncCallback<SubmissionPage> callback
  ) {
    String url =
      getRepoServiceUrl() +
      ACCESS_REQUIREMENT +
  ...
  public void getUploadDestinations(
    String parentEntityId,
    AsyncCallback<List<UploadDestination>> callback
  ) {
    String url =
      getFileServiceUrl() + ENTITY + "/" + parentEntityId + UPLOAD_DESTINATIONS;
  ...
  public void deleteTeamMember(
    ...
    String url =
      getRepoServiceUrl() + TEAM + "/" + teamId + MEMBER + "/" + memberId;
    doDelete(url, callback);
  }

  public void addFileToDownloadListV2(
    String fileEntityId,
    Long version,
    AsyncCallback<AddBatchOfFilesToDownloadListResponse> callback
  ) {
    ...
    doPost(
      url,
      request,
      OBJECT_TYPE.AddBatchOfFilesToDownloadListResponse,
      false,
      callback
    );
  }

  public void addFileToDownloadList(
    String fileHandleId,
    String fileEntityId,
  ...
  public void addFilesToDownloadList(
    List<FileHandleAssociation> toAdd,
    AsyncCallback<DownloadList> callback
  ) {
  ...
  public void removeFileFromDownloadList(
  ...
  public void removeFilesFromDownloadList(
    List<FileHandleAssociation> toRemove,
    AsyncCallback<DownloadList> callback
  ) {
    FileHandleAssociationList request = new FileHandleAssociationList();
  ...
  public void createDownloadOrderFromUsersDownloadList(
    String zipFileName,
    AsyncCallback<DownloadOrder> callback
  ) {
    String url =
      getFileServiceUrl() + DOWNLOAD_ORDER + "?zipFileName=" + zipFileName;
    doPost(url, null, OBJECT_TYPE.DownloadOrder, false, callback);
  }

  public void getDownloadOrder(
    String orderId,
    AsyncCallback<DownloadOrder> callback
  ) {
  ...
  public void getDownloadOrderHistory(
    DownloadOrderSummaryRequest request,
    ...
    doPost(
      url,
      request,
      OBJECT_TYPE.DownloadOrderSummaryResponse,
      false,
      callback
    );
  }
  ...
  public FluentFuture<String> getAccessToken() {
    return getFuture(cb ->
      doGet(jsniUtils.getAccessTokenCookieUrl(), OBJECT_TYPE.String, cb)
    );
  }
  ...
  public void getColumnModelsForTableEntity(
  ...
  public Request getEntityVersions(
    String entityId,
    int offset,
    int limit,
  ...
  public FluentFuture<List<VersionInfo>> getEntityVersions(
    String entityId,
    int offset,
    int limit
  ) {
  ...
  public void getThreadsForEntity(
    String entityId,
    Long limit,
    Long offset,
    DiscussionThreadOrder order,
    Boolean ascending,
    DiscussionFilter filter,
    AsyncCallback<List<DiscussionThreadBundle>> callback
  ) {
    String url = getThreadsURL(
      ENTITY,
      entityId,
      limit,
      offset,
  ...
  public void getThreadsForForum(
    String forumId,
    Long limit,
    Long offset,
    DiscussionThreadOrder order,
  ...
  public void getRepliesForThread(
    String threadId,
    Long limit,
    Long offset,
    DiscussionReplyOrder order,
    Boolean ascending,
    DiscussionFilter filter,
  ...
  public void getV2WikiHeaderTree(
    String ownerId,
    String ownerType,
    ...
    getV2WikiHeaderTree(
      ...
      callback,
      0,
      new ArrayList<V2WikiHeader>()
    );
  }

  private void getV2WikiHeaderTree(
    String ownerId,
    String ownerType,
    AsyncCallback<List<V2WikiHeader>> finalCallback,
    int offset,
    ...
    doGet(
      url,
      OBJECT_TYPE.PaginatedResultsV2WikiHeader,
      new AsyncCallback<List<V2WikiHeader>>() {
        @Override
        public void onFailure(Throwable caught) {
  ...
  public void changePassword(
    ChangePasswordInterface changePasswordRequest,
    AsyncCallback<Void> cb
  ) {
  ...
  public void getTeamMembersStep2(
        ...
        for (int i = 0; i < userIds.size(); i++) {
          teamMemberBundles.add(
            new TeamMemberBundle(
              ...
              teamMembers.get(i).getIsAdmin(),
              teamMembers.get(i).getTeamId()
            )
          );
        }
  ...
  public void updateAnnotations(
    ...
    String url =
      getRepoServiceUrl() + ENTITY + "/" + entityId + "/annotations2";
  ...
  public Request getFileEntityTemporaryUrlForVersion(
    String entityId,
    Long versionNumber,
    boolean preview,
  ...
  public void additionalEmailValidation(
    ...
    String url =
      ...
      EMAIL_VALIDATION +
      "?" +
      PORTAL_ENDPOINT_PARAM +
      gwt.encodeQueryString(callbackUrl);
    Username username = new Username();
    username.setEmail(emailAddress);
    doPost(url, username, OBJECT_TYPE.None, false, cb);
  }
  ...
  public void getSynapseVersions(AsyncCallback<String> cb) {
    ...
    doGet(
      jsniUtils.getVersionsServletUrl(),
      OBJECT_TYPE.String,
      null,
      null,
      false,
  ...
  public void getAvailableEvaluations(
    ...
    Integer limit,
    Integer offset,
    AsyncCallback<List<Evaluation>> cb
  ) {
    String url =
      getRepoServiceUrl() +
  ...
  public void listApprovedSubmissionInfo(
    String requirementId,
    String nextPageToken,
    AsyncCallback<SubmissionInfoPage> cb
  ) {
    ...
    String url =
      ...
      "/" +
      requirementId +
      "/approvedSubmissionInfo";
    doPost(url, request, OBJECT_TYPE.SubmissionInfoPage, true, cb);
  }

  public void submitNRGRDataAccessToken(
    String token,
    AsyncCallback<String> cb
  ) {
  ...
  public void getAccessApprovalNotifications(
    String requirementId,
    ...
    doPost(
      url,
      request,
      OBJECT_TYPE.AccessApprovalNotificationResponse,
      true,
      cb
    );
  }

  public void getDefaultUploadDestination(
    String parentEntityId,
    AsyncCallback<UploadDestination> cb
  ) {
    String url =
      getFileServiceUrl() +
      ENTITY +
  ...
  public void getSchemaBinding(
    String entityId,
    AsyncCallback<JsonSchemaObjectBinding> cb
  ) {
    String url =
      getRepoServiceUrl() + ENTITY + "/" + entityId + "/schema/binding";
    doGet(url, OBJECT_TYPE.JsonSchemaObjectBinding, cb);
  }

  public void getSchemaValidationResults(
    String entityId,
    AsyncCallback<ValidationResults> cb
  ) {
    String url =
      getRepoServiceUrl() + ENTITY + "/" + entityId + "/schema/validation";
    doGet(url, OBJECT_TYPE.ValidationResults, cb);
  }

  private void getSchemaValidationResultsWithMatchingEtag(
    String entityId,
    String expectedEtag,
    int delayMs,
    AsyncCallback<ValidationResults> cb
    ...
    gwt.scheduleExecution(
      () ->
        getSchemaValidationResults(
          entityId,
          new AsyncCallback<ValidationResults>() {
            @Override
            public void onSuccess(ValidationResults result) {
              ...
              if (result.getObjectEtag().equals(expectedEtag)) {
                ...
                getSchemaValidationResultsWithMatchingEtag(
                  entityId,
                  expectedEtag,
                  delayMs * 2,
                  cb
   ...
   * @param cb
   */
  public void getSchemaValidationResultsWithMatchingEtag(
    String entityId,
    String expectedEtag,
    AsyncCallback<ValidationResults> cb
  ) {
  ...
  public FluentFuture<AccessControlList> createAccessRequirementACL(
    String id,
    AccessControlList acl
  ) {
    String url = getRepoServiceUrl() + ACCESS_REQUIREMENT + id + ACL;
    return getFuture(cb ->
      doPost(url, acl, OBJECT_TYPE.AccessControlList, false, cb)
    );
  }

  public FluentFuture<AccessControlList> updateAccessRequirementACL(
    String id,
    AccessControlList acl
  ) {
    String url = getRepoServiceUrl() + ACCESS_REQUIREMENT + id + ACL;
