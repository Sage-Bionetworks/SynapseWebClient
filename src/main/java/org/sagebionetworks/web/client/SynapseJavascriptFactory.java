	...
	public Object newInstance(OBJECT_TYPE type, JSONObjectAdapter json)
		...
		switch (type) {
			...
			case ListWrapperUserProfile:
				// json really represents a ListWrapper, but we can't reference ListWrapper here because it
				// uses Class.forName() (breaks gwt compile)
