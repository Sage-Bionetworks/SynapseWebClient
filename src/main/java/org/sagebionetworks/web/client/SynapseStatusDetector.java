...
public class SynapseStatusDetector {
	...
	@Inject
	public SynapseStatusDetector(GWTWrapper gwt, PopupUtilsView popupUtils,
			DateTimeUtils dateTimeUtils) {
		this.gwt = gwt;
	...
	public void showScheduledMaintenance(String name, String scheduledFor, String scheduledUntil) {
		...
		popupUtils.showInfo(
				"<a href=\"http://status.synapse.org/\" target=\"_blank\" class=\"color-white\">Maintenance on "
						+ startTime + " - " + name + "</a>",
				0);
	}
	...
	public void showOutage(String info) {
		popupUtils
				.showError("<a href=\"http://status.synapse.org/\" target=\"_blank\" class=\"color-white\">"
						+ info + "</a>", INTERVAL_MS - 1200);
	}
