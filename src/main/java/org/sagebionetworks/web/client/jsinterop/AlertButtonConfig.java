...
public class AlertButtonConfig {
	...
	@JsOverlay
	public static AlertButtonConfig create(String text, String href, Boolean isDisabled, String tooltipText) {
		AlertButtonConfig props = new AlertButtonConfig();
		props.text = text;
		props.href = href;
	...
	@JsOverlay
	public static AlertButtonConfig create(String text, Callback onClick, Boolean isDisabled, String tooltipText) {
		AlertButtonConfig props = new AlertButtonConfig();
		props.text = text;
		props.onClick = onClick;
		props.isDisabled = isDisabled;
