...
public class PageProgressProps extends ReactComponentProps {
	...
	@JsOverlay
	public static PageProgressProps create(String barColor, int barPercent, String backBtnLabel, Callback backBtnCallback,
										   String forwardBtnLabel, Callback forwardBtnCallback, boolean forwardBtnActive) {
