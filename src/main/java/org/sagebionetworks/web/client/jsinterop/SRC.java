...
public class SRC {
  ...
  public static class SynapseComponents {
    ...
    public static ReactComponentType<CsvPreviewDialogProps> CsvPreviewDialog;
    ...
    public static ReactComponentType<SynapseGridProps> SynapseGrid;
    public static ReactComponentType<EntityTreeTableProps> EntityTreeTable;
