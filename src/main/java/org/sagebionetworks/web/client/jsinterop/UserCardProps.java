...
public class UserCardProps extends ReactComponentProps {
	...
	@JsOverlay
	public static UserCardProps create(Object userProfile, String size, String avatarSize, boolean showCardOnHover,
									   Object menuActions, String preSignedURL, boolean hideEmail, String link,
									   boolean isCertified, boolean isValidated, boolean withAvatar, String className) {
