...
public class ACTAccessApprovalsPresenter extends AbstractActivity
		implements Presenter<ACTAccessApprovalsPlace>, ACTAccessApprovalsView.Presenter {
	...
	@Inject
	public ACTAccessApprovalsPresenter(final ACTAccessApprovalsView view, SynapseAlert synAlert,
			PortalGinInjector ginInjector, LoadMoreWidgetContainer loadMoreContainer,
			final Button showHideAccessRequirementButton, DataAccessClientAsync dataAccessClient,
			SynapseSuggestBox peopleSuggestWidget, UserGroupSuggestionProvider provider,
			UserBadge selectedUserBadge, AccessRequirementWidget accessRequirementWidget,
			GlobalApplicationState globalAppState) {
		this.view = view;
	...
	public void loadMore() {
		...
		synAlert.clear();
		dataAccessClient.listAccessorGroup(accessorGroupRequest,
