...
public class ACTDataAccessSubmissionDashboardPresenter
  ...
  public static final String NO_RESULTS =
    "There is no new Data Access Submissions.";
  ...
  public void loadMore() {
    synAlert.clear();
    dataAccessClient.getOpenSubmissions(
      nextPageToken,
      new AsyncCallback<OpenSubmissionPage>() {
        @Override
        ...
        public void onSuccess(OpenSubmissionPage openSubmissionPage) {
          noResultsDiv.setVisible(
            nextPageToken == null &&
            openSubmissionPage.getOpenSubmissionList().isEmpty()
          );
