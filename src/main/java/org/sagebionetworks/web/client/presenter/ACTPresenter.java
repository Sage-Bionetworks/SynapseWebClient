...
public class ACTPresenter extends AbstractActivity
		implements ACTView.Presenter, Presenter<ACTPlace> {
	...
	public ACTPresenter(ACTView view, UserProfileClientAsync userProfileClient, SynapseAlert synAlert,
			...
			PortalGinInjector ginInjector, GlobalApplicationState globalAppState,
			UserBadge selectedUserBadge, LoadMoreWidgetContainer loadMoreContainer) {
		this.view = view;
	...
	public void loadMore() {
		...
		userProfileClient.listVerificationSubmissions(stateFilter, submitterIdFilter, LIMIT,
				currentOffset, new AsyncCallback<VerificationPagedResults>() {
					@Override
