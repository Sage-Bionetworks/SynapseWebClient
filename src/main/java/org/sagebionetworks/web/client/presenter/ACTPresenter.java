...
public class ACTPresenter
  ...
  public ACTPresenter(
    ...
    peopleSuggestBox.addItemSelectedHandler(
  ...
  public void loadMore() {
    ...
    userProfileClient.listVerificationSubmissions(
      stateFilter,
      submitterIdFilter,
      LIMIT,
      currentOffset,
      new AsyncCallback<VerificationPagedResults>() {
        @Override
  ...
  public void setPlace(ACTPlace place) {
    ...
    if (stateFilterParam != null) {
      stateFilter =
        VerificationStateEnum.valueOf(stateFilterParam.toUpperCase());
      view.setSelectedStateText(stateFilterParam);
    }
    String submitterIdFilterParam = place.getParam(
      ACTPlace.SUBMITTER_ID_FILTER_PARAM
    );
