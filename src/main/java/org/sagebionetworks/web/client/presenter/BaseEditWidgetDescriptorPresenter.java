...
public class BaseEditWidgetDescriptorPresenter
  implements BaseEditWidgetDescriptorView.Presenter {
  ...
  @Inject
  public BaseEditWidgetDescriptorPresenter(
    BaseEditWidgetDescriptorView view,
  ...
  public void apply() {
    ...
    try {
      fireUpdatedEvent(
        WidgetRegistrarImpl.getWidgetMarkdown(
          contentTypeKey,
          widgetDescriptor,
          widgetRegistrar
        ),
        newFileHandleIds,
        deletedFileHandleIds
      );
  ...
  public void fireUpdatedEvent(
    ...
    List<String> newFileHandleIds,
    List<String> deletedFileHandleIds
  ) {
  ...
  @Override
  public void addWidgetDescriptorUpdatedHandler(
    WidgetDescriptorUpdatedHandler handler
  ) {
  ...
  public void editExisting(
    ...
    if (contentTypeKey == null) throw new IllegalArgumentException(
      "content type key cannot be null"
    );
    cleanInit();
