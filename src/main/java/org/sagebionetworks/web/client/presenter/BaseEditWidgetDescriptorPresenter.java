...
public class BaseEditWidgetDescriptorPresenter implements BaseEditWidgetDescriptorView.Presenter {
	...
	@Inject
	public BaseEditWidgetDescriptorPresenter(BaseEditWidgetDescriptorView view,
	...
	public void apply() {
		...
		try {
			fireUpdatedEvent(
					WidgetRegistrarImpl.getWidgetMarkdown(contentTypeKey, widgetDescriptor, widgetRegistrar),
					newFileHandleIds, deletedFileHandleIds);
	...
	@Override
	public void editExisting(WikiPageKey wikiKey, String contentTypeKey,
