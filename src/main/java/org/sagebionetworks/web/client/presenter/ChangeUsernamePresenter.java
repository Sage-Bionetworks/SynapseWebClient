...
public class ChangeUsernamePresenter extends AbstractActivity
		implements ChangeUsernameView.Presenter, Presenter<ChangeUsername> {
	...
	@Inject
	public ChangeUsernamePresenter(ChangeUsernameView view, SynapseClientAsync synapseClient,
			GlobalApplicationState globalAppState, AuthenticationController authController,
			JSONObjectAdapter jsonObjectAdapter, SynapseAlert synAlert) {
		this.view = view;
