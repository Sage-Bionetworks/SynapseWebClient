...
public class DownloadCartPresenter extends AbstractActivity implements DownloadCartPageView.Presenter, Presenter<org.sagebionetworks.web.client.place.DownloadCartPlace> {
	...
	@Inject
	public DownloadCartPresenter(DownloadCartPageView view, PortalGinInjector ginInjector, PopupUtilsView popupUtils) {
		this.view = view;
	...
	public void onViewSharingSettingsClicked(String benefactorEntityId) {
		ginInjector.getSynapseJavascriptClient().getEntity(benefactorEntityId, new AsyncCallback<Entity>() {
			@Override
