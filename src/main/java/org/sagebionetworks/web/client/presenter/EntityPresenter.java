...
public class EntityPresenter extends AbstractActivity
	...
	public EntityPresenter(EntityView view, EntityPresenterEventBinder entityPresenterEventBinder,
			GlobalApplicationState globalAppState, AuthenticationController authenticationController,
			SynapseJavascriptClient jsClient, StuAlert synAlert, EntityPageTop entityPageTop,
			Header headerWidget, OpenTeamInvitationsWidget openTeamInvitesWidget, GWTWrapper gwt,
			EventBus eventBus) {
	...
	public void refresh() {
		...
		if (isValidEntityId(entityId)) {
			if (versionNumber == null) {
				...
				jsClient.getEntityBundleForVersion(entityId, versionNumber, EntityPageTop.ALL_PARTS_REQUEST,
						callback);
			}
		} else {
