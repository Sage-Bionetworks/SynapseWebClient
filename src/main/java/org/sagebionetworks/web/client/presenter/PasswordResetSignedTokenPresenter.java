...
public class PasswordResetSignedTokenPresenter
  extends AbstractActivity
  implements
    PasswordResetSignedTokenView.Presenter,
    Presenter<PasswordResetSignedTokenPlace> {
  ...
  @Inject
  public PasswordResetSignedTokenPresenter(
    PasswordResetSignedTokenView view,
