...
public class PeopleSearchPresenter extends AbstractActivity
		implements PeopleSearchView.Presenter, Presenter<PeopleSearch> {
	...
	@Inject
	public PeopleSearchPresenter(PeopleSearchView view, GlobalApplicationState globalApplicationState,
			SynapseAlert synAlert, LoadMoreWidgetContainer loadMoreWidgetContainer,
			PortalGinInjector ginInjector, SynapseJavascriptClient jsClient) {
		this.view = view;
	...
	public void loadMore() {
		...
		jsClient.getUserGroupHeadersByPrefix(searchTerm, TypeFilter.USERS_ONLY,
				(long) SEARCH_PEOPLE_LIMIT, (long) this.offset, callback);
	}
}
