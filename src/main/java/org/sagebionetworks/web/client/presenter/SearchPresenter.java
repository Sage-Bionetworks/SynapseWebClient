...
public class SearchPresenter extends AbstractActivity
	...
	@Inject
	public SearchPresenter(SearchView view, GlobalApplicationState globalApplicationState,
			SynapseJavascriptClient jsClient, JSONObjectAdapter jsonObjectAdapter, SynapseAlert synAlert,
	...
	public IconType getIconForHit(Hit hit) {
		...
		return org.sagebionetworks.web.client.EntityTypeUtils
				.getIconTypeForEntityClassName(EntityTypeUtils.getEntityTypeClassName(type));
	}
