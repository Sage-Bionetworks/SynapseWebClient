...
public class SignedTokenPresenter
  ...
  @Inject
  public SignedTokenPresenter(
    SignedTokenView view,
  ...
  public void handleEmailInvitationToken(final String signedEncodedToken) {
    globalApplicationState
      .getPlaceChanger()
      .goTo(new EmailInvitation(signedEncodedToken));
  }
  ...
  public void handleSignedToken(SignedTokenInterface signedToken) {
    view.clear();
    view.setLoadingVisible(true);
    synapseClient.handleSignedToken(
      signedToken,
  ...
  public void okClicked() {
    globalApplicationState
      .getPlaceChanger()
      .goTo(AppActivityMapper.getDefaultPlace());
  }
}
