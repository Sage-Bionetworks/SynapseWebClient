...
public class SubscriptionPresenter
  ...
  public static final String MISSING_PARAMS_MESSAGE =
    "Missing subscription and topic information.";
  ...
  public void setPlace(SubscriptionPlace place) {
    ...
    if (subscriptionIdParam != null) {
      ...
      objectType =
        SubscriptionObjectType.valueOf(objectTypeParam.toUpperCase());
