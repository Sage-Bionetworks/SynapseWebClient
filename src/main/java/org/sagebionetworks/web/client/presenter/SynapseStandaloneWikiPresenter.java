...
public class SynapseStandaloneWikiPresenter extends AbstractActivity
		implements Presenter<StandaloneWiki> {
	...
	@Inject
	public SynapseStandaloneWikiPresenter(SynapseStandaloneWikiView view,
	...
	public void setPlace(StandaloneWiki place) {
		...
		if (place.getWikiId() != null && place.getOwnerId() != null && place.getOwnerType() != null) {
			WikiPageKey key =
					new WikiPageKey(place.getOwnerId(), place.getOwnerType(), place.getWikiId());
			configure(key);
