...
public class SynapseWikiPresenter extends AbstractActivity
		implements SynapseWikiView.Presenter, Presenter<Wiki> {
	...
	public void configure(final WikiPageKey wikiKey) {
		synapseClient.hasAccess(wikiKey.getOwnerObjectId(), wikiKey.getOwnerObjectType(),
				ACCESS_TYPE.UPDATE.toString(), new AsyncCallback<Boolean>() {
					@Override
