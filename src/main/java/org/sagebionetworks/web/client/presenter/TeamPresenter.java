...
public class TeamPresenter
  ...
  implements
    TeamView.Presenter, Presenter<org.sagebionetworks.web.client.place.Team> {
      ...
      new AsyncCallback<TeamBundle>() {
        ...
        public void onSuccess(TeamBundle result) {
          ...
          managerListWidget.configure(
            teamId,
            isAdmin,
            TeamMemberTypeFilterOptions.ADMIN,
            refreshCallback
          );
          memberListWidget.configure(
            teamId,
            isAdmin,
            TeamMemberTypeFilterOptions.MEMBER,
            refreshCallback
          );
  ...
  public void refreshOpenMembershipRequests() {
    ...
    openMembershipRequestsWidget.configure(
      currentTeamId,
      refreshOpenMembershipRequestsCallback
    );
  }
  ...
  public void refreshOpenUserInvitations() {
    ...
    openUserInvitationsWidget.configure(
      currentTeamId,
      refreshOpenUserInvitationsCallback
    );
  }
