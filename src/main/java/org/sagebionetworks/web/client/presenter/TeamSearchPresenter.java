...
public class TeamSearchPresenter extends AbstractActivity
		implements TeamSearchView.Presenter, Presenter<TeamSearch> {
	...
	@Inject
	public TeamSearchPresenter(TeamSearchView view, GlobalApplicationState globalApplicationState,
			SynapseClientAsync synapseClient, CookieProvider cookieProvider, SynapseAlert synAlert,
			LoadMoreWidgetContainer loadMoreWidgetContainer, PortalGinInjector ginInjector) {
		this.view = view;
