...
public class WikiDiffPresenter extends AbstractActivity
		implements WikiDiffView.Presenter, Presenter<WikiDiff> {
	...
	@Inject
	public WikiDiffPresenter(WikiDiffView view, SynapseClientAsync synapseClient,
			SynapseJavascriptClient jsClient, SynapseAlert synAlert,
			GlobalApplicationState globalAppState, ResourceLoader resourceLoader,
	...
	public void getVersions(Long offset) {
		synapseClient.getV2WikiHistory(key, LIMIT, offset,
