...
public class GovernanceServiceHelper {
	...
	public static final String LOCK_ACCESS_REQUIREMENT_TEXT =
	...
	public static void signTermsOfUse(final String principalId, final AccessRequirement ar,
			final SynapseClientAsync synapseClient, AsyncCallback<AccessApproval> callback) {
		AccessApproval ew;
	...
	public static String getAccessRequirementText(AccessRequirement ar) {
		if (ar == null || ar instanceof ManagedACTAccessRequirement
				|| ar instanceof SelfSignAccessRequirement)
			return "";
