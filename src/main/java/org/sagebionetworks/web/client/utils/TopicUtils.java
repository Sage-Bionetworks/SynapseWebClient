...
public class TopicUtils {
  ...
  public static Synapse getReplyPlace(
    String projectId,
    String threadId,
    String replyId
  ) {
    String token =
      THREAD_ID_KEY + "=" + threadId + "&" + REPLY_ID_KEY + "=" + replyId;
    return new Synapse(projectId, null, Synapse.EntityArea.DISCUSSION, token);
  }

  public static String buildReplyLink(
    String projectId,
    String threadId,
    String replyId
  ) {
  ...
  public static String buildSynapseForumReplyLink(
    String threadId,
    String replyId
  ) {
    String link =
