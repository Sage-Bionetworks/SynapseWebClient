...
public class ChallengeOverviewViewImpl extends Composite implements ChallengeOverviewView {
	...
	public interface ChallengeOverviewViewImplUiBinder
			extends UiBinder<Widget, ChallengeOverviewViewImpl> {
	}
	...
	@Inject
	public ChallengeOverviewViewImpl(ChallengeOverviewViewImplUiBinder binder, Header headerWidget,
	...
	public void showSubmissionError() {
		DisplayUtils.showErrorMessage(
				"There was an error during submission.  Please try again or contact Sage Bionetworks.");
	}
