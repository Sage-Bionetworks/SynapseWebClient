...
public class ComingSoonViewImpl extends Composite implements ComingSoonView {
	...
	@Inject
	public ComingSoonViewImpl(ComingSoonViewImplUiBinder binder, Header headerWidget,
			Footer footerWidget, SynapseJSNIUtils synapseJSNIUtils, PortalGinInjector ginInjector,
			AuthenticationController authenticationController, GoogleMap map,
			RejectReasonWidget rejectReasonWidget, JSONObjectAdapter jsonObjectAdapter,
			DownloadSpeedTester downloadSpeedTester, SRCDemoWidget srcTableWidget) {
