...
public class ComingSoonViewImpl extends Composite implements ComingSoonView {
  ...
  public interface ComingSoonViewImplUiBinder
  ...
  private final ComingSoonViewImplUiBinder binder = GWT.create(
    ComingSoonViewImplUiBinder.class
  );

  @Inject
  public ComingSoonViewImpl(
    Header headerWidget,
    Footer footerWidget,
    ...
    AsyncCallback<Double> downloadSpeedCallback = new AsyncCallback<Double>() {
      ...
      public void onFailure(Throwable caught) {
        downloadSpeedResult.setText(
          "Use SynapseAlert to handle error: " + caught.getMessage()
        );
      }
      ...
      public void onSuccess(Double result) {
        ...
        downloadSpeedResult.setText(
          DisplayUtils.getFriendlySize(result, true) + "/s"
        );
      }
    };
