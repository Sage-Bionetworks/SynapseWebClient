 ...
 * @author jayhodgson
 */
public interface DivView extends HasId, HasResponsiveness, HasInlineStyle, HasPull, HasWidgets.ForIsWidget, IsWidget, HasVisibility, SupportsLazyLoadInterface {
