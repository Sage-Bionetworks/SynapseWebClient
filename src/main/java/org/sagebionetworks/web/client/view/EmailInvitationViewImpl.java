...
public class EmailInvitationViewImpl extends Composite implements EmailInvitationView {
	...
	@Inject
	public EmailInvitationViewImpl(EmailInvitationViewImplUiBinder binder, Header headerWidget,
			SynapseJSNIUtils jsniUtils) {
	...
	public interface EmailInvitationViewImplUiBinder
			extends UiBinder<Widget, EmailInvitationViewImpl> {
	}
}
