...
public class HomeViewImpl extends Composite implements HomeView {
	...
	public HomeViewImpl(HomeViewImplUiBinder binder, Header headerWidget,
			...
			final AuthenticationController authController, UserBadge userBadge,
			RegisterWidget registerWidget, LoginWidget loginWidget) {
		...
		dashboardBtn.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				globalApplicationState.getPlaceChanger()
						.goTo(new Profile(authController.getCurrentUserPrincipalId(), ProfileArea.PROJECTS));
			}
		});
		...
		becomeCertifiedBox.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				DisplayUtils.newWindow(
						WebConstants.DOCS_URL + "accounts_certified_users_and_profile_validation.html", "", "");
			}
		});
	}
