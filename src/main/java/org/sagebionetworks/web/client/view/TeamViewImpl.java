...
public class TeamViewImpl extends Composite implements TeamView {
	...
	@Inject
	public TeamViewImpl(TeamViewImplUiBinder binder, InviteWidget inviteWidget, Header headerWidget,
			GWTWrapper gwt, BigTeamBadge bigTeamBadge, CookieProvider cookieProvider) {
