...
public class TrashViewImpl extends Composite implements TrashView {
	...
	private static final String DELETE_SELECTED_CONFIRM_TITLE =
			"Delete selected items from your Trash?";
	...
	@Inject
	public TrashViewImpl(TrashViewImplUiBinder binder, Header headerWidget, Footer footerWidget,
		...
		deleteSelectedButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				DisplayUtils.showConfirmDialog(DELETE_SELECTED_CONFIRM_TITLE,
						DELETE_SELECTED_CONFIRM_MESSAGE, new Callback() {
	...
	private void createPagination() {
		...
		List<PaginationEntry> entries =
				presenter.getPaginationEntries(TrashPresenter.TRASH_LIMIT, MAX_PAGES_IN_PAGINATION);
		if (entries != null) {
