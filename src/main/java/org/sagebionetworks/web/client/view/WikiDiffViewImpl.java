...
public class WikiDiffViewImpl implements WikiDiffView {
	...
	public final ClickHandler VERSION_1_CLICKHANDLER = event -> {
		...
		String wikiVersion =
				panel.getElement().getAttribute(WikiVersionAnchorListItem.WIKI_VERSION_ATTRIBUTE);
	...
	@Inject
	public WikiDiffViewImpl(WikiDiffViewImplUiBinder binder, Header headerWidget,
	...
	public void showDiff(String markdown1, String markdown2) {
		_showDiff(diffContainer.getElement(), version1DropdownButton.getText(),
				version2DropdownButton.getText(), markdown1, markdown2);
	}

	private static native void _showDiff(Element outputDivElement, String baseTextTitle,
			String newTextTitle, String markdown1, String markdown2) /*-{
	...
	private void addVersions(DropDownMenu dropdown, ClickHandler clickHandler,
