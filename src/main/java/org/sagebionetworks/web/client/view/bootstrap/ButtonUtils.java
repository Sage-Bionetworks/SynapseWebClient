...
public class ButtonUtils {
	...
	/**
	 * Helper to change the enable state of a button and the button type at the same time. When a
	 * button is enabled the passed ButtonType will be applied. Wehen the button is disabled, the
