...
public class RegisterWidget
  implements RegisterWidgetView.Presenter, SynapseWidgetPresenter {
  ...
  public void registerUser(String email) {
    ...
    newUser.setEncodedMembershipInvtnSignedToken(
  ...
  public void setEncodedMembershipInvtnSignedToken(
    String encodedMembershipInvtnSignedToken
  ) {
