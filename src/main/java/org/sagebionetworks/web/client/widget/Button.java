 ...
 *
 */
public interface Button extends HasEnabled, HasActive, HasType<ButtonType>, HasSize<ButtonSize>,
		HasDataTarget, HasClickHandlers, Focusable, HasAllMouseHandlers, HasTargetHistoryToken, HasHref,
		HasText, HasIcon, HasIconPosition, HasBadge, IsWidget, HasPull {
