...
public class DownloadSpeedTesterImpl implements DownloadSpeedTester {
  ...
  public static final String ESTIMATED_DOWNLOAD_SPEED_CACHE_KEY =
  ...
  public void testDownloadSpeed(final AsyncCallback<Double> callback) {
    if (clientCache.contains(ESTIMATED_DOWNLOAD_SPEED_CACHE_KEY)) {
      String downloadSpeedString = clientCache.get(
        ESTIMATED_DOWNLOAD_SPEED_CACHE_KEY
      );
    ...
    if (authController.isLoggedIn()) {
      ...
      callback.onFailure(
        new UnauthorizedException("Must be logged in to check download speed.")
      );
    }
  }

  public void testDownloadSpeedStep2(
      ...
      new AsyncCallback<FileResult>() {
        ...
        public void onSuccess(FileResult fileResult) {
          if (fileResult.getFailureCode() == null) {
            ...
            onFailure(
              new Exception(
                "Unable to get the test file presigned url and file handle: " +
  ...
  public void testDownloadSpeedStep3(
    String url,
    double fileSize,
    AsyncCallback<Double> callback
  ) {
            ...
            if (statusCode == Response.SC_OK) {
              ...
              onError(
                ...
                new IllegalArgumentException(
                  "Unable to retrieve test file. Reason: " +
