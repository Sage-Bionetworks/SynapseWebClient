...
public class FileHandleWidget implements IsWidget {
	...
	@Inject
	public FileHandleWidget(FileHandleWidgetView view, AuthenticationController authController,
			FileHandleAsyncHandler fileHandleAsynHandler, SynapseJSNIUtils jsniUtils) {
		this.view = view;
	...
	public String createAnchorHref(FileHandleAssociation fha) {
		return jsniUtils.getFileHandleAssociationUrl(fha.getAssociateObjectId(),
