...
public class SelectableItemList extends ArrayList<SelectableListItem>
		implements SelectableListView.Presenter {
	...
	/**
	 * 
	 * @param refreshCallback called back when UI should be refreshed (after underlying items have
	 *        been modified).
