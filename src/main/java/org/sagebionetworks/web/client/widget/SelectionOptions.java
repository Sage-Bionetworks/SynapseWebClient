...
public class SelectionOptions implements IsWidget {
	...
	public interface SelectionOptionsUiBinder extends UiBinder<Widget, SelectionOptions> {
	}
	...
	public SelectionOptions() {
		SelectionOptionsUiBinder binder = GWT.create(SelectionOptionsUiBinder.class);
