...
public class SelectionToolbar implements IsWidget {
  ...
  public interface SelectionToolbarUiBinder
    extends UiBinder<Widget, SelectionToolbar> {}
  ...
  public SelectionToolbar() {
    SelectionToolbarUiBinder binder = GWT.create(
      SelectionToolbarUiBinder.class
    );
