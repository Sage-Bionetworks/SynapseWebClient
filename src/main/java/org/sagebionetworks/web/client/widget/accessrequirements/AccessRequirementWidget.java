...
public class AccessRequirementWidget implements IsWidget {
	...
	public AccessRequirementWidget(PortalGinInjector ginInjector,
			DataAccessClientAsync dataAccessClient, DivView div) {
	...
	public void configure(final String accessRequirementId,
		...
		dataAccessClient.getAccessRequirement(Long.parseLong(accessRequirementId),
	...
	public void configure(AccessRequirement requirement, RestrictableObjectDescriptor targetSubject,
		...
		if (requirement instanceof ManagedACTAccessRequirement) {
			...
			handleException(new IllegalArgumentException(
					"unsupported access requirement type: " + requirement.getClass().getName()));
		}
	}
