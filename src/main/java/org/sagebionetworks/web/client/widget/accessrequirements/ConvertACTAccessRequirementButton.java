...
public class ConvertACTAccessRequirementButton
  implements IsWidget, ClickHandler {

  public static final String SUCCESS_MESSAGE =
    "Successfully converted access requirement";
  public static final String CONVERT_AR_CONFIRM_TITLE =
    "Are you sure you want to migrate this Access Requirement?";
  public static final String CONVERT_AR_CONFIRM_MESSAGE =
    "Clicking OK will change this access requirement so that new data access requests will be handled within Synapse (no longer through Jira/email/spreadsheets). Please test the migration on staging (staging.synapse.org) before running on production (www.synapse.org). THIS ACTION CANNOT BE UNDONE.";
  public static final String DELETE_OLD_INSTRUCTIONS_MESSAGE =
    "Sorry, you have to delete the old (html) instructions before it can be converted.  Edit the Access Requirement, add a wiki, then delete the old instructions.";
  ...
  @Inject
  public ConvertACTAccessRequirementButton(
    Button button,
  ...
  public void convertAccessRequirement() {
    ...
    dataAccessClient.convertAccessRequirement(
      request,
