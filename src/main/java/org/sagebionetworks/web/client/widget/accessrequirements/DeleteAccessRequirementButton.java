...
public class DeleteAccessRequirementButton implements IsWidget {
  ...
  public static final String DELETE_ACCESS_REQUIREMENT_MESSAGE =
    "Are you sure?";
  public static final String DELETE_ACCESS_REQUIREMENT_TITLE =
  ...
  @Inject
  public DeleteAccessRequirementButton(
    Button button,
  ...
  public void deleteAccessRequirementAfterConfirmation() {
    synapseClient.deleteAccessRequirement(
      ar.getId(),
