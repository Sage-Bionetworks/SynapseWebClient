...
public class LockAccessRequirementWidget implements IsWidget {
	...
	@Inject
	public LockAccessRequirementWidget(LockAccessRequirementWidgetView view,
			SubjectsWidget subjectsWidget, DeleteAccessRequirementButton deleteAccessRequirementButton) {
		this.view = view;
