...
public class ManagedACTAccessRequirementWidget
	...
	public ManagedACTAccessRequirementWidget(ManagedACTAccessRequirementWidgetView view,
			...
			DeleteAccessRequirementButton deleteAccessRequirementButton,
			ReviewAccessRequestsButton reviewAccessRequestsButton,
			IntendedDataUseReportButton iduReportButton, DataAccessClientAsync dataAccessClient,
			LazyLoadHelper lazyLoadHelper, AuthenticationController authController,
			UserBadge submitterUserBadge, DateTimeUtils dateTimeUtils,
			ReviewAccessorsButton manageAccessButton) {
		this.view = view;
