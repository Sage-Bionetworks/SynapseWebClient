...
public class ReviewAccessorsButton implements IsWidget {
  ...
  public static final String MANAGE_ACCESS_BUTTON_TEXT =
    "Review Data Requestors";
  public Button button;
  public IsACTMemberAsyncHandler isACTMemberAsyncHandler;
  AccessRequirement ar;

  @Inject
  public ReviewAccessorsButton(
    Button button,
    ...
    button.addClickHandler(
      new ClickHandler() {
        ...
        public void onClick(ClickEvent event) {
          ACTAccessApprovalsPlace place = new ACTAccessApprovalsPlace(
            ACTAccessApprovalsPlace.ACCESS_REQUIREMENT_ID_PARAM +
            "=" +
            ar.getId()
          );
