...
public class AccessorGroupWidget
  implements AccessorGroupView.Presenter, IsWidget {

  public static final String NO_NOTIFICATIONS_FOUND_MESSAGE =
    "No notifications found.";
  public static final String ARE_YOU_SURE =
    "Accessors will lose access to resources that this approval grants. Are you sure?";
  ...
  @Inject
  public AccessorGroupWidget(
    AccessorGroupView view,
    SynapseAlert synAlert,
    PortalGinInjector ginInjector,
    PopupUtilsView popupUtils,
    AccessRequirementWidget accessRequirementWidget,
  ...
  public void onShowAccessRequirement() {
    accessRequirementWidget.configure(
      accessorGroup.getAccessRequirementId(),
      null
    );
  ...
  public void onShowNotifications() {
    jsClient.getAccessApprovalNotifications(
      accessorGroup.getAccessRequirementId(),
      accessorGroup.getAccessorIds(),
      new AsyncCallback<AccessApprovalNotificationResponse>() {
        @Override
