...
public class AccessorGroupWidget implements AccessorGroupView.Presenter, IsWidget {
	...
	public AccessorGroupWidget(AccessorGroupView view, SynapseAlert synAlert,
			PortalGinInjector ginInjector, PopupUtilsView popupUtils,
			AccessRequirementWidget accessRequirementWidget, DataAccessClientAsync dataAccessClient,
			DateTimeUtils dateTimeUtils, UserProfileAsyncHandler userProfileAsyncHandler) {
		this.view = view;
	...
	public void onRevokeAfterConfirm() {
		dataAccessClient.revokeGroup(accessorGroup.getAccessRequirementId(),
				accessorGroup.getSubmitterId(), new AsyncCallback<Void>() {
					@Override
