...
public class CreateBasicAccessRequirementStep2
  ...
  public void configure(AccessRequirement accessRequirement) {
    ...
    String oldTerms = GovernanceServiceHelper.getAccessRequirementText(
      accessRequirement
    );
    ...
    view.setHasAccessorRequirementUIVisible(
    ...
    if (accessRequirement instanceof HasAccessorRequirement) {
      ...
      view.setIsValidatedProfileRequired(
        hasAccessorRequirement.getIsValidatedProfileRequired()
      );
    }
    configureWiki();
  }
  ...
  public void onClearOldInstructions() {
    popupUtils.showConfirmDialog(
      "Are you sure?",
      "Deleting the old instructions cannot be undone.  Continue?",
      new Callback() {
        @Override
        public void invoke() {
  ...
  public void onPrimary() {
    if (accessRequirement instanceof HasAccessorRequirement) {
      ...
      hasAccessorRequirement.setIsValidatedProfileRequired(
