...
public class CreateManagedACTAccessRequirementStep2
  ...
  public void configure(ManagedACTAccessRequirement accessRequirement) {
    ...
    view.setAreOtherAttachmentsRequired(
      accessRequirement.getAreOtherAttachmentsRequired()
    );
    if (accessRequirement.getExpirationPeriod() != null) {
      view.setExpirationPeriod(
        Long.toString(accessRequirement.getExpirationPeriod() / DAY_IN_MS)
      );
    } else {
      view.setExpirationPeriod("");
    }
    ...
    view.setIsCertifiedUserRequired(
      accessRequirement.getIsCertifiedUserRequired()
    );
  ...
  public void onEditWiki() {
    wikiMarkdownEditor.configure(
      wikiKey,
      new CallbackP<WikiPage>() {
        @Override
  ...
  public void onPrimary() {
    ...
    accessRequirement.setAreOtherAttachmentsRequired(
      view.areOtherAttachmentsRequired()
    );
    ...
    if (DisplayUtils.isDefined(expirationPeriod)) {
      try {
        ...
        accessRequirement.setExpirationPeriod(
          expirationPeriodInDays * DAY_IN_MS
        );
      } catch (NumberFormatException e) {
        modalPresenter.setErrorMessage(
          "Please enter a valid expiration period (in days): " + e.getMessage()
        );
        return;
      }
    } else {
    ...
    accessRequirement.setIsCertifiedUserRequired(
