...
public class CreateDataAccessSubmissionWizardStep2ViewImpl
  implements CreateDataAccessSubmissionWizardStep2View {

  public interface Binder
    extends UiBinder<Widget, CreateDataAccessSubmissionWizardStep2ViewImpl> {}
