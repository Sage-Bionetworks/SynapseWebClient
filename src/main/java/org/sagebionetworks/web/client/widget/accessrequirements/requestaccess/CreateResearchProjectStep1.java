...
public class CreateResearchProjectStep1 implements ModalPage {
  ...
  public void configure(
    ...
    client.getResearchProject(
      ar.getId(),
      new AsyncCallback<ResearchProject>() {
        @Override
        ...
        public void onSuccess(ResearchProject researchProject) {
          ...
          if (researchProject.getIntendedDataUseStatement() != null) {
            view.setIntendedDataUseStatement(
              researchProject.getIntendedDataUseStatement()
            );
          }
  ...
  private void updateResearchProject() {
    ...
    researchProject.setIntendedDataUseStatement(
      view.getIntendedDataUseStatement()
    );
    researchProject.setProjectLead(view.getProjectLead());
    // create/update research project
    client.updateResearchProject(
      researchProject,
      new AsyncCallback<ResearchProject>() {
        @Override
        public void onFailure(Throwable caught) {
  ...
  public void onPrimary() {
    ...
    if (!DisplayUtils.isDefined(view.getInstitution())) {
      ...
      ar.getIsIDURequired() &&
      !DisplayUtils.isDefined(view.getIntendedDataUseStatement())
    ) {
      modalPresenter.setErrorMessage(
        "Please fill in the intended data use statement."
      );
    } else {
