...
public class ACTDataAccessSubmissionWidgetViewImpl
  ...
  public interface Binder
    extends UiBinder<Widget, ACTDataAccessSubmissionWidgetViewImpl> {}
  ...
  public ACTDataAccessSubmissionWidgetViewImpl(Binder binder) {
    ...
    moreInfoButton.addClickHandler(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
