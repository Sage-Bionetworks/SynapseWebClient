...
public abstract class AsyncHandlerImpl {
	private Map<String, List<AsyncCallback>> reference2Callback =
			new HashMap<String, List<AsyncCallback>>();
	...
	public void executeRequests() {
		if (!reference2Callback.isEmpty()) {
			final Map<String, List<AsyncCallback>> reference2CallbackCopy =
					new HashMap<String, List<AsyncCallback>>();
