...
public class AsynchronousJobTrackerImpl implements AsynchronousJobTracker {
	 ...
	 */
	public void startAndTrack(AsynchType type, final AsynchronousRequestBody requestBody,
	...
	/**
	 * Will call handler.onComplete() as long as no other handler method, other than onUpdate() has
	 * been called on the handler.
	 * 
	 * @param status
	 */
	...
	/**
	 * Will call handler.onFailure() as long as no other handler method, other than onUpdate() has
	 * been called on the handler.
	 * 
	 * @param jobId
	 * @param caught
