...
public class AsynchronousJobTrackerImpl implements AsynchronousJobTracker {
  ...
  public void startAndTrack(
    AsynchType type,
    final AsynchronousRequestBody requestBody,
     ...
     */
    this.oneTimeReference =
      new OneTimeReference<AsynchronousProgressHandler>(handler);
  ...
  private void oneTimeOnCancel() {
    AsynchronousProgressHandler mightBeNull =
      this.oneTimeReference.getReference();
    if (mightBeNull != null) {
