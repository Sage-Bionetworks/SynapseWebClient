...
public class UserGroupHeaderAsyncHandlerImpl
  extends AsyncHandlerImpl
  implements UserGroupHeaderAsyncHandler {

  SynapseJavascriptClient jsClient;

  @Inject
  public UserGroupHeaderAsyncHandlerImpl(
    SynapseJavascriptClient jsClient,
    GWTWrapper gwt
  ) {
    super(gwt);
  ...
  @Override
  public void getUserGroupHeader(
    String principalId,
