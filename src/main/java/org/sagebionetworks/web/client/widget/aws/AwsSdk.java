...
public class AwsSdk {
	 ...
	 * @param endpoint
	 */
	public void upload(final String key, JavaScriptObject file, String contentType,
			JavaScriptObject s3, S3DirectUploadHandler callback) {
		_upload(key, file, contentType, s3, callback);
	}

	private static native void _upload(String key, JavaScriptObject file, String contentType,
			JavaScriptObject s3, S3DirectUploadHandler callback) /*-{
		var parameters = {
			Key : key,
	...
	public String getPresignedURL(String key, String bucketName, String fileName,
			JavaScriptObject s3) {
		return _getPresignedURL(key, bucketName, fileName, s3);
	}

	private static native String _getPresignedURL(String key, String bucketName, String fileName,
			JavaScriptObject s3)
	/*-{
		var params = {
			Bucket : bucketName,
	...
	public void getS3(final String accessKeyId, final String secretAccessKey, final String bucketName,
			final String endpoint, final CallbackP<JavaScriptObject> s3Callback) {
	...
	private static native JavaScriptObject _getS3(String accessKeyId, String secretAccessKey,
