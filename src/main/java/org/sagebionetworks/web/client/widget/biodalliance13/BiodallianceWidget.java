...
public class BiodallianceWidget
  implements
    BiodallianceWidgetView.Presenter, IsWidget, WidgetRendererPresenter {
  ...
  public static void updateSourceURIs(BiodallianceSource source) {
    source.setSourceURI(
      BiodallianceWidget.getFileResolverURL(
        source.getEntityId(),
        source.getVersion()
      )
    );
    source.setIndexSourceURI(
      BiodallianceWidget.getFileResolverURL(
        source.getIndexEntityId(),
        source.getIndexVersion()
      )
    );
  }
