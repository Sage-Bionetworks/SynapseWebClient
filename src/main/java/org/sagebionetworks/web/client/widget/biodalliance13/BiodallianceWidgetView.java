...
public interface BiodallianceWidgetView extends IsWidget {
	 ...
	 * @param sources
	 */
	void showBiodallianceBrowser(String urlPrefix, String containerId, String initChr,
			int initViewStart, int initViewEnd, BiodallianceConfigInterface currentConfig,
