...
public class BiodallianceWidgetViewImpl implements BiodallianceWidgetView {
	...
	private static BiodallianceWidgetViewImplUiBinder uiBinder =
			GWT.create(BiodallianceWidgetViewImplUiBinder.class);
	...
	public void showBiodallianceBrowser(final String urlPrefix, final String containerId,
			...
			final BiodallianceConfigInterface currentConfig, final List<BiodallianceSource> sources) {
		GWT.runAsync(new RunAsyncCallback() {
			@Override
			public void onSuccess() {
				new Biodalliance013dev().show(urlPrefix, containerId, initChr, initViewStart, initViewEnd,
