    ...
    humanTwoBitURI =
      BiodallianceWidget.getFileResolverURL(
        synapseProperties.getSynapseProperty(
          "org.sagebionetworks.portal.biodalliance.human.twobit"
        )
      );
    humanBwgURI =
      BiodallianceWidget.getFileResolverURL(
        synapseProperties.getSynapseProperty(
          "org.sagebionetworks.portal.biodalliance.human.bwg"
        )
      );
    humanTrixURI =
      BiodallianceWidget.getFileResolverURL(
        synapseProperties.getSynapseProperty(
          "org.sagebionetworks.portal.biodalliance.human.trix"
        )
      );
    humanTrixxURI =
      BiodallianceWidget.getFileResolverURL(
        synapseProperties.getSynapseProperty(
          "org.sagebionetworks.portal.biodalliance.human.trixx"
        )
      );
    humanStylesheetURI =
      BiodallianceWidget.getFileResolverURL(
        synapseProperties.getSynapseProperty(
          "org.sagebionetworks.portal.biodalliance.human.stylesheet"
        )
      );
