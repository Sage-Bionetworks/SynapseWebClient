    ...
    mouseTwoBitURI =
      BiodallianceWidget.getFileResolverURL(
        synapseProperties.getSynapseProperty(
          "org.sagebionetworks.portal.biodalliance.mouse.twobit"
        )
      );
    mouseBwgURI =
      BiodallianceWidget.getFileResolverURL(
        synapseProperties.getSynapseProperty(
          "org.sagebionetworks.portal.biodalliance.mouse.bwg"
        )
      );
    mouseTrixURI =
      BiodallianceWidget.getFileResolverURL(
        synapseProperties.getSynapseProperty(
          "org.sagebionetworks.portal.biodalliance.mouse.trix"
        )
      );
    mouseTrixxURI =
      BiodallianceWidget.getFileResolverURL(
        synapseProperties.getSynapseProperty(
          "org.sagebionetworks.portal.biodalliance.mouse.trixx"
        )
      );
    mouseStylesheetURI =
      BiodallianceWidget.getFileResolverURL(
        synapseProperties.getSynapseProperty(
          "org.sagebionetworks.portal.biodalliance.mouse.stylesheet"
        )
      );
