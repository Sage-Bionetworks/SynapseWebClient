...
public class BiodallianceEditorViewImpl implements BiodallianceEditorView {
  ...
  public interface BiodallianceEditorViewImplUiBinder
    extends UiBinder<Widget, BiodallianceEditorViewImpl> {}
  ...
  public BiodallianceEditorViewImpl(BiodallianceEditorViewImplUiBinder binder) {
    ...
    selectionToolbar.setDeleteClickedCallback(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
    ...
    selectionToolbar.setMovedownClicked(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
    ...
    selectionToolbar.setMoveupClicked(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
    ...
    selectionToolbar.setSelectAllClicked(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
    ...
    selectionToolbar.setSelectNoneClicked(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
