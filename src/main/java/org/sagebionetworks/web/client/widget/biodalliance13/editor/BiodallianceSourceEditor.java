...
public class BiodallianceSourceEditor
		implements BiodallianceSourceEditorView.Presenter, IsWidget, SelectableListItem {
	...
	@Inject
	public BiodallianceSourceEditor(BiodallianceSourceEditorView view, EntityFinder entityFinder,
			EntityFinder indexEntityFinder, BiodallianceSource source, SynapseJavascriptClient jsClient) {
		this.view = view;
	...
	public void checkParams() throws IllegalArgumentException {
		...
		if (SourceType.VCF.equals(source.getSourceType())
	...
	public void entitySelected(Reference ref) {
		...
		if (ref.getTargetVersionNumber() == null) {
			...
			jsClient.getEntityBundleForVersion(ref.getTargetId(), ref.getTargetVersionNumber(),
					bundleRequest, callback);
		}
	}
	...
	private void updateFromView() {
		...
		// entity id and version are pushed back from the view (on selection), so we don't need to
		// update here
	}
