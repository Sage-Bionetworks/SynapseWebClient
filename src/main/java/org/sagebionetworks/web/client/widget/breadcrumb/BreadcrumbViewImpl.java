	...
	public void setLinksList(List<LinkData> breadcrumbs, String current) {
		...
		for (int i = 0; i < breadcrumbs.size(); i++) {
			...
			if (data.getPlace() instanceof Synapse) {
				...
				anchor.setHref("#" + DisplayUtils.getSynapseHistoryTokenNoHash(synapsePlace.getEntityId(),
						synapsePlace.getVersionNumber(), synapsePlace.getArea(), synapsePlace.getAreaToken()));
			}
