...
public class DiscussionThreadListItemWidget
		implements DiscussionThreadListItemWidgetView.Presenter {
	...
	@Inject
	public DiscussionThreadListItemWidget(DiscussionThreadListItemWidgetView view,
			UserBadge authorWidget, PortalGinInjector ginInjector, DateTimeUtils dateTimeUtils) {
