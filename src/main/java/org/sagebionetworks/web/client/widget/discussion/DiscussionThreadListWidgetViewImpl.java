...
public class DiscussionThreadListWidgetViewImpl
  implements DiscussionThreadListWidgetView {
  ...
  public void clearSort() {
    SortableTableHeaderImpl[] sortableColumns = new SortableTableHeaderImpl[] {
      sortByReplies,
      sortByViews,
      sortByActivity,
      sortByTopic,
  ...
  private void updateSortUI(
    SortableTableHeaderImpl sortColumn,
    boolean ascending
  ) {
    SortDirection newDirection = ascending
      ? SortDirection.ASC
      : SortDirection.DESC;
