...
public class ReplyWidget implements ReplyWidgetView.Presenter {
  ...
  public void configure(
    ...
    view.setCreatedOn(
      SingleDiscussionThreadWidget.CREATED_ON_PREFIX +
            ...
            if (statusCode == Response.SC_OK) {
              ...
              onError(
                ...
                new IllegalArgumentException(
                  "Unable to retrieve message for reply " +
                  replyId +
                  ". Reason: " +
  ...
  public void deleteReply() {
    synAlert.clear();
    discussionForumClientAsync.markReplyAsDeleted(
      replyId,
  ...
  public void onClickReplyLink() {
    ...
    if (projectId == forumSynapseId) {
      url =
        ...
        TopicUtils.buildSynapseForumReplyLink(threadId, replyId).substring(1);
    } else {
      url =
        gwt.getHostPageBaseURL() +
