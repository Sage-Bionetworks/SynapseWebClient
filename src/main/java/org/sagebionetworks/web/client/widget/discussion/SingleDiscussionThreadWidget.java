...
public class SingleDiscussionThreadWidget
  implements SingleDiscussionThreadWidgetView.Presenter {
  ...
  private static final DiscussionReplyOrder DEFAULT_ORDER =
    DiscussionReplyOrder.CREATED_ON;
  public static final Boolean DEFAULT_ASCENDING = true;
  public static final Long LIMIT = 30L;
  private static final DiscussionFilter DEFAULT_FILTER =
    DiscussionFilter.EXCLUDE_DELETED;

  private static final String CONFIRM_RESTORE_DIALOG_TITLE =
    "Confirm Restoration";
  ...
  private static final String RESTORE_SUCCESS_MESSAGE =
    "A thread has been restored.";
  ...
  ActionListenerV2 editActionListener, unpinActionListener, pinActionListener, deleteActionListener, restoreActionListener;
  Boolean isPinned;
  ...
  public SingleDiscussionThreadWidget(
    ...
    Callback refreshSubscribersCallback = new Callback() {
      @Override
      public void invoke() {
        SingleDiscussionThreadWidget.this.threadSubscribersWidget.configure(
            threadTopic
          );
      }
    };
      ...
      !bundle
        ...
        .equals(
          ginInjector
            ...
            .getSynapseProperty(ForumWidget.DEFAULT_THREAD_ID_KEY)
        )
    ) {
  ...
  private void configureView(DiscussionThreadBundle bundle) {
    ...
    view.setTitle(title);
    view.setCreatedOn(
      CREATED_ON_PREFIX + dateTimeUtils.getRelativeTime(bundle.getCreatedOn())
    );
  ...
  public void onClickThread() {
    if (threadIdClickedCallback == null) {
      globalApplicationState
        .getPlaceChanger()
        .goTo(TopicUtils.getThreadPlace(projectId, threadId));
    } else {
      threadIdClickedCallback.invoke(threadId);
    }
  }

  public void setThreadIdClickedCallback(
    CallbackP<String> threadIdClickedCallback
  ) {
  ...
  public void configureMessage() {
    ...
    subscribeButtonWidget.configure(
            ...
            if (statusCode == Response.SC_OK) {
              ...
              onError(
                ...
                new IllegalArgumentException(
                  "Unable to retrieve message for thread " +
                  threadId +
                  ". Reason: " +
    ...
    jsClient.getReply(
      ...
      new AsyncCallback<DiscussionReplyBundle>() {
        ...
        public void onSuccess(DiscussionReplyBundle bundle) {
          ...
          replyWidget.addStyleName("highlight-reply");
          repliesContainer.add(replyWidget.asWidget());
        }
      }
    );
  ...
  public void deleteThread() {
    synAlert.clear();
    discussionForumClientAsync.markThreadAsDeleted(
      threadId,
  ...
  public void onClickPinThread() {
    synAlert.clear();
    discussionForumClientAsync.pinThread(
      threadId,
      new AsyncCallback<Void>() {
        @Override
        public void onFailure(Throwable caught) {
  ...
  public void onClickUnpinThread() {
    synAlert.clear();
    discussionForumClientAsync.unpinThread(
      threadId,
      new AsyncCallback<Void>() {
        @Override
        public void onFailure(Throwable caught) {
  ...
  public void restoreThread() {
    synAlert.clear();
    discussionForumClientAsync.restoreThread(
      threadId,
      new AsyncCallback<Void>() {
        @Override
        public void onFailure(Throwable caught) {
