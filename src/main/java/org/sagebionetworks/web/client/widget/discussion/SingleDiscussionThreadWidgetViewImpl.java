...
public class SingleDiscussionThreadWidgetViewImpl
  implements SingleDiscussionThreadWidgetView {
  ...
  @Inject
  public SingleDiscussionThreadWidgetViewImpl() {
    ...
    showAllRepliesButton.addClickHandler(
      new ClickHandler() {
        @Override
