...
public class SubscribersWidget
  implements SubscribersWidgetView.Presenter, IsWidget {
  ...
  public void loadMoreSubscribers() {
    synAlert.clear();
    jsClient.getSubscribers(
      topic,
      nextPageToken,
      new AsyncCallback<SubscriberPagedResults>() {
        @Override
        public void onFailure(Throwable caught) {
