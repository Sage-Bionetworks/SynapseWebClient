...
public class DockerCommitListWidget
  implements IsWidget, DockerCommitListWidgetView.Presenter {

  public static final Long LIMIT = 10L;
  public static final DockerCommitSortBy DEFAULT_ORDER =
    DockerCommitSortBy.CREATED_ON;
  ...
  public void loadMore() {
    synAlert.clear();
    jsClient.getDockerTaggedCommits(
      entityId,
      LIMIT,
      offset,
      order,
