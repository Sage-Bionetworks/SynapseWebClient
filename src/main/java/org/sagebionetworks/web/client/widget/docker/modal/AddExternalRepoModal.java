...
public class AddExternalRepoModal
  implements AddExternalRepoModalView.Presenter {

  public static final String ADD_EXTERNAL_REPO_MODAL_TITLE =
    "Add External Repository";
  public static final String SUCCESS_TITLE = "External repository added";
  public static final String SUCCESS_MESSAGE =
    "An external repository has been added";
