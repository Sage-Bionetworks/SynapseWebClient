...
public class CreateOrUpdateDoiModal implements CreateOrUpdateDoiModalView.Presenter {
    ...
    public void configureAndShow(Entity entity, Optional<Long> entityVersion, UserProfile userProfile) {
        this.entity = entity;
     ...
     */
    public Doi createNewDoi(Entity entity, Optional<Long> entityVersion, UserProfile userProfile) {
        Doi newDoi = new Doi();
