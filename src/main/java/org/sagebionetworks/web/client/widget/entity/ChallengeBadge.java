...
public class ChallengeBadge implements SynapseWidgetPresenter {
	...
	@Inject
	public ChallengeBadge(ChallengeBadgeView view, EntityHeaderAsyncHandler entityHeaderAsyncHandler,
	...
	public void configure(Challenge challenge) {
		if (challenge != null) {
			...
			entityHeaderAsyncHandler.getEntityHeader(challenge.getProjectId(),
