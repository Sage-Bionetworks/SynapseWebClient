...
public class EditFileMetadataModalWidgetImpl
	...
	private boolean isFileHandleChange() {
		return !this.fileHandle.getFileName().equals(getFileNameFromView())
				|| !Objects.equal(this.fileHandle.getContentType(), getFileContentTypeFromView());
	}
	...
	@Override
	public void configure(final FileEntity fileEntity, FileHandle fileHandle,
