...
public class EditProjectMetadataModalWidgetImpl
  implements
    EditProjectMetadataModalView.Presenter, EditProjectMetadataModalWidget {
  ...
  public void onPrimary() {
    ...
    boolean isSameAlias = startingAlias == null
      ? alias == null
      : startingAlias.equals(alias);
    if (name == null) {
      view.showError(
