...
public class EditRegisteredTeamDialog
  implements EditRegisteredTeamDialogView.Presenter {
  ...
  @Inject
  public EditRegisteredTeamDialog(
    EditRegisteredTeamDialogView view,
  ...
  public void configure(ChallengeTeam challengeTeam, Callback callback) {
    ...
    if (challengeTeam.getMessage() != null) view.setRecruitmentMessage(
      challengeTeam.getMessage()
    );
    view.showModal();
  }
  ...
  public void onOk() {
    ...
    challengeClient.updateRegisteredChallengeTeam(
      challengeTeam,
      new AsyncCallback<ChallengeTeam>() {
        @Override
  ...
  public void onUnregister() {
    challengeClient.unregisterChallengeTeam(
      challengeTeam.getId(),
