...
public class EntityBadgeViewImpl extends Composite implements EntityBadgeView {
	...
	@Inject
	public EntityBadgeViewImpl(final Binder uiBinder, final SynapseJSNIUtils synapseJSNIUtils,
			PortalGinInjector ginInjector, GlobalApplicationState globalAppState,
			UserBadge modifiedByBadge, DateTimeUtils dateTimeUtils) {
	...
	public void setEntity(final EntityHeader entityHeader) {
		...
		if (entityHeader != null) {
			...
			entityAnchor.addStyleName(
					"link text-overflow-ellipsis inline-block whitespace-nowrap overflowHidden");
