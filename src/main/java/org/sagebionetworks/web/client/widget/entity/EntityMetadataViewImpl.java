...
public class EntityMetadataViewImpl extends Composite implements EntityMetadataView {
	...
	public EntityMetadataViewImpl(IconsImageBundle iconsImageBundle,
			SynapseJSNIUtils synapseJSNIUtils, FavoriteWidget favoriteWidget, DoiWidget doiWidget, PortalGinInjector ginInjector, AccessControlListEditor accessControlListEditor) {
