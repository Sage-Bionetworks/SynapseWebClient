 ...
 *
 */
public class EntitySearchBoxViewImpl
  extends FlowPanel
  implements EntitySearchBoxView, IsWidget {
  ...
  @Inject
  public EntitySearchBoxViewImpl(EntitySearchBoxOracle oracle) {
    suggestBox =
      new SuggestBox(oracle, new TextBox(), new SynapseSuggestionDisplay());
  ...
  public void updateFieldStateForSuggestions(
    ...
    boolean moreResults =
      offset + EntitySearchBox.PAGE_SIZE < responsePage.getFound();
  ...
  public void showLoading() {
    ((SynapseSuggestionDisplay) suggestBox.getSuggestionDisplay()).showLoading(
        this
      );
  }
