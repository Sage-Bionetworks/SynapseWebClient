...
public class FavoriteWidget implements Presenter, IsWidget {
	...
	@Inject
	public FavoriteWidget(FavoriteWidgetView view, SynapseClientAsync synapseClient,
	...
	private void setIsFavorite(final String entityId, final boolean isFavorite,
