...
public class MarkdownEditorWidgetViewImpl implements MarkdownEditorWidgetView {
  ...
  public interface Binder
    extends UiBinder<Widget, MarkdownEditorWidgetViewImpl> {}
  ...
  private void lazyConstruct() {
    if (viewWidget == null) {
      ...
      editWidgetButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.EDIT_WIDGET)
      );
      attachmentLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_ATTACHMENT)
      );
      genomeBrowserLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_BIODALLIANCE_GENOME_BROWSER)
      );
      buttonLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_BUTTON_LINK)
      );
      entityListLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_ENTITY_LIST)
      );
      imageLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_IMAGE)
      );
      joinTeamLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_JOIN_TEAM)
      );
      linkLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_LINK)
      );
      detailsSummaryLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_DETAILS_SUMMARY)
      );
      provenanceGraphLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_PROV_GRAPH)
      );
      queryLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_QUERY_TABLE)
      );
      leaderboardLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_LEADERBOARD)
      );
      referenceLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_REFERENCE)
      );
      submitToEvaluationLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_SUBMIT_TO_EVALUATION)
      );
      tableLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_TABLE)
      );
      tableOfContentsLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_TOC)
      );
      userLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_USER_LINK)
      );
      graphLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_GRAPH)
      );
      userButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_USER_LINK)
      );
      teamLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_USER_TEAM_BADGE)
      );
      ...
      previewLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_PREVIEW)
      );
      synapseTableLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_SYNAPSE_TABLE)
      );
      externalWebsiteLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_EXTERNAL_WEBSITE)
      );
      supertableLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_API_SUPERTABLE)
      );
      wikifilesPreviewLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_WIKI_FILES_PREVIEW)
      );
      tutorialWizardLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_TUTORIAL_WIZARD)
      );
      iduReportLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_INTENDED_DATA_USE_REPORT)
      );
      registerChallengeTeamLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_REGISTER_CHALLENGE_TEAM)
      );
      challengeTeamsLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_CHALLENGE_TEAMS)
      );
      challengeParticipantsLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_CHALLENGE_PARTICIPANTS)
      );
      boldButton.addClickHandler(getClickHandler(MarkdownEditorAction.BOLD));
      italicButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.ITALIC)
      );
      strikeButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.STRIKETHROUGH)
      );
      codeBlockButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.CODE_BLOCK)
      );
      mathButton.addClickHandler(getClickHandler(MarkdownEditorAction.MATH));
      subscriptButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.SUBSCRIPT)
      );
      superscriptButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.SUPERSCRIPT)
      );
      ...
      attachmentButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_ATTACHMENT)
      );
      imageButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_IMAGE)
      );
      imageLinkMenuItem.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_IMAGE_LINK)
      );
      imageLinkButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_IMAGE_LINK)
      );
      videoButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_VIDEO)
      );
      linkButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_LINK)
      );
      cytoscapeJsLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_CYTOSCAPE_JS)
      );
      teamMembersLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_TEAM_MEMBERS)
      );
      teamMemberCountLink.addClickHandler(
        getClickHandler(MarkdownEditorAction.INSERT_TEAM_MEMBER_COUNT)
      );
      markdownPreviewButton.addClickHandler(
        getClickHandler(MarkdownEditorAction.MARKDOWN_PREVIEW)
      );
      ...
      formattingGuideButton.addClickHandler(event -> {
        ...
        formattingGuideModal.configure(
          "Formatting Guide",
          null,
          "Close",
          null,
      ...
      markdownTextArea.addKeyPressHandler(
        new KeyPressHandler() {
          @Override
      ...
      writeMarkdownButton.addClickHandler(
        new ClickHandler() {
          @Override
