...
public class PreviewWidgetViewImpl
  extends FlowPanel
  implements PreviewWidgetView, IsWidget {
  ...
  private String getCodeHtml(String code, String language) {
    ...
    sb.append(
      "<pre style=\"overflow:auto;white-space:pre;\"><code class=\"" +
      language +
      "\">"
    );
    sb.append(code);
  ...
  private String getTableHtml(ArrayList<String[]> rows) {
    StringBuilder sb = new StringBuilder();
    sb.append(
      "<table class=\"previewtable\" style=\"overflow:auto;display:block\">"
    );
    for (String[] row : rows) {
      sb.append("<tr>");
