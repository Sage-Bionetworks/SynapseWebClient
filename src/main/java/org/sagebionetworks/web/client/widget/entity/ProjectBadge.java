...
public class ProjectBadge implements SynapseWidgetPresenter {
	...
	@Inject
	public ProjectBadge(ProjectBadgeView view, FavoriteWidget favoritesWidget, GWTWrapper gwt,
	...
	public void updateTooltip() {
		if (header.getModifiedBy() != null) {
			userProfileAsyncHandler.getUserProfile(header.getModifiedBy().toString(),
	...
	public void updateTooltip(UserProfile modifiedBy) {
		...
		if (header.getModifiedOn() != null) {
			...
			map.put("Modified On",
					gwt.getDateTimeFormat(PredefinedFormat.DATE_TIME_MEDIUM).format(header.getModifiedOn()));
		}
