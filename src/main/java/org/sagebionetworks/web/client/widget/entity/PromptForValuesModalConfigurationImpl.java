 ...
 *
 */
public class PromptForValuesModalConfigurationImpl implements PromptForValuesModalView.Configuration {
	...
	@Override
	public void setInputTypes(List<PromptForValuesModalView.InputType> inputTypes) {
	...
	public static class Builder implements PromptForValuesModalView.Configuration.Builder {
		String title;
		String bodyCopy;
		...
		@Override
		public Builder addPrompt(String prompt, String initialValue, PromptForValuesModalView.InputType inputType) {
		...
		@Override
		public Builder addPrompts(List<String> prompts, List<String> initialValues) {
		...
		@Override
		public Builder addPrompts(List<String> prompts, List<String> initialValues, List<PromptForValuesModalView.InputType> inputTypes) {
			for (int i = 0; i < prompts.size(); i++) {
