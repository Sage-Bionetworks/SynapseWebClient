...
public class PromptForValuesModalViewImpl implements PromptForValuesModalView {
  ...
  public interface Binder
    extends UiBinder<Modal, PromptForValuesModalViewImpl> {}
  ...
  public void configureAndShow(
    ...
    configureAndShow(
      title,
      promptListWrapper,
      initialValueListWrapper,
      newValueCallbackWrapper
    );
  }
  ...
  public void configureAndShow(
    ...
    for (int i = 0; i < configuration.getPrompts().size(); i++) {
      ...
      ValueBoxBase<String> inputBox = getNewInstanceOfInputField(
        configuration.getInputTypes().get(i)
      );
