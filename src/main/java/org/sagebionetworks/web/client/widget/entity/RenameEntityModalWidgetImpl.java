...
public class RenameEntityModalWidgetImpl implements RenameEntityModalWidget {
	...
	@Inject
	public RenameEntityModalWidgetImpl(PromptForValuesModalView view, SynapseJavascriptClient jsClient, CookieProvider cookieProvider) {
		super();
		this.view = view;
	...
	public void onRename(List<String> newValues) {
		...
		} else if (this.startingName.equals(name) && Objects.equals(this.startingDescription, description)) {
