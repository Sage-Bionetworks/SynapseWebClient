...
public class TutorialWizard implements TutorialWizardView.Presenter, WidgetRendererPresenter {
	...
	public void configure(WikiPageKey wikiKey, Map<String, String> widgetDescriptor,
			org.sagebionetworks.web.client.utils.Callback widgetRefreshRequired, Long wikiVersionInView) {
	...
	/**
	 * Give it a base entity Id and it will discover all subpages (and show their content in a
	 * tutorial wizard)
	 * 
	 * @param entityId
	 */
	public void configure(final String entityId, Callback callback) {
		...
		jsClient.getV2WikiHeaderTree(entityId, ObjectType.ENTITY.toString(),
