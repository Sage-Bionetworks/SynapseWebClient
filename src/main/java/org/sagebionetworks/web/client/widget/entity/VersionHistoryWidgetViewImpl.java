 ...
 * @author jayhodgson
 */
public class VersionHistoryWidgetViewImpl extends Composite
	...
	private static VersionHistoryWidgetViewImplUiBinder uiBinder =
			GWT.create(VersionHistoryWidgetViewImplUiBinder.class);
	...
	@Inject
	public VersionHistoryWidgetViewImpl(PortalGinInjector ginInjector,
	...
	public void setEntityBundle(Entity entity, boolean isShowingOlderVersion) {
		...
		currentVersionLink
				.setTargetHistoryToken(DisplayUtils.getSynapseHistoryTokenNoHash(entity.getId()));
	...
	@Override
	public void addVersion(String entityId, final VersionInfo version, boolean canEdit,
		...
		String versionHref =
				DisplayUtils.getSynapseHistoryToken(version.getId(), version.getVersionNumber());
		fileHistoryRow.configure(versionNumber, versionHref, "Version " + versionName, modifiedByUserId,
				modifiedOn, size, md5, versionComment, deleteCallback, doiWidget);
	...
	public void showEditVersionInfo(String oldLabel, String oldComment) {
		...
		editVersionInfoModal.configureAndShow("Edit Version Info", prompts, initialValues,
