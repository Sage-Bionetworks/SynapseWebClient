...
public class WikiHistoryWidget
  ...
  public static final String NO_HISTORY_IS_FOUND_FOR_A_WIKI =
    "No history is found for a wiki";
        ...
        public void onSuccess(PaginatedResults<V2WikiHistorySnapshot> result) {
          ...
          if (
            ...
            for (int i = 0; i < historyAsListOfHeaders.size(); i++) {
              String modifiedById = historyAsListOfHeaders
                .get(i)
                .getModifiedBy();
              // Only add unique ids to the list being built
              if (
                mapIdToName != null &&
                !idsToSearch.contains(modifiedById) &&
