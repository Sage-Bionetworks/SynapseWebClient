...
public class WikiMarkdownEditor
  implements IsWidget, WikiMarkdownEditorView.Presenter {
  ...
  public WikiMarkdownEditor(
    ...
    editor.setFilesAddedCallback(
      new CallbackP<List<String>>() {
        @Override
    ...
    editor.setFilesRemovedCallback(
      new CallbackP<List<String>>() {
        @Override
        public void invoke(List<String> fileHandleIds) {
  ...
  public void configure(
    ...
    CallbackP<WikiPage> wikiPageUpdatedHandler
  ) {
        ...
        public void onFailure(Throwable caught) {
          ...
          if (caught instanceof NotFoundException) {
            ...
            view.showErrorMessage(
              DisplayConstants.ERROR_LOADING_WIKI_FAILED + caught.getMessage()
            );
          }
        }
      }
    ...
    synapseClient.updateV2WikiPageWithV1(
      ...
      new AsyncCallback<WikiPage>() {
        ...
        public void onSuccess(WikiPage result) {
          ...
          if (wikiPageUpdatedHandler != null) wikiPageUpdatedHandler.invoke(
            result
          );
        }
        ...
        public void onFailure(Throwable caught) {
          view.showErrorMessage(
            DisplayConstants.ERROR_SAVING_WIKI + caught.getMessage()
          );
        }
      }
    );
  ...
  public void cancelClicked() {
    if (!editor.getMarkdown().equals(currentPage.getMarkdown())) {
      ...
      popupUtils.showConfirmDialog(
        DisplayConstants.UNSAVED_CHANGES,
