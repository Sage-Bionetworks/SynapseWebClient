...
public class WikiMarkdownEditorViewImpl implements WikiMarkdownEditorView {
  ...
  public interface Binder
    extends UiBinder<Widget, WikiMarkdownEditorViewImpl> {}
  ...
  @Inject
  public WikiMarkdownEditorViewImpl() {
    super();
    ...
    cancelButton.addDomHandler(
      DisplayUtils.getPreventTabHandler(cancelButton),
      KeyDownEvent.getType()
    );
    editorDialog.addCloseHandler(onCancel);
    deleteButton.addClickHandler(onDelete);
    editorDialog.addDomHandler(
