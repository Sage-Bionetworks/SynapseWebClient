...
public class WikiPageDeleteConfirmationDialogViewImpl
	...
	public WikiPageDeleteConfirmationDialogViewImpl(
		...
		deleteWikiButton.addDomHandler(DisplayUtils.getPreventTabHandler(deleteWikiButton),
	...
	@Override
	public void showModal(String wikiPageId, Map<String, V2WikiHeader> id2HeaderMap,
	...
	private void addToDeleteListRecursive(String pageId, Map<String, V2WikiHeader> id2HeaderMap,
			Map<String, List<V2WikiHeader>> id2ChildrenMap, UnorderedList parentUL) {
