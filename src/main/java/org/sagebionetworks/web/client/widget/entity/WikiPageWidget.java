 ...
 *
 */
public class WikiPageWidget
  implements WikiPageWidgetView.Presenter, SynapseWidgetPresenter {
  ...
  public WikiPageWidget(
    WikiPageWidgetView view,
    SynapseClientAsync synapseClient,
    StuAlert stuAlert,
    WikiHistoryWidget historyWidget,
  ...
  public void setWikiPage(WikiPage result) {
    ...
    try {
      ...
      view.setModifiedCreatedByHistoryPanelVisible(
        isModifiedCreatedByHistoryVisible
      );
  ...
  public void showPreview(final Long versionToPreview, Long currentVersion) {
    ...
    jsClient.getVersionOfV2WikiPageAsV1(
      wikiKey,
      versionToPreview,
      new AsyncCallback<WikiPage>() {
        @Override
        public void onFailure(Throwable caught) {
          if (caught instanceof NotFoundException) {
            if (callback != null) callback.noWikiFound();
          } else {
