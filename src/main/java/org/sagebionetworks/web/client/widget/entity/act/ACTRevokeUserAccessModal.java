...
public class ACTRevokeUserAccessModal
  implements RevokeUserAccessModalView.Presenter, IsWidget {
  ...
  @Inject
  public ACTRevokeUserAccessModal(
    RevokeUserAccessModalView view,
