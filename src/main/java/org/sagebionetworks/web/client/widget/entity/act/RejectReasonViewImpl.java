...
public class RejectReasonViewImpl implements RejectReasonView {
	...
	public RejectReasonViewImpl(Binder binder) {
		...
		primaryButton.addDomHandler(DisplayUtils.getPreventTabHandler(primaryButton),
	...
	public String getSelectedCheckboxText() {
		...
		CheckBox[] checkboxes = new CheckBox[] {synapseQuizOption, addInfoOption, orcIDPublicOption,
				physicallyInitialOption, submitDocsOption};
