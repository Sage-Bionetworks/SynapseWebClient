...
public class EditAnnotationsDialog
  implements EditAnnotationsDialogView.Presenter {
  ...
  public AnnotationEditor createAnnotationEditor(
    String key,
  ...
  public void onAddNewAnnotation(List<String> values) {
    ...
    AnnotationEditor newEditor = createAnnotationEditor(
      initialKey,
      annotationValue
    );
    view.addAnnotationEditor(newEditor.asWidget());
  ...
  public void onSave() {
    ...
    jsClient.updateAnnotations(
      entityId,
      annotationsCopy,
      new AsyncCallback<Annotations>() {
        @Override
