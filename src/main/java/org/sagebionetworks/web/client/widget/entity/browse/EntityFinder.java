...
public class EntityFinder implements EntityFinderView.Presenter, IsWidget {
	public static final String ENTITY_FINDER_AREA_KEY =
			"org.sagebionetworks.web.client.entityfinder.area";
	...
	@Inject
	public EntityFinder(EntityFinderView view, GlobalApplicationState globalApplicationState,
			AuthenticationController authenticationController, ClientCache cache, SynapseAlert synAlert,
	...
	public void configure(EntityFilter filter, boolean showVersions,
	...
	public void configureMulti(EntityFilter filter, boolean showVersions,
			SelectedHandler<List<Reference>> handler) {
		this.filter = filter;
		this.showVersions = showVersions;
	...
	public void lookupEntity(ReferenceList rl, final CallbackP<List<EntityHeader>> callback) {
		synAlert.clear();
		jsClient.getEntityHeaderBatchFromReferences(rl.getReferences(),
	...
	public void loadVersions(String entityId) {
		synAlert.clear();
		jsClient.getEntityVersions(entityId, WebConstants.ZERO_OFFSET.intValue(), 200,
