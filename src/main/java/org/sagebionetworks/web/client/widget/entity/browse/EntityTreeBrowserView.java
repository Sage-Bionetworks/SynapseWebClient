...
public interface EntityTreeBrowserView extends IsWidget, SynapseView {
	...
	public interface Presenter {
		...
		void addMoreButton(MoreTreeItem moreItem, String parentId, EntityTreeItem parent,
	...
	void placeChildMoreTreeItem(MoreTreeItem childToCreate, EntityTreeItem parent,
			String nextPageToken);
