...
public class EntityTreeBrowserViewImpl extends FlowPanel implements EntityTreeBrowserView {
	...
	@Inject
	public EntityTreeBrowserViewImpl(IconsImageBundle iconsImageBundle, Binder uiBinder,
	 ...
	 */
	@Override
	public void placeRootMoreTreeItem(final MoreTreeItem childToCreate, final String parentId,
	 ...
	 */
	@Override
	public void placeChildMoreTreeItem(final MoreTreeItem childToCreate, final EntityTreeItem parent,
			final String nextPageToken) {
		childToCreate.setClickHandler(event -> {
