...
public class MyEntitiesBrowser
  implements MyEntitiesBrowserView.Presenter, SynapseWidgetPresenter {
  ...
  @Inject
  public MyEntitiesBrowser(
    MyEntitiesBrowserView view,
  ...
  public boolean isSameContext() {
    if (
      globalApplicationState.getCurrentPlace() == null ||
      authenticationController.getCurrentUserPrincipalId() == null
    ) {
      return false;
    }
    return (
      globalApplicationState.getCurrentPlace().equals(cachedPlace) &&
  ...
  public void loadMoreUserUpdateable() {
    if (authenticationController.isLoggedIn()) {
      jsClient.getMyProjects(
        ...
        PROJECT_LIMIT,
        nextPageToken,
        ProjectListSortColumn.PROJECT_NAME,
        SortDirection.ASC,
