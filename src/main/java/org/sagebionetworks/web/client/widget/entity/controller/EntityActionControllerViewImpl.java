...
public class EntityActionControllerViewImpl
  implements EntityActionControllerView {
  ...
  public void showPromptDialog(
    ...
    lazyConstruct();
    promptForValuesDialog.configureAndShow(
      title,
      "",
      initialValue,
      inputType,
  ...
  @Override
  public void showMultiplePromptDialog(
