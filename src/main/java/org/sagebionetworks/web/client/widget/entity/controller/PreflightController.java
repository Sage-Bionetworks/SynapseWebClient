...
public interface PreflightController
		extends UploadController, DownloadController, EntityCRUDController {
	 ...
	 * @param callback
	 */
	public void checkCreateEntityAndUpload(EntityBundle parentEntity, String entityClassName,
			Callback callback);
}
