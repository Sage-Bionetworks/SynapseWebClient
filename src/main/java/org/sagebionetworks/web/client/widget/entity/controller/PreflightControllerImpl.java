...
public class PreflightControllerImpl implements PreflightController {
  ...
  @Override
  public void checkUploadToEntity(
    final EntityBundle uploadTo,
  ...
  @Override
  public void checkDownloadFromEntity(
    EntityBundle uploadTo,
    Callback callback
  ) {
  ...
  public void checkCreateEntity(
    ...
    // only certified user.
    certifiedUserController.checkCreateEntity(
      parentBundle,
      entityClassName,
      callback
    );
  ...
  @Override
  public void checkCreateEntityAndUpload(
    final EntityBundle parentEntity,
    String entityClassName,
    final Callback callback
  ) {
    // Test create first
