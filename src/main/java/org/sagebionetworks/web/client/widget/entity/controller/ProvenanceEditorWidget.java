...
public class ProvenanceEditorWidget implements ProvenanceEditorWidgetView.Presenter {
	...
	@Inject
	public ProvenanceEditorWidget(ProvenanceEditorWidgetView view, SynapseJavascriptClient jsClient,
			SynapseAlert synAlert, PortalGinInjector ginInjector, EntityFinder entityFinder,
			ProvenanceURLDialogWidget urlDialog, EventBus eventBus) {
		this.view = view;
