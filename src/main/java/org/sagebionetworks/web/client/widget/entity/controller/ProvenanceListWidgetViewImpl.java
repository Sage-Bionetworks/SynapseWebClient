...
public class ProvenanceListWidgetViewImpl
  extends Composite
  implements ProvenanceListWidgetView {

  public interface ProvenanceListWidgetViewImplUiBinder
    extends UiBinder<Widget, ProvenanceListWidgetViewImpl> {}
