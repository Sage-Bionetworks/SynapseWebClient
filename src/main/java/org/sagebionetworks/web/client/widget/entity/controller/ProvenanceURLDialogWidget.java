...
public class ProvenanceURLDialogWidget
  implements ProvenanceURLDialogWidgetView.Presenter, IsWidget {
  ...
  @Inject
  public ProvenanceURLDialogWidget(
    ProvenanceURLDialogWidgetView view,
    SynapseAlert synAlert
  ) {
    this.view = view;
  ...
  public void onSave() {
    ...
    if (url == null || url.isEmpty()) {
      ...
      synAlert.showError(
        "External URL is malformed. Please enter a valid URL."
      );
