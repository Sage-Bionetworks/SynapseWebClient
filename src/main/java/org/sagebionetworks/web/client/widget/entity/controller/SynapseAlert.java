...
/**
 * This widget can be added to any view, and then asked to handle an error or show a specific error message.
 */
public interface SynapseAlert extends IsWidget {
	/**
	 * Handles the given throwable. Can be used to handle async rpc failures (it recognizes common Synapse states, like if the system is down).
	 * @param t
	 */
	void handleException(Throwable t);
	/**
	 * Tell the widget to display the given error message.  
	 * This is an alternative to asking the widget to handle an exception, used when you expect specific exceptions, and can interpret them in the correct context.
	 * @param error
	 */
