...
public interface SynapseAlert extends IsWidget {
	...
	/**
	 * Called to instruct the widget to ask the user to login to access the resource (with a link to
	 * the login page). Can be called when you know that the user must be logged in in order to use
	 * the widget.
	 */
	void showLogin();
