...
public class BaseEditWidgetDescriptorViewImpl implements BaseEditWidgetDescriptorView {
	...
	@Override
	public void setWidgetDescriptor(WikiPageKey wikiKey, String contentTypeKey,
			Map<String, String> widgetDescriptor) {
		// clear out params panel. Get the right params editor based on the descriptor (it's concrete
		// class, and configure based on the parameters inside of it).
		synAlert.clear();
		okButton.setEnabled(true);
		paramsPanel.clear();
		widgetRegistrar.getWidgetEditorForWidgetDescriptor(wikiKey, contentTypeKey, widgetDescriptor,
				dialogCallback, new AsyncCallback<WidgetEditorPresenter>() {
					@Override
