...
public class BaseEditWidgetDescriptorViewImpl
  implements BaseEditWidgetDescriptorView {

  public interface Binder
    extends UiBinder<Widget, BaseEditWidgetDescriptorViewImpl> {}
  ...
  @Override
  public void setWidgetDescriptor(
    WikiPageKey wikiKey,
    String contentTypeKey,
    Map<String, String> widgetDescriptor
  ) {
    // clear out params panel. Get the right params editor based on the descriptor (it's concrete class,
    // and configure based on the parameters inside of it).
    synAlert.clear();
    ...
    widgetRegistrar.getWidgetEditorForWidgetDescriptor(
      ...
      widgetDescriptor,
      dialogCallback,
      new AsyncCallback<WidgetEditorPresenter>() {
        @Override
        public void onSuccess(WidgetEditorPresenter result) {
          ...
          if (widgetDescriptorPresenter != null) {
            ...
            String friendlyName = widgetRegistrar.getFriendlyTypeName(
              contentTypeKey
            );
            ...
            showErrorMessage(
              "No editor found for the content type: " + contentTypeKey
            );
          }
        }
