...
public interface EntityEditorDialog {
	 ...
	 * @param callback
	 */
	public void showEditEntityDialog(String windowTitle, EntityBundle bundle,
			JSONObjectAdapter newAdapter, ObjectSchema schema, Annotations newAnnos, Set<String> filter,
			Callback callback);
