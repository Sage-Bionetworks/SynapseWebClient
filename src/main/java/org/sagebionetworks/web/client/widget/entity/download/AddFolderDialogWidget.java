...
public class AddFolderDialogWidget
		implements AddFolderDialogWidgetView.Presenter, SynapseWidgetPresenter {
	...
	public AddFolderDialogWidget(AddFolderDialogWidgetView view,
			SharingAndDataUseConditionWidget sharingAndDataUseWidget, SynapseJavascriptClient jsClient,
			GlobalApplicationState globalAppState, PopupUtilsView popupUtils, SynapseAlert synAlert) {
		this.view = view;
