...
public class AddFolderDialogWidgetViewImpl
  implements AddFolderDialogWidgetView {
  ...
  public AddFolderDialogWidgetViewImpl(Binder uiBinder) {
    ...
    folderNameField.addKeyDownHandler(
      new KeyDownHandler() {
        @Override
    ...
    newFolderDialog.addDomHandler(
      DisplayUtils.getESCKeyDownHandler(deleteCancelledHandler),
