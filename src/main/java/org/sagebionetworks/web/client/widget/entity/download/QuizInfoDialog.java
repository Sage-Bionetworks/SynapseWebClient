...
public class QuizInfoDialog implements SynapseWidgetPresenter {
	...
	@Inject
	public QuizInfoDialog(Dialog modal, QuizInfoWidget widget,
	...
	public void show() {
		...
		modal.configure("Join the Synapse Certified User Community", widget.asWidget(),
				"Become Certified today!", null, callback, true);
		modal.show();
	}
}
