...
public class S3DirectUploader implements S3DirectUploadHandler {
	...
	@Inject
	public S3DirectUploader(AwsSdk awsSdk, SynapseJSNIUtils synapseJsniUtils, GWTWrapper gwt,
			SynapseClientAsync synapseClient) {
		this.awsSdk = awsSdk;
	...
	public void configure(String accessKeyId, String secretAccessKey, String bucketName,
			String endpoint) {
	...
	public void uploadFile(String fileName, String contentType, JavaScriptObject blob,
			final ProgressingFileUploadHandler handler, final String keyPrefixUUID,
			final Long storageLocationId, final HasAttachHandlers view) {
		...
		synapseJsniUtils.getFileMd5(blob, new MD5Callback() {
			...
			public void setMD5(String hexValue) {
				...
				awsSdk.getS3(accessKeyId, secretAccessKey, bucketName, endpoint,
						new CallbackP<JavaScriptObject>() {
							@Override
