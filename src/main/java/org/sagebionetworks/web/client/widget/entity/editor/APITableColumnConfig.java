...
public class APITableColumnConfig {
  ...
  public boolean equals(Object obj) {
    ...
    if (decimalPlaces == null) {
      if (other.decimalPlaces != null) return false;
    } else if (!decimalPlaces.equals(other.decimalPlaces)) return false;
    if (displayColumnName == null) {
      if (other.displayColumnName != null) return false;
    } else if (!displayColumnName.equals(other.displayColumnName)) return false;
    if (inputColumnNames == null) {
      if (other.inputColumnNames != null) return false;
    } else if (!inputColumnNames.equals(other.inputColumnNames)) return false;
    if (rendererName == null) {
      if (other.rendererName != null) return false;
    } else if (!rendererName.equals(other.rendererName)) return false;
  ...
  public String toString() {
    return (
      "APITableColumnConfig [displayColumnName=" +
      displayColumnName +
      ", inputColumnNames=" +
      inputColumnNames +
      ", rendererName=" +
