...
public class APITableColumnManager
  implements APITableColumnManagerView.Presenter, SynapseWidgetPresenter {
  ...
  @Inject
  public APITableColumnManager(
    APITableColumnManagerView view,
