...
public class APITableColumnManagerViewImpl
  implements APITableColumnManagerView {

  public interface APITableColumnManagerViewImplUiBinder
    extends UiBinder<Widget, APITableColumnManagerViewImpl> {}
  ...
  private final APITableColumnManagerViewImplUiBinder binder = GWT.create(
    APITableColumnManagerViewImplUiBinder.class
  );
