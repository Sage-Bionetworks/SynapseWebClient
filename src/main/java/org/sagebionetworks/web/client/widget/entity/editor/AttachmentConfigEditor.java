...
public class AttachmentConfigEditor
	...
	@Inject
	public AttachmentConfigEditor(AttachmentConfigView view, FileHandleUploadWidget fileInputWidget,
	...
	public void updateDescriptorFromView() {
		...
		if (!fileHandleIds.isEmpty()) {
			...
			descriptor.put(WidgetConstants.IMAGE_WIDGET_FILE_NAME_KEY,
