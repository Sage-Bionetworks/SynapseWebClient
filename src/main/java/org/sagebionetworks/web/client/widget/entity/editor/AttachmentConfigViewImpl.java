...
public class AttachmentConfigViewImpl implements AttachmentConfigView {
  ...
  public interface AttachmentConfigViewImplUiBinder
    extends UiBinder<Widget, AttachmentConfigViewImpl> {}
  ...
  private final AttachmentConfigViewImplUiBinder binder = GWT.create(
    AttachmentConfigViewImplUiBinder.class
  );

  @Inject
  public AttachmentConfigViewImpl() {
