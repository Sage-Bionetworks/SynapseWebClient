...
public class EntityListConfigEditor
	...
	public EntityListConfigEditor(EntityListConfigView view,
			AuthenticationController authenticationController, EntityListWidget entityListWidget,
			EntityFinder entityFinder, PromptForValuesModalView promptForNoteModal) {
		this.view = view;
	...
	public void refreshCanEditNoteState() {
		...
		CheckBoxState state =
				CheckBoxState.getStateFromCount(count, entityListWidget.getRowWidgets().size());
	...
	public void configure(WikiPageKey wikiKey, Map<String, String> widgetDescriptor,
		...
		descriptor.put(WidgetConstants.ENTITYLIST_WIDGET_SHOW_DESCRIPTION_KEY,
	...
	public void onAddRecord() {
		entityFinder.configure(true, new SelectedHandler<Reference>() {
			...
			public void onSelected(Reference selected) {
				entityFinder.hide();
				EntityGroupRecord record =
						createRecord(selected.getTargetId(), selected.getTargetVersionNumber(), null);
	...
	public void updateDescriptorFromView() {
		...
		descriptor.put(WidgetConstants.ENTITYLIST_WIDGET_LIST_KEY,
