...
public class ImageParamsPanelViewImpl implements ImageParamsPanelView {
  ...
  public interface ImageParamsPanelViewImplUiBinder
    extends UiBinder<Widget, ImageParamsPanelViewImpl> {}
