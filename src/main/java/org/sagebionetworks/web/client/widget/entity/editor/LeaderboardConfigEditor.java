...
public class LeaderboardConfigEditor implements WidgetEditorPresenter {
  ...
  public static final String LEADERBOARD_QUERY_PLACEHOLDER =
    "select objectId, createdOn, entityId, team, annotation1 from evaluation_12345";

  QueryTableConfigEditor queryTableConfigEditor;

  @Inject
  public LeaderboardConfigEditor(
    QueryTableConfigEditor queryTableConfigEditor
  ) {
    this.queryTableConfigEditor = queryTableConfigEditor;
    queryTableConfigEditor.setServicePrefix(
