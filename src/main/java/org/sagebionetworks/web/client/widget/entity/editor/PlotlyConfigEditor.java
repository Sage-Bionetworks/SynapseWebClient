...
public class PlotlyConfigEditor implements PlotlyConfigView.Presenter, WidgetEditorPresenter {
	...
	@Inject
	public PlotlyConfigEditor(final PlotlyConfigView view, EntityFinder finder, SynapseAlert synAlert,
			Button showHideAdvancedButton, SynapseJavascriptClient jsClient) {
		this.view = view;
		this.finder = finder;
	...
	public void setAdvancedModeVisible(boolean visible) {
		...
		showHideAdvancedButton
				.setIcon(isAdvancedVisible ? IconType.TOGGLE_DOWN : IconType.TOGGLE_RIGHT);
	...
	public void onFindTable() {
		finder.configure(EntityFilter.PROJECT_OR_TABLE, false,
				new DisplayUtils.SelectedHandler<Reference>() {
					@Override
