...
public class PlotlyConfigViewImpl implements PlotlyConfigView {
  ...
  public interface PlotlyConfigViewImplUiBinder
    extends UiBinder<Widget, PlotlyConfigViewImpl> {}
  ...
  public PlotlyConfigViewImpl(PlotlyConfigViewImplUiBinder binder) {
    ...
    typeDropdownMenu.addChangeHandler(
      new ChangeHandler() {
        @Override
    ...
    yColumnNamesMenu.addChangeHandler(
      new ChangeHandler() {
        @Override
        public void onChange(ChangeEvent event) {
    ...
    xColumnNamesMenu.addChangeHandler(
      new ChangeHandler() {
        @Override
        public void onChange(ChangeEvent event) {
  ...
  public BarMode getBarMode() {
    return BarMode.valueOf(
      barModeDropdownMenu.getSelectedValue().toUpperCase()
    );
  }
  ...
  public AxisType getXAxisType() {
    return AxisType.valueOf(
      xAxisTypeDropdownMenu.getSelectedValue().toUpperCase()
    );
  }
  ...
  public AxisType getYAxisType() {
    return AxisType.valueOf(
      yAxisTypeDropdownMenu.getSelectedValue().toUpperCase()
    );
  }
