...
public class QueryTableConfigViewImpl implements QueryTableConfigView {
	...
	public interface QueryTableConfigViewImplUiBinder
			extends UiBinder<Widget, QueryTableConfigViewImpl> {
	}
	...
	@Inject
	public QueryTableConfigViewImpl(QueryTableConfigViewImplUiBinder binder,
