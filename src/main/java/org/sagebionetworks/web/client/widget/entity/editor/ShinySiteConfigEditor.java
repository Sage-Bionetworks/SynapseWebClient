...
public class ShinySiteConfigEditor implements WidgetEditorPresenter {
  ...
  public void configure(
    ...
    boolean isIncludePrincipalId = ShinySiteWidget.isIncludePrincipalId(
      descriptor
    );
    if (siteUrl != null) view.configure(siteUrl, height, isIncludePrincipalId);
  }
  ...
  public void updateDescriptorFromView() {
    ...
    try {
      ...
      descriptor.put(
        WidgetConstants.INCLUDE_PRINCIPAL_ID_KEY,
        view.isIncludePrincipalId().toString()
      );
      if (view.getSiteHeight() != null) descriptor.put(
        WidgetConstants.HEIGHT_KEY,
        String.valueOf(view.getSiteHeight())
      );
