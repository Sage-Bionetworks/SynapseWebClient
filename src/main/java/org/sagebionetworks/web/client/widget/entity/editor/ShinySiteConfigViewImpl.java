...
public class ShinySiteConfigViewImpl implements ShinySiteConfigView {
  ...
  public interface ShinySiteConfigViewImplUiBinder
    extends UiBinder<Widget, ShinySiteConfigViewImpl> {}
  ...
  public void checkParams() throws IllegalArgumentException {
    ...
    if (
      !ShinySiteWidget.isValidShinySite(urlField.getValue(), jsniUtils)
    ) throw new IllegalArgumentException(
      urlField.getValue() + DisplayConstants.INVALID_SHINY_SITE
    );
  }
