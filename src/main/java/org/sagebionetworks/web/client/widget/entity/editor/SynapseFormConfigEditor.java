...
public class SynapseFormConfigEditor implements SynapseFormConfigView.Presenter, WidgetEditorPresenter {
	...
	@Inject
	public SynapseFormConfigEditor(SynapseFormConfigView view, EntityFinderWidget.Builder entityFinderBuilder) {
		this.view = view;
	...
	private EntityFinderWidget configureEntityFinder(EntityFinderWidget.Builder builder) {
		return builder
