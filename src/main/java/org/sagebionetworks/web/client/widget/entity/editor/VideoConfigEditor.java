...
public class VideoConfigEditor
  implements VideoConfigView.Presenter, WidgetEditorPresenter {
  ...
  public static final String UNRECOGNIZED_VIDEO_FORMAT_MESSAGE =
  ...
  private static final String[] MP4_EXTENSIONS = new String[] {
    ".mp4",
    ".m4a",
    ".m4p",
    ".m4b",
  ...
  private static final HashSet<String> MP4_EXTENSIONS_SET = new HashSet<String>(
    Arrays.asList(MP4_EXTENSIONS)
  );

  private static final String[] OGG_EXTENSIONS = new String[] {
    ".ogv",
    ".ogg",
  };
  private static final HashSet<String> OGG_EXTENSIONS_SET = new HashSet<String>(
    Arrays.asList(OGG_EXTENSIONS)
  );
  VIDEO_TYPE currentType;

  @Inject
  public VideoConfigEditor(
    VideoConfigView view,
  ...
  public void configure(
    ...
    if (vimeoVideoId != null) {
      ...
      view.showSynapseTab();
      if (
        descriptor.get(WidgetConstants.VIDEO_WIDGET_MP4_SYNAPSE_ID_KEY) != null
      ) {
        currentType = VIDEO_TYPE.MP4;
        view.setEntity(
          descriptor.get(WidgetConstants.VIDEO_WIDGET_MP4_SYNAPSE_ID_KEY)
        );
      } else if (
        descriptor.get(WidgetConstants.VIDEO_WIDGET_OGG_SYNAPSE_ID_KEY) != null
      ) {
        currentType = VIDEO_TYPE.OGG;
        view.setEntity(
          descriptor.get(WidgetConstants.VIDEO_WIDGET_OGG_SYNAPSE_ID_KEY)
        );
      } else if (
        descriptor.get(WidgetConstants.VIDEO_WIDGET_WEBM_SYNAPSE_ID_KEY) != null
      ) {
  ...
  public static boolean isRecognizedVideoFileName(String fileName) {
    ...
    return (
      MP4_EXTENSIONS_SET.contains(extension) ||
