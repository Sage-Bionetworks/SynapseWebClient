...
public class FileTitleBarViewImpl extends Composite implements FileTitleBarView {
	...
	private static FileTitleBarViewImplUiBinder uiBinder =
			GWT.create(FileTitleBarViewImplUiBinder.class);

	@Inject
	public FileTitleBarViewImpl(FavoriteWidget favoriteWidget, Md5Link md5Link,
	...
	@Override
	public void setExternalObjectStoreInfo(String endpointValue, String bucketValue,
			String fileKeyValue) {
