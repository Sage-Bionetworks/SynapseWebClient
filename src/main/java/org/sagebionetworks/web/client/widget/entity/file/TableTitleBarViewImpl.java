...
public class TableTitleBarViewImpl
  extends Composite
  implements TableTitleBarView {
  ...
  interface TableTitleBarViewImplUiBinder
    extends UiBinder<Widget, TableTitleBarViewImpl> {}

  private String currentEntityId;
  private static TableTitleBarViewImplUiBinder uiBinder = GWT.create(
    TableTitleBarViewImplUiBinder.class
  );

  @Inject
  public TableTitleBarViewImpl(
