...
public class DownloadListWidgetViewImpl implements DownloadListWidgetView, IsWidget {
	...
	interface DownloadListWidgetViewImplUiBinder
			extends UiBinder<Widget, DownloadListWidgetViewImpl> {
	}

	private static DownloadListWidgetViewImplUiBinder uiBinder =
			GWT.create(DownloadListWidgetViewImplUiBinder.class);
	...
	public void showFilesDownloadedAlert(int fileCount) {
		filesDownloadedAlert
				.setMessage(fileCount + " files were downloaded and removed from the list.");
