...
public class FileHandleAssociationRowViewImpl implements FileHandleAssociationRowView, IsWidget {
	...
	interface FileHandleAssociationRowViewImplUiBinder
			extends UiBinder<Widget, FileHandleAssociationRowViewImpl> {
	}
	...
	Presenter presenter;
	private static FileHandleAssociationRowViewImplUiBinder uiBinder =
			GWT.create(FileHandleAssociationRowViewImplUiBinder.class);
