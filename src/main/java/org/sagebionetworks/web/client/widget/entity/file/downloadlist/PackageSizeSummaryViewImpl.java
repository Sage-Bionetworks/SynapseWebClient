...
public class PackageSizeSummaryViewImpl
  implements PackageSizeSummaryView, IsWidget {

  Widget w;

  public interface PackageSizeSummaryViewImplUiBinder
    extends UiBinder<Widget, PackageSizeSummaryViewImpl> {}
  ...
  private static PackageSizeSummaryViewImplUiBinder uiBinder = GWT.create(
    PackageSizeSummaryViewImplUiBinder.class
  );
