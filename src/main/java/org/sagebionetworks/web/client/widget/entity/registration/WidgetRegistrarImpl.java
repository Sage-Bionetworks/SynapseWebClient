...
public class WidgetRegistrarImpl implements WidgetRegistrar {
	 ...
	 */
	@Override
	public void getWidgetEditorForWidgetDescriptor(WikiPageKey wikiKey, String contentTypeKey,
			Map<String, String> model, DialogCallback dialogCallback,
			AsyncCallback<WidgetEditorPresenter> callback) {
		GWT.runAsync(WidgetEditorPresenter.class, new RunAsyncCallback() {
			@Override
			public void onSuccess() {
				WidgetEditorPresenter presenter =
						getWidgetEditorForWidgetDescriptor(wikiKey, contentTypeKey, model, dialogCallback);
	 ...
	 * @return
	 */
	public WidgetEditorPresenter getWidgetEditorForWidgetDescriptor(WikiPageKey wikiKey,
			String contentTypeKey, Map<String, String> model, DialogCallback dialogCallback) {
		...
		} else if (contentTypeKey.equals(SUBMIT_TO_EVALUATION_CONTENT_TYPE)
	 ...
	 */
	@Override
	public IsWidget getWidgetRendererForWidgetDescriptor(WikiPageKey wikiKey, String contentTypeKey,
			Map<String, String> model, Callback widgetRefreshRequired, Long wikiVersionInView) {
	...
	@Override
	public void getWidgetRendererForWidgetDescriptorAfterLazyLoad(String contentTypeKey,
	...
	public void getWidgetRendererForWidgetDescriptorAfterLazyLoadAndCodeSplit(String contentTypeKey,
			AsyncCallback<WidgetRendererPresenter> callback) {
		WidgetRendererPresenter presenter =
				getWidgetRendererForWidgetDescriptorAfterLazyLoad(contentTypeKey);
		if (presenter == null) {
			callback.onFailure(
					new NotFoundException("Widget renderer not found for type \"" + contentTypeKey + "\""));
		} else {
			callback.onSuccess(presenter);
		}
	...
	public WidgetRendererPresenter getWidgetRendererForWidgetDescriptorAfterLazyLoad(
		...
		} else if (contentTypeKey.equals(WIKI_SUBPAGES_CONTENT_TYPE)
	...
	public String getMDRepresentation(String contentType, Map<String, String> model) {
		...
		for (Iterator iterator = model.keySet().iterator(); iterator.hasNext();) {
			...
			if (value != null) {
				urlBuilder.append(prefix).append(key).append('=')
	...
	public static String getWidgetMarkdown(String contentType, Map<String, String> widgetDescriptor,
			WidgetRegistrar widgetRegistrar) throws JSONObjectAdapterException {
