...
public class WidgetRegistrarImpl implements WidgetRegistrar {
   ...
   */
  @Override
  public void getWidgetEditorForWidgetDescriptor(
    WikiPageKey wikiKey,
    String contentTypeKey,
    Map<String, String> model,
    DialogCallback dialogCallback,
    AsyncCallback<WidgetEditorPresenter> callback
  ) {
    GWT.runAsync(
      WidgetEditorPresenter.class,
      new RunAsyncCallback() {
        @Override
        public void onSuccess() {
          WidgetEditorPresenter presenter = getWidgetEditorForWidgetDescriptor(
            wikiKey,
            contentTypeKey,
            model,
            dialogCallback
   ...
   * @return
   */
  public WidgetEditorPresenter getWidgetEditorForWidgetDescriptor(
    WikiPageKey wikiKey,
    String contentTypeKey,
    Map<String, String> model,
    DialogCallback dialogCallback
    ...
    if (contentTypeKey.equals(REFERENCE_CONTENT_TYPE)) {
      ...
      contentTypeKey.equals(SUBMIT_TO_EVALUATION_CONTENT_TYPE) ||
      contentTypeKey.equals(OLD_JOIN_EVALUATION_CONTENT_TYPE)
    ) {
      ...
      contentTypeKey.equals(VIDEO_CONTENT_TYPE) ||
    ...
    if (presenter != null) presenter.configure(wikiKey, model, dialogCallback);
   ...
   */
  @Override
  public IsWidget getWidgetRendererForWidgetDescriptor(
    WikiPageKey wikiKey,
    String contentTypeKey,
    Map<String, String> model,
  ...
  @Override
  public void getWidgetRendererForWidgetDescriptorAfterLazyLoad(
    String contentTypeKey,
    AsyncCallback<WidgetRendererPresenter> callback
  ) {
    // use gin to create a new instance of the proper class.
    GWT.runAsync(
      WidgetRendererPresenter.class,
      new RunAsyncCallback() {
        @Override
        public void onSuccess() {
          getWidgetRendererForWidgetDescriptorAfterLazyLoadAndCodeSplit(
            contentTypeKey,
            callback
          );
        }
  ...
  public void getWidgetRendererForWidgetDescriptorAfterLazyLoadAndCodeSplit(
    String contentTypeKey,
    AsyncCallback<WidgetRendererPresenter> callback
  ) {
    ...
    if (presenter == null) {
      callback.onFailure(
        new NotFoundException(
          "Widget renderer not found for type \"" + contentTypeKey + "\""
        )
      );
    } else {
      callback.onSuccess(presenter);
   ...
   * @return
   */
  public WidgetRendererPresenter getWidgetRendererForWidgetDescriptorAfterLazyLoad(
    String contentTypeKey
  ) {
    ...
    if (contentTypeKey.equals(BOOKMARK_CONTENT_TYPE)) {
      ...
      contentTypeKey.equals(API_TABLE_CONTENT_TYPE) ||
      ...
      contentTypeKey.equals(WIKI_SUBPAGES_CONTENT_TYPE) ||
      contentTypeKey.equals(NO_AUTO_WIKI_SUBPAGES)
    ) {
  ...
  public String getFriendlyTypeName(String contentTypeKey) {
    ...
    if (friendlyName != null) return friendlyName; else return "Widget";
  }
    ...
    for (Iterator iterator = model.keySet().iterator(); iterator.hasNext();) {
      ...
      if (value != null) {
        urlBuilder
          ...
          .append(key)
          .append('=')
          .append(WidgetEncodingUtil.encodeValue(value.toString()));
      }
      prefix = '&';
    }
  ...
  public Map<String, String> getWidgetDescriptor(String md) {
    if (md == null || md.length() == 0) throw new IllegalArgumentException(
      DisplayConstants.INVALID_WIDGET_MARKDOWN_MESSAGE + md
    );
  ...
  public String getWidgetContentType(String mdRepresentation) {
    if (
      mdRepresentation == null || mdRepresentation.length() == 0
    ) throw new IllegalArgumentException(
      DisplayConstants.INVALID_WIDGET_MARKDOWN_MESSAGE + mdRepresentation
    );
    String decodedMd = mdRepresentation;
    if (
      decodedMd == null || decodedMd.length() == 0
    ) throw new IllegalArgumentException(
      DisplayConstants.INVALID_WIDGET_MARKDOWN_MESSAGE + decodedMd
    );
  ...
  private void initWithKnownWidgets() {
    ...
    registerWidget(
      ATTACHMENT_PREVIEW_CONTENT_TYPE,
      ATTACHMENT_PREVIEW_FRIENDLY_NAME
    );
    ...
    registerWidget(
      ...
      TEAM_MEMBER_COUNT_FRIENDLY_NAME
    );
    registerWidget(TEAM_MEMBERS_CONTENT_TYPE, TEAM_MEMBERS_FRIENDLY_NAME);
    registerWidget(
      SUBMIT_TO_EVALUATION_CONTENT_TYPE,
      "Submit to Evaluation Queue"
    );
  }

  public static String getWidgetMarkdown(
    String contentType,
    ...
    sb.append(
      widgetRegistrar.getMDRepresentation(contentType, widgetDescriptor)
    );
