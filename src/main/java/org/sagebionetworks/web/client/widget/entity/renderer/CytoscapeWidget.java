...
public class CytoscapeWidget
  implements CytoscapeView.Presenter, WidgetRendererPresenter {
  ...
  public void getFileContents(
    ...
    final CallbackP<String> fileContentCallback
  ) {
    Long version = null;
    synAlert.clear();
    String url = DisplayUtils.createFileEntityUrl(
              ...
              if (responseText != null && responseText.length() > 0) {
                ...
                onError(
                  ...
                  new IllegalArgumentException(
                    "Unable to retrieve Cytoscape JS data file entity " +
                    entityId
                  )
                );
              }
