...
public class EntityListWidget implements WidgetRendererPresenter {
  ...
  public void configure(
    ...
    List<EntityGroupRecord> records = EntityListUtil.parseRecords(
      descriptor.get(WidgetConstants.ENTITYLIST_WIDGET_LIST_KEY)
    );
  ...
  public void addRecord(EntityGroupRecord entityGroupRecord) {
    ...
    badge.setSelectionChangedCallback(
      new Callback() {
        @Override
        public void invoke() {
          selectableItemList.checkSelectionState();
