...
public class ImageWidget
  implements ImageWidgetView.Presenter, WidgetRendererPresenter {
  ...
  public void configure(
    ...
    if (synapseId != null) {
      ...
      jsClient.getWikiAttachmentFileHandles(
        wikiKey,
        wikiVersionInView,
  ...
  public static String getAlignmentStyleNames(String alignment) {
    if (alignment != null) {
      ...
      if (WidgetConstants.FLOAT_LEFT.equalsIgnoreCase(trimmedAlignment)) {
        ...
        WidgetConstants.FLOAT_RIGHT.equalsIgnoreCase(trimmedAlignment)
      ) {
        return FLOAT_RIGHT_STYLES;
      } else if (
        WidgetConstants.FLOAT_CENTER.equalsIgnoreCase(trimmedAlignment)
      ) {
