...
public class ImageWidgetViewImpl extends LayoutContainer implements ImageWidgetView {
	...
	public void configure(WikiPageKey wikiKey, final String fileName,
			final String scale, String alignment, final String synapseId, String altText, final boolean isLoggedIn, boolean fromWeb) {
		...
		if (fromWeb) {
			//External source; just reference an image from the web
			url = WidgetEncodingUtil.decodeValue(fileName);
