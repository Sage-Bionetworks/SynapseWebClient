...
public class NbConvertPreviewWidget extends HtmlPreviewWidget {
	...
	@Inject
	public NbConvertPreviewWidget(HtmlPreviewView view,
			PresignedURLAsyncHandler presignedURLAsyncHandler, SynapseJSNIUtils jsniUtils,
			RequestBuilderWrapper requestBuilder, SynapseAlert synAlert, SynapseClientAsync synapseClient,
			PopupUtilsView popupUtils, SynapseProperties synapseProperties, GWTWrapper gwt) {
	...
	public void onShowFullContent() {
		// in this case (ipynb), to show the full content they need to download the ipynb file and view
		// it locally
