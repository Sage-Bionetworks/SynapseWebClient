...
public class PlotlyWidgetViewImpl implements PlotlyWidgetView {
	...
	@Override
	public void showChart(String title, String xTitle, String yTitle, List<PlotlyTraceWrapper> xyData,
			String barMode, AxisType xAxisType, AxisType yAxisType, boolean showLegend) {
		chartContainer.clear();
		String xAxisTypeString =
				AxisType.AUTO.equals(xAxisType) ? "-" : xAxisType.toString().toLowerCase();
		String yAxisTypeString =
				AxisType.AUTO.equals(yAxisType) ? "-" : yAxisType.toString().toLowerCase();
		_showChart(chartContainer.getElement(), getPlotlyTraceArray(xyData), barMode, title, xTitle,
				yTitle, xAxisTypeString, yAxisTypeString, showLegend);
	}
	...
	private static native void _showChart(Element el, JavaScriptObject[] xyData, String barMode,
			String plotTitle, String xTitle, String yTitle, String xAxisType, String yAxisType,
			boolean showLegend) /*-{
	...
	private static native void _addPlotlyClickEventListener(Element el,
