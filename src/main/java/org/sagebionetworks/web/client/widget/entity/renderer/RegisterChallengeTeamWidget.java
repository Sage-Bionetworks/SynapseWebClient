...
public class RegisterChallengeTeamWidget
		implements SingleButtonView.Presenter, WidgetRendererPresenter {
	...
	@Inject
	public RegisterChallengeTeamWidget(SingleButtonView view, PortalGinInjector ginInjector,
