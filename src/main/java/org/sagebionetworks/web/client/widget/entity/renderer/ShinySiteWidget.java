...
public class ShinySiteWidget implements WidgetRendererPresenter {
	...
	private static final String[] VALID_URL_BASES = {"http://spark.rstudio.com/", "https://s3.amazonaws.com/static.synapse.org/", "https://docs.google.com/a/sagebase.org/forms/", "https://calendar.google.com/calendar/", "https://sage-bionetworks.shinyapps.io/", "https://publish.smartsheet.com/"
	};
	...
	@Inject
	public ShinySiteWidget(IFrameView view, AuthenticationController authenticationController, SynapseJSNIUtils jsniUtils) {
		this.view = view;
	...
	public void configure(WikiPageKey wikiKey, Map<String, String> widgetDescriptor, Callback widgetRefreshRequired, Long wikiVersionInView) {
		...
		if (isValidShinySite(siteUrl, jsniUtils)) {
			...
			// if we should include the current user's principal id, then append ?principal=<principal> to the
			// siteUrl
	...
	public static boolean isValidShinySite(String siteUrl, SynapseJSNIUtils jsniUtils) {
		if (siteUrl != null) {
			...
			if (hostName != null && (hostName.endsWith(".synapse.org") || hostName.endsWith(".sagebase.org"))) {
				return true;
			}
