...
public class ShinySiteWidget implements WidgetRendererPresenter {
  ...
  public void configure(
    ...
    } else view.showError(siteUrl + DisplayConstants.INVALID_SHINY_SITE);
  }
      ...
      try {
        isIncludePrincipleId =
          Boolean.parseBoolean(
            descriptor.get(WidgetConstants.INCLUDE_PRINCIPAL_ID_KEY)
          );
      } catch (Throwable e) {
        // fall back to default
      }
  ...
  public static boolean isValidShinySite(
    String siteUrl,
    SynapseJSNIUtils jsniUtils
  ) {
    if (siteUrl != null) {
