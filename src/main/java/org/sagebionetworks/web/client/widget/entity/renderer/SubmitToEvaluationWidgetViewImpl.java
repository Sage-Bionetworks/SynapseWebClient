...
public class SubmitToEvaluationWidgetViewImpl extends FlowPanel
	...
	public void configure(String buttonText) {
		...
		String primaryButtonText =
				buttonText == null ? WidgetConstants.SUBMIT_TO_CHALLENGE : buttonText;
	...
	public void showAnonymousRegistrationMessage() {
		...
		DisplayUtils.showPopup("Login or Register", DisplayConstants.ANONYMOUS_JOIN_EVALUATION,
				MessagePopup.INFO, okCallback, cancelCallback);
	}
