...
public class SubmitToEvaluationWidgetViewImpl
  extends FlowPanel
  ...
  public void configure(String buttonText) {
    ...
    String primaryButtonText = buttonText == null
      ? WidgetConstants.SUBMIT_TO_CHALLENGE
      : buttonText;
    Button button = DisplayUtils.createButton(
      primaryButtonText,
      ButtonType.PRIMARY
    );
