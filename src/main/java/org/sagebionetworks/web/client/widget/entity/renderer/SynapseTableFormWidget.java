...
public class SynapseTableFormWidget
		implements SynapseTableFormWidgetView.Presenter, WidgetRendererPresenter {
	...
	@Inject
	public SynapseTableFormWidget(SynapseTableFormWidgetView view, SynapseAlert synAlert,
			RowFormEditorWidget rowWidget, AsynchronousJobTracker jobTracker, UserBadge ownerUserBadge,
			SynapseJavascriptClient jsClient) {
		this.view = view;
	...
	public void onSubmit() {
		...
		jobTracker.startAndTrack(AsynchType.TableAppendRowSet, request,
				AsynchronousProgressWidget.WAIT_MS, new UpdatingAsynchProgressHandler() {
