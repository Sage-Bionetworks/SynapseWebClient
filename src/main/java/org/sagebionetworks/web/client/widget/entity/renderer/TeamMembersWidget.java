...
public class TeamMembersWidget implements WidgetRendererPresenter, PageChangeListener {
	...
	@Inject
	public TeamMembersWidget(TeamMembersWidgetView view, BasicPaginationWidget paginationWidget,
			SynapseJavascriptClient jsClient, SynapseAlert synAlert, PortalGinInjector ginInjector) {
		this.view = view;
	...
	public void onPageChange(final Long newOffset) {
		...
		jsClient.getTeamMembers(teamId, "", TeamMemberTypeFilterOptions.ALL,
				DEFAULT_USER_LIMIT.intValue(), newOffset.intValue(),
				new AsyncCallback<TeamMemberPagedResults>() {
					...
					public void onSuccess(TeamMemberPagedResults results) {
						...
						paginationWidget.configure(DEFAULT_USER_LIMIT, newOffset, rowCount,
								TeamMembersWidget.this);
