...
public class VideoWidget implements WidgetRendererPresenter {
	...
	public static final String PLEASE_LOGIN_TO_VIEW_THIS_RESOURCE =
	...
	public void configure(String synapseId, String filename, int width, int height) {
		...
		configureFromSynapseFile(mp4SynapseId, oggSynapseId, webmSynapseId, Integer.toString(width),
				Integer.toString(height));
	}

	private void configureFromSynapseFile(String mp4SynapseId, String oggSynapseId,
			String webmSynapseId, String width, String height) {
