...
public class VideoWidgetViewImpl extends FlowPanel implements VideoWidgetView {
	...
	@Override
	public void configure(String mp4SynapseId, String oggSynapseId, String webmSynapseId,
		...
		if (mp4SynapseId != null) {
			...
			builder.append(DisplayUtils.createFileEntityUrl(synapseJsniUtils.getBaseFileHandleUrl(),
					mp4SynapseId, null, false));
