...
public class WikiFilesPreviewWidget
  implements WikiFilesPreviewWidgetView.Presenter, WidgetRendererPresenter {
  ...
  @Inject
  public WikiFilesPreviewWidget(
    WikiFilesPreviewWidgetView view,
  ...
  public void configure(
    ...
    synapseClient.getWikiAttachmentHandles(
      wikiKey,
      new AsyncCallback<FileHandleResults>() {
        @Override
