...
public class WikiFilesPreviewWidgetViewImpl extends FlowPanel
		implements WikiFilesPreviewWidgetView {
		...
		for (Iterator iterator = list.iterator(); iterator.hasNext();) {
			...
			if (!FileHandleUtils.isPreviewFileHandle(fileHandle)) {
				...
				sb.append(DisplayUtils.createWikiAttachmentUrl(synapseJsniUtils.getBaseFileHandleUrl(),
						wikiKey, fileHandle.getFileName(), false));
				sb.append("\"><img class=\"center-in-div\" alt ");
				sb.append(" src=\"");
				sb.append(DisplayUtils.createWikiAttachmentUrl(synapseJsniUtils.getBaseFileHandleUrl(),
						wikiKey, fileHandle.getFileName(), true));
				sb.append("\"></img></a>");
