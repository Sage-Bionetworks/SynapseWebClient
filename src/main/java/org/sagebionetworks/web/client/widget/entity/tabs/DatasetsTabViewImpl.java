...
public class DatasetsTabViewImpl implements DatasetsTabView {
	...
	public interface TabsViewImplUiBinder extends UiBinder<Widget, DatasetsTabViewImpl> {
	}

	Widget widget;

	@Inject
	public DatasetsTabViewImpl(TabsViewImplUiBinder binder) {
