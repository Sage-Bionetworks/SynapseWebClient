...
public class FilesTabViewImpl implements FilesTabView {
	...
	private ClickHandler getExpandClickHandler(final Widget w) {
		return new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				w.setHeight(new Double(com.google.gwt.user.client.Window.getClientHeight()).intValue() - 170
						+ "px");
	...
	public void setProvenance(Widget w) {
		...
		expandProvHandlerRegistration =
				expandProvenanceLink.addClickHandler(getExpandClickHandler(provenanceGraphWidget));
	}
