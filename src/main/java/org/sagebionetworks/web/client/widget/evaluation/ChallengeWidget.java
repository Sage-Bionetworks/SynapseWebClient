...
public class ChallengeWidget implements ChallengeWidgetView.Presenter, IsWidget {
	...
	@Inject
	public ChallengeWidget(ChallengeWidgetView view, ChallengeClientAsync challengeClient,
			SynapseAlert synAlert, BigTeamBadge teamBadge, SelectTeamModal selectTeamModal,
