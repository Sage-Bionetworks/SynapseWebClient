...
public class EvaluationEditorModal
  implements EvaluationEditorModalView.Presenter, IsWidget {
  ...
  @Inject
  public EvaluationEditorModal(
    EvaluationEditorModalView view,
  ...
  public void configure(
    ...
    Callback evaluationUpdatedCallback
  ) {
  ...
  private void configure(
    ...
    view.setSubmissionInstructionsMessage(
  ...
  public void onSave() {
    ...
    evaluation.setSubmissionInstructionsMessage(
      view.getSubmissionInstructionsMessage()
    );
    ...
    boolean isUserTryingToSetQuota =
