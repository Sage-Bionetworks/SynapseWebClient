...
public class EvaluationFinder implements EvaluationFinderView.Presenter, IsWidget, PageChangeListener {
	...
	@Inject
	public EvaluationFinder(EvaluationFinderView view, BasicPaginationWidget paginationWidget, SynapseAlert synAlert, SynapseJavascriptClient jsClient, EvaluationList evaluationList) {
		this.view = view;
	...
	public void configure(Boolean isActiveOnly, ACCESS_TYPE accessType, CallbackP<Evaluation> evaluationSelectedCallback) {
