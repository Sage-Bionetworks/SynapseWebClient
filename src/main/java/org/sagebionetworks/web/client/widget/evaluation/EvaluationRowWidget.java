...
public class EvaluationRowWidget implements IsWidget {
	...
	public EvaluationRowWidget(UserBadge userBadge, DateTimeUtils dateTimeUtils,
		...
		deleteButton.addClickHandler(event -> {
			DisplayUtils.showConfirmDialog("Delete Evaluation Queue?",
					DisplayConstants.CONFIRM_DELETE_EVAL_QUEUE + evaluation.getName(), new Callback() {
						@Override
						public void invoke() {
	...
	public void configure(Evaluation evaluation, EvaluationActionHandler handler) {
		...
		submitToEvaluationParams.put(WidgetConstants.JOIN_WIDGET_SUBCHALLENGE_ID_LIST_KEY,
				subchallengeList);
