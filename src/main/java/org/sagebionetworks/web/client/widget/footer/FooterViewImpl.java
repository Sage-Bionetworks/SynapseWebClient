...
public class FooterViewImpl implements FooterView {
	...
	public FooterViewImpl(Binder binder, CookieProvider cookies,
			GlobalApplicationState globalAppState, ToggleACTActionsButton hideACTActionsButton,
			GWTWrapper gwt) {
		...
		Callback constructViewCallback = () -> {
			...
			copyrightYear
					.setText(DateTimeFormat.getFormat("yyyy").format(new Date()) + " SAGE BIONETWORKS");
