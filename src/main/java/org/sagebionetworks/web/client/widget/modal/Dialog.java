...
public class Dialog extends UIObject implements IsWidget, HasWidgets {
	 ...
	 *        highlighted.
	 * @param defaultButtonText The text for the default button (i.e "Cancel"). The default button
	 *        will not be highlighted. If null, will hide default button.
	 * @param callback
	 * @param autoHide if true, will hide the dialog on primary or default button click.
	 */
	public void configure(String title, Widget body, String primaryButtonText,
			String defaultButtonText, Callback callback, boolean autoHide) {
	 ...
	 * @param autoHide if true, will hide the dialog on primary or default button click.
	 */
	public void configure(String title, String primaryButtonText, String defaultButtonText,
			Callback callback, boolean autoHide) {
