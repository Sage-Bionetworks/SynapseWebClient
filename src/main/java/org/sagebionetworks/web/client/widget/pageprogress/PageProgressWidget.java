...
public class PageProgressWidget implements IsWidget {
	...
	public void configure(String barColor, int barPercent, String backBtnLabel, Callback backBtnCallback,
		String forwardBtnLabel, Callback forwardBtnCallback, boolean isForwardActive) {
		view.configure(barColor, barPercent, backBtnLabel, backBtnCallback, forwardBtnLabel, forwardBtnCallback, isForwardActive);
	}
