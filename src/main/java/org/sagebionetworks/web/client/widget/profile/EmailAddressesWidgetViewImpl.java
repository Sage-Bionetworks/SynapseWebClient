...
public class EmailAddressesWidgetViewImpl implements EmailAddressesWidgetView {
  ...
  public interface Binder
    extends UiBinder<Widget, EmailAddressesWidgetViewImpl> {}
  ...
  public EmailAddressesWidgetViewImpl(Binder binder) {
    ...
    addEmailButton.addClickHandler(
      new ClickHandler() {
        @Override
    ...
    newEmailTextBox
      .getElement()
      .setAttribute("placeholder", "New email address");
  }
  ...
  public void addSecondaryEmail(final String email) {
    ...
    Button makePrimaryButton = new Button(
      "Make primary",
      IconType.ENVELOPE,
      new ClickHandler() {
        @Override
