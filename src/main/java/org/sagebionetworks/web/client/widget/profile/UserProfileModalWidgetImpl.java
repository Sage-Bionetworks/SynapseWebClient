...
public class UserProfileModalWidgetImpl implements UserProfileModalWidget {
	...
	@Inject
	public UserProfileModalWidgetImpl(UserProfileModalView view, UserProfileEditorWidget editorWidget,
			SynapseClientAsync synapse, SynapseJavascriptClient jsClient,
			AuthenticationController authController, ClientCache clientCache) {
		this.modalView = view;
	...
	public UserProfile updateProfileFromEditor() {
		...
		originalProfile
				.setDisplayName(originalProfile.getFirstName() + " " + originalProfile.getLastName());
