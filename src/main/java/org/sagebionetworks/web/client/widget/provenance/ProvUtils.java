...
public class ProvUtils {
  ...
  public static ProvGraph buildProvGraph(
    ...
    Map<Reference, EntityHeader> refToHeader,
    boolean showExpand,
    ...
    for (Reference ref : refToHeader.keySet()) {
      ...
      String name = header.getName() == null
        ? ref.getTargetId()
        : header.getName();
      ...
      if (act.getUsed() != null) {
        ...
        while (itr.hasNext()) {
          ...
          if (used instanceof UsedEntity) {
            ...
            EntityHeader refHeader = refToHeader.containsKey(ref)
              ? refToHeader.get(ref)
              : new EntityHeader();
            if (
              showExpand &&
              ...
              ProvGraphNode expandNode = new ExpandGraphNode(
                createUniqueNodeId(),
                ref.getTargetId(),
                ref.getTargetVersionNumber()
              );
    ...
    for (Reference ref : generatedByActivityId.keySet()) {
      ...
      if (act != null) {
        graph.addEdge(
          new ProvGraphEdge(entityNodes.get(ref), activityNodes.get(act))
        );
      }
    }
  ...
  public static KeyValueDisplay<String> entityToKeyValueDisplay(
    Entity entity,
    String modifiedBy,
    ...
    if (entity instanceof VersionableEntity) {
      ...
      map.put(
        "Version",
        DisplayUtils.getVersionDisplay((VersionableEntity) entity)
      );
    }
    ...
    if (entity.getModifiedOn() != null) map.put(
      "Modified On",
      dateTimeUtils.getLongFriendlyDate(entity.getModifiedOn())
    );
  ...
  public static KeyValueDisplay<String> activityToKeyValueDisplay(
    Activity activity,
    String modifiedBy,
    DateTimeUtils dateTimeUtils
  ) {
    ...
    map.put(
      "Modified On",
      dateTimeUtils.getLongFriendlyDate(activity.getModifiedOn())
    );
