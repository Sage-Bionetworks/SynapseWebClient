...
public class ProvenanceWidget implements WidgetRendererPresenter {
	...
	public void configure(WikiPageKey wikiKey, Map<String, String> widgetDescriptor, Callback widgetRefreshRequired, Long wikiVersionInView) {
		...
		if (widgetDescriptor.containsKey(WidgetConstants.PROV_WIDGET_ENTITY_LIST_KEY))
			entityListStr = widgetDescriptor.get(WidgetConstants.PROV_WIDGET_ENTITY_LIST_KEY);
		...
		if (widgetDescriptor.containsKey(WidgetConstants.PROV_WIDGET_ENTITY_ID_KEY)) {
			startRefs.add(DisplayUtils.parseEntityVersionString(widgetDescriptor.get(WidgetConstants.PROV_WIDGET_ENTITY_ID_KEY)));
		}
		if (widgetDescriptor.containsKey(WidgetConstants.PROV_WIDGET_DISPLAY_HEIGHT_KEY)) {
			height = Integer.parseInt(widgetDescriptor.get(WidgetConstants.PROV_WIDGET_DISPLAY_HEIGHT_KEY)) + "px";
		}
