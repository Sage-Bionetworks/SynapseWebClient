...
public class DiscussionThreadCountAlert
		implements RefreshAlertView.Presenter, SynapseWidgetPresenter {
	...
	public static final int DELAY = 80000; // check every 80 seconds (until detached, configuration
																					// cleared, or a change has been detected)

	@Inject
	public DiscussionThreadCountAlert(RefreshAlertView view, GWTWrapper gwt,
	...
	private void checkThreadCount() {
		if (view.isAttached() && forumId != null) {
			jsClient.getThreadCountForForum(forumId, DiscussionFilter.NO_FILTER,
