...
public class EntityRefreshAlert implements RefreshAlertView.Presenter, SynapseWidgetPresenter {
	...
	public static final int DELAY = 60000; // check every minute (until detached, configuration
																					// cleared, or a change has been detected)

	@Inject
	public EntityRefreshAlert(RefreshAlertView view, SynapseJavascriptClient jsClient, GWTWrapper gwt,
