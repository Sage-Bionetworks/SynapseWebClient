...
public class SearchBox
  implements SearchBoxView.Presenter, SynapseWidgetPresenter {

  private SearchBoxView view;
  private GlobalApplicationState globalApplicationState;
  public static final RegExp DOI_REGEX = RegExp.compile(
    "10[.]{1}[0-9]+[/]{1}(syn([0-9]+[.]?[0-9]*)+)$",
    "i"
  );
