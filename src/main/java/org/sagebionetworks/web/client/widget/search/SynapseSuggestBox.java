...
public class SynapseSuggestBox
  implements
    SynapseSuggestBoxView.Presenter,
  ...
  @Inject
  public SynapseSuggestBox(
    SynapseSuggestBoxView view,
  ...
  public void setSelectedSuggestion(UserGroupSuggestion selectedSuggestion) {
    ...
    if (selectedSuggestion != null) {
      view.setSelectedText(
        "Currently selected: " + selectedSuggestion.getName()
      );
      if (callback != null) {
