...
public class SynapseSuggestionDisplay extends SuggestBox.DefaultSuggestionDisplay {
	...
	public void showLoading(UIObject suggestBox) {
		...
		// When in a bootstrap modal, the popup panel only has the correct top position when the window
		// is scrolled up.
	...
	protected void showSuggestions(final com.google.gwt.user.client.ui.SuggestBox suggestBox,
		...
		Window.scrollTo(0, 0);
		super.showSuggestions(suggestBox, suggestions, isDisplayStringHTML, isAutoSelectEnabled,
				callback);
