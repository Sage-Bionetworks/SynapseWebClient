...
public interface SynapseUserGroupSuggestBoxView extends IsWidget, SynapseView, Focusable, HasKeyDownHandlers {
	 ...
	 */
	String getText();
	SynapseUserGroupSuggestOracle getUserGroupSuggestOracle();
	void hideLoading();
	void clear();
	...
	void configure(SynapseUserGroupSuggestOracle oracle);
