...
public class SynapseUserGroupSuggestBoxViewImpl extends FlowPanel implements SynapseUserGroupSuggestBoxView {
	...
	@Inject
	public SynapseUserGroupSuggestBoxViewImpl(SageImageBundle sageImageBundle, SynapseAlert synAlert) {
		this.sageImageBundle = sageImageBundle;
		this.synAlert = synAlert;
	}
	
	@Override
	public void configure(SynapseUserGroupSuggestOracle oracle) {
...
//					suggestBox.setText(selectedItem.getText());
	...
	@Override
	public SynapseUserGroupSuggestOracle getUserGroupSuggestOracle() {
		return (SynapseUserGroupSuggestOracle) suggestBox.getSuggestOracle();
	}
