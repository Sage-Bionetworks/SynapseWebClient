...
public class UserGroupSuggestion implements IsSerializable, SuggestOracle.Suggestion {
	...
	public String getDisplayString() {
		...
		result.append("<div id=\"" + uniqueId + "\" " + DATA_IS_INDIVIDUAL + "=\""
				+ header.getIsIndividual() + "\" " + DATA_USER_GROUP_ID + "=\"" + header.getOwnerId()
				+ "\" class=\"padding-left-5 userGroupSuggestion\" style=\"height:28px; width:" + width
				+ "px;\"></div>");
		loadBadge(uniqueId);
