...
public interface AccessControlListEditorView extends IsWidget, SynapseView {
	...
	void setPermissionsToDisplay(PermissionLevel[] permList,
	...
	public interface Presenter {
		...
		/**
		 * Delete the ACL for the current entity. The entity will subsequently inherit access
		 * permissions from its ancestor's ACL. Changes are NOT pushed to Synapse. *
		 */
		void deleteAcl();
