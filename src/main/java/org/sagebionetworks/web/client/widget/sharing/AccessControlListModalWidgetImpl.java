...
public class AccessControlListModalWidgetImpl
  implements
  ...
  public void configure(Entity entity, boolean canChangePermission) {
    ...
    String entityTypeName = EntityTypeUtils.getDisplayName(
      EntityTypeUtils.getEntityTypeForClass(entity.getClass())
    );
