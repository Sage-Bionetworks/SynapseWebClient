 ...
 *
 */
public class AccessControlListModalWidgetViewImpl
  implements AccessControlListModalWidgetView {

  public interface Binder
    extends UiBinder<Modal, AccessControlListModalWidgetViewImpl> {}
