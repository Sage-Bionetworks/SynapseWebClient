...
public class EvaluationAccessControlListEditor implements AccessControlListEditorView.Presenter {
	...
	public EvaluationAccessControlListEditor(AccessControlListEditorView view,
			SynapseJavascriptClient jsClient, AuthenticationController authenticationController,
			SynapseProperties synapseProperties, JSONObjectAdapter jsonObjectAdapter,
			ChallengeClientAsync challengeClient, SynapseAlert synAlert) {
		this.view = view;
	...
	public PermissionLevel[] getPermList() {
		return new PermissionLevel[] {PermissionLevel.CAN_VIEW, PermissionLevel.CAN_SUBMIT_EVALUATION,
	...
	public HashMap<PermissionLevel, String> getPermissionsToDisplay() {
		...
		permissionDisplay.put(PermissionLevel.CAN_SCORE_EVALUATION,
				DisplayConstants.MENU_PERMISSION_LEVEL_CAN_SCORE);
		permissionDisplay.put(PermissionLevel.CAN_SUBMIT_EVALUATION,
				DisplayConstants.MENU_PERMISSION_LEVEL_CAN_SUBMIT);
		permissionDisplay.put(PermissionLevel.CAN_ADMINISTER_EVALUATION,
	...
	private void refresh(final AsyncCallback<Void> callback) {
		if (this.evaluation.getId() == null)
			throw new IllegalStateException(NULL_EVALUATION_MESSAGE);
		view.showLoading();
