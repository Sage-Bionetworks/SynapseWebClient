...
public class PublicPrivateBadgeViewImpl
  implements PublicPrivateBadgeView, IsWidget {

  public interface PublicPrivateBadgeViewImplUiBinder
    extends UiBinder<Widget, PublicPrivateBadgeViewImpl> {}
