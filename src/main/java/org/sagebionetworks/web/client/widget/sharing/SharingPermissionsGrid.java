...
public class SharingPermissionsGrid
		implements SharingPermissionsGridView.Presenter, SynapseWidgetPresenter {
	...
	public void add(AclEntry aclEntry, PermissionLevel[] permissionLevels,
		...
		boolean deleteButtonVisible =
				!aclEntry.getOwnerId().equals(authController.getCurrentUserPrincipalId());
