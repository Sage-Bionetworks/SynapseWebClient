...
public class SharingPermissionsGridViewImpl extends Composite
	...
	@Override
	public void insert(AclEntry aclEntry, int beforeIndex, PermissionLevel[] permissionLevels,
			Map<PermissionLevel, String> permissionDisplays, boolean deleteButtonVisible) {
		tableBody.insert(
				createAclEntryTableRow(aclEntry, permissionLevels, permissionDisplays, deleteButtonVisible),
				beforeIndex);
	}
	...
	@Override
	public void add(AclEntry aclEntry, PermissionLevel[] permissionLevels,
			Map<PermissionLevel, String> permissionDisplay, boolean deleteButtonVisible) {
		tableBody.add(
				createAclEntryTableRow(aclEntry, permissionLevels, permissionDisplay, deleteButtonVisible));
	}

	private TableRow createAclEntryTableRow(final AclEntry aclEntry,
			PermissionLevel[] permissionLevels, Map<PermissionLevel, String> permissionDisplay,
	...
	private ListBox createEditAccessListBox(final AclEntry aclEntry,
			final PermissionLevel[] permissionLevels, Map<PermissionLevel, String> permissionDisplay) {
		final Long principalId = Long.parseLong(aclEntry.getOwnerId());

		final ListBox listBox = new ListBox();

		PermissionLevel permLevel =
				AclUtils.getPermissionLevel(new HashSet<ACCESS_TYPE>(aclEntry.getAccessTypes()));
