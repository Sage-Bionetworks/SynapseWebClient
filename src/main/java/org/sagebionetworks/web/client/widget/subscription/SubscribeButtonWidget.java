...
public class SubscribeButtonWidget
	...
	@Inject
	public SubscribeButtonWidget(SubscribeButtonWidgetView view, SynapseJavascriptClient jsClient,
			SynapseAlert synAlert, AuthenticationController authController,
			GlobalApplicationState globalApplicationState) {
		this.view = view;
	...
	public void showUnfollowButton() {
		if (actionMenu != null) {
			...
			actionMenu.setActionText(Action.FOLLOW,
					"Unfollow " + StringUtils.toTitleCase(type.toString()));
		}
