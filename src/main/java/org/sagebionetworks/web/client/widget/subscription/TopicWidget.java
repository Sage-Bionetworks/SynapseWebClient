...
public class TopicWidget
  implements TopicWidgetView.Presenter, SynapseWidgetPresenter {

  public static final String DATA_ACCESS_SUBMISSION_TOPIC_TEXT =
    "Notifications";
    ...
    jsClient.getThread(
      ...
      new AsyncCallback<DiscussionThreadBundle>() {
        ...
        public void onSuccess(DiscussionThreadBundle threadBundle) {
          ...
          String href = TopicUtils.buildThreadLink(
            threadBundle.getProjectId(),
            threadBundle.getId()
          );
