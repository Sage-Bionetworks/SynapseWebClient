...
public class ColumnDetailsPanel extends FlowPanel {
	...
	private Widget createColumnView(org.sagebionetworks.repo.model.table.ColumnModel col) {
		...
		.appendHtmlConstant("<span class=\"boldText\">" + DisplayConstants.TYPE + "</span>: ").appendEscaped(TableUtils.getColumnDisplayName(col.getColumnType())).appendHtmlConstant("<br/>");
