 ...
 * 
 * <p>
 * Each {@link DatePickerCellNullTolerant} has a unique {@link DatePicker} popup associated
 * with it; thus, if a single {@link DatePickerCellNullTolerant} is used as the cell for a
 * column in a table, only one entry in that column will be editable at a given
 * time.
 * </p>
 */
public class DatePickerCellNullTolerant extends AbstractEditableCell<Date, Date> {
  ...
  public DatePickerCellNullTolerant() {
   ...
   */
  public DatePickerCellNullTolerant(DateTimeFormat format) {
   ...
   */
  public DatePickerCellNullTolerant(SafeHtmlRenderer<String> renderer) {
   ...
   * @param renderer a {@link SafeHtmlRenderer SafeHtmlRenderer<String>} instance
   */
  public DatePickerCellNullTolerant(DateTimeFormat format, SafeHtmlRenderer<String> renderer) {
    super(CLICK, KEYDOWN);
    if (format == null) {
