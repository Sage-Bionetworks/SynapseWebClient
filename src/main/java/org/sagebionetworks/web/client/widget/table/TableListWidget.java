...
public class TableListWidget implements TableListWidgetView.Presenter, IsWidget {
	...
	@Inject
	public TableListWidget(TableListWidgetView view, SynapseJavascriptClient jsClient,
			LoadMoreWidgetContainer loadMoreWidget, SynapseAlert synAlert) {
		this.view = view;
	...
	public void toggleSort(SortBy sortColumn) {
		Direction newDirection =
				Direction.ASC.equals(query.getSortDirection()) ? Direction.DESC : Direction.ASC;
