...
public class APITableWidgetViewImpl implements APITableWidgetView {
	...
	@Inject
	public APITableWidgetViewImpl(PortalGinInjector ginInjector, SynapseJSNIUtils synapseJSNIUtils,
			GWTWrapper gwt) {
	...
	public void showTableUnavailable() {
		...
		unavailableContainer.add(new HTML(
				"<h2>" + DisplayConstants.TABLE_UNAVAILABLE + "</h2><p><strong>" + TableState.PROCESSING
						+ "</strong>: " + DisplayConstants.TABLE_PROCESSING_DESCRIPTION + "</p>"));
