...
public enum ApiTableColumnType {
	STRING(ColumnType.STRING), USERID(ColumnType.USERID), DATE(ColumnType.DATE), ENTITYID(
			ColumnType.ENTITYID), LARGETEXT(
					ColumnType.LARGETEXT), MARKDOWN_LINK(null), CANCEL_CONTROL(null);
