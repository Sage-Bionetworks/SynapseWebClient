...
public class CreateDownloadPageImpl implements CreateDownloadPage {
	...
	@Inject
	public CreateDownloadPageImpl(CreateDownloadPageView view, JobTrackingWidget jobTrackingWidget,
			DownloadFilePage nextPage) {
		super();
		this.view = view;
	...
	public void onPrimary() {
		...
		this.jobTrackingWidget.startAndTrackJob(CREATING_THE_FILE, false, AsynchType.TableCSVDownload,
