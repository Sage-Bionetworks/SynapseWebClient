...
public class MaterializedViewEditorViewImpl implements MaterializedViewEditorView {

	public interface Binder extends UiBinder<Widget, MaterializedViewEditorViewImpl> {
	}
