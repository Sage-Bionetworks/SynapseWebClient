...
public enum TableType {
	table(null), projects(PROJECT), tables(TABLE), folders(FOLDER), folders_tables(
			FOLDER | TABLE), files(FILE), files_tables(
					FILE | TABLE), files_folders(FILE | FOLDER), files_folders_tables(FILE | FOLDER | TABLE);
	...
	public static TableType getTableType(boolean isFileSelected, boolean isFolderSelected,
