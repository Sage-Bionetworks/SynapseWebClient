...
public class UploadCSVAppendPageImpl implements UploadCSVAppendPage {
	...
	@Inject
	public UploadCSVAppendPageImpl(UploadCSVAppendPageView view, SynapseClientAsync synapseClient,
			JobTrackingWidget jobTrackingWidget) {
		this.view = view;
	...
	public void onPrimary() {
		...
		this.jobTrackingWidget.startAndTrackJob("Applying CSV to the Table...", false,
