...
public class UploadCSVFilePageImpl implements UploadCSVFilePage {
  ...
  public void setModalPresenter(final ModalPresenter presenter) {
    ...
    this.fileInputWidget.configure(
        WebConstants.DEFAULT_FILE_HANDLE_WIDGET_TEXT,
    ...
    this.fileInputWidget.setUploadingCallback(
        new Callback() {
          @Override
          public void invoke() {
    ...
    validator.setInvalidFileCallback(
      new Callback() {
        @Override
        public void invoke() {
          presenter.setErrorMessage(PLEASE_SELECT_A_CSV_OR_TSV_FILE_TO_UPLOAD);
