...
public class UploadCSVFilePageImpl implements UploadCSVFilePage {
	...
	public static final String PLEASE_SELECT_A_CSV_OR_TSV_FILE_TO_UPLOAD =
			"Please select a CSV or TSV file to upload";
	public static final String UNKNOWN_TYPE_SLECTED =
			"The selected files is not of the expected type. Please select a comma-separated or tab-separated file.";
	public static final String CHOOSE_A_CSV_OR_TSV_FILE =
			"Choose a CSV or TSV file and then click next.";
	...
	@Inject
	public UploadCSVFilePageImpl(FileHandleUploadWidget fileInputWidget,
			UploadCSVPreviewPage uploadCSVConfigurationWidget) {
		super();
	...
	public void setModalPresenter(final ModalPresenter presenter) {
		...
		this.fileInputWidget.configure(WebConstants.DEFAULT_FILE_HANDLE_WIDGET_TEXT,
	...
	private void fileHandleCreated(FileUpload uploadFile) {
		...
		this.nextPage.configure(contentTypeDelimiter, fileName, this.parentId,
				uploadFile.getFileHandleId(), this.tableId);
