...
public class UploadPreviewWidgetImpl implements UploadPreviewWidget {
  ...
  public static final String NO_ROWS_WERE_FOUND_IN_THE_FILE =
    "No rows were found in the file.";
  public static final String NO_DATA_WAS_FOUND_IN_THE_FILE =
    "No data was found in the file.";
  public static final String PREVIEW_MESSAGE_PREFIX = "Scanned ";
  public static final String PREVIEW_MESSAGE_SUFFIX =
  ...
  public void configure(UploadToTablePreviewResult preview) {
    if (isPreviewSchemaEmpty(preview)) {
      ...
      view.setPreviewMessage(
        PREVIEW_MESSAGE_PREFIX +
        preview.getRowsScanned() +
        PREVIEW_MESSAGE_SUFFIX
      );
  ...
  private boolean isPreviewRowsEmpty(UploadToTablePreviewResult preview) {
    ...
    if (
      firstRow == null ||
      firstRow.getValues() == null ||
      firstRow.getValues().isEmpty()
    ) {
      return true;
    }
    return false;
  ...
  private boolean isPreviewSchemaEmpty(UploadToTablePreviewResult preview) {
    ...
    if (
      preview.getSuggestedColumns() == null ||
      preview.getSuggestedColumns().isEmpty()
    ) {
      return true;
    }
    return false;
