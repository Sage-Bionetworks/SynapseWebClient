...
public class UploadRequestUtils {
   ...
   * @return
   */
  public static UploadToTableRequest cloneUploadToTableRequest(
    UploadToTableRequest in
  ) {
    if (in == null) {
      return null;
    }
    UploadToTableRequest clone = new UploadToTableRequest();
    clone.setCsvTableDescriptor(
      cloneCsvTableDescriptor(in.getCsvTableDescriptor())
    );
   ...
   * @return
   */
  public static CsvTableDescriptor cloneCsvTableDescriptor(
    CsvTableDescriptor in
  ) {
    if (in == null) {
      return null;
    }
   ...
   * @return
   */
  public static UploadToTableRequest createFromPreview(
    UploadToTablePreviewRequest preview
  ) {
    if (preview == null) {
      return null;
    }
    UploadToTableRequest out = new UploadToTableRequest();
    out.setCsvTableDescriptor(
      cloneCsvTableDescriptor(preview.getCsvTableDescriptor())
    );
