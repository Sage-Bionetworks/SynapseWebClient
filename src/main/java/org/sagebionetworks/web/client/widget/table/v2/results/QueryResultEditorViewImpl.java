...
public class QueryResultEditorViewImpl implements QueryResultEditorView {
  ...
  public void setPresenter(Presenter presenterin) {
    ...
    this.addRowButton.addClickHandler(
        new ClickHandler() {
          @Override
    ...
    this.addRowToolButton.addClickHandler(
        new ClickHandler() {
          @Override
          public void onClick(ClickEvent event) {
            presenter.onAddRow();
    ...
    saveRowsButton.addClickHandler(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
          presenter.onSave();
    ...
    saveRowsButton.addDomHandler(
      DisplayUtils.getPreventTabHandler(saveRowsButton),
      KeyDownEvent.getType()
    );
    // Track clicks to the close button at the top of the dialog
    editRowsModal.addCloseHandler(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
          presenter.onCancel();
    ...
    cancelProgressButton.addClickHandler(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
          presenter.onCancel();
