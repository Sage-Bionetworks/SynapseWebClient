...
public class RowSetUtils {
   ...
   * @return
   */
  public static PartialRowSet buildDelta(
    RowSet original,
    List<Row> updateRows,
    ...
    LinkedHashMap<Long, Row> originalRowMap = buildRowIdToRowMap(
      original.getRows()
    );
   ...
   */
  public static PartialRow buildPartialRow(
