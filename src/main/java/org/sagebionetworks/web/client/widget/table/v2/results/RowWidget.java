...
public class RowWidget implements IsWidget, RowView.Presenter {
  ...
  public void configure(
    ...
    this.view.setSelectVisible(
        rowSelectionListener != null && TableType.table.equals(tableType)
      );
  ...
  private void configureAfterInit(
    ...
    for (ColumnModel type : types) {
      ...
      if (cell instanceof TakesAddressCell) {
        ...
        takesAddress.setCellAddresss(
          new CellAddress(tableId, type, rowId, rowVersion, tableType)
        );
      }
    }
