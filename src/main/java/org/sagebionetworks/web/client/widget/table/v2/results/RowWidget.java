...
public class RowWidget
		implements IsWidget, RowView.Presenter, KeyboardNavigationHandler.RowOfWidgets {
	 ...
	 * @param isEditor When true this row will be setup with editors. When false renderer will be
	 *        used.
	 ...
	 *        selectable.
	 */
	public void configure(final String tableId, final List<ColumnModel> types, final boolean isEditor,
			TableType tableType, final Row row, RowSelectionListener rowSelectionListener) {
	...
	private void configureAfterInit(String tableId, List<ColumnModel> types, boolean isEditor,
			TableType tableType, Row row) {
		// Setup each cell
