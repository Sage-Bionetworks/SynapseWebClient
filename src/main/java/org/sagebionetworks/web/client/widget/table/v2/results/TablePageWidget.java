...
public class TablePageWidget implements IsWidget, RowSelectionListener {
	 ...
	 */
	public void configure(QueryResultBundle bundle, Query query, List<SortItem> sortList,
			boolean isEditable, TableType tableType, RowSelectionListener rowSelectionListener,
		...
		if (pageChangeListener != null) {
			this.paginationWidget.configure(query.getLimit(), query.getOffset(), rowCount.longValue(),
					pageChangeListener);
		...
		types = ColumnModelUtils.buildTypesForQueryResults(QueryBundleUtils.getSelectFromBundle(bundle),
