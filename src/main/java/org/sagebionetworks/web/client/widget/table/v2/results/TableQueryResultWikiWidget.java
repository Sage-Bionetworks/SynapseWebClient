...
public class TableQueryResultWikiWidget implements WidgetRendererPresenter, QueryChangeHandler {
	...
	public TableQueryResultWikiWidget(TableQueryResultWikiWidgetView view,
			ActionMenuWidget actionMenu, EntityActionController entityActionController,
			SynapseJSNIUtils synapseJsniUtils, SynapseJavascriptClient jsClient, SynapseAlert synAlert,
			GWTWrapper gwt, PortalGinInjector ginInjector) {
		this.view = view;
	...
	public void configureTableQueryResultWidget(String tableId, Long tableVersionNumber) {
		...
		AsyncCallback<EntityBundle> callback = new AsyncCallback<EntityBundle>() {
			...
			public void onSuccess(EntityBundle bundle) {
				...
				entityActionController.configure(actionMenu, bundle, isCurrentVersion,
						bundle.getRootWikiId(), EntityArea.TABLES);
				boolean canEdit = false;
				getTableEntityWidget().configure(bundle, tableVersionNumber, canEdit,
						TableQueryResultWikiWidget.this, actionMenu);
				hideEditActions();
				isLoading = false;
			}
