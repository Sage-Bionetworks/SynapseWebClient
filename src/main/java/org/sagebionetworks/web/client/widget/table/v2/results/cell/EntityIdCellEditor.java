 ...
 *
 */
public class EntityIdCellEditor
  extends AbstractCellEditor
  implements CellEditor {

  public static final String MUST_BE_OF_THE_FORM_SYN123 =
    "Must be in the form of a Synapse ID. For example: 'syn123'";
  public static final String SYN_PREFIX = "syn";
  public static final String PLACE_HOLDER = "Example: 'syn123'";
  public static final RegExp SYN_PATTERN = RegExp.compile(
    "^\\s*(syn)?\\d+(\\.(\\d)+)?\\s*$",
    "i"
  );
