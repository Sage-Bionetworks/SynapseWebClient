...
public class EntityIdCellRenderer implements Cell, TakesAddressCell {
  ...
  public void loadData() {
    if (entityName == null && entityId != null) {
      ...
      String requestEntityId = entityId.toLowerCase().startsWith("syn")
        ? entityId
        : "syn" + entityId;
      ...
      String dotVersionEntityId = entityVersion != null
        ? requestEntityId + "." + entityVersion
        : requestEntityId;
      ...
      if (entityVersion != null) {
        versionedHeaderAsyncHandler.getEntityHeader(
          requestEntityId,
          entityVersion,
          callback
        );
