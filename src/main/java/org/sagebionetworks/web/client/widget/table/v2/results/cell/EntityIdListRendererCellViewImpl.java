 ...
 *
 */
public class EntityIdListRendererCellViewImpl implements EntityIdListRendererCellView {
	String v;
	...
	@Inject
	public EntityIdListRendererCellViewImpl(JSONObjectAdapter adapter, 	PortalGinInjector ginInjector) {
		super();
