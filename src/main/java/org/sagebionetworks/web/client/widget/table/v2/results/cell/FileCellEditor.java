...
public class FileCellEditor
  implements CellEditor, FileCellEditorView.Presenter {

  public static final String MUST_BE_A_FILE_ID_NUMBER =
    "Must be a File ID number";
  public static final String PLEASE_SELECT_A_FILE_TO_UPLOAD =
