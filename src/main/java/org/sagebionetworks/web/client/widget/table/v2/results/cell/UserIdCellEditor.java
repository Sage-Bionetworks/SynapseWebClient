...
public class UserIdCellEditor implements CellEditor {
	...
	@Inject
	public UserIdCellEditor(UserIdCellEditorView view, SynapseSuggestBox peopleSuggestWidget,
			UserGroupSuggestionProvider provider, UserIdCellRenderer userIdCellRenderer) {
		this.view = view;
