...
public class UserIdCellRenderer implements Cell {
	...
	@Inject
	public UserIdCellRenderer(DivView view, UserGroupHeaderAsyncHandler userGroupHeaderAsyncHandler,
			PortalGinInjector ginInjector) {
		this.view = view;
	...
	public void setValue(String value) {
		...
		if (DisplayUtils.isDefined(principalId)) {
			userGroupHeaderAsyncHandler.getUserGroupHeader(principalId,
