 ...
 *
 */
public class UserIdListRendererCellViewImpl implements UserIdListRendererCellView {
	String v;
	...
	@Inject
	public UserIdListRendererCellViewImpl(JSONObjectAdapter adapter, PortalGinInjector ginInjector) {
		super();
