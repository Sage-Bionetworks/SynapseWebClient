...
public class FacetColumnResultRangeWidget
  implements IsWidget, FacetColumnResultRangeView.Presenter {
  ...
  public static final String MIN_OR_MAX_MUST_BE_DEFINED =
    "Min or max must be defined.";
  public static final String MIN_MAX_MUST_BE_VALID_NUMBERS =
  ...
  public void configure(
    ...
    boolean isAny =
      facet.getSelectedMin() == null && facet.getSelectedMax() == null;
    boolean isNotSetFilter =
      (
        facet.getSelectedMin() != null &&
        facet.getSelectedMin().equals(TableConstants.NULL_VALUE_KEYWORD)
      ) ||
      (
        facet.getSelectedMax() != null &&
        facet.getSelectedMax().equals(TableConstants.NULL_VALUE_KEYWORD)
      );
    if (isAny) {
      view.setIsAnyValue();
