...
public class FacetColumnResultSliderRangeViewImpl
  implements FacetColumnResultRangeView {

  public static final int NUMBER_OF_STEPS = 200;

  public interface Binder
    extends UiBinder<Widget, FacetColumnResultSliderRangeViewImpl> {}
  ...
  public double getStepSize(Number min, Number max) {
    ...
    if (min != null && max != null) {
      stepSize =
        Math.round((max.doubleValue() - min.doubleValue()) / NUMBER_OF_STEPS);
      if (stepSize < 1) {
        stepSize = 1;
      }
    }
