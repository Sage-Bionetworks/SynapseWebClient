...
public class FacetColumnResultValueWidgetImpl
  implements FacetColumnResultValueWidget {

  interface FacetColumnResultValueWidgetBinder
    extends UiBinder<Widget, FacetColumnResultValueWidgetImpl> {}

  private static FacetColumnResultValueWidgetBinder binder = GWT.create(
    FacetColumnResultValueWidgetBinder.class
  );
