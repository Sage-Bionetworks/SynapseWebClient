...
public class FacetColumnResultValuesViewImpl
  implements FacetColumnResultValuesView {

  public interface Binder
    extends UiBinder<Widget, FacetColumnResultValuesViewImpl> {}
  ...
  public void addValue(
    ...
    facetValues.add(
      getNewFacetColumnResultValueWidget(
        isSelected,
        displayWidget,
        count,
        originalFacetValue
  ...
  @Override
  public void addValueToOverflow(
    boolean isSelected,
    Widget displayWidget,
    Long count,
    String originalFacetValue
  ...
  private FacetColumnResultValueWidgetImpl getNewFacetColumnResultValueWidget(
    boolean isSelected,
    Widget displayWidget,
    Long count,
    final String originalFacetValue
  ) {
