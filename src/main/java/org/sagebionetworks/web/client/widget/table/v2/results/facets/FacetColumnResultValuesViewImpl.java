...
public class FacetColumnResultValuesViewImpl implements FacetColumnResultValuesView {
	...
	@Override
	public void addValue(boolean isSelected, Widget displayWidget, Long count,
			String originalFacetValue) {
		facetValues.add(
				getNewFacetColumnResultValueWidget(isSelected, displayWidget, count, originalFacetValue));
	}

	@Override
	public void addValueToOverflow(boolean isSelected, Widget displayWidget, Long count,
			String originalFacetValue) {
		overflowFacetValues.add(
				getNewFacetColumnResultValueWidget(isSelected, displayWidget, count, originalFacetValue));
	}
	...
	private FacetColumnResultValueWidgetImpl getNewFacetColumnResultValueWidget(boolean isSelected,
			Widget displayWidget, Long count, final String originalFacetValue) {
