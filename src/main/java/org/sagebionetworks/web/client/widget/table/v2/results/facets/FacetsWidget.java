    ...
    progress.startAndTrackJob(
      ...
      new AsynchronousProgressHandler() {
        ...
        public void onComplete(AsynchronousResponseBody response) {
          ...
          configure(
            resultBundle.getFacets(),
            facetChangedHandler,
            resultBundle.getColumnModels(),
            resetFacetsHandler
          );
        }
        ...
        if (cm != null) {
          switch (facet.getFacetType()) {
            case enumeration:
              ...
              if (
                facetResultValues.getFacetValues() != null &&
            ...
            case range:
              ...
              if (rangeFacet.getColumnMin() != null) {
                ...
                if (ColumnType.INTEGER.equals(cm.getColumnType())) {
                  rangeView =
                    ginInjector.getFacetColumnResultSliderRangeViewImpl();
                  ...
                  rangeView =
                    ginInjector.getFacetColumnResultDateRangeViewImpl();
                }

                if (rangeView != null) {
                  rangeWidget.configure(
                    rangeView,
                    rangeFacet,
                    facetChangedHandler
                  );
