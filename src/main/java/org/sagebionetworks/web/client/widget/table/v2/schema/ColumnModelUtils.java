...
public class ColumnModelUtils {
   ...
   * @param row
   */
  public static void applyColumnModelToRow(
    ColumnModel model,
    ColumnModelView row
  ) {
    if (model == null) {
   ...
   * @return
   */
  public static List<ColumnModel> extractColumnModels(
    List<ColumnModelTableRow> rows
  ) {
   ...
   * @return
   */
  public static Map<String, ColumnModel> buildMapColumnIdtoModel(
    List<ColumnModel> schema
  ) {
    Map<String, ColumnModel> map = new HashMap<String, ColumnModel>(
      schema.size()
    );
   ...
   * @return
   */
  public static List<ColumnModel> buildTypesForQueryResults(
