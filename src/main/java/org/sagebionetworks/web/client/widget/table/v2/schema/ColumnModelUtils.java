...
public class ColumnModelUtils {
	 ...
	 * @return
	 */
	public static List<ColumnModel> buildTypesForQueryResults(List<SelectColumn> headers,
		...
		for (SelectColumn header : headers) {
			...
			if (cm == null) {
				// Not all select columns match the schema. For this case we use a column model with a null
				// id.
