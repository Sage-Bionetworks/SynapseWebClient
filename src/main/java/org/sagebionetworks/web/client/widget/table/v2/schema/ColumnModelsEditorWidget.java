...
public class ColumnModelsEditorWidget
		implements ColumnModelsView.Presenter, ColumnModelTableRow.SelectionPresenter, IsWidget {
	...
	@Inject
	public ColumnModelsEditorWidget(PortalGinInjector ginInjector, AdapterFactory adapterFactory,
			ViewDefaultColumns fileViewDefaultColumns) {
