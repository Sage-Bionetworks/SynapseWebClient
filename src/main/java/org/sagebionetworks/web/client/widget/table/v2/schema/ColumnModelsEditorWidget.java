...
public class ColumnModelsEditorWidget
  implements
    ColumnModelsView.Presenter,
    ColumnModelTableRow.SelectionPresenter,
    IsWidget {
  ...
  public ColumnModelsEditorWidget(
    ...
    this.addTableViewColumnsButton =
      ginInjector.getImportTableViewColumnsButton();
    editor.addButton(addTableViewColumnsButton);
    cookies = ginInjector.getCookieProvider();
    addTableViewColumnsButton.configure(
      new CallbackP<List<ColumnModel>>() {
        @Override
  ...
  public ColumnModelTableRowEditorWidget addNewColumn() {
    ...
    ColumnModelTableRowEditorWidget rowEditor = createColumnModelEditorWidget(
      cm
    );
  ...
  private ColumnModelTableRowEditorWidget createColumnModelEditorWidget(
    ColumnModel cm
  ) {
  ...
  public void setOnAddDefaultViewColumnsCallback(
  ...
  public void setOnAddAnnotationColumnsCallback(
    Callback onAddAnnotationColumnsCallback
  ) {
