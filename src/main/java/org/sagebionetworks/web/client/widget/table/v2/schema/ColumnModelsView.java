...
public interface ColumnModelsView extends IsWidget {
	...
	public interface Presenter {
		...
		/**
		 * Validate the column models for this view. If there are any errors they will be reflected in
		 * the UI.
		 * 
		 * @return return True if the current ColumnModels are valid. False, if there are any errors
		 *         that would prevent the column models from being saved.
		 */
