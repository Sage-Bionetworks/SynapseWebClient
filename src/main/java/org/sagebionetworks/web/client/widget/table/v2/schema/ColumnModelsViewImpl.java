...
public class ColumnModelsViewImpl
  ...
  public void setEditHandler(final EditHandler handler) {
    // Edit clicks
    this.editColumnsButton.addClickHandler(
        new ClickHandler() {
          @Override
  ...
  public void setPresenter(Presenter setPresenter) {
    ...
    // Add clicks
    this.addColumnButton.addClickHandler(
        new ClickHandler() {
          @Override
          public void onClick(ClickEvent event) {
    ...
    // Toggle select
    this.selectTogglebutton.addClickHandler(
        new ClickHandler() {
          @Override
          public void onClick(ClickEvent event) {
    ...
    // Select all
    this.selectAllItem.addClickHandler(
        new ClickHandler() {
          @Override
          public void onClick(ClickEvent event) {
            presenter.selectAll();
    ...
    // select none
    this.selectNoneItem.addClickHandler(
        new ClickHandler() {
          @Override
          public void onClick(ClickEvent event) {
    ...
    // move up
    this.moveUpButton.addClickHandler(
        new ClickHandler() {
          @Override
          public void onClick(ClickEvent event) {
            presenter.onMoveUp();
    ...
    // move down
    this.moveDownButton.addClickHandler(
        new ClickHandler() {
          @Override
          public void onClick(ClickEvent event) {
    ...
    // delete selected
    this.deleteSelectedButton.addClickHandler(
        new ClickHandler() {
          @Override
          public void onClick(ClickEvent event) {
    ...
    addDefaultColumnsButton.addClickHandler(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
    ...
    addAnnotationColumnsButton.addClickHandler(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
