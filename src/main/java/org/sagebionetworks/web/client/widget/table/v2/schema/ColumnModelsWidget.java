 ...
 *
 */
public class ColumnModelsWidget implements ColumnModelsViewBase.Presenter,
		ColumnModelsView.EditHandler, SynapseWidgetPresenter {
	 ...
	 */
	@Inject
	public ColumnModelsWidget(ColumnModelsViewBase baseView, PortalGinInjector ginInjector,
			SynapseClientAsync synapseClient, ColumnModelsEditorWidget editor,
			JobTrackingWidget jobTrackingWidget, ViewDefaultColumns fileViewDefaultColumns,
			SynapseAlert synAlert) {
	...
	public void getDefaultColumnsForView() {
		...
		List<ColumnModel> defaultColumns =
				fileViewDefaultColumns.getDefaultViewColumns(tableType.isIncludeFiles(), isClearIds);
	...
	public void getPossibleColumnModelsForViewScope(String nextPageToken) {
		...
		synapseClient.getPossibleColumnModelsForViewScope(scope, nextPageToken,
				new AsyncCallback<ColumnModelPage>() {
					@Override
	...
	public void onSave() {
		...
		synapseClient.getTableUpdateTransactionRequest(bundle.getEntity().getId(),
				bundle.getTableBundle().getColumnModels(), newSchema,
	...
	public void startTrackingJob(TableUpdateTransactionRequest request) {
		...
		this.jobTrackingWidget.startAndTrackJob(UPDATING_SCHEMA, false, AsynchType.TableTransaction,
