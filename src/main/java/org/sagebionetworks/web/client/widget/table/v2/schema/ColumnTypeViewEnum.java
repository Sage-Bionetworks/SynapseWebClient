...
public enum ColumnTypeViewEnum {
	...
	String(ColumnType.STRING), Boolean(ColumnType.BOOLEAN), Integer(ColumnType.INTEGER), Double(
			ColumnType.DOUBLE), Date(ColumnType.DATE), File(ColumnType.FILEHANDLEID), Entity(
					ColumnType.ENTITYID), Link(
							ColumnType.LINK), LargeText(ColumnType.LARGETEXT), User(ColumnType.USERID);
