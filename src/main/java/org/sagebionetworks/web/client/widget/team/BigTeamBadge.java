...
public class BigTeamBadge implements SynapseWidgetPresenter, HasNotificationUI {
	...
	@Inject
	public BigTeamBadge(BigTeamBadgeView view, SynapseJavascriptClient jsClient,
			AuthenticationController authController, TeamMemberCountWidget teamMemberCountWidget) {
		this.view = view;
