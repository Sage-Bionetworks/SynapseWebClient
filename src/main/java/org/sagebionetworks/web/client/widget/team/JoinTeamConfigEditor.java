...
public class JoinTeamConfigEditor
  implements WidgetEditorPresenter, JoinTeamConfigEditorView.Presenter {
  ...
  @Inject
  public JoinTeamConfigEditor(
    JoinTeamConfigEditorView view,
      ...
      jsClient.getTeam(
        ...
        new AsyncCallback<Team>() {
          ...
          public void onSuccess(Team team) {
            ...
            UserGroupSuggestion suggestion = new UserGroupSuggestion(
              ugh,
              team.getName(),
              teamSuggestBox.getWidth(),
              null
            );
  ...
  public void updateDescriptorFromView() throws IllegalArgumentException {
    ...
    if (descriptor.containsKey(WidgetConstants.TEAM_ID_KEY)) {
      descriptor.put(
        ...
        String.valueOf(view.getIsChallenge())
      );
      descriptor.put(
        WidgetConstants.JOIN_TEAM_IS_SIMPLE_REQUEST_BUTTON,
        String.valueOf(view.getIsSimpleRequest())
      );
      descriptor.put(
        WidgetConstants.IS_MEMBER_MESSAGE,
        view.getIsMemberMessage()
      );
      descriptor.put(WidgetConstants.SUCCESS_MESSAGE, view.getSuccessMessage());
      descriptor.put(
        WidgetConstants.JOIN_TEAM_BUTTON_TEXT,
        view.getButtonText()
      );
      descriptor.put(
        WidgetConstants.JOIN_TEAM_OPEN_REQUEST_TEXT,
        view.getRequestOpenInfotext()
      );
    } else {
