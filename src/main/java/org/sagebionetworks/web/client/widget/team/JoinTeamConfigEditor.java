...
public class JoinTeamConfigEditor
	...
	@Inject
	public JoinTeamConfigEditor(JoinTeamConfigEditorView view, SynapseSuggestBox teamSuggestBox,
			UserGroupSuggestionProvider provider, SynapseJavascriptClient jsClient,
			...
			jsClient.getTeam(descriptor.get(WidgetConstants.TEAM_ID_KEY), new AsyncCallback<Team>() {
				...
				public void onSuccess(Team team) {
					...
					UserGroupSuggestion suggestion =
							new UserGroupSuggestion(ugh, team.getName(), teamSuggestBox.getWidth());
	...
	public void updateDescriptorFromView() throws IllegalArgumentException {
		...
		if (descriptor.containsKey(WidgetConstants.TEAM_ID_KEY)) {
			descriptor.put(WebConstants.JOIN_WIDGET_IS_CHALLENGE_KEY,
