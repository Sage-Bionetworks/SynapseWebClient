...
public class JoinTeamWidgetViewImpl implements JoinTeamWidgetView {
	...
	private void showAnonymousMessage() {
		...
		DisplayUtils.showPopup("Login or Register", DisplayConstants.ANONYMOUS_JOIN, MessagePopup.INFO,
	...
	private void showAccessRequirement(Widget arTextWidget, Callback callback,
