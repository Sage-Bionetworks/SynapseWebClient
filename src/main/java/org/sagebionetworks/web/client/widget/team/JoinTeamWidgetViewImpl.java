...
public class JoinTeamWidgetViewImpl implements JoinTeamWidgetView {
  ...
  public interface JoinTeamWidgetViewImplUiBinder
    extends UiBinder<Widget, JoinTeamWidgetViewImpl> {}
  ...
  public JoinTeamWidgetViewImpl(
    ...
    acceptInviteButton.addClickHandler(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
    ...
    simpleRequestButton.addClickHandler(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
          presenter.sendJoinRequest("");
    ...
    sendRequestButton.addClickHandler(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
    ...
    actRequestAccessButton.addClickHandler(
      new ClickHandler() {
        @Override
        public void onClick(ClickEvent event) {
  ...
  private void showAnonymousMessage() {
    ...
    DisplayUtils.showPopup(
      "Login or Register",
      DisplayConstants.ANONYMOUS_JOIN,
      MessagePopup.INFO,
      okCallback,
      cancelCallback
    );
  ...
  public void showJoinWizard(boolean isChallengeSignup) {
    ...
    joinWizard.configure(
      dialogTitle,
      "Continue",
      DisplayConstants.BUTTON_CANCEL,
      new Dialog.Callback() {
        @Override
  ...
  private void showAccessRequirement(
    Widget arTextWidget,
    Callback callback,
