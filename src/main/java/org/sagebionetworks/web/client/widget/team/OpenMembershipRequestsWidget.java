...
public class OpenMembershipRequestsWidget implements OpenMembershipRequestsWidgetView.Presenter {
	...
	@Inject
	public OpenMembershipRequestsWidget(OpenMembershipRequestsWidgetView view, SynapseClientAsync synapseClient, GlobalApplicationState globalApplicationState, GWTWrapper gwt, SynapseAlert synAlert, PopupUtilsView popupUtils, DateTimeUtils dateTimeUtils, SynapseJavascriptClient jsClient) {
		this.view = view;
	...
	public void deleteRequest(String requestId) {
		gwt.saveWindowPosition();
		synAlert.clear();
		jsClient.deleteMembershipRequest(requestId).addCallback(new FutureCallback<Void>() {
			@Override
