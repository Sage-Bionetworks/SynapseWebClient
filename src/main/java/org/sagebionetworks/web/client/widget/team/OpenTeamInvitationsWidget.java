...
public class OpenTeamInvitationsWidget
  ...
  @Inject
  public OpenTeamInvitationsWidget(
    OpenTeamInvitationsWidgetView view,
  ...
  public void configure(
    final Callback teamUpdatedCallback,
    ...
    if (authenticationController.isLoggedIn()) {
      ...
      synapseClient.getOpenInvitations(
        ...
        new AsyncCallback<ArrayList<OpenUserInvitationBundle>>() {
          ...
          public void onSuccess(ArrayList<OpenUserInvitationBundle> result) {
            if (
              openTeamInvitationsCallback != null
  ...
  public void showTeamInvites(List<OpenUserInvitationBundle> invites) {
    ...
    for (OpenUserInvitationBundle b : invites) {
      ...
      if (invite.getCreatedOn() != null) {
        createdOnString =
          RECEIVED + dateTimeUtils.getRelativeTime(invite.getCreatedOn());
      }
  ...
  public void deleteInvitation(String inviteId) {
    synAlert.clear();
    jsClient
      .deleteMembershipInvitation(inviteId)
      .addCallback(
  ...
  public void refresh() {
    ...
    configure(
      teamUpdatedCallback,
      (CallbackP<List<OpenUserInvitationBundle>>) null
    );
  }
