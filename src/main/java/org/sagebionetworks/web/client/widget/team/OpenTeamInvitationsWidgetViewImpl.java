...
public class OpenTeamInvitationsWidgetViewImpl implements OpenTeamInvitationsWidgetView {
	...
	public OpenTeamInvitationsWidgetViewImpl(Binder binder, PortalGinInjector ginInjector) {
		...
		mainContainer.getElement().setAttribute("highlight-box-title",
				DisplayConstants.PENDING_TEAM_INVITATIONS);
	}
	...
	@Override
	public void addTeamInvite(Team team, String inviteMessage, String createdOn,
			final String inviteId, Widget joinButtonWidget) {
