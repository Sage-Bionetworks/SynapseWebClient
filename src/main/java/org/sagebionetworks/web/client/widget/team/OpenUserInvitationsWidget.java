...
public class OpenUserInvitationsWidget
  implements OpenUserInvitationsWidgetView.Presenter {
  ...
  @Inject
  public OpenUserInvitationsWidget(
    OpenUserInvitationsWidgetView view,
  ...
  public void removeInvitation(String invitationId) {
    ...
    synAlert.clear();
    jsClient.deleteMembershipInvitation(
      invitationId,
  ...
  public void getNextBatch() {
    ...
    synapseClient.getOpenTeamInvitations(
      teamId,
  ...
  private void addInvitations(List<OpenTeamInvitationBundle> bundles) {
    ...
    for (OpenTeamInvitationBundle b : bundles) {
      ...
      String createdOn = dateTimeUtils.getDateTimeString(
        b.getMembershipInvitation().getCreatedOn()
      );
  ...
  private void updateMoreButton(int resultSize) {
    if (resultSize == INVITATION_BATCH_LIMIT) {
      ...
      synAlert.showError(
        "Result size can't be greater than " + INVITATION_BATCH_LIMIT
      );
    }
  }
  ...
  public void resendInvitation(String membershipInvitationId) {
    gwt.saveWindowPosition();
    synapseClient.resendTeamInvitation(
