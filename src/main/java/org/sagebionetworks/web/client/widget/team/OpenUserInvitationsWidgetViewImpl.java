...
public class OpenUserInvitationsWidgetViewImpl implements OpenUserInvitationsWidgetView {
	...
	@Override
	public void addInvitation(IsWidget badge, String inviteeEmail, String misId, String message,
			String createdOn) {
		...
		openUserInvitationWidget.cancelButton.getElement().setAttribute(MEMBERSHIP_INVITATION_ID,
				misId);
		openUserInvitationWidget.cancelButton.addClickHandler(removeInvitationClickHandler);

		openUserInvitationWidget.resendButton.getElement().setAttribute(MEMBERSHIP_INVITATION_ID,
				misId);
