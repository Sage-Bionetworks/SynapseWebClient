...
public class TeamBadge implements SynapseWidgetPresenter, HasNotificationUI, IsWidget {
	...
	public TeamBadge(TeamBadgeView view, TeamAsyncHandler teamAsyncHandler,
			SynapseProperties synapseProperties, SynapseJSNIUtils synapseJsniUtils) {
		this.view = view;
		this.teamAsyncHandler = teamAsyncHandler;
		this.synapseJsniUtils = synapseJsniUtils;
		publicAclPrincipalId =
				synapseProperties.getSynapseProperty(WebConstants.PUBLIC_ACL_PRINCIPAL_ID);
	...
	public void configure(Team team) {
		String teamIconUrl = synapseJsniUtils.getFileHandleAssociationUrl(team.getId(),
