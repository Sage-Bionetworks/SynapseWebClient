...
public class TeamBadgeViewImpl extends FlowPanel implements TeamBadgeView {
  ...
  public void setTeam(
    ...
    if (team != null) {
      String name = maxNameLength == null
        ? team.getName()
      ...
      if (teamIconUrl != null) {
        ...
        profilePicture.addStyleName(
          "imageButton displayInline margin-right-4 img-circle"
        );
        ...
        defaultProfilePicture.addStyleName(
          "imageButton lightGreyText margin-right-4"
        );
  ...
  public void setTeamWithoutLink(String name, boolean isPublic) {
    ...
    Icon profilePicture = isPublic
      ? new Icon(IconType.GLOBE)
      : new Icon(IconType.SYN_USERS);
    profilePicture.addStyleName(
      "font-size-lg imageButton lightGreyText margin-right-4 margin-left-5"
    );
    add(profilePicture);
