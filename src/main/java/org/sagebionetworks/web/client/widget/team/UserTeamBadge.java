...
public class UserTeamBadge implements WidgetRendererPresenter {
	...
	public UserTeamBadge(PortalGinInjector ginInjector,
			UserGroupHeaderAsyncHandler usgFromIdAsyncHandler,
			UserGroupHeaderFromAliasAsyncHandler usgFromAliasAsyncHandler, DivView div) {
	...
	public void configure(WikiPageKey wikiKey, Map<String, String> widgetDescriptor,
		...
		if (alias == null
				&& widgetDescriptor.containsKey(WidgetConstants.USER_TEAM_BADGE_WIDGET_USERNAME_KEY)) {
		...
		if (alias != null) {
			...
			Boolean isIndividual = Boolean
					.valueOf(widgetDescriptor.get(WidgetConstants.USER_TEAM_BADGE_WIDGET_IS_INDIVIDUAL_KEY));
