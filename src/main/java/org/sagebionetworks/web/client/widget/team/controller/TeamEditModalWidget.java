...
public class TeamEditModalWidget
  implements IsWidget, TeamEditModalWidgetView.Presenter {
      ...
      synapseClient.updateTeam(
        ...
        new AsyncCallback<Team>() {
          ...
          public void onSuccess(Team result) {
            ...
            if (refreshCallback != null) refreshCallback.invoke();
            view.hide();
          }
  ...
  private void show() {
    ...
    ); else view.setDefaultIconVisible();
