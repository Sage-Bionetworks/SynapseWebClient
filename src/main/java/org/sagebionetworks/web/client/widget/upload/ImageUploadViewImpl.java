...
public class ImageUploadViewImpl implements ImageUploadView {
	...
	/**
	 * Used to ensure each new instance of this widget has its own ID. This is important because the
	 * ID is used when interacting with the actual DOM element.
	 */
	...
	public void processFile() {
		...
		_loadImage(fileInput.getElement().getId(), ImageUploadViewImpl.this, originalCanvas,
				resizedCanvas);
	}

	private static native void _loadImage(String fileFieldId, ImageUploadViewImpl v,
			CanvasElement originalCanvas, CanvasElement resizedCanvas) /*-{
