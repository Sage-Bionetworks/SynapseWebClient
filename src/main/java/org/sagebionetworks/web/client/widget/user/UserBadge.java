...
public class UserBadge implements SynapseWidgetPresenter, WidgetRendererPresenter, IsWidget {
	...
	@Inject
	public UserBadge(UserBadgeView view, SynapseClientAsync synapseClient,
			GlobalApplicationState globalApplicationState, SynapseJSNIUtils synapseJSNIUtils,
			ClientCache clientCache, UserProfileAsyncHandler userProfileAsyncHandler,
	...
	public static UserProfile getUserProfileFromCache(String principalId,
	...
	public void cacheProfile(UserProfile profile) {
		...
		try {
			...
			clientCache.put(profile.getOwnerId() + WebConstants.USER_PROFILE_SUFFIX,
