...
public class AliasRedirectorServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			List<UserGroupHeader> ughList =
					client.getUserGroupHeadersByAliases(Collections.singletonList(alias));
			if (!ughList.isEmpty()) {
				...
				URL redirectURL =
						new URL(requestURL.getProtocol(), requestURL.getHost(), requestURL.getPort(), newPath);
