...
public class ChallengeClientImpl
  extends SynapseClientBase
  implements ChallengeClient {
  ...
  public static List<Evaluation> getShareableEvaluations(
    String entityId,
    SynapseClient synapseClient
  ) throws SynapseException {
    // look up the available evaluations
    org.sagebionetworks.reflection.model.PaginatedResults<Evaluation> allEvaluations = synapseClient.getEvaluationByContentSource(
      entityId,
    ...
    for (Evaluation eval : allEvaluations.getResults()) {
      ...
      // permissions?
      UserEvaluationPermissions uep = synapseClient.getUserEvaluationPermissions(
        eval.getId()
      );
  ...
  public Submission createTeamSubmission(
    Submission submission,
    String etag,
    String memberStateHash,
    String hostPageBaseURL
  ) throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      String signedTokenEndpoint = SynapseClientImpl.getSignedTokenEndpoint(
        hostPageBaseURL
      );
      String challengeEndpoint = SynapseClientImpl.getChallengeEndpoint(
        hostPageBaseURL
      );
      return synapseClient.createTeamSubmission(
        submission,
        etag,
        memberStateHash,
        challengeEndpoint,
  ...
  public Submission createIndividualSubmission(
    Submission submission,
    String etag,
    String hostPageBaseURL
  ) throws RestServiceException {
    ...
    try {
      ...
      return synapseClient.createIndividualSubmission(
        submission,
        etag,
        challengeEndpoint,
        signedTokenEndpoint
  ...
  public String getUserEvaluationPermissions(String evalId)
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      UserEvaluationPermissions permissions = synapseClient.getUserEvaluationPermissions(
        evalId
      );
      JSONObjectAdapter json = permissions.writeToJSONObject(
  ...
  public String getEvaluationAcl(String evalId) throws RestServiceException {
    ...
    try {
      ...
      JSONObjectAdapter json = acl.writeToJSONObject(
        adapterFactory.createNew()
      );
      return json.toJSONString();
    } catch (SynapseException e) {
  ...
  public List<Team> getSubmissionTeams(String userId, String challengeId)
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      PaginatedIds results = synapseClient.listSubmissionTeams(
        challengeId,
        userId,
        GROUPS_PAGINATION_LIMIT,
        GROUPS_PAGINATION_OFFSET
      );
  ...
  @Override
  public void unregisterChallengeTeam(String challengeTeamId)
    throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
  ...
  @Override
  public ChallengeTeam updateRegisteredChallengeTeam(
  ...
  @Override
  public ChallengeTeamPagedResults getChallengeTeams(
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      org.sagebionetworks.repo.model.ChallengeTeamPagedResults pagedResults = synapseClient.listChallengeTeams(
        challengeId,
        limit.longValue(),
        offset.longValue()
      );
      ...
      for (ChallengeTeam challengeTeam : pagedResults.getResults()) {
        ChallengeTeamBundle teamBundle = new ChallengeTeamBundle(
          challengeTeam,
          false
        );
      ...
      if (currentUserId != null) {
        for (int i = 0; i < teamIds.size(); i++) {
          try {
            TeamMember member = synapseClient.getTeamMember(
              teamIds.get(i).toString(),
              currentUserId
            );
      ...
      ChallengeTeamPagedResults returnResults = new ChallengeTeamPagedResults(
        challengeTeamList,
        totalCount
      );
  ...
  @Override
  public UserProfilePagedResults getChallengeParticipants(
    boolean affiliated,
    String challengeId,
    Integer limit,
    Integer offset
    ...
    try {
      org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
      PaginatedIds paginatedIds = synapseClient.listChallengeParticipants(
        challengeId,
        affiliated,
        limit.longValue(),
        offset.longValue()
      ...
      userProfiles.setTotalNumberOfResults(
        paginatedIds.getTotalNumberOfResults()
      );
  ...
  @Override
  public Challenge getChallengeForProject(String projectId)
    throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
  ...
  @Override
  public List<Team> getRegistratableTeams(String userId, String challengeId)
    throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      ...
      TeamMembershipStatus status = synapseClient.getTeamMembershipStatus(
        challenge.getParticipantTeamId(),
        userId
      );
      if (!status.getIsMember()) {
        throw new NotFoundException(
          "User is not registered for the Challenge."
        );
      }
      PaginatedIds results = synapseClient.listRegistratableTeams(
        challengeId,
        GROUPS_PAGINATION_LIMIT,
        GROUPS_PAGINATION_OFFSET
      );
  ...
  @Override
  public Set<String> getChallengeEvaluationIds(String challengeId)
    throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      Challenge challenge = synapseClient.getChallenge(challengeId);
  ...
  @Override
  public Set<String> getProjectEvaluationIds(String projectId)
    throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      org.sagebionetworks.reflection.model.PaginatedResults<Evaluation> allEvaluations = synapseClient.getEvaluationByContentSource(
  ...
  @Override
  public TeamSubmissionEligibility getTeamSubmissionEligibility(
    String evaluationId,
    String teamId
  ) throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
