...
public class FileUploaderJnlp extends HttpServlet {
  ...
  private static Logger logger = Logger.getLogger(
    FileUploaderJnlp.class.getName()
  );
  ...
  private TokenProvider tokenProvider = new TokenProvider() {
    ...
    public String getToken() {
      return UserDataProvider.getThreadLocalUserToken(
        FileUploaderJnlp.perThreadRequest.get()
      );
    }
  };
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    Boolean isUpdate = Boolean.parseBoolean(
      request.getParameter(WebConstants.FILE_UPLOADER_IS_UPDATE_PARAM)
    );
  ...
  private static String buildJnlp(
    String jnlpServletUrl,
    String fileUploaderJarUrl,
    String accessToken,
    String entityId,
    boolean isUpdate
  ) {
