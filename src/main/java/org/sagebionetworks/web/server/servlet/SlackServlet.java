...
public class SlackServlet extends HttpServlet {
  ...
  public static final String IS_INVALID_SYN_ID =
    " is not a valid Synapse ID (in the form syn123).";
  ...
  public void doGet(
    ...
    try {
      ...
      if (
        lowercaseCommand.equals("/synapse") ||
        lowercaseCommand.equals("/synapsestaging")
      ) {
        String title = null;
        StringBuilder sb = new StringBuilder();
        if (text.toLowerCase().equals("help")) {
          sb.append(
            "Given a Synapse ID (like syn123), post public information about that entity."
          );
        } else {
