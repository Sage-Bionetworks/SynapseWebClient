...
public class SynapseClientImpl extends SynapseClientBase implements SynapseClient, TokenProvider {
	...
	public static final ContentType HTML_MESSAGE_CONTENT_TYPE =
			ContentType.create("text/html", MESSAGE_CHARSET);
	public static final ContentType PLAIN_MESSAGE_CONTENT_TYPE =
			ContentType.create("text/plain", MESSAGE_CHARSET);

	public static final long LIMIT_50 = 50;
	static private Log log = LogFactory.getLog(SynapseClientImpl.class);

	private final Supplier<Set<String>> htmlTeamMembersCache =
			Suppliers.memoizeWithExpiration(teamMembersSupplier(), 1, TimeUnit.HOURS);
				...
				try {
					...
					do {
						org.sagebionetworks.reflection.model.PaginatedResults<TeamMember> teamMembersPaginatedResults =
								synapseClient.getTeamMembers(htmlTeamId, null, LIMIT_50, currentOffset);
	...
	public EntityBundle getEntityBundleForVersion(String entityId, Long versionNumber,
			EntityBundleRequest bundleRequest) throws RestServiceException {
		try {
			org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
	...
	@Override
	public void purgeMultipleTrashedEntitiesForUser(Set<String> entityIds)
			throws RestServiceException {
		try {
			org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
	...
	private List<AccessRequirement> getAllAccessRequirements(boolean unmetOnly,
			RestrictableObjectDescriptor subjectId, ACCESS_TYPE accessType,
			org.sagebionetworks.client.SynapseClient synapseClient) throws SynapseException {
		...
		while (!isDone) {
			...
			if (unmetOnly) {
				accessRequirments = synapseClient
						.getUnmetAccessRequirements(subjectId, accessType, LIMIT_50, offset).getResults();
			} else {
				accessRequirments =
						synapseClient.getAccessRequirements(subjectId, LIMIT_50, offset).getResults();
			}
	...
	private List<AccessRequirement> getTeamAccessRequirements(String teamId, boolean unmetOnly)
		...
		try {
			...
			List<AccessRequirement> accessRequirements =
					getAllAccessRequirements(unmetOnly, subjectId, ACCESS_TYPE.PARTICIPATE, synapseClient);
	...
	public PaginatedResults<AccessRequirement> getEntityAccessRequirements(String entityId,
			boolean unmetOnly, ACCESS_TYPE targetAccessType) throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			RestrictableObjectDescriptor subjectId = new RestrictableObjectDescriptor();
			...
			List<AccessRequirement> accessRequirements =
					getAllAccessRequirements(unmetOnly, subjectId, targetAccessType, synapseClient);

			// filter to the targetAccessType
			if (targetAccessType != null) {
				accessRequirements =
						AccessRequirementUtils.filterAccessRequirements(accessRequirements, targetAccessType);
			}
	...
	@Override
	public Entity updateExternalFile(String entityId, String externalUrl, String name,
			String contentType, Long fileSize, String md5, Long storageLocationId)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			Entity entity = synapseClient.getEntityById(entityId);
			if (!(entity instanceof FileEntity)) {
				throw new RuntimeException(
						"Upload failed. Entity id: " + entity.getId() + " is not a File.");
			}
			ExternalFileHandle clone = createExternalFileHandle(externalUrl, name, contentType, fileSize,
					md5, storageLocationId, synapseClient);
	...
	private ExternalFileHandle createExternalFileHandle(String externalUrl, String name,
			String contentType, Long fileSize, String md5, Long storageLocationId,
			org.sagebionetworks.client.SynapseClient synapseClient) throws SynapseException {
	...
	@Override
	public Entity createExternalFile(String parentEntityId, String externalUrl, String name,
			String contentType, Long fileSize, String md5, Long storageLocationId)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
	...
	private String getRootWikiId(org.sagebionetworks.client.SynapseClient synapseClient,
	...
	@Override
	public FileHandleResults getWikiAttachmentHandles(org.sagebionetworks.web.shared.WikiPageKey key)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			if (key.getWikiPageId() == null) {
				// asking for the root. find the root id first
				String rootWikiPage = getRootWikiId(synapseClient, key.getOwnerObjectId(),
						ObjectType.valueOf(key.getOwnerObjectType()));
				key.setWikiPageId(rootWikiPage);
			}
			WikiPageKey properKey = WikiPageKeyHelper.createWikiPageKey(key.getOwnerObjectId(),
					ObjectType.valueOf(key.getOwnerObjectType()), key.getWikiPageId());
	...
	@Override
	public V2WikiPage restoreV2WikiPage(String ownerId, String ownerType, String wikiId,
			Long versionToUpdate) throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			return synapseClient.restoreV2WikiPage(ownerId, ObjectType.valueOf(ownerType), wikiId,
					versionToUpdate);
		} catch (SynapseException e) {
			throw ExceptionUtil.convertSynapseException(e);
		}
	...
	public FileHandleResults getV2WikiAttachmentHandles(
			org.sagebionetworks.web.shared.WikiPageKey key) throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			if (key.getWikiPageId() == null) {
				// asking for the root. find the root id first
	...
	public PaginatedResults<V2WikiHistorySnapshot> getV2WikiHistory(
			org.sagebionetworks.web.shared.WikiPageKey key, Long limit, Long offset)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			WikiPageKey properKey = WikiPageKeyHelper.createWikiPageKey(key.getOwnerObjectId(),
	...
	@Override
	public WikiPage createV2WikiPageWithV1(String ownerId, String ownerType, WikiPage page)
	...
	@Override
	public WikiPage updateV2WikiPageWithV1(String ownerId, String ownerType, WikiPage page)
			throws IOException, RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
	...
	private String getWikiKeyId(org.sagebionetworks.client.SynapseClient synapseClient,
			org.sagebionetworks.web.shared.WikiPageKey key) throws RestServiceException {
	...
	public WikiPage getV2WikiPageAsV1(org.sagebionetworks.web.shared.WikiPageKey key)
			throws RestServiceException, IOException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		WikiPageKey properKey = WikiPageKeyHelper.createWikiPageKey(key.getOwnerObjectId(),
				ObjectType.valueOf(key.getOwnerObjectType()), getWikiKeyId(synapseClient, key));
		try {
	...
	public TeamMemberPagedResults getTeamMembers(String teamId, String fragment,
			TeamMemberTypeFilterOptions memberType, Integer limit, Integer offset)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			org.sagebionetworks.reflection.model.PaginatedResults<TeamMember> members =
					synapseClient.getTeamMembers(teamId, fragment, memberType, limit, offset);
			...
			for (int i = 0; i < userIds.size(); i++) {
				teamMemberBundles.add(new TeamMemberBundle(profiles.get(i), teamMembers.get(i).getIsAdmin(),
	...
	public List<UserProfile> listUserProfiles(List<String> userIds,
			org.sagebionetworks.client.SynapseClient synapseClient) throws SynapseException {
	...
	public PaginatedResults<Team> getTeamsBySearch(String searchTerm, Integer limit, Integer offset)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
	...
	@Override
	public TeamMembershipStatus requestMembership(String currentUserId, String teamId, String message,
			String hostPageBaseURL, Date expiresOn) throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			String signedTokenEndpoint = getSignedTokenEndpoint(hostPageBaseURL);
			TeamMembershipStatus membershipStatus =
					synapseClient.getTeamMembershipStatus(teamId, currentUserId);
			...
			if (membershipStatus.getCanJoin()) {
				synapseClient.addTeamMember(teamId, currentUserId, getTeamEndpoint(hostPageBaseURL),
						signedTokenEndpoint);
				...
				synapseClient.createMembershipRequest(membershipRequest, signedTokenEndpoint,
						signedTokenEndpoint);
			}
			return synapseClient.getTeamMembershipStatus(teamId, currentUserId);
		} catch (SynapseException e) {
	...
	@Override
	public void addTeamMember(String userGroupId, String teamId, String message,
			String hostPageBaseURL) throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			String signedTokenEndpoint = getSignedTokenEndpoint(hostPageBaseURL);
			synapseClient.addTeamMember(teamId, userGroupId, getTeamEndpoint(hostPageBaseURL),
					signedTokenEndpoint);
		} catch (SynapseException e) {
			throw ExceptionUtil.convertSynapseException(e);
		}
	...
	public void inviteMember(String userGroupId, String teamId, String message,
		...
		try {
			...
			TeamMembershipStatus membershipStatus =
					synapseClient.getTeamMembershipStatus(teamId, userGroupId);
			...
			if (membershipStatus.getCanJoin()) {
				...
				synapseClient.createMembershipInvitation(membershipInvite, signedTokenEndpoint,
						signedTokenEndpoint);
			}
		} catch (SynapseException e) {
			throw ExceptionUtil.convertSynapseException(e);
	...
	@Override
	public void inviteNewMember(String email, String teamId, String message, String hostPageBaseURL)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
	...
	public String getCertifiedUserPassingRecord(String userId) throws RestServiceException {
		...
		try {
			...
			JSONObjectAdapter passingRecordJson =
					passingRecord.writeToJSONObject(adapterFactory.createNew());
	...
	public Boolean isTeamMember(String userId, Long groupPrincipalId) throws RestServiceException {
		...
		try {
			TeamMembershipStatus membershipStatus =
					synapseClient.getTeamMembershipStatus(groupPrincipalId.toString(), userId);
	...
	@Override
	public TeamBundle getTeamBundle(String userId, String teamId, boolean isLoggedIn)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
	...
	public List<MembershipRequestBundle> getOpenRequests(String teamId) throws RestServiceException {
		...
		try {
			org.sagebionetworks.reflection.model.PaginatedResults<MembershipRequest> requests =
					synapseClient.getOpenMembershipRequests(teamId, null, MAX_LIMIT, ZERO_OFFSET);
	...
	private Map<String, UserProfile> getUserProfiles(List<Long> userIds,
			org.sagebionetworks.client.SynapseClient synapseClient) throws SynapseException {
	...
	public ArrayList<OpenUserInvitationBundle> getOpenInvitations(String userId)
		...
		try {
			org.sagebionetworks.reflection.model.PaginatedResults<MembershipInvitation> invitations =
					synapseClient.getOpenMembershipInvitations(userId, null, MAX_LIMIT, ZERO_OFFSET);
			// and ask for the team info for each invite, and fill that in the
			// bundle
	...
	@Override
	public void resendTeamInvitation(String membershipInvitationId, String hostPageBaseURL)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			...
			MembershipInvitation membershipInvitation =
					synapseClient.getMembershipInvitation(membershipInvitationId);
			membershipInvitation.setCreatedBy(null);
			membershipInvitation.setCreatedOn(null);
			membershipInvitation.setId(null);

			// SWC-4360: if both the principal ID and email are set, then clear out the email in the new
			// invite to avoid a backend error.
			if (membershipInvitation.getInviteeId() != null
					&& membershipInvitation.getInviteeEmail() != null) {
				membershipInvitation.setInviteeEmail(null);
			}

			synapseClient.createMembershipInvitation(membershipInvitation, signedTokenEndpoint,
					signedTokenEndpoint);
	...
	@Override
	public ArrayList<OpenTeamInvitationBundle> getOpenTeamInvitations(String teamId, Integer limit,
			Integer offset) throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			org.sagebionetworks.reflection.model.PaginatedResults<MembershipInvitation> invitations =
					synapseClient.getOpenMembershipInvitationSubmissions(teamId, null, limit, offset);
			// and ask for the team info for each invite, and fill that in the
			// bundle
	...
	@Override
	public void setIsTeamAdmin(String currentUserId, String targetUserId, String teamId,
			boolean isTeamAdmin) throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
	 ...
	 */
	@Override
	public String getFileEntityIdWithSameName(String fileName, String parentEntityId)
	...
	@Override
	public String setFileEntityFileHandle(String fileHandleId, String entityId, String parentEntityId)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			...
			if (entityId == null) {
				fileEntity = FileHandleServlet.getNewFileEntity(parentEntityId, fileHandleId,
						newHandle.getFileName(), synapseClient);
			} else {
	...
	public static Long defaultStorageLocation =
			Long.parseLong(PortalPropertiesHolder.getProperty(DEFAULT_STORAGE_ID_PROPERTY_KEY));
	...
	@Override
	public ResponseMessage handleSignedToken(SignedTokenInterface signedToken, String hostPageBaseURL)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		...
		try {
			if (signedToken instanceof JoinTeamSignedToken) {
				...
				return synapseClient.addTeamMember(joinTeamSignedToken, getTeamEndpoint(hostPageBaseURL),
						getSignedTokenEndpoint(hostPageBaseURL));
			} else if (signedToken instanceof NotificationSettingsSignedToken) {
				NotificationSettingsSignedToken notificationSignedToken =
	...
	@Override
	public SignedTokenInterface hexDecodeAndDeserialize(String signedTokenString)
			throws RestServiceException {
		try {
			return SerializationUtils.hexDecodeAndDeserialize(signedTokenString,
					SignedTokenInterface.class);
		} catch (Exception e) {
	...
	@Override
	public AccountCreationToken hexDecodeAndDeserializeAccountCreationToken(String tokenString)
			throws RestServiceException {
		try {
	...
	@Override
	public String sendMessage(Set<String> recipients, String subject, String messageBody,
			String hostPageBaseURL) throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			...
			String cleanedMessageBody = Jsoup.clean(messageBody, "", Whitelist.simpleText().addTags("br"),
	...
	@Override
	public String sendMessageToEntityOwner(String entityId, String subject, String messageBody,
			String hostPageBaseURL) throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			MessageToUser message = new MessageToUser();
			...
			MessageToUser sentMessage =
					synapseClient.sendStringMessage(message, entityId, cleanedMessageBody);
			JSONObjectAdapter sentMessageJson = sentMessage.writeToJSONObject(adapterFactory.createNew());
			return sentMessageJson.toJSONString();
		} catch (SynapseException e) {
			throw ExceptionUtil.convertSynapseException(e);
	...
	private void initHelpPagesMap() {
		if (pageName2WikiKeyMap == null) {
			HashMap<String, org.sagebionetworks.web.shared.WikiPageKey> tempMap =
					new HashMap<String, org.sagebionetworks.web.shared.WikiPageKey>();
			...
			for (String key : properties.keySet()) {
				if (key.startsWith(WebConstants.WIKI_PROPERTIES_PACKAGE)) {
					...
					tempMap.put(key.substring(WebConstants.WIKI_PROPERTIES_PACKAGE.length()),
							new org.sagebionetworks.web.shared.WikiPageKey(synId, ObjectType.ENTITY.toString(),
									wikiId));
				}
			}
	...
	@Override
	public TableUpdateTransactionRequest getTableUpdateTransactionRequest(String tableId,
			List<ColumnModel> oldSchema, List<ColumnModel> proposedSchema) throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
			...
			// now that all columns have been created, figure out the column changes (create, update, and
			// no-op)
	...
	public EntityChildrenResponse getEntityChildren(EntityChildrenRequest request)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
	...
	@Override
	public List<ColumnModel> createTableColumns(List<ColumnModel> models)
			throws RestServiceException {
		org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
		try {
	...
	public String getHost(String urlString) throws RestServiceException {
		...
		// URL does not recognize sftp:// protocol. replace with http (we're after the host in this
		// method)
	...
	public List<String> getMyLocationSettingBanners() throws RestServiceException {
		try {
			...
			List<StorageLocationSetting> existingStorageLocations =
					synapseClient.getMyStorageLocationSettings();
	...
	@Override
	public StorageLocationSetting getStorageLocationSetting(String parentEntityId)
			throws RestServiceException {
		try {
			org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
			UploadDestination uploadDestination =
					synapseClient.getDefaultUploadDestination(parentEntityId);
			if (uploadDestination == null
					|| uploadDestination.getStorageLocationId().equals(defaultStorageLocation)) {
	...
	@Override
	public void createStorageLocationSetting(String parentEntityId, StorageLocationSetting setting)
			throws RestServiceException {
		try {
			org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
			...
			UploadDestinationListSetting projectSetting = (UploadDestinationListSetting) synapseClient
					.getProjectSetting(parentEntityId, ProjectSettingsType.upload);
	...
	@Override
	public Entity updateFileEntity(FileEntity toUpdate, FileHandleCopyRequest copyRequest)
			throws RestServiceException {
		try {
			org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
			...
			if (copyResults.size() != 1) {
				throw new UnknownErrorException(
						"Copy file handle resulted in unexpected response list size.");
			}
	...
	@Override
	public String generateSqlWithFacets(String basicSql, List<FacetColumnRequest> selectedFacets,
			List<ColumnModel> schema) throws RestServiceException {
		try {
			org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
	...
	@Override
	public ColumnModelPage getPossibleColumnModelsForViewScope(ViewScope scope, String nextPageToken)
			throws RestServiceException {
		try {
			org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
	...
	private boolean isChallenge(String projectId,
			org.sagebionetworks.client.SynapseClient synapseClient) throws SynapseException {
	...
	@Override
	public String createExternalObjectStoreFileHandle(ExternalObjectStoreFileHandle fileHandle)
			throws RestServiceException {
		try {
			org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
	...
	@Override
	public ArrayList<String[]> parseCsv(String csvPreviewText, char delimiter)
			throws RestServiceException {
