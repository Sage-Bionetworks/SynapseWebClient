...
public class SynapseClientImpl
  extends SynapseClientBase
  implements SynapseClient, TokenProvider {
  ...
  public static final String HTML_TEAM_ID_PROPERTY_KEY =
    "org.sagebionetworks.portal.html_team_id";

  public static final String SYN_PREFIX = "syn";
  public static final Charset MESSAGE_CHARSET = Charset.forName("UTF-8");
  public static final ContentType HTML_MESSAGE_CONTENT_TYPE = ContentType.create(
    "text/html",
    MESSAGE_CHARSET
  );
  public static final ContentType PLAIN_MESSAGE_CONTENT_TYPE = ContentType.create(
    "text/plain",
    MESSAGE_CHARSET
  );

  public static final long LIMIT_50 = 50;
  private static Log log = LogFactory.getLog(SynapseClientImpl.class);

  private final Supplier<Set<String>> htmlTeamMembersCache = Suppliers.memoizeWithExpiration(
    teamMembersSupplier(),
    1,
    TimeUnit.HOURS
  );
    ...
    return new Supplier<Set<String>>() {
      public Set<String> get() {
        ...
        try {
          ...
          do {
            org.sagebionetworks.reflection.model.PaginatedResults<TeamMember> teamMembersPaginatedResults = synapseClient.getTeamMembers(
              htmlTeamId,
              null,
              LIMIT_50,
              currentOffset
  ...
  public EntityBundle getEntityBundleForVersion(
    String entityId,
    Long versionNumber,
    EntityBundleRequest bundleRequest
  ) throws RestServiceException {
    try {
      org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
      return synapseClient.getEntityBundleV2(
        entityId,
        versionNumber,
        bundleRequest
      );
  ...
  @Override
  public Entity moveEntity(String entityId, String newParentEntityId)
    throws RestServiceException {
    try {
      org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
  ...
  @Override
  public PaginatedResults<TrashedEntity> viewTrashForUser(
    long offset,
    long limit
  ) throws RestServiceException {
    try {
  ...
  private String getUserIdFromUsername(String username)
    ...
    try {
      ...
      PrincipalAliasResponse response = synapseClient.getPrincipalAlias(
        request
      );
  ...
  public AccessControlList getBenefactorAcl(String id)
    throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      ...
      return synapseClient
        .getEntityBundleV2(id, bundleRequest)
        .getBenefactorAcl();
    } catch (SynapseException e) {
      throw ExceptionUtil.convertSynapseException(e);
    }
  ...
  @Override
  public AccessControlList getEntityBenefactorAcl(String id)
    throws RestServiceException {
  ...
  @Override
  public AccessRequirement createOrUpdateAccessRequirement(
  ...
  private List<AccessRequirement> getAllAccessRequirements(
    ...
    while (!isDone) {
      ...
      accessRequirments =
        synapseClient
          .getAccessRequirements(subjectId, LIMIT_50, offset)
          .getResults();
  ...
  public List<AccessRequirement> getTeamAccessRequirements(String teamId)
    ...
    try {
      ...
      List<AccessRequirement> accessRequirements = getAllAccessRequirements(
        subjectId,
  ...
  @Override
  public Entity updateExternalFile(
    String entityId,
    String externalUrl,
    String name,
    String contentType,
    ...
    try {
      ...
      ExternalFileHandle clone = createExternalFileHandle(
        externalUrl,
        name,
        contentType,
        fileSize,
  ...
  @Override
  public Entity createExternalFile(
  ...
  private String getRootWikiId(
    ...
    try {
      return synapseClient
        .getRootWikiPageKey(ownerId, ownerType)
        .getWikiPageId();
    } catch (SynapseException e) {
      throw ExceptionUtil.convertSynapseException(e);
    }
  ...
  public FileHandleResults getWikiAttachmentHandles(
    ...
    try {
      if (key.getWikiPageId() == null) {
        ...
        String rootWikiPage = getRootWikiId(
          synapseClient,
      ...
      FileHandleResults results = synapseClient.getWikiAttachmenthHandles(
        properKey
      );
      return results;
    } catch (SynapseException e) {
  ...
  @Override
  public V2WikiPage restoreV2WikiPage(
    String ownerId,
    String ownerType,
    String wikiId,
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      return synapseClient.restoreV2WikiPage(
        ownerId,
  ...
  public PaginatedResults<V2WikiHistorySnapshot> getV2WikiHistory(
    ...
    try {
      ...
      return convertPaginated(
        synapseClient.getV2WikiHistory(properKey, limit, offset)
      );
    } catch (SynapseException e) {
      throw ExceptionUtil.convertSynapseException(e);
    }
  ...
  @Override
  public WikiPage createV2WikiPageWithV1(
    String ownerId,
    String ownerType,
    WikiPage page
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      return synapseClient.createWikiPage(
        ownerId,
        ObjectType.valueOf(ownerType),
        page
      );
  ...
  @Override
  public WikiPage updateV2WikiPageWithV1(
    String ownerId,
    String ownerType,
    WikiPage page
  ) throws IOException, RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      return synapseClient.updateWikiPage(
        ownerId,
        ObjectType.valueOf(ownerType),
        page
      );
  ...
  public TeamMemberPagedResults getTeamMembers(
    String teamId,
    String fragment,
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      org.sagebionetworks.reflection.model.PaginatedResults<TeamMember> members = synapseClient.getTeamMembers(
        teamId,
        fragment,
        memberType,
        limit,
  ...
  public PaginatedResults<Team> getTeamsBySearch(
    String searchTerm,
    Integer limit,
    Integer offset
  ) throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      if (searchTerm != null && searchTerm.trim().length() == 0) searchTerm =
        null;
      if (offset == null) offset = ZERO_OFFSET.intValue();
      return convertPaginated(
        synapseClient.getTeams(searchTerm, limit, offset)
      );
    } catch (SynapseException e) {
      throw ExceptionUtil.convertSynapseException(e);
    }
  ...
  public TeamMembershipStatus getTeamMembershipState(
  ...
  @Override
  public TeamMembershipStatus requestMembership(
    String currentUserId,
    String teamId,
    String message,
    ...
    try {
      ...
      TeamMembershipStatus membershipStatus = synapseClient.getTeamMembershipStatus(
        teamId,
        currentUserId
      );
      ...
      if (membershipStatus.getCanJoin()) {
        synapseClient.addTeamMember(
          teamId,
          currentUserId,
          getTeamEndpoint(hostPageBaseURL),
          signedTokenEndpoint
        );
        ...
        synapseClient.createMembershipRequest(
          membershipRequest,
          signedTokenEndpoint,
          signedTokenEndpoint
        );
  ...
  public String getCertifiedUserPassingRecord(String userId)
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      PassingRecord passingRecord = synapseClient.getCertifiedUserPassingRecord(
        userId
      );
      ...
      JSONObjectAdapter passingRecordJson = passingRecord.writeToJSONObject(
        adapterFactory.createNew()
      );
  ...
  public String getCertificationQuiz() throws RestServiceException {
    ...
    try {
      ...
      JSONObjectAdapter quizJson = quiz.writeToJSONObject(
        adapterFactory.createNew()
      );
  ...
  public TeamBundle getTeamBundle(
    ...
    try {
      ...
      if (isLoggedIn) {
        membershipStatus =
          synapseClient.getTeamMembershipStatus(teamId, userId);
  ...
  public List<MembershipRequestBundle> getOpenRequests(String teamId)
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      org.sagebionetworks.reflection.model.PaginatedResults<MembershipRequest> requests = synapseClient.getOpenMembershipRequests(
        teamId,
        null,
        MAX_LIMIT,
        ZERO_OFFSET
      ...
      Map<String, UserProfile> userId2UserProfile = getUserProfiles(
        userIds,
        synapseClient
      );
  ...
  private Map<String, UserProfile> getUserProfiles(
    List<Long> userIds,
    org.sagebionetworks.client.SynapseClient synapseClient
  ) throws SynapseException {
  ...
  public ArrayList<OpenUserInvitationBundle> getOpenInvitations(String userId)
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      org.sagebionetworks.reflection.model.PaginatedResults<MembershipInvitation> invitations = synapseClient.getOpenMembershipInvitations(
        userId,
        null,
        MAX_LIMIT,
        ZERO_OFFSET
  ...
  @Override
  public void resendTeamInvitation(
    ...
    try {
      ...
      String signedTokenEndpoint = getSignedTokenEndpoint(hostPageBaseURL);
      MembershipInvitation membershipInvitation = synapseClient.getMembershipInvitation(
  ...
  public ArrayList<OpenTeamInvitationBundle> getOpenTeamInvitations(
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      org.sagebionetworks.reflection.model.PaginatedResults<MembershipInvitation> invitations = synapseClient.getOpenMembershipInvitationSubmissions(
        teamId,
        null,
        limit,
        offset
      ...
      for (MembershipInvitation invite : invitationsToUsers) {
        ...
        OpenTeamInvitationBundle b = new OpenTeamInvitationBundle(
          invite,
          profile
        );
        returnList.add(b);
  ...
  @Override
  public Team updateTeam(Team team, AccessControlList teamAcl)
    throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
   ...
   */
  @Override
  public String getFileEntityIdWithSameName(
    String fileName,
    String parentEntityId
  ...
  @Override
  public String setFileEntityFileHandle(
    String fileHandleId,
    String entityId,
    String parentEntityId
  ) throws RestServiceException {
    ...
    try {
      ...
      if (entityId == null) {
        fileEntity =
          FileHandleServlet.getNewFileEntity(
            parentEntityId,
            fileHandleId,
            newHandle.getFileName(),
            synapseClient
          );
      } else {
  ...
  public static class PortalVersionHolder {
    ...
    static {
      InputStream s =
        SynapseClientImpl.class.getResourceAsStream("/version-info.properties");
  ...
  public static Long defaultStorageLocation = Long.parseLong(
    PortalPropertiesHolder.getProperty(DEFAULT_STORAGE_ID_PROPERTY_KEY)
  );
  public static String htmlTeamId = PortalPropertiesHolder.getProperty(
    HTML_TEAM_ID_PROPERTY_KEY
  );
  ...
  @Override
  public ResponseMessage handleSignedToken(
    ...
    try {
      if (signedToken instanceof JoinTeamSignedToken) {
        ...
        return synapseClient.addTeamMember(
          joinTeamSignedToken,
          getTeamEndpoint(hostPageBaseURL),
        ...
        return synapseClient.updateNotificationSettings(
          notificationSignedToken
        );
        ...
        throw new BadRequestException(
          "token not supported: " + signedToken.getClass().getName()
        );
      }
    } catch (SynapseException e) {
      throw ExceptionUtil.convertSynapseException(e);
  ...
  public SignedTokenInterface hexDecodeAndDeserialize(String signedTokenString)
    throws RestServiceException {
    try {
      return SerializationUtils.hexDecodeAndDeserialize(
        signedTokenString,
  ...
  @Override
  public AccountCreationToken hexDecodeAndDeserializeAccountCreationToken(
    String tokenString
  ) throws RestServiceException {
    try {
      return SerializationUtils.hexDecodeAndDeserialize(
        tokenString,
        AccountCreationToken.class
      );
    } catch (Exception e) {
      // error decoding, respond with a bad request
      throw new BadRequestException(e.getMessage());
  ...
  public String sendMessage(
    ...
    try {
      ...
      message.setNotificationUnsubscribeEndpoint(
        getSignedTokenEndpoint(hostPageBaseURL)
      );
      ...
      JSONObjectAdapter sentMessageJson = sentMessage.writeToJSONObject(
        adapterFactory.createNew()
      );
    ...
    if (pageName2WikiKeyMap == null) {
      ...
      for (String key : properties.keySet()) {
        if (key.startsWith(WebConstants.WIKI_PROPERTIES_PACKAGE)) {
          ...
          tempMap.put(
            key.substring(WebConstants.WIKI_PROPERTIES_PACKAGE.length()),
  ...
  public TableUpdateTransactionRequest getTableUpdateTransactionRequest(
    ...
    List<ColumnModel> proposedSchema
  ) throws RestServiceException {
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
  ...
  private ColumnChange createNewColumnChange(
    String oldColumnId,
    String newColumnId
  ) {
  ...
  public EntityChildrenResponse getEntityChildren(
  ...
  public String getHost(String urlString) throws RestServiceException {
    ...
    if (urlString.toLowerCase().startsWith(WebConstants.SFTP_PREFIX)) {
      urlString =
        "http://" + urlString.substring(WebConstants.SFTP_PREFIX.length());
    }
    try {
  ...
  @Override
  public List<String> getMyLocationSettingBanners()
    throws RestServiceException {
    try {
  ...
  @Override
  public void createStorageLocationSetting(
    String parentEntityId,
    ...
    try {
      ...
      if (setting != null) {
        locationId =
          synapseClient
            .createStorageLocationSetting(setting)
      ...
      UploadDestinationListSetting projectSetting = (UploadDestinationListSetting) synapseClient.getProjectSetting(
        parentEntityId,
  ...
  @Override
  public Entity updateFileEntity(
    FileEntity toUpdate,
    ...
    try {
      ...
      BatchFileHandleCopyResult batchCopyResults = synapseClient.copyFileHandles(
        batchRequest
      );
  ...
  private boolean isChallenge(
    ...
    try {
      ...
      return synapseClient.canAccess(
        challenge.getProjectId(),
        ACCESS_TYPE.UPDATE
      );
    } catch (Exception e) {
      return (
  ...
  @Override
  public void deleteAccessRequirement(Long accessRequirementId)
    throws RestServiceException {
    try {
      org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
  ...
  @Override
  public String createExternalObjectStoreFileHandle(
    ExternalObjectStoreFileHandle fileHandle
  ) throws RestServiceException {
    try {
      org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
      return synapseClient
        .createExternalObjectStoreFileHandle(fileHandle)
        .getId();
    } catch (SynapseException e) {
      throw ExceptionUtil.convertSynapseException(e);
    }
  ...
  public ArrayList<String[]> parseCsv(String csvPreviewText, char delimiter)
    ...
    try (
      CSVReader reader = new CSVReader(
        new StringReader(csvPreviewText),
        delimiter
      )
    ) {
      String[] row = null;
