...
public class UserProfileClientImpl
  ...
  public VerificationSubmission createVerificationSubmission(
    ...
    try {
      ...
      return synapseClient.createVerificationSubmission(
  ...
  public VerificationPagedResults listVerificationSubmissions(
    ...
    org.sagebionetworks.client.SynapseClient synapseClient = createSynapseClient();
    try {
      return synapseClient.listVerificationSubmissions(
        currentState,
        submitterId,
        limit,
        offset
  ...
  public void updateVerificationState(
    ...
    try {
      ...
      synapseClient.updateVerificationState(
        verificationId,
        verificationState,
        signedTokenEndpoint
      );
