...
public class ProvTreeNodeExtentProvider
  implements NodeExtentProvider<ProvTreeNode> {

  private static final Dimension ENTITY_DIMENSION = new Dimension(96, 50);
  private static final Dimension ACTIVITY_ENTITY_DIMENSION = new Dimension(
    110,
    75
  );
  private static final Dimension ACTIVITY_MANUAL_DIMENSION = new Dimension(
    110,
    24
  );
  private static final Dimension ACTIVITY_UNDEFINED_DIMENSION = new Dimension(
    110,
    42
  );
