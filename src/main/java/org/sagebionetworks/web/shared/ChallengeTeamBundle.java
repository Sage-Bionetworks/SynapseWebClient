...
public class ChallengeTeamBundle implements IsSerializable {
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
      prime * result + ((challengeTeam == null) ? 0 : challengeTeam.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (challengeTeam == null) {
      if (other.challengeTeam != null) return false;
    } else if (!challengeTeam.equals(other.challengeTeam)) return false;
  ...
  public String toString() {
    return (
      "ChallengeTeamBundle [challengeTeam=" +
      challengeTeam +
      ", isAdmin=" +
      isAdmin +
      "]"
