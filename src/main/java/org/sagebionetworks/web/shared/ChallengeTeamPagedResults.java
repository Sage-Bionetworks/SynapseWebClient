...
public class ChallengeTeamPagedResults implements IsSerializable {
  ...
  public ChallengeTeamPagedResults(
    List<ChallengeTeamBundle> results,
  ...
  public boolean equals(Object obj) {
    ...
    if (totalNumberOfResults == null) {
      if (other.totalNumberOfResults != null) return false;
    } else if (
      !totalNumberOfResults.equals(other.totalNumberOfResults)
    ) return false;
    return true;
  }
  ...
  public String toString() {
    return (
      "ChallengeTeamPagedResults [totalNumberOfResults=" +
