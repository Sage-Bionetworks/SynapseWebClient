...
public class EntityBundlePlus implements IsSerializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (entityBundle == null) {
      if (other.entityBundle != null) return false;
    } else if (!entityBundle.equals(other.entityBundle)) return false;
    if (latestVersionNumber == null) {
      if (other.latestVersionNumber != null) return false;
    } else if (
