...
public class FormParams implements IsSerializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (containerSynId == null) {
      if (other.containerSynId != null) return false;
    } else if (!containerSynId.equals(other.containerSynId)) return false;
    if (jsonSchemaSynId == null) {
      if (other.jsonSchemaSynId != null) return false;
    } else if (!jsonSchemaSynId.equals(other.jsonSchemaSynId)) return false;
    if (uiSchemaSynId == null) {
      if (other.uiSchemaSynId != null) return false;
    } else if (!uiSchemaSynId.equals(other.uiSchemaSynId)) return false;
    return true;
  }
