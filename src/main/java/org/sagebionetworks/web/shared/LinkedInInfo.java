...
public class LinkedInInfo implements IsSerializable {
  ...
  public int hashCode() {
    ...
    result =
      prime * result + ((requestSecret == null) ? 0 : requestSecret.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (requestSecret == null) {
      if (other.requestSecret != null) return false;
    } else if (!requestSecret.equals(other.requestSecret)) return false;
    return true;
  }
