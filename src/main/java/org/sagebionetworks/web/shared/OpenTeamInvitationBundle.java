...
public class OpenTeamInvitationBundle implements IsSerializable {
	...
	public OpenTeamInvitationBundle(MembershipInvitation membershipInvitation,
	...
	public int hashCode() {
		...
		int result = 1;
		result =
				prime * result + ((membershipInvitation == null) ? 0 : membershipInvitation.hashCode());
	...
	public String toString() {
		return "OpenTeamInvitationBundle [membershipInvitation=" + membershipInvitation
				+ ", userProfile=" + userProfile + "]";
	}
