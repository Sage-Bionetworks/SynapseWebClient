...
public class PublicPrincipalIds implements IsSerializable {
  ...
  public boolean isPublic(Long principalId) {
    ...
    return (
      principalId.equals(getPublicAclPrincipalId()) ||
  ...
  public boolean equals(Object obj) {
    ...
    if (anonymousUserId == null) {
      if (other.anonymousUserId != null) return false;
    } else if (!anonymousUserId.equals(other.anonymousUserId)) return false;
    if (authenticatedAclPrincipalId == null) {
      if (other.authenticatedAclPrincipalId != null) return false;
    } else if (
      !authenticatedAclPrincipalId.equals(other.authenticatedAclPrincipalId)
    ) return false;
    if (publicAclPrincipalId == null) {
      if (other.publicAclPrincipalId != null) return false;
    } else if (
      !publicAclPrincipalId.equals(other.publicAclPrincipalId)
    ) return false;
    return true;
  }
  ...
  public String toString() {
    return (
      "PublicPrincipalIds [publicAclPrincipalId=" +
