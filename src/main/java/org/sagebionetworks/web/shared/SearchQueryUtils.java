...
public class SearchQueryUtils {
	...
	public static SearchQuery getDefaultSearchQuery() {
		...
		// For example, to return Projects only: add a KeyValue with key = "node_type" and value =
		// "project"
	...
	static SearchQuery getBaseSearchQuery() {
		...
		List<SearchFieldName> facetFieldNames =
				Arrays.asList(EntityType, Consortium, ModifiedOn, ModifiedBy, CreatedOn, Tissue, CreatedBy);
	...
	public final static List<String> FACETS_DISPLAY_ORDER = Arrays.asList("node_type", "consortium",
			"disease", "modified_on", "modified_by", "created_on", "tissue", "num_samples", "created_by");
