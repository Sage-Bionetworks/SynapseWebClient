...
public class TeamBundle implements IsSerializable {
	...
	public TeamBundle(Team team, Long totalMemberCount, TeamMembershipStatus teamMembershipStatus,
			boolean isUserAdmin) {
		super();
		this.team = team;
	...
	public int hashCode() {
		...
		result =
				prime * result + ((teamMembershipStatus == null) ? 0 : teamMembershipStatus.hashCode());
	...
	public String toString() {
		return "TeamBundle [team=" + team + ", teamMembershipStatus=" + teamMembershipStatus
				+ ", totalMemberCount=" + totalMemberCount + ", isUserAdmin=" + isUserAdmin + "]";
	}
