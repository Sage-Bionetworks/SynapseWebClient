...
public class TeamBundle implements IsSerializable {
  ...
  public void setTeamMembershipStatus(
    TeamMembershipStatus teamMembershipStatus
  ) {
    this.teamMembershipStatus = teamMembershipStatus;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (isUserAdmin != other.isUserAdmin) return false;
    if (team == null) {
      if (other.team != null) return false;
    } else if (!team.equals(other.team)) return false;
    if (teamMembershipStatus == null) {
      if (other.teamMembershipStatus != null) return false;
    } else if (
      !teamMembershipStatus.equals(other.teamMembershipStatus)
    ) return false;
    if (totalMemberCount == null) {
      if (other.totalMemberCount != null) return false;
    } else if (!totalMemberCount.equals(other.totalMemberCount)) return false;
    return true;
  }
