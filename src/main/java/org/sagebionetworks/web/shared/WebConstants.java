...
public class WebConstants {
   ...
   *
   */
  public static final String VALID_ENTITY_NAME_REGEX =
    ModelConstants.VALID_ENTITY_NAME_REGEX;

  public static final String INVALID_ENTITY_NAME_MESSAGE =
  ...
  public static final String INVALID_IMAGE_FILETYPE_MESSAGE =
    "The file selected is not recognized as an image file type. Please convert to PNG, JPEG, GIF, or SVG and try again.";
  public static final String INVALID_FILE_SIZE =
    "The selected file exceeds the maximum size. Please select a file that is less than ";

  public static final String INVALID_TABLE_FILETYPE_MESSAGE =
    "The file selected is not recognized as an table file type. Please convert to TXT or CSV and try again.";
  ...
  public static final String VALID_URL_REGEX =
    "([a-zA-Z_0-9:\\/]+)|(^((https?)|(ftp)):\\/\\/[-a-zA-Z0-9*+&@#\\/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#\\/%=~_|])";
  ...
  public static final String WIDGET_NAME_REGEX =
    "[a-z,A-Z,0-9,., ,\\-,\\+,(,)]";
  public static final String VALID_WIDGET_NAME_REGEX =
    "^" + WIDGET_NAME_REGEX + "+";
  ...
  public static final String ASSOCIATED_OBJECT_ID_PARAM_KEY =
    "associatedObjectId";
  public static final String ASSOCIATED_OBJECT_TYPE_PARAM_KEY =
  ...
  public static final String ADD_TO_ENTITY_ATTACHMENTS_PARAM_KEY =
    "isAddToAttachments";
  ...
  public static final String ENTITY_CREATEDBYPRINCIPALID_KEY =
  ...
  // Synapse Properties
  public static final String CHALLENGE_TUTORIAL_PROPERTY =
    "org.sagebionetworks.portal.challenge_synapse_id";
  public static final String CHALLENGE_WRITE_UP_TUTORIAL_PROPERTY =
    "org.sagebionetworks.portal.challenge_writeup_synapse_id";
  public static final String FORMATTING_GUIDE_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.formattingguide_synapse_id";
  public static final String FORMATTING_GUIDE_WIKI_ID_PROPERTY =
    "org.sagebionetworks.portal.formattingguide_wiki_id";
  public static final String CHALLENGE_PARTICIPATION_INFO_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.challenge_participation_info_synapse_id";
  public static final String CHALLENGE_PARTICIPATION_INFO_WIKI_ID_PROPERTY =
    "org.sagebionetworks.portal.challenge_participation_info_wiki_id";
  public static final String GOVERNANCE_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.governance_synapse_id";
  public static final String GOVERNANCE_WIKI_ID_PROPERTY =
    "org.sagebionetworks.portal.governance_wiki_id";
  public static final String AUTHENTICATED_ACL_PRINCIPAL_ID =
    "org.sagebionetworks.portal.authenticated_acl_principal_id";
  public static final String PUBLIC_ACL_PRINCIPAL_ID =
    "org.sagebionetworks.portal.public_acl_principal_id";
  public static final String ANONYMOUS_USER_PRINCIPAL_ID =
    "org.sagebionetworks.portal.anonymous_user_principal_id";
  public static final String PROVENANCE_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.provenance_synapse_id";
  public static final String PROVENANCE_WIKI_ID_PROPERTY =
    "org.sagebionetworks.portal.provenance_wiki_id";
  public static final String NBCONVERT_ENDPOINT_PROPERTY =
    "org.sagebionetworks.portal.nbconvert_endpoint";
  public static final String NRGR_SYNAPSE_GLUE_ENDPOINT_PROPERTY =
    "org.sagebionetworks.portal.nrgrsynapseglue_endpoint";
  public static final String FORUM_SYNAPSE_ID_PROPERTY =
  ...
  // Workshop
  public static final String COLLABORATORIUM_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.collaboratorium_synapse_id";
  public static final String STAGE_I_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.stageI_synapse_id";
  public static final String STAGE_II_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.stageII_synapse_id";
  public static final String STAGE_III_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.stageIII_synapse_id";
  public static final String STAGE_IV_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.stageIV_synapse_id";
  public static final String STAGE_V_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.stageV_synapse_id";
  public static final String STAGE_VI_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.stageVI_synapse_id";
  public static final String STAGE_VII_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.stageVII_synapse_id";
  public static final String STAGE_VIII_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.stageVIII_synapse_id";
  public static final String STAGE_IX_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.stageIX_synapse_id";
  public static final String STAGE_X_ENTITY_ID_PROPERTY =
    "org.sagebionetworks.portal.stageX_synapse_id";

  public static final String FILE_HANDLE_ASSOCIATION_SERVLET =
  ...
  public static final String SFTP_PROXY_ENDPOINT =
    "org.sagebionetworks.portal.sftp_proxy_endpoint";
  ...
  public static final String CHALLENGE_PARTICIPATION_INFO =
    "ChallengeParticipationInfo";

  public static final String WIKI_PROPERTIES_PACKAGE =
    "org.sagebionetworks.portal.wikis.";
  ...
  public static final String DEFAULT_COL_NAME_MODIFIED_BY_PRINCIPAL_ID =
    "modifiedbyprincipalid";
  public static final String DEFAULT_COL_NAME_CREATED_BY_PRINCIPAL_ID =
    "createdbyprincipalid";
  ...
  public static final String TEMP_IMAGE_ATTACHMENT_SUFFIX =
  ...
  public static final String CACHE_CONTROL_VALUE_NO_CACHE =
  ...
  // query parameters
  public static final String SELECT_ID_FROM_ENTITY_WHERE_PARENT_ID =
  ...
  // discussion message
  public static final String DISCUSSION_MESSAGE_SERVLET =
    "/discussion/messageUrl";
  ...
  public static final String TEXT_PLAIN_CHARSET_UTF8 =
  ...
  public static final String AUTH_PUBLIC_SERVICE_URL_KEY =
    "authPublicServiceUrl";
  ...
  public static final int FILE = 0x01, PROJECT = 0x02, TABLE = 0x04, FOLDER =
    0x08, VIEW = 0x10, DOCKER = 0x20, SUBMISSION_VIEW = 0x40, DATASET = 0x80;
  ...
  // Governance Project.
  public static final String REVIEW_ABUSIVE_CONTENT_REQUEST_COMPONENT_ID =
    "14868";
  ...
  // flag issue
  public static final String FLAG_ISSUE_COLLECTOR_URL =
  ...
  public static final String FLAG_ISSUE_DESCRIPTION_PART_1 =
    "Reporting this page: ";
  ...
  // request access
  public static final String REQUEST_ACCESS_ISSUE_COLLECTOR_URL =
  ...
  public static final String REQUEST_ACCESS_ISSUE_SUMMARY =
    "Request for ACT to grant access to data";
  public static final String REQUEST_ACCESS_ISSUE_DESCRIPTION =
