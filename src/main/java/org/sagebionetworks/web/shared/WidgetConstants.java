...
public class WidgetConstants {
  ...
  public static final String ATTACHMENT_PREVIEW_CONTENT_TYPE =
    "previewattachment";
  ...
  public static final String COLLAPSED_SECTION =
  ...
  public static final String API_TABLE_FRIENDLY_NAME =
    "Super Table (Synapse API Based)";
  ...
  public static final String OLD_JOIN_EVALUATION_CONTENT_TYPE =
    "joinevaluation";
  ...
  public static final String TEAM_MEMBER_COUNT_FRIENDLY_NAME =
    "Team Member Count";
  ...
  public static final String WIKI_FILES_PREVIEW_CONTENT_TYPE =
    "wikifilepreview";
  ...
  public static final String JOIN_WIDGET_REQUEST_EXPIRES_IN_X_DAYS_KEY =
    "requestExpiresInXDays";
  ...
  public static final String JOIN_TEAM_IS_SIMPLE_REQUEST_BUTTON =
    "isSimpleRequestButton";
  public static final String JOIN_TEAM_DEFAULT_OPEN_REQUEST_TEXT =
    "Your request to join this team has been sent.";
  public static final String SUCCESS_MESSAGE = "successMessage";
  public static final String JOIN_TEAM_DEFAULT_SUCCESS_MESSAGE =
    "Successfully joined";
  public static final String JOIN_WIDGET_SHOW_PROFILE_FORM_KEY =
    "showProfileForm";
  public static final String JOIN_WIDGET_SUBCHALLENGE_ID_LIST_KEY =
    "subchallengeIdList";
  ...
  public static final String API_TABLE_WIDGET_QUERY_TABLE_RESULTS =
    "queryTableResults";
  public static final String API_TABLE_WIDGET_SHOW_IF_LOGGED_IN =
    "showIfLoggedInOnly";
  public static final String API_TABLE_WIDGET_RESULTS_KEY =
    "jsonResultsKeyName";
  public static final String API_TABLE_WIDGET_CSS_STYLE = "cssStyle";
  public static final String API_TABLE_WIDGET_COLUMN_CONFIG_PREFIX =
    "columnConfig";
  ...
  public static final String USER_TEAM_BADGE_WIDGET_IS_INDIVIDUAL_KEY =
    "isUser";
  ...
  public static final String REGISTER_CHALLENGE_TEAM_CONTENT_TYPE =
    "registerChallengeTeam";
  public static final String CHALLENGE_TEAMS_CONTENT_TYPE = "challengeTeams";
  public static final String CHALLENGE_PARTICIPANTS_CONTENT_TYPE =
  ...
  public static final String API_TABLE_COLUMN_RENDERER_ANNOTATIONS =
    "annotations";
  public static final String API_TABLE_COLUMN_RENDERER_CANCEL_CONTROL =
    "cancelcontrol";
