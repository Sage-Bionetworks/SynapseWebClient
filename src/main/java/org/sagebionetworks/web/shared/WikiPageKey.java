...
public class WikiPageKey implements IsSerializable {
	...
	public WikiPageKey(String ownerObjectId, String ownerObjectType, String wikiPageId,
		...
		// if wiki page id is null, then it's a request for the root wiki associated with the owner
		// object
	...
	public String toString() {
		return "WikiPageKey [ownerObjectId=" + ownerObjectId + ", ownerObjectType=" + ownerObjectType
				+ ", wikiPageId=" + wikiPageId + ", version=" + ownerObjectVersion + "]";
	}
