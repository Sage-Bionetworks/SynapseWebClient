...
public class WikiPageKey implements IsSerializable {
  ...
  public WikiPageKey(
    ...
    String ownerObjectType,
    String wikiPageId,
    Long ownerObjectVersion
  ) {
    super();
    if (ownerObjectId == null) throw new IllegalArgumentException(
      "owner object id cannot be null"
    );
    if (ownerObjectType == null) throw new IllegalArgumentException(
      "ownerObjectType cannot be null"
    );
  ...
  public boolean equals(Object obj) {
    ...
    if (ownerObjectId == null) {
      if (other.ownerObjectId != null) return false;
    } else if (!ownerObjectId.equals(other.ownerObjectId)) return false;
    if (ownerObjectType == null) {
      if (other.ownerObjectType != null) return false;
    } else if (!ownerObjectType.equals(other.ownerObjectType)) return false;
    if (ownerObjectVersion == null) {
      if (other.ownerObjectVersion != null) return false;
    } else if (
      !ownerObjectVersion.equals(other.ownerObjectVersion)
    ) return false;
    if (wikiPageId == null) {
      if (other.wikiPageId != null) return false;
    } else if (!wikiPageId.equals(other.wikiPageId)) return false;
    return true;
  }
