...
public class ExceptionUtil {
  ...
  public static RestServiceException convertSynapseException(Throwable ex) {
    ...
    if (ex instanceof SynapseForbiddenException) {
      ...
      return new ResultNotReadyException(
        ((SynapseResultNotReadyException) ex).getJobStatus()
      );
      ...
      return new BadRequestException(
        "The Synapse web client is calling a Synapse backend service that's not available!",
        code
      );
    }
