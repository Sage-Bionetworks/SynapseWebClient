...
public class ActivityGraphNode extends ProvGraphNode implements IsSerializable {
  ...
  public int hashCode() {
    ...
    result =
      prime * result + ((activityName == null) ? 0 : activityName.hashCode());
    result = prime * result + ((id == null) ? 0 : id.hashCode());
    result =
      prime * result + ((modifiedBy == null) ? 0 : modifiedBy.hashCode());
    result =
      prime * result + ((modifiedOn == null) ? 0 : modifiedOn.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (activityDescription == null) {
      if (other.activityDescription != null) return false;
    } else if (
    ...
    if (modifiedOn == null) {
      if (other.modifiedOn != null) return false;
    } else if (!modifiedOn.equals(other.modifiedOn)) return false;
