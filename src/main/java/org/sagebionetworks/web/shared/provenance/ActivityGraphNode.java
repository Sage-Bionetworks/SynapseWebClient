...
public class ActivityGraphNode extends ProvGraphNode implements IsSerializable {
	...
	public ActivityGraphNode(String id, String activityId, String activityName, ActivityType type,
			String modifiedBy, Date modifiedOn, Boolean startingNode) {
		super();
		this.id = id;
	...
	public String toString() {
		return "ActivityGraphNode [id=" + id + ", activityId=" + activityId + ", activityName="
				+ activityName + ", type=" + type + ", modifiedBy=" + modifiedBy + ", modifiedOn="
				+ modifiedOn + "]";
	}
