...
public class EntityGraphNode extends ProvGraphNode implements IsSerializable {
	...
	public EntityGraphNode(String id, String entityId, String name, String versionLabel,
			Long versionNumber, String entityType, Boolean wasExecuted, Boolean startingNode) {
		super();
		this.id = id;
	...
	public String toString() {
		return "EntityGraphNode [id=" + id + ", entityId=" + entityId + ", name=" + name
				+ ", versionLabel=" + versionLabel + ", versionNumber=" + versionNumber + ", entityType="
