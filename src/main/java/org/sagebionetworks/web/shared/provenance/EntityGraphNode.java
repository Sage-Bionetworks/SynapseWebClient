...
public class EntityGraphNode extends ProvGraphNode implements IsSerializable {
  ...
  public int hashCode() {
    ...
    result =
      prime * result + ((versionNumber == null) ? 0 : versionNumber.hashCode());
    result =
      prime * result + ((wasExecuted == null) ? 0 : wasExecuted.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (wasExecuted == null) {
      if (other.wasExecuted != null) return false;
    } else if (!wasExecuted.equals(other.wasExecuted)) return false;
    return true;
  }
