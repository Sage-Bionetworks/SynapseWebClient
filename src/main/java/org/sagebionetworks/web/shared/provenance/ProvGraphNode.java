...
public abstract class ProvGraphNode implements IsSerializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (startingNode != other.startingNode) return false;
    if (pushRight != other.pushRight) return false;
    if (
      !Double.toString(xPos).equals(Double.toString(other.xPos))
    ) return false;
    if (
      !Double.toString(yPos).equals(Double.toString(other.yPos))
    ) return false;
    return true;
  }
