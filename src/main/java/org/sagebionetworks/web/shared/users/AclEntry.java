...
public class AclEntry implements IsSerializable {
	...
	public AclEntry(String ownerId, Set<ACCESS_TYPE> accessTypes, String title, String subtitle,
	...
	public String toString() {
		return "AclEntry [accessTypes=" + accessTypes + ", isIndividual=" + isIndividual + ", ownerId="
				+ ownerId + ", title=" + title + ", subtitle=" + subtitle + "]";
	}
