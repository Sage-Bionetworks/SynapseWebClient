...
public class AclEntry implements IsSerializable {
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
      prime * result + ((accessTypes == null) ? 0 : accessTypes.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (accessTypes == null) {
      if (other.accessTypes != null) return false;
    } else if (!accessTypes.equals(other.accessTypes)) return false;
    if (isIndividual != other.isIndividual) return false;
    if (ownerId == null) {
