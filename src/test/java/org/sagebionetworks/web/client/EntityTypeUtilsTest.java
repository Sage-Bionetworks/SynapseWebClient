...
public class EntityTypeUtilsTest {
  ...
  public void testGetEntityClassNameForEntityType() {
    ...
    assertEquals(
      ...
      EntityTypeUtils.getEntityClassNameForEntityType(
        EntityType.submissionview.name()
      )
    );
    assertEquals(
      Dataset.class.getName(),
      EntityTypeUtils.getEntityClassNameForEntityType(EntityType.dataset.name())
    );
    assertEquals(
  ...
  public void testGetEntityTypeForEntityClassName() {
    ...
    assertEquals(
      EntityType.dataset,
      EntityTypeUtils.getEntityTypeForEntityClassName(Dataset.class.getName())
    );
    assertEquals(
  ...
  public void testGetFriendlyTableTypeName() {
    assertEquals(
      EntityTypeUtils.TABLE_ENTITY_DISPLAY_NAME,
      EntityTypeUtils.getFriendlyTableTypeName(TableEntity.class.getName())
    );
    assertEquals(
      EntityTypeUtils.ENTITY_VIEW_DISPLAY_NAME,
      EntityTypeUtils.getFriendlyTableTypeName(EntityView.class.getName())
    );
    assertEquals(
      EntityTypeUtils.SUBMISSION_VIEW_DISPLAY_NAME,
      EntityTypeUtils.getFriendlyTableTypeName(SubmissionView.class.getName())
    );
    assertEquals(
      EntityTypeUtils.DATASET_DISPLAY_NAME,
      EntityTypeUtils.getFriendlyTableTypeName(Dataset.class.getName())
    );
    assertEquals(
    ...
    assertEquals(
      EntityTypeUtils.UNKNOWN_TABLE_TYPE,
      EntityTypeUtils.getFriendlyTableTypeName("coffee table")
    );
  }
