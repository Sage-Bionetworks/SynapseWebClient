...
public class SynapseJavascriptClientTest {
  ...
  public static final String SESSION_COOKIE_URL =
    "http://session-cookie-servlet/";
  ...
  public void before() throws RequestException {
    ...
    when(mockSynapseProperties.getSynapseProperty(REPO_SERVICE_URL_KEY))
      .thenReturn(REPO_ENDPOINT);
    when(mockSynapseProperties.getSynapseProperty(FILE_SERVICE_URL_KEY))
      .thenReturn(FILE_ENDPOINT);
  ...
  public void testGetException() {
    ...
    assertNull(
      getException(SC_FORBIDDEN, reason, errorResponseCode)
  ...
  public void testGetEntityBundleAnonymousSuccess()
    ...
    verify(mockRequestBuilder, never())
      .setHeader(eq(AUTHORIZATION_HEADER), anyString());
  ...
  public void testGetEntityBundleForVersionLoggedInFailure()
    ...
    when(mockAuthController.getCurrentUserAccessToken())
      .thenReturn(USER_ACCESS_TOKEN);

    client.getEntityBundleForVersion(
      entityId,
      versionNumber,
      request,
      mockAsyncCallback
    ...
    verify(mockRequestBuilder).setHeader(ACCEPT, APPLICATION_JSON_CHARSET_UTF8);
    verify(mockRequestBuilder)
      .setHeader(AUTHORIZATION_HEADER, BEARER_PREFIX + USER_ACCESS_TOKEN);
  ...
  @Test
  public void testGetReasonFromFailure()
    throws RequestException, JSONObjectAdapterException {
    String entityId = "syn291";
    EntityBundleRequest request = new EntityBundleRequest();
    Long versionNumber = 5L;
  ...
  @Test
  public void testGetTeamWithRetry()
    throws RequestException, JSONObjectAdapterException {
    String teamId = "9123";
    ...
    verify(mockRequestBuilder)
      .sendRequest(eq((String) null), requestCallbackCaptor.capture());
    RequestCallback requestCallback = requestCallbackCaptor.getValue();

    // simulate too many requests
    when(mockResponse.getStatusCode())
      .thenReturn(TOO_MANY_REQUESTS_STATUS_CODE);
    requestCallback.onResponseReceived(mockRequest1, mockResponse);
    ...
    verify(mockGwt)
      .scheduleExecution(
        ...
        eq(INITIAL_RETRY_REQUEST_DELAY_MS)
      );
    // simulate retry
    callbackCaptor.getValue().invoke();
    verify(mockRequestBuilder, times(2))
      .sendRequest(eq((String) null), any(RequestCallback.class));
  }

  @Test
  public void testPostRestrictionInformation()
    throws RequestException, JSONObjectAdapterException {
    ...
    verify(mockRequestBuilder).setHeader(ACCEPT, APPLICATION_JSON_CHARSET_UTF8);
    verify(mockRequestBuilder)
      .setHeader(WebConstants.CONTENT_TYPE, APPLICATION_JSON_CHARSET_UTF8);
    verify(mockRequestBuilder)
      .sendRequest(stringCaptor.capture(), requestCallbackCaptor.capture());

    // verify request data
    String json = stringCaptor.getValue();
    RestrictionInformationRequest request = new RestrictionInformationRequest(
      jsonObjectAdapter.createNew(json)
    );
  ...
  @Test
  public void testGetVersionOfV2WikiPageAsV1()
    throws RequestException, JSONObjectAdapterException {
  ...
  public void testGetUserGroupHeadersByPrefix()
    ...
    client.getUserGroupHeadersByPrefix(
      prefix,
      typeFilter,
      limit,
      offset,
    ...
    String url =
      ...
      OFFSET_PARAMETER +
      offset +
      TYPE_FILTER_PARAMETER +
      typeFilter.name();
    verify(mockRequestBuilder).configure(GET, url);
  }

  @Test
  public void testPostListUserProfiles()
    throws RequestException, JSONObjectAdapterException {
    String userId1 = "32";
    String userId2 = "8";
    ...
    ListWrapper<UserProfile> results = new ListWrapper<UserProfile>(
      UserProfile.class
    );
  ...
  public void testGetUserBundle()
    ...
    // verify url and method
    String url =
      REPO_ENDPOINT + USER + "/" + principalId + BUNDLE_MASK_PATH + mask;
    verify(mockRequestBuilder).configure(GET, url);
  }
  ...
  public void testGetNewEntityInstance()
    ...
    assertTrue(
      synapseJsFactory.newInstance(OBJECT_TYPE.Entity, adapter) instanceof Link
    );
  ...
  @Test
  public void testUpdateV2WikiPage()
    throws RequestException, JSONObjectAdapterException {
    ...
    String url =
      REPO_ENDPOINT +
      "/" +
      pageKey.getOwnerObjectType().toLowerCase() +
      "/" +
      ownerObjectId +
      WIKI2 +
      wikiPageId;
  ...
  @Test
  public void testAsyncTableTransaction()
    throws RequestException, JSONObjectAdapterException {
  ...
  @Test
  public void testStartAsynchJob()
    throws RequestException, JSONObjectAdapterException {
  ...
  public void testAsyncGetTableQueryJobResults()
    ...
    // verify url and method
    String url =
      REPO_ENDPOINT + ENTITY + "/" + entityId + TABLE_QUERY + ASYNC_GET + jobId;
    verify(mockRequestBuilder).configure(GET, url);
    verify(mockRequestBuilder).setHeader(ACCEPT, APPLICATION_JSON_CHARSET_UTF8);
    verify(mockRequestBuilder)
      .setHeader(AUTHORIZATION_HEADER, BEARER_PREFIX + USER_ACCESS_TOKEN);
  ...
  @Test
  public void testAsyncBulkFileDownload()
    throws RequestException, JSONObjectAdapterException {
    String jobId = "99993";
    when(mockAuthController.isLoggedIn()).thenReturn(true);
    when(mockAuthController.getCurrentUserAccessToken())
  ...
  @Test
  public void testAsyncCSVDownload()
    throws RequestException, JSONObjectAdapterException {
  ...
  @Test
  public void testGetTeamMembersFirstStep()
    throws RequestException, JSONObjectAdapterException {
    ...
    when(mockGwt.encodeQueryString(anyString()))
      .thenReturn(fragment, memberType.toString());
    when(mockAuthController.isLoggedIn()).thenReturn(true);
    when(mockAuthController.getCurrentUserAccessToken())
      .thenReturn(USER_ACCESS_TOKEN);
  ...
  @Test
  public void testGetTeamMembersSecondStep()
    throws RequestException, JSONObjectAdapterException {
