...
public class ExamplePresenter {
  ...
  public ExamplePresenter(ExampleServiceAsync asyncService) {
    if (asyncService == null) throw new IllegalArgumentException(
      "ExampleServiceAsync cannot be null"
    );
  ...
  public void doNoArgs() {
    // Make the call
    asyncService.noArgs(
      new AsyncCallback<List<SampleDTO>>() {
        @Override
