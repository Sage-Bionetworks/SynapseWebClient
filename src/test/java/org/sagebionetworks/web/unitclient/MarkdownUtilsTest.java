...
public class MarkdownUtilsTest {
	...
	public void testDetectEntityLinks(){
		...
		MarkdownUtils.addSynapseLinks(htmlDoc);
	...
	public void testDetectUrlLinks(){
		...
		Document htmlDoc = Jsoup.parse(testString);
		MarkdownUtils.addUrlLinks(htmlDoc);
		String actualResult = htmlDoc.html();
		assertEquals(expectedResult, actualResult);
	}
	...
	public void testYouTubeVideos(){
		...
		Document htmlDoc = Jsoup.parse(testString);
		MarkdownUtils.addYouTubeVideos(htmlDoc);
		String actualResult = htmlDoc.html();
		assertEquals(expectedResult, actualResult);
	}
	...
	public void testFixCSSClass(){
		...
		Document htmlDoc = Jsoup.parse(testString);
		MarkdownUtils.applyCssClass(htmlDoc, "myclass");
		String actualResult = htmlDoc.html();
		assertEquals(expectedResult, actualResult);
	}
	...
	public void testImageAttachmentLinks(){
		...
		String actualResult = MarkdownUtils.markdown2Html(attachmentMd, "http://mySynapse/attachment", new MarkdownProcessor());
	...
	public void testMarkdown2HtmlEscapeControlCharacters(){
		...
		String actualResult = MarkdownUtils.markdown2Html(testString, "http://mySynapse/attachment", new MarkdownProcessor());
		assertEquals(expectedResult, actualResult);
	}
}
