...
public class SynapsePropertiesTest {
	...
	public void setUp() throws Exception {
		...
		AsyncMockStubber.callSuccessWith(testProps).when(mockStackConfigService)
	...
	public void testInitSynapseProperties() {
		...
		assertEquals(authenticatedPrincipalId,
	...
	public void testInitSynapsePropertiesFailure() {
		...
		AsyncMockStubber.callFailureWith(new Exception(errorMessage)).when(mockStackConfigService)
				.getSynapseProperties(any(AsyncCallback.class));
