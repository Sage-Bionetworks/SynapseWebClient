...
public class AppActivityMapperTest {
	 ...
	 * Then go to the login page and verify that the entity place is stored. Part 2: Then go back to
	 * the login page (SSO simulation) and assure that last place is still the entity place and not
	 * the first login page visit
	 */
	@Test
