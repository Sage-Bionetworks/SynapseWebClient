...
public class ProfilePlaceTest {
	...
	public void testTeamProjectFilterCase() {
		String teamId = "99993";
		String testToken =
				testUserId + PROJECTS_DELIMITER + TEAM_PROJECTS_DELIMITER + Profile.DELIMITER + teamId;
		Profile place = tokenizer.getPlace(testToken);
		assertEquals(testUserId, place.getUserId());
		assertEquals(Synapse.ProfileArea.PROJECTS, place.getArea());
		assertEquals(testToken, tokenizer.getToken(place));
	...
	public static final String SETTINGS_DELIMITER =
			Profile.getDelimiter(Synapse.ProfileArea.SETTINGS);
	public static final String PROJECTS_DELIMITER =
			Profile.getDelimiter(Synapse.ProfileArea.PROJECTS);
	public static final String PROFILE_DELIMITER = Profile.getDelimiter(Synapse.ProfileArea.PROFILE);
	public static final String CHALLENGES_DELIMITER =
			Profile.getDelimiter(Synapse.ProfileArea.CHALLENGES);
	...
	public static final String FAV_PROJECTS_DELIMITER =
			Profile.getDelimiter(ProjectFilterEnum.FAVORITES);
	public static final String CREATED_BY_ME_DELIMITER =
			Profile.getDelimiter(ProjectFilterEnum.CREATED_BY_ME);
