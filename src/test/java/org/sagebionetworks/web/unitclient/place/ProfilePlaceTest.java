...
public class ProfilePlaceTest {
  ...
  public void testMyProjectFilterCase() {
    String testToken =
      testUserId + PROJECTS_DELIMITER + CREATED_BY_ME_DELIMITER;
    Profile place = tokenizer.getPlace(testToken);
    assertEquals(testUserId, place.getUserId());
    assertEquals(Synapse.ProfileArea.PROJECTS, place.getArea());
    assertEquals(testToken, tokenizer.getToken(place));
  ...
  public void testSharedWithMeProjectFilterCase() {
    String testToken =
      testUserId +
      PROJECTS_DELIMITER +
      SHARED_DIRECTLY_WITH_ME_PROJECTS_DELIMITER;
    Profile place = tokenizer.getPlace(testToken);
    assertEquals(testUserId, place.getUserId());
    assertEquals(Synapse.ProfileArea.PROJECTS, place.getArea());
    assertEquals(testToken, tokenizer.getToken(place));
  ...
  public void testAllMyTeamsProjectFilterCase() {
    String testToken =
      testUserId + PROJECTS_DELIMITER + ALL_MY_TEAM_PROJECTS_DELIMITER;
    Profile place = tokenizer.getPlace(testToken);
    assertEquals(testUserId, place.getUserId());
    assertEquals(Synapse.ProfileArea.PROJECTS, place.getArea());
    assertEquals(testToken, tokenizer.getToken(place));
  ...
  public static final String SETTINGS_DELIMITER = Profile.getDelimiter(
    Synapse.ProfileArea.SETTINGS
  );
  public static final String PROJECTS_DELIMITER = Profile.getDelimiter(
    Synapse.ProfileArea.PROJECTS
  );
  public static final String PROFILE_DELIMITER = Profile.getDelimiter(
    Synapse.ProfileArea.PROFILE
  );
  public static final String CHALLENGES_DELIMITER = Profile.getDelimiter(
    Synapse.ProfileArea.CHALLENGES
  );
  public static final String TEAMS_DELIMITER = Profile.getDelimiter(
    Synapse.ProfileArea.TEAMS
  );

  public static final String ALL_PROJECTS_DELIMITER = Profile.getDelimiter(
    ProjectFilterEnum.ALL
  );
  public static final String FAV_PROJECTS_DELIMITER = Profile.getDelimiter(
