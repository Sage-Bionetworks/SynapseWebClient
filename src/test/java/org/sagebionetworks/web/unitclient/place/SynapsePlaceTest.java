...
public class SynapsePlaceTest {
  ...
  public static final String ADMIN_DELIMITER = Synapse.getDelimiter(
    Synapse.EntityArea.CHALLENGE
  );
  public static final String WIKI_DELIMITER = Synapse.getDelimiter(
    Synapse.EntityArea.WIKI
  );
  public static final String FILES_DELIMITER = Synapse.getDelimiter(
    Synapse.EntityArea.FILES
  );
  public static final String TABLES_DELIMITER = Synapse.getDelimiter(
    Synapse.EntityArea.TABLES
  );
  public static final String DISCUSSION_DELIMITER = Synapse.getDelimiter(
    Synapse.EntityArea.DISCUSSION
  );
  public static final String DOCKER_DELIMITER = Synapse.getDelimiter(
    Synapse.EntityArea.DOCKER
  );
  ...
  public void testFilesVersionCase() {
    String testToken =
      testEntityId + VERSION_DELIMITER + testVersionNumber + FILES_DELIMITER;
    Synapse place = tokenizer.getPlace(testToken);
  ...
  public void testAdminVersionCase() {
    String testToken =
      testEntityId + VERSION_DELIMITER + testVersionNumber + ADMIN_DELIMITER;
    Synapse place = tokenizer.getPlace(testToken);
  ...
  public void testTablesQueryCase() {
    ...
    String testToken =
      testEntityId +
      TABLES_DELIMITER +
      AbstractTablesTab.TABLE_QUERY_PREFIX +
      queryToken;
    Synapse place = tokenizer.getPlace(testToken);
    ...
    assertEquals(
      queryToken,
      areaToken.substring(AbstractTablesTab.TABLE_QUERY_PREFIX.length())
    );
    Assert.assertEquals(testToken, tokenizer.getToken(place));
  }
