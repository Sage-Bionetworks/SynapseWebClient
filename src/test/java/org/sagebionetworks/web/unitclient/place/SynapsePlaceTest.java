...
public class SynapsePlaceTest {
	...
	public static final String DISCUSSION_DELIMITER =
			Synapse.getDelimiter(Synapse.EntityArea.DISCUSSION);
	...
	public void testWikiVersionCase() {
		String testToken =
				testEntityId + VERSION_DELIMITER + testVersionNumber + WIKI_DELIMITER + testAreaToken;
		Synapse place = tokenizer.getPlace(testToken);
