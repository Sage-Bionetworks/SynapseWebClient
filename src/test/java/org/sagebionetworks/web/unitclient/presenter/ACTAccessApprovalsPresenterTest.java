...
public class ACTAccessApprovalsPresenterTest {
	...
	public void setup() {
		...
		presenter = new ACTAccessApprovalsPresenter(mockView, mockSynAlert, mockGinInjector,
				mockLoadMoreContainer, mockShowHideAccessRequirementButton, mockDataAccessClient,
				mockPeopleSuggestWidget, mockProvider, mockSelectedUserBadge, mockAccessRequirementWidget,
				mockGlobalAppState);
		AsyncMockStubber.callSuccessWith(mockAccessorGroupResponse).when(mockDataAccessClient)
				.listAccessorGroup(any(AccessorGroupRequest.class), any(AsyncCallback.class));
	...
	public void testSetPlace() {
		...
		verify(mockDataAccessClient).listAccessorGroup(accessorGroupRequestCaptor.capture(),
