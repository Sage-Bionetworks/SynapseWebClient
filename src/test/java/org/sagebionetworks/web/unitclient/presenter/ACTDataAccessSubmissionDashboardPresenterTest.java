...
public class ACTDataAccessSubmissionDashboardPresenterTest {
	...
	public void setUp() {
		...
		presenter = new ACTDataAccessSubmissionDashboardPresenter(mockView, mockDataAccessClient,
				mockSynAlert, mockGinInjector, mockLoadMoreContainer, mockNoResultsDiv);
	}
	...
	public void testLoadMoreFailure() {
		...
		AsyncMockStubber.callFailureWith(ex).when(mockDataAccessClient).getOpenSubmissions(anyString(),
	...
	public void testLoadMoreSuccessNoResults() {
		...
		AsyncMockStubber.callSuccessWith(page).when(mockDataAccessClient)
