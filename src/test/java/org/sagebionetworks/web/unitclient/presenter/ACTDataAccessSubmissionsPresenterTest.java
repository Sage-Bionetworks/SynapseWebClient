...
public class ACTDataAccessSubmissionsPresenterTest {
	...
	public void setup() {
		...
		presenter = new ACTDataAccessSubmissionsPresenter(mockView, mockSynAlert, mockGinInjector, mockLoadMoreContainer, mockACTAccessRequirementWidget, mockButton, mockDucTemplateFileHandleWidget, mockJsClient, mockSubjectsWidget, mockGWT, mockAccessorSuggestWidget, mockUserGroupSuggestionProvider, mockSelectedAccessorUserBadge);
		...
		AsyncMockStubber.callSuccessWith(mockDataAccessSubmissionPage).when(mockJsClient).getDataAccessSubmissions(anyString(), anyString(), anyString(), any(SubmissionState.class), any(SubmissionOrder.class), anyBoolean(), any(AsyncCallback.class));
		...
		when(mockACTAccessRequirement.getExpirationPeriod()).thenReturn(EXPIRATION_PERIOD);
	...
	public void testConstruction() {
		...
		verify(mockAccessorSuggestWidget).setSuggestionProvider(mockUserGroupSuggestionProvider);
	...
	public void testLoadData() {
		...
		verify(mockJsClient).getDataAccessSubmissions(anyString(), eq(ACCESSOR_ID), eq((String) null), any(SubmissionState.class), any(SubmissionOrder.class), anyBoolean(), any(AsyncCallback.class));
		...
		presenter.loadMore();
		verify(mockJsClient).getDataAccessSubmissions(anyString(), eq(ACCESSOR_ID), eq(NEXT_PAGE_TOKEN), any(SubmissionState.class), any(SubmissionOrder.class), anyBoolean(), any(AsyncCallback.class));
	...
	public void testClearAccessorFilter() {
		...
		verify(mockJsClient).getDataAccessSubmissions(anyString(), eq((String) null), eq((String) null), any(SubmissionState.class), any(SubmissionOrder.class), anyBoolean(), any(AsyncCallback.class));
	}
	...
	public void testOnAccessorSelected() {
		...
		verify(mockJsClient).getDataAccessSubmissions(anyString(), eq(USER_ID_SELECTED), eq((String) null), any(SubmissionState.class), any(SubmissionOrder.class), anyBoolean(), any(AsyncCallback.class));
	}

	@Test
	public void testLoadDataFailure() {
		Exception ex = new Exception();
		AsyncMockStubber.callFailureWith(ex).when(mockJsClient).getDataAccessSubmissions(anyString(), anyString(), anyString(), any(SubmissionState.class), any(SubmissionOrder.class), anyBoolean(), any(AsyncCallback.class));
		presenter.loadData();
