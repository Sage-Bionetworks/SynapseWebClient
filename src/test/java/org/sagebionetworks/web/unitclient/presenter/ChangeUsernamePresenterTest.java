...
public class ChangeUsernamePresenterTest {
	...
	public void setup() {
		...
		presenter = new ChangeUsernamePresenter(mockView, mockSynapseClient, mockGlobalApplicationState,
				mockAuthenticationController, jsonObjectAdapter, mockSynAlert);
	...
	public void testSetUsernameFailure() throws JSONObjectAdapterException {
		...
		AsyncMockStubber.callFailureWith(t).when(mockSynapseClient)
				.updateUserProfile(any(UserProfile.class), any(AsyncCallback.class));
		presenter.setUsername("newname");
