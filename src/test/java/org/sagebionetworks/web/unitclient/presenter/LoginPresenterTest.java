...
public class LoginPresenterTest {
	...
	public void setup() {
		...
		AsyncMockStubber.callSuccessWith(mockUserProfile).when(mockAuthenticationController)
				.setNewSessionToken(anyString(), any(AsyncCallback.class));
		AsyncMockStubber.callSuccessWith(mockUserProfile).when(mockAuthenticationController)
				.initializeFromExistingSessionCookie(any(AsyncCallback.class));
	}
	...
	public void testSetPlaceShowAndAcceptToU() {
		...
		when(mockAuthenticationController.getCurrentUserSessionToken())
		...
		AsyncMockStubber.callSuccessWith(null).when(mockAuthenticationController)
				.signTermsOfUse(anyBoolean(), any(AsyncCallback.class));
	...
	public void testSetPlaceSSOLogin() throws JSONObjectAdapterException {
		...
		verify(mockAuthenticationController).setNewSessionToken(eq(fakeToken),
