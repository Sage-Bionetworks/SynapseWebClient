...
public class PeopleSearchPresenterTest {
	...
	public void setup() throws JSONObjectAdapterException {
		...
		presenter = new PeopleSearchPresenter(mockView, mockGlobalApplicationState, mockSynAlert,
				mockLoadMoreWidgetContainer, mockPortalGinInjector, mockSynapseJavascriptClient);
		AsyncMockStubber.callSuccessWith(peopleList).when(mockSynapseJavascriptClient)
				.getUserGroupHeadersByPrefix(anyString(), any(TypeFilter.class), anyLong(), anyLong(),
	...
	public void testSearch() throws RestServiceException {
		...
		verify(mockSynapseJavascriptClient).getUserGroupHeadersByPrefix(eq(searchTerm),
				eq(TypeFilter.USERS_ONLY), anyLong(), anyLong(), any(AsyncCallback.class));
