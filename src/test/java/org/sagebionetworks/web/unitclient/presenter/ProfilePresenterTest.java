...
public class ProfilePresenterTest {
	...
	public void setup() throws JSONObjectAdapterException {
		...
		profilePresenter = new ProfilePresenter(mockView, mockAuthenticationController,
				mockGlobalApplicationState, mockGwt, mockTeamListWidget, mockTeamInviteWidget, mockInjector,
				mockSynapseJavascriptClient, mockIsACTMemberAsyncHandler);
		...
		when(mockInjector.getProfileCertifiedValidatedWidget())
				.thenReturn(mockProfileCertifiedValidatedWidget);
		...
		AsyncMockStubber.callSuccessWith(mockUserBundle).when(mockSynapseJavascriptClient)
		...
		AsyncMockStubber.callSuccessWith(mockPrincipalAliasResponse).when(mockSynapseJavascriptClient)
				.getPrincipalAlias(any(PrincipalAliasRequest.class), any(AsyncCallback.class));
		...
		when(mockSynapseJavascriptClient.getUserTeams(anyString(), anyBoolean(), anyString()))
				.thenReturn(getDoneFuture(mockPaginatedTeamIds), getDoneFuture(mockPaginatedTeamIdsPage2));
		...
		AsyncMockStubber.callSuccessWith(mockProjectHeaderList).when(mockSynapseJavascriptClient)
				.getMyProjects(any(ProjectListType.class), anyInt(), anyString(),
						any(ProjectListSortColumn.class), any(SortDirection.class), any(AsyncCallback.class));
		AsyncMockStubber.callSuccessWith(mockProjectHeaderList).when(mockSynapseJavascriptClient)
				.getUserProjects(anyString(), anyInt(), anyString(), any(ProjectListSortColumn.class),
						any(SortDirection.class), any(AsyncCallback.class));
		AsyncMockStubber.callSuccessWith(mockProjectHeaderList).when(mockSynapseJavascriptClient)
				.getProjectsForTeam(anyString(), anyInt(), anyString(), any(ProjectListSortColumn.class),
						any(SortDirection.class), any(AsyncCallback.class));

		AsyncMockStubber.callSuccessWith(myFavorites).when(mockSynapseJavascriptClient)
		...
		AsyncMockStubber.callSuccessWith(mockTeam).when(mockSynapseJavascriptClient)
				.createTeam(any(Team.class), any(AsyncCallback.class));

		org.sagebionetworks.reflection.model.PaginatedResults<EntityHeader> testBatchResults =
	...
	public void setupTestChallengePagedResults() {
		...
		AsyncMockStubber.callSuccessWith(testChallenges).when(mockSynapseJavascriptClient)
	...
	public void testPublicView() throws JSONObjectAdapterException {
		...
		when(place.getUserId()).thenReturn(targetUserId);
		profilePresenter.setPlace(place);
		verify(mockSynapseJavascriptClient).getUserBundle(anyLong(), anyInt(),
				any(AsyncCallback.class));

		verify(mockSynapseJavascriptClient, never()).getUserTeams(anyString(), anyBoolean(),
				anyString());
	...
	public void testViewUsername() {
		...
		verify(mockSynapseJavascriptClient).getPrincipalAlias(principalAliasRequestCaptor.capture(),
				any(AsyncCallback.class));
		assertEquals(targetUsername, principalAliasRequestCaptor.getValue().getAlias());
		verify(mockSynapseJavascriptClient).getUserBundle(eq(Long.parseLong(targetUserId)), anyInt(),
				any(AsyncCallback.class));
	...
	public void testViewUsernameFailure() {
		...
		verify(mockSynapseJavascriptClient).getPrincipalAlias(any(PrincipalAliasRequest.class),
				any(AsyncCallback.class));
	...
	private void invokeGetMyTeamsCallback() {
		...
		verify(mockGwt).scheduleExecution(callbackCaptor.capture(),
	...
	public void testGetProfileError() {
		...
		AsyncMockStubber.callFailureWith(ex).when(mockSynapseJavascriptClient).getUserBundle(anyLong(),
				anyInt(), any(AsyncCallback.class));
	...
	public void testGetAllMyProjects() {
		...
		verify(mockSynapseJavascriptClient).getMyProjects(eq(ProjectListType.ALL), anyInt(),
				anyString(), any(ProjectListSortColumn.class), any(SortDirection.class),
				any(AsyncCallback.class));
	...
	public void testGetAllTheirProjects() {
		...
		profilePresenter.setProjectFilterAndRefresh(ProjectFilterEnum.ALL, null);
		verify(mockView).setProjectContainer(any(Widget.class));
		verify(mockSynapseJavascriptClient).getUserProjects(anyString(), anyInt(), anyString(),
				any(ProjectListSortColumn.class), any(SortDirection.class), any(AsyncCallback.class));
		verify(mockLoadMoreContainer, times(2)).add(any(Widget.class));
	}
	...
	public void testGetProjectsDefaultFilterFailure() {
		AsyncMockStubber.callFailureWith(new Exception("unhandled")).when(mockSynapseJavascriptClient)
				.getUserProjects(anyString(), anyInt(), anyString(), any(ProjectListSortColumn.class),
						any(SortDirection.class), any(AsyncCallback.class));
		profilePresenter.setIsOwner(false);
		// when setting the filter to all, it should ask for all of their projects
	...
	public void testGetProjectsCreatedByMe() {
		...
		verify(mockSynapseJavascriptClient).getMyProjects(eq(ProjectListType.CREATED), anyInt(),
				anyString(), any(ProjectListSortColumn.class), any(SortDirection.class),
				any(AsyncCallback.class));
		verify(mockLoadMoreContainer, times(2)).add(any(Widget.class));
		verify(mockView).setLastActivityOnColumnVisible(true);
	...
	public void testGetSharedDirectlyWithMeProjects() {
		...
		verify(mockSynapseJavascriptClient).getMyProjects(eq(ProjectListType.PARTICIPATED), anyInt(),
				anyString(), any(ProjectListSortColumn.class), any(SortDirection.class),
				any(AsyncCallback.class));
		verify(mockLoadMoreContainer, times(2)).add(any(Widget.class));
		verify(mockView).setLastActivityOnColumnVisible(true);
	...
	public void testGetProjectsByTeam() {
		...
		verify(mockSynapseJavascriptClient).getProjectsForTeam(eq(teamId), anyInt(), anyString(),
				any(ProjectListSortColumn.class), any(SortDirection.class), any(AsyncCallback.class));
		verify(mockLoadMoreContainer, times(2)).add(any(Widget.class));
		verify(mockView).setLastActivityOnColumnVisible(true);
	}
	...
	public void testGetProjectsByTeamFailure() {
		profilePresenter.setPlace(place);
		profilePresenter.setIsOwner(true);
		AsyncMockStubber.callFailureWith(new Exception("failed")).when(mockSynapseJavascriptClient)
				.getProjectsForTeam(anyString(), anyInt(), anyString(), any(ProjectListSortColumn.class),
						any(SortDirection.class), any(AsyncCallback.class));
	...
	public void testGetProjectCreatedByMeFailure() {
		...
		AsyncMockStubber.callFailureWith(new Exception("unhandled")).when(mockSynapseJavascriptClient)
				.getMyProjects(eq(ProjectListType.CREATED), anyInt(), anyString(),
						any(ProjectListSortColumn.class), any(SortDirection.class), any(AsyncCallback.class));
		profilePresenter.setProjectFilterAndRefresh(ProjectFilterEnum.CREATED_BY_ME, null);
		verify(mockSynAlert).handleException(any(Exception.class));
	}
	...
	public void testApplyFilterClickedMyTeamProjects() {
		...
		verify(mockSynapseJavascriptClient).getMyProjects(eq(ProjectListType.TEAM), anyInt(),
				anyString(), any(ProjectListSortColumn.class), any(SortDirection.class),
				any(AsyncCallback.class));
		verify(mockView).setLastActivityOnColumnVisible(true);
	}
	...
	public void testGetMyProjectsError() {
		AsyncMockStubber.callFailureWith(new Exception("unhandled")).when(mockSynapseJavascriptClient)
				.getMyProjects(eq(ProjectListType.ALL), anyInt(), anyString(),
						any(ProjectListSortColumn.class), any(SortDirection.class), any(AsyncCallback.class));
		profilePresenter.getMyProjects(ProjectListType.ALL, ProjectFilterEnum.ALL, null);
		verify(mockSynapseJavascriptClient).getMyProjects(eq(ProjectListType.ALL), anyInt(),
				anyString(), any(ProjectListSortColumn.class), any(SortDirection.class),
				any(AsyncCallback.class));
		verify(mockSynAlert).handleException(any(Exception.class));
	...
	public void testCreateProjectNameConflictError() {
		when(mockSynapseJavascriptClient.createEntity(any(Entity.class)))
				.thenReturn(getFailedFuture(new ConflictException("special handled exception type")));
		profilePresenter.createProjectAfterPrompt("valid name");
	...
	public void testSortedByLatestActivity() {
		...
		verify(mockSynapseJavascriptClient).getUserProjects(anyString(), anyInt(), anyString(),
				eq(ProjectListSortColumn.LAST_ACTIVITY), eq(SortDirection.ASC), any(AsyncCallback.class));

		profilePresenter.sort(ProjectListSortColumn.LAST_ACTIVITY);
		verify(mockSynapseJavascriptClient).getUserProjects(anyString(), anyInt(), anyString(),
				eq(ProjectListSortColumn.LAST_ACTIVITY), eq(SortDirection.DESC), any(AsyncCallback.class));

		profilePresenter.sort(ProjectListSortColumn.PROJECT_NAME);
		verify(mockSynapseJavascriptClient).getUserProjects(anyString(), anyInt(), anyString(),
				eq(ProjectListSortColumn.PROJECT_NAME), eq(SortDirection.ASC), any(AsyncCallback.class));

		profilePresenter.sort(ProjectListSortColumn.PROJECT_NAME);
		verify(mockSynapseJavascriptClient).getUserProjects(anyString(), anyInt(), anyString(),
				eq(ProjectListSortColumn.PROJECT_NAME), eq(SortDirection.DESC), any(AsyncCallback.class));
	}
	...
	public void testCreateTeamEmptyName() {
		...
		verify(mockSynapseJavascriptClient, never()).createTeam(any(Team.class),
				any(AsyncCallback.class));
		verify(mockPromptModalView).showError(anyString());
		reset(mockPromptModalView);
	...
	public void testCreateTeamError() {
		String errorMessage = "unhandled";
		AsyncMockStubber.callFailureWith(new Exception(errorMessage)).when(mockSynapseJavascriptClient)
				.createTeam(any(Team.class), any(AsyncCallback.class));
		profilePresenter.createTeamAfterPrompt("valid name");
		verify(mockPromptModalView).showError(errorMessage);
	}
	...
	public void testCreateTeamNameConflictError() {
		AsyncMockStubber.callFailureWith(new ConflictException("special handled exception type"))
				.when(mockSynapseJavascriptClient).createTeam(any(Team.class), any(AsyncCallback.class));
		profilePresenter.createTeamAfterPrompt("valid name");
	...
	public void testRefreshChallenges() {
		...
		assertEquals(ProfilePresenter.CHALLENGE_PAGE_SIZE,
	...
	public ArrayList<Team> setupUserTeams(long openRequestNumberPerTeam, int numTeams) {
		...
		AsyncMockStubber.callSuccessWith(openRequestNumberPerTeam).when(mockSynapseJavascriptClient)
	...
	public void testGetTeamFilters() {
		...
		verify(mockSynapseJavascriptClient, times(2)).getUserTeams(anyString(), anyBoolean(),
				anyString());
	...
	public void testUpdateTeamInvites() {
		profilePresenter.setIsOwner(true);
		Long inviteCount = 3L;
		AsyncMockStubber.callSuccessWith(inviteCount).when(mockSynapseJavascriptClient)
	...
	public void testAddMembershipRequests() {
		...
		AsyncMockStubber.callSuccessWith(beforeNotificationCount).when(mockSynapseJavascriptClient)
				.getOpenMembershipRequestCount(any(AsyncCallback.class));
		...
		verify(mockView)
				.setTeamNotificationCount(eq(Long.toString(beforeNotificationCount + inviteCount)));
	}

	@Test
	public void testUpdateTeamInvitesZero() {
		profilePresenter.setIsOwner(true);
		AsyncMockStubber.callSuccessWith(0L).when(mockSynapseJavascriptClient)
				.getOpenMembershipInvitationCount(any(AsyncCallback.class));
		profilePresenter.updateMembershipInvitationCount();
	...
	public void testRefreshTeamsOwnerTeamsAndInvites() {
		...
		AsyncMockStubber.callSuccessWith((long) totalNotifications).when(mockSynapseJavascriptClient)
				.getOpenMembershipInvitationCount(any(AsyncCallback.class));
		...
		verifyLoadMoreTeamsConfiguredAndLoading();
		verify(mockTeamInviteWidget, times(2)).configure(refreshTeamsCallback.capture(),
				eq((CallbackP) null));
	...
	public void testInitUserFavorites() {
		...
		AsyncMockStubber.callSuccessWith(favorites).when(mockSynapseJavascriptClient)
				.getFavorites(any(AsyncCallback.class));
