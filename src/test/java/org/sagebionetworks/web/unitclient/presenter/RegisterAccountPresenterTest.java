...
public class RegisterAccountPresenterTest {
	...
	public void setup() {
		...
		registerAccountPresenter = new RegisterAccountPresenter(mockView, mockSynapseClient,
				mockRegisterWidget, mockAuthController, mockGlobalAppState, mockGoogleSynAlert);
	}
