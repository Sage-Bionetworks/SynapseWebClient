...
public class SynapseForumPresenterTest {
	...
	public void setUp() {
		...
		presenter = new SynapseForumPresenter(mockView, mockGlobalApplicationState, mockForumWidget,
	...
	public void testShowForum() {
		...
		verify(mockForumWidget).configure(anyString(), any(ParameterizedToken.class),
				eq(DEFAULT_IS_MODERATOR), any(ActionMenuWidget.class), any(CallbackP.class),
				any(Callback.class));
	}
