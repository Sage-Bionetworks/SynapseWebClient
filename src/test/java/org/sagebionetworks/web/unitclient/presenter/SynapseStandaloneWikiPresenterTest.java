...
public class SynapseStandaloneWikiPresenterTest {
  ...
  public void setup() {
    ...
    presenter =
      new SynapseStandaloneWikiPresenter(
        mockView,
        mockSynapseClient,
    ...
    String wikiId = "44442";
    certificationWikiKey =
      new WikiPageKey(entityId, ObjectType.ENTITY.toString(), wikiId);
