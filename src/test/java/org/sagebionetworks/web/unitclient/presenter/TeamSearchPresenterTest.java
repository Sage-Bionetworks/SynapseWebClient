...
public class TeamSearchPresenterTest {
	...
	public void setup() throws JSONObjectAdapterException {
		...
		presenter = new TeamSearchPresenter(mockView, mockGlobalApplicationState, mockSynapse,
				mockCookies, mockSynAlert, mockLoadMoreWidgetContainer, mockPortalGinInjector);

		AsyncMockStubber.callSuccessWith(teamList).when(mockSynapse).getTeamsBySearch(anyString(),
	...
	public void testSearchFailure() throws RestServiceException {
		...
		AsyncMockStubber.callFailureWith(caught).when(mockSynapse).getTeamsBySearch(anyString(),
				anyInt(), anyInt(), any(AsyncCallback.class));
		presenter.setPlace(mockPlace);
	...
	public void testEmptyTeams() {
		...
		AsyncMockStubber.callSuccessWith(teams).when(mockSynapse).getTeamsBySearch(anyString(),
				anyInt(), anyInt(), any(AsyncCallback.class));
		presenter.setPlace(mockPlace);
