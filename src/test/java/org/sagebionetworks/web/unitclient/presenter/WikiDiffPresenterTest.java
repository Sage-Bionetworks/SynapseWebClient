...
public class WikiDiffPresenterTest {
  ...
  public void setUp() throws Exception {
    ...
    when(mockSingleItemHistoryPaginatedResults.getResults())
      .thenReturn(singleItemHistory);
    when(mockEmptyItemHistoryPaginatedResults.getResults())
      .thenReturn(emptyItemHistory);
  ...
  public void testConstructor() {
    ...
    AsyncMockStubber
      .callFailureWith(loadingErrorEx)
      .when(mockResourceLoader)
      .requires(anyList(), any(AsyncCallback.class));
    presenter =
      new WikiDiffPresenter(
        mockView,
        mockSynapseClient,
  ...
  public void testGetWikiHistory() {
    ...
    AsyncMockStubber
      .callSuccessWith(
        mockSingleItemHistoryPaginatedResults,
  ...
  public void testGetWikiMarkdown() {
    AsyncMockStubber
      .callSuccessWith(mockWikiPageV1)
      .when(mockJsClient)
    ...
    AsyncMockStubber
      .callSuccessWith(mockWikiPageV2)
      .when(mockJsClient)
      .getVersionOfV2WikiPageAsV1(
        any(WikiPageKey.class),
        eq(VERSION_2_VALUE),
