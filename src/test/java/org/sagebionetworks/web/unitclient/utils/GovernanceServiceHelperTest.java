...
public class GovernanceServiceHelperTest {
  ...
  public void setup() {
    ...
    AsyncMockStubber
      ...
      .createAccessApproval(captor.capture(), any(AsyncCallback.class));
  }
  ...
  public void testLockAccessRequirementText() throws Exception {
    assertEquals(
      GovernanceServiceHelper.LOCK_ACCESS_REQUIREMENT_TEXT,
      GovernanceServiceHelper.getAccessRequirementText(
        new LockAccessRequirement()
      )
    );
  }
