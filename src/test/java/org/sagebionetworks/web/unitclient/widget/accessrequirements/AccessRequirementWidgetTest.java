...
public class AccessRequirementWidgetTest {
	...
	public void setUp() throws Exception {
		...
		widget = new AccessRequirementWidget(mockGinInjector, mockJsClient, mockView);

		AsyncMockStubber.callSuccessWith(mockManagedACTAccessRequirement).when(mockJsClient).getAccessRequirement(eq(MANAGED_ACT_AR_ID), any(AsyncCallback.class));
		AsyncMockStubber.callSuccessWith(mockACTAccessRequirement).when(mockJsClient).getAccessRequirement(eq(ACT_AR_ID), any(AsyncCallback.class));
		AsyncMockStubber.callSuccessWith(mockToUAccessRequirement).when(mockJsClient).getAccessRequirement(eq(TOU_AR_ID), any(AsyncCallback.class));
		AsyncMockStubber.callSuccessWith(mockLockAccessRequirement).when(mockJsClient).getAccessRequirement(eq(LOCK_AR_ID), any(AsyncCallback.class));
	...
	public void testConfigureManagedACTAccessRequirement() {
		...
		verify(mockJsClient).getAccessRequirement(anyString(), any(AsyncCallback.class));
	...
	public void testFailureToLoadAccessRequirement() {
		...
		AsyncMockStubber.callFailureWith(ex).when(mockJsClient).getAccessRequirement(anyString(), any(AsyncCallback.class));
