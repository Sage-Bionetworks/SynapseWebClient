...
public class ConvertACTAccessRequirementButtonTest {
  ...
  public void setUp() throws Exception {
    ...
    widget =
      new ConvertACTAccessRequirementButton(
        mockButton,
  ...
  public void testOnClickWithOldInstructions() {
    when(mockAccessRequirement.getActContactInfo())
      .thenReturn("old instructions are set");

    widget.onClick(null);

    verify(mockPopupUtilsView)
      .showErrorMessage(DELETE_OLD_INSTRUCTIONS_MESSAGE);
  }
  ...
  public void testOnClick() {
    ...
    verify(mockPopupUtilsView)
      .showConfirmDialog(
        eq(CONVERT_AR_CONFIRM_TITLE),
        eq(CONVERT_AR_CONFIRM_MESSAGE),
        any(Callback.class)
      );
  }
  ...
  public void testConvertAccessRequirement() {
    AsyncMockStubber
      .callSuccessWith(mockAccessRequirement)
      .when(mockDataAccessClientAsync)
      .convertAccessRequirement(
        any(AccessRequirementConversionRequest.class),
        any(AsyncCallback.class)
      );

    widget.convertAccessRequirement();

    verify(mockDataAccessClientAsync)
      .convertAccessRequirement(
