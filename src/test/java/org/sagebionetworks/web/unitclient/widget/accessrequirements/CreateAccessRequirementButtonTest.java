...
public class CreateAccessRequirementButtonTest {
	...
	public void setUp() throws Exception {
		...
		widget =
				new CreateAccessRequirementButton(mockButton, mockIsACTMemberAsyncHandler, mockGinInjector);
	...
	public void testConfigureWithSubject() {
		...
		verify(mockButton)
				.setText(CreateAccessRequirementButton.CREATE_NEW_ACCESS_REQUIREMENT_BUTTON_TEXT);
		verify(mockIsACTMemberAsyncHandler).isACTActionAvailable(callbackPCaptor.capture());

		// configured with a subject, when clicked it should pop up the wizard pointing to the new
		// subject
		onButtonClickHandler.onClick(null);
