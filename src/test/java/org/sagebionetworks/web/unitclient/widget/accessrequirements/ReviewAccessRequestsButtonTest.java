...
public class ReviewAccessRequestsButtonTest {
	...
	public void setUp() throws Exception {
		...
		widget = new ReviewAccessRequestsButton(mockButton, mockIsACTMemberAsyncHandler,
	...
	public void testConfigureWithAR() {
		...
		assertEquals(AR_ID.toString(), ((ACTDataAccessSubmissionsPlace) place)
				.getParam(ACTDataAccessSubmissionsPlace.ACCESS_REQUIREMENT_ID_PARAM));
	}
}
