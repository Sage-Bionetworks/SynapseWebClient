...
public class AccessorGroupWidgetTest {
  ...
  public void setUp() throws Exception {
    ...
    when(mockAccessorGroup.getAccessRequirementId())
      .thenReturn(ACCESS_REQUIREMENT_ID);
    ...
    AsyncMockStubber
      .callSuccessWith(mockAccessApprovalNotificationResponse)
      .when(mockJsClient)
      .getAccessApprovalNotifications(
        anyString(),
        anyList(),
        any(AsyncCallback.class)
      );
    accessApprovalNotifications = new ArrayList<AccessApprovalNotification>();
    when(mockAccessApprovalNotificationResponse.getResults())
      .thenReturn(accessApprovalNotifications);
  }
  ...
  public void testOnRevokeAfterConfirm() {
    AsyncMockStubber
      ...
      .revokeGroup(anyString(), anyString(), any(AsyncCallback.class));
    widget.configure(mockAccessorGroup);
