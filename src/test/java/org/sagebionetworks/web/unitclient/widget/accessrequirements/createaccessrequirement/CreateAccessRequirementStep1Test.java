...
public class CreateAccessRequirementStep1Test {
	...
	public void setUp() throws Exception {
		...
		widget = new CreateAccessRequirementStep1(mockView, mockActStep2, mockTouStep2,
				mockSynapseClient, mockSubjectsWidget);
		...
		AsyncMockStubber.callSuccessWith(mockACTAccessRequirement).when(mockSynapseClient)
				.createOrUpdateAccessRequirement(any(AccessRequirement.class), any(AsyncCallback.class));
	...
	public void testConfigureWithEntityRod() {
		...
		// go to the next page
		widget.onPrimary();
		verify(mockSynapseClient).createOrUpdateAccessRequirement(arCaptor.capture(),
	...
	public void testConfigureWithTeamRod() {
		...
		AsyncMockStubber.callSuccessWith(mockTermsOfUseAccessRequirement).when(mockSynapseClient)
				.createOrUpdateAccessRequirement(any(AccessRequirement.class), any(AsyncCallback.class));
	...
	public void testConfigureWithACTAccessRequirement() {
		when(mockACTAccessRequirement.getSubjectIds())
				.thenReturn(Collections.singletonList(mockEntityRestrictableObjectDescriptor));
		widget.configure(mockACTAccessRequirement);
		...
		verify(mockSynapseClient).createOrUpdateAccessRequirement(eq(mockACTAccessRequirement),
				any(AsyncCallback.class));
	}
	...
	public void testConfigureWithToUAccessRequirement() {
		...
		verify(mockSynapseClient).createOrUpdateAccessRequirement(eq(mockTermsOfUseAccessRequirement),
				any(AsyncCallback.class));
