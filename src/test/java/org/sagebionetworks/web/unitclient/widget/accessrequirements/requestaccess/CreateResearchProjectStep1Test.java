...
public class CreateResearchProjectStep1Test {
	...
	public void setUp() throws Exception {
		...
		AsyncMockStubber.callSuccessWith(mockResearchProject).when(mockClient)
				.getResearchProject(anyLong(), any(AsyncCallback.class));
		...
		AsyncMockStubber.callSuccessWith(mockResearchProject).when(mockClient)
				.updateResearchProject(any(ResearchProject.class), any(AsyncCallback.class));
	}
	...
	public void testConfigureNewResearchProject() {
		AsyncMockStubber.callSuccessWith(mock(ResearchProject.class)).when(mockClient)
				.getResearchProject(anyLong(), any(AsyncCallback.class));
	...
	public void testConfigureFailure() {
		...
		AsyncMockStubber.callFailureWith(ex).when(mockClient).getResearchProject(anyLong(),
	...
	public void testNext() {
		...
		verify(mockClient).updateResearchProject(researchProjectCaptor.capture(),
				any(AsyncCallback.class));
	...
	public void testNextInvalidViewValue() {
		...
		verify(mockClient, never()).updateResearchProject(any(ResearchProject.class),
				any(AsyncCallback.class));
