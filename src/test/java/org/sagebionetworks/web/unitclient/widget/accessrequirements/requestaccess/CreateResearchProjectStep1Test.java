...
public class CreateResearchProjectStep1Test {
  ...
  public void testConfigureNewResearchProject() {
    AsyncMockStubber
      .callSuccessWith(mock(ResearchProject.class))
      .when(mockClient)
      .getResearchProject(anyLong(), any(AsyncCallback.class));
  ...
  public void testNext() {
    ...
    verify(mockStep2)
      .configure(mockResearchProject, mockACTAccessRequirement, mockSubject);
