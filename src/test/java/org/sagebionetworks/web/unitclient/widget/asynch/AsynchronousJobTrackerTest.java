...
public class AsynchronousJobTrackerTest {
  ...
  @Test
  public void testMultipleStatesThenSuccess()
    throws JSONObjectAdapterException {
    // Simulate start
    AsyncMockStubber
      .callSuccessWith(jobId)
      .when(mockJsClient)
      .startAsynchJob(
    ...
    AsyncMockStubber
      .callMixedWith(startNotReady, middleNotReady, doneNotReady, responseBody)
      .when(mockJsClient)
      .getAsynchJobResults(
        any(AsynchType.class),
        anyString(),
  ...
  public void testWithFailure() throws JSONObjectAdapterException {
    ...
    verify(mockHandler, never())
      .onComplete(any(AsynchronousResponseBody.class));
    verify(mockHandler, never()).onCancel();
  ...
  @Test
  public void testMultipleStatesThenFailure()
    throws JSONObjectAdapterException {
    // Simulate start
    AsyncMockStubber
      .callSuccessWith(jobId)
    ...
    AsyncMockStubber
      .callMixedWith(startNotReady, middleNotReady, doneNotReady, exception)
      .when(mockJsClient)
      .getAsynchJobResults(
        any(AsynchType.class),
        anyString(),
