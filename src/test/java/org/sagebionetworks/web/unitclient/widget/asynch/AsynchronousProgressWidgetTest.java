...
public class AsynchronousProgressWidgetTest {
  ...
  public void before() throws JSONObjectAdapterException {
    ...
    widget =
      new AsynchronousProgressWidget(
        mockView,
  ...
  public void testHappy() {
    ...
    verify(mockView)
      .setDeterminateProgress(0.0, "0.00%", start.getProgressMessage());
    verify(mockView)
      .setDeterminateProgress(50.00, "50.00%", middle.getProgressMessage());
    verify(mockView)
      .setDeterminateProgress(100.00, "100.00%", done.getProgressMessage());
