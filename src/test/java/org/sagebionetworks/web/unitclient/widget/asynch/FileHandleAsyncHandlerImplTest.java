...
public class FileHandleAsyncHandlerImplTest {
	...
	public void setUp() throws Exception {
		...
		fileHandleAsyncHandler = new FileHandleAsyncHandlerImpl(mockSynapseJavascriptClient, mockGwt,
				mockClientCache, mockAdapterFactory);
		resultList = new ArrayList<FileResult>();
		AsyncMockStubber.callSuccessWith(mockResult).when(mockSynapseJavascriptClient)
				.getFileHandleAndUrlBatch(any(BatchFileRequest.class), any(AsyncCallback.class));
	...
	public void testSuccess() {
		...
		fileHandleAsyncHandler.executeRequests();
		verify(mockSynapseJavascriptClient).getFileHandleAndUrlBatch(any(BatchFileRequest.class),
