...
public class UserGroupHeaderFromAliasAsyncHandlerImplTest {
	...
	public void setUp() throws Exception {
		...
		asyncHandler =
				new UserGroupHeaderFromAliasAsyncHandlerImpl(mockSynapseJavascriptClient, mockGwt);
		resultList = new ArrayList<UserGroupHeader>();
		AsyncMockStubber.callSuccessWith(resultList).when(mockSynapseJavascriptClient)
				.getUserGroupHeadersByAlias(any(ArrayList.class), any(AsyncCallback.class));
	...
	public void testSuccess() {
		...
		asyncHandler.executeRequests();
		verify(mockSynapseJavascriptClient).getUserGroupHeadersByAlias(any(ArrayList.class),
