...
public class BiodallianceWidgetTest {
  ...
  public void testConfigure() {
    ...
    verify(mockView, times(0))
      .showBiodallianceBrowser(
        ...
        anyInt(),
        anyInt(),
        any(BiodallianceConfigInterface.class),
        anyList()
      );
  ...
  public void testFileResolverURL() {
    String expectedUrl =
      BiodallianceWidget.FILE_RESOLVER_URL + "entityId=syn123&version=4";
    assertEquals(
      expectedUrl,
      BiodallianceWidget.getFileResolverURL("syn123", 4L)
    );
    assertEquals(
      expectedUrl,
      BiodallianceWidget.getFileResolverURL("syn123.4")
    );
