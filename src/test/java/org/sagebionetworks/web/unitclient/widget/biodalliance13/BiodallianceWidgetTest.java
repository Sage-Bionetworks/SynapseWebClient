...
public class BiodallianceWidgetTest {
	...
	public void before() {
		...
		widget = new BiodallianceWidget(mockView, mockAuthenticationController,
				mockGlobalApplicationState, mockHumanConfig, mockMouseConfig, mockSynAlert);
	}
	...
	public void testConfigure() {
		...
		verify(mockView, times(0)).showBiodallianceBrowser(anyString(), anyString(), anyString(),
				anyInt(), anyInt(), any(BiodallianceConfigInterface.class), anyList());
		...
		verify(mockView).showBiodallianceBrowser(anyString(), anyString(), anyString(), anyInt(),
				anyInt(), any(BiodallianceConfigInterface.class), anyList());
	}
	...
	public void testConfigureIsAlreadyAttached() {
		...
		verify(mockView).showBiodallianceBrowser(eq(BiodallianceWidget.PORTAL_URL_PREFIX), anyString(), // container
																																																		// id
				eq(BiodallianceWidget.DEFAULT_CHR), eq(BiodallianceWidget.DEFAULT_VIEW_START),
				eq(BiodallianceWidget.DEFAULT_VIEW_END), any(BiodallianceConfigInterface.class), anyList());
	}
