...
public class BiodallianceEditorTest {
  ...
  public void setup() throws Exception {
    ...
    when(mockGinInjector.getBiodallianceSourceEditor())
      .thenReturn(mockSourceEditor);
  ...
  public void testConfigure() {
    ...
    verify(mockView)
      .setViewStart(Integer.toString(BiodallianceWidget.DEFAULT_VIEW_START));
    verify(mockView)
      .setViewEnd(Integer.toString(BiodallianceWidget.DEFAULT_VIEW_END));
    // default to human
  ...
  public void testConfigureNonDefaults() {
    ...
    verify(mockSourceEditor, times(2))
  ...
  public void testUpdateFromView() {
    ...
    assertEquals(
      Species.MOUSE.name(),
      descriptor.get(WidgetConstants.BIODALLIANCE_SPECIES_KEY)
    );
  }
  ...
  private BiodallianceSourceEditor setupTrackEditor(boolean isSelected) {
    BiodallianceSourceEditor mockSourceEditor = mock(
      BiodallianceSourceEditor.class
    );
    JSONObject jsonObject = mock(JSONObject.class);
    when(mockSourceEditor.toJsonObject()).thenReturn(jsonObject);
    when(jsonObject.toString()).thenReturn(testSourceJsonString);
