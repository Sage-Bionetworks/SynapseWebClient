...
public class BiodallianceSourceEditorTest {
  ...
  public void setup() throws Exception {
    ...
    when(mockEntityFinderBuilder.build())
      .thenReturn(mockEntityFinder, mockIndexEntityFinder);
  ...
  public void testConstructorAndUpdateViewFromSource() {
    ...
    verify(mockEntityFinderBuilder, times(2))
    ...
    verify(mockView)
      .setIndexEntityFinderText(indexEntityId + "." + indexVersion);
  ...
  public void testEntitySelectedNoVersion() {
    ...
    verify(mockView)
      .setEntityFinderText(selectedEntityId + "." + currentEntityVersion);
  ...
  public void testEntitySelectedVersion() {
    ...
    verify(mockView)
      .setEntityFinderText(selectedEntityId + "." + selectedVersion);
    verify(mockEntityFinder).hide();
  }
  ...
  public void testIndexEntitySelectedNoVersion() {
    ...
    verify(mockView)
      .setIndexEntityFinderText(selectedEntityId + "." + currentEntityVersion);
  ...
  public void testIndexEntitySelectedVersion() {
    ...
    verify(mockView)
      .setIndexEntityFinderText(selectedEntityId + "." + selectedVersion);
    verify(mockIndexEntityFinder).hide();
  }
