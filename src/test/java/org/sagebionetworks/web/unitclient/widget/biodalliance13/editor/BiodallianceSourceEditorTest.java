...
public class BiodallianceSourceEditorTest {
	...
	public void setup() throws Exception {
		...
		editor = new BiodallianceSourceEditor(mockView, mockEntityFinder, mockIndexEntityFinder,
				mockSource, mockSynapseJavascriptClient);
	}

	@Test
	public void testConstructorAndUpdateViewFromSource() {
		verify(mockView).setPresenter(editor);
		verify(mockEntityFinder).configure(eq(EntityFilter.ALL_BUT_LINK), eq(true),
				any(SelectedHandler.class));
		verify(mockIndexEntityFinder).configure(eq(EntityFilter.ALL_BUT_LINK), eq(true),
				any(SelectedHandler.class));
