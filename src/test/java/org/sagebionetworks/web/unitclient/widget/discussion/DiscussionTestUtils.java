...
public class DiscussionTestUtils {
	...
	public static DiscussionThreadBundle createThreadBundle(String threadId, String title,
		...
		return createThreadBundle(threadId, null, null, title, messageKey, isEdited,
				isPinned, isDeleted, createdBy, null, null, lastActivity,
				null, activeAuthors, numberOfReplies, numberOfViews);
	}

	public static DiscussionThreadBundle createThreadBundle(String threadId,
			String projectId, String forumId, String title, String messageKey,
			Boolean isEdited, Boolean isPinned, Boolean isDeleted, String createdBy,
			Date createdOn, Date modifiedOn, Date lastActivity, String etag,
			List<String> activeAuthors, Long numberOfReplies, Long numberOfViews) {
