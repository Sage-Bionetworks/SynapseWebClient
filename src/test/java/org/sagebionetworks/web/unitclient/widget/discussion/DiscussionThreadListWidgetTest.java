...
public class DiscussionThreadListWidgetTest {
  ...
  public void before() {
    ...
    when(mockGinInjector.createThreadListItemWidget())
      .thenReturn(mockDiscussionThreadWidget);
    when(mockGinInjector.getDiscussionThreadCountAlert())
      .thenReturn(mockDiscussionThreadCountAlert);
    discussionThreadListWidget =
      new DiscussionThreadListWidget(
        mockView,
        mockGinInjector,
        mockSynAlert,
        mockThreadsContainer,
  ...
  public void testConfigureWithEntity() {
    ...
    verify(mockSynapseJavascriptClient)
      .getThreadsForEntity(
        ...
        anyLong(),
        anyLong(),
        eq(DiscussionThreadOrder.PINNED_AND_LAST_ACTIVITY),
        eq(false),
    ...
    verify(mockSynapseJavascriptClient, times(2))
      .getThreadsForEntity(
        ...
        anyLong(),
        anyLong(),
        any(DiscussionThreadOrder.class),
        anyBoolean(),
        any(DiscussionFilter.class),
        any(AsyncCallback.class)
      );
    ...
    verify(mockView, never())
      .setSorted(any(DiscussionThreadOrder.class), anyBoolean());
    ...
    verify(mockSynapseJavascriptClient)
      .getThreadsForEntity(
        ...
        anyLong(),
        anyLong(),
        eq(DiscussionThreadOrder.NUMBER_OF_REPLIES),
        eq(false),
        any(DiscussionFilter.class),
        any(AsyncCallback.class)
      );
  ...
  public void testConfigure() {
    ...
    String forumId = "123";
    discussionThreadListWidget.configure(
      forumId,
      canModerate,
      moderatorIds,
      mockEmptyListCallback,
    ...
    verify(mockSynapseJavascriptClient)
      .getThreadsForForum(
        ...
        anyLong(),
        anyLong(),
        eq(DiscussionThreadOrder.NUMBER_OF_VIEWS),
        eq(false),
        any(DiscussionFilter.class),
        any(AsyncCallback.class)
      );
  ...
  public void testConfigureWithModerator() {
    ...
    AsyncMockStubber
      .callSuccessWith(discussionThreadBundleList)
    ...
    verify(mockDiscussionThreadWidget)
      .setThreadIdClickedCallback(mockThreadIdClickedCallback);
  ...
  public void testLoadMoreSuccess() {
    ...
    verify(mockDiscussionThreadWidget, never())
      .configure(mockDiscussionThreadBundle);
  ...
  public void testSortByLastActivityRepeated() {
    ...
    discussionThreadListWidget.sortBy(
  ...
  public void testSortByTitleRepeated() {
    ...
    verify(mockSynapseJavascriptClient)
      .getThreadsForForum(
        ...
        anyLong(),
        anyLong(),
        eq(DiscussionThreadOrder.THREAD_TITLE),
        eq(DEFAULT_ASCENDING),
        any(DiscussionFilter.class),
        any(AsyncCallback.class)
      );
