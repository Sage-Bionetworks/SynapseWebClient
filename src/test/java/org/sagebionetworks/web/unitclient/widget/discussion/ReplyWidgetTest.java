...
public class ReplyWidgetTest {
  ...
  public void testConfigure() {
    ...
    DiscussionReplyBundle bundle = createReplyBundle(
      "123",
      "author",
      "messageKey",
      new Date(),
  ...
  public void testConfigureMessageSuccess() throws RequestException {
    ...
    verify(mockView).setLoadingMessageVisible(true);
    verify(mockView).setLoadingMessageVisible(false);
    verify(mockEditReplyModal, never())
      .configure(anyString(), anyString(), any(Callback.class));

    replyWidget.onClickEditReply();
    verify(mockEditReplyModal)
      .configure(anyString(), anyString(), any(Callback.class));
  ...
  public void testDeleteReplySuccess() throws RequestException {
    ...
    verify(mockDiscussionForumClientAsync)
      .markReplyAsDeleted(eq("123"), any(AsyncCallback.class));
  ...
  private DiscussionReplyBundle createReplyBundle(
    String replyId,
    String author,
    String messageKey,
    Date createdOn,
