...
public class DockerCommitListWidgetTest {
  ...
  public void before() {
    ...
    dockerCommitListWidget =
      new DockerCommitListWidget(
        mockView,
        mockJsClient,
        mockSynAlert,
        mockCommitsContainer,
        mockGinInjector,
        mockGwtWrapper
      );
    ...
    AsyncMockStubber
      .callSuccessWith(dockerCommitList)
      .when(mockJsClient)
  ...
  public void testLoadMoreSuccess() {
    boolean withRadio = false;
    when(mockGinInjector.createNewDockerCommitRowWidget())
      .thenReturn(mockCommitRow);
