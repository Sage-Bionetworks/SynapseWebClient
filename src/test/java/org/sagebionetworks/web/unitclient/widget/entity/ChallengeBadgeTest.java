...
public class ChallengeBadgeTest {
	...
	public void before() throws JSONObjectAdapterException {
		...
		AsyncMockStubber.callSuccessWith(mockChallengeProjectHeader).when(mockEntityHeaderAsyncHandler)
	...
	public void testConfigureNullProjectHeader() {
		AsyncMockStubber.callFailureWith(new NotFoundException()).when(mockEntityHeaderAsyncHandler)
				.getEntityHeader(anyString(), any(AsyncCallback.class));
		widget.configure(mockTestChallenge);
		verifyProjectId();
