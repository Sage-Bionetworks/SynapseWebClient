...
public class EditRegisterTeamDialogTest {
	...
	public void before() {
		...
		AsyncMockStubber.callSuccessWith(challengeTeam).when(mockChallengeClient)
				.updateRegisteredChallengeTeam(any(ChallengeTeam.class), any(AsyncCallback.class));
	...
	public void testConfigure() {
		...
		verify(mockChallengeClient).updateRegisteredChallengeTeam(challengeTeamCaptor.capture(),
