...
public class EntityListRowBadgeTest {
	...
	public void testCheckForInViewAndLoadData() {
		...
		// note: can't test modified on because it format it using the gwt DateUtils (calls
		// GWT.create())
	...
	public void testOnAddToDownloadList() {
		...
		verify(mockSynapseJavascriptClient).addFileToDownloadList(eq(fileHandleId), eq(entityId),
				any(AsyncCallback.class));
