...
public class EntityMetadataTest {
	...
	public void before() {
		...
		widget = new EntityMetadata(mockView, mockDoiWidgetV2, mockAnnotationsWidget, mockJsClient,
				mockJSNI, mockRestrictionWidgetV2, mockItemCountWidget, mockGinInjector);
	}
	...
	public void testConfigureStorageLocationExternalS3() {
		...
		AsyncMockStubber.callSuccessWith(uploadDestinations).when(mockJsClient)
	...
	public void testConfigureStorageLocationSynapseStorage() {
		AsyncMockStubber.callSuccessWith(null).when(mockJsClient).getUploadDestinations(anyString(),
	...
	public void testConfigureStorageLocationFailure() {
		AsyncMockStubber.callFailureWith(new Exception("This is an exception!")).when(mockJsClient)
				.getUploadDestinations(anyString(), any(AsyncCallback.class));
		widget.configureStorageLocation(folderEntity);
