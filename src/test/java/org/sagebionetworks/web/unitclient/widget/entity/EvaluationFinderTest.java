...
public class EvaluationFinderTest {
	...
	@Before
	public void before() {
		widget = new EvaluationFinder(mockView, mockPaginationWidget, mockSynAlert, mockJsClient, mockEvaluationListWidget);
	...
	public void testConfigure() {
		...
		verify(mockEvaluationListWidget).configure(evaluationListPage, expectedIsSelectable);
		...
		when(mockEvaluationListWidget.getSelectedEvaluation()).thenReturn(mockEvaluation1);
		widget.onOk();
