...
public class HtmlPreviewWidgetTest {
  ...
  public static final String SANITIZED_HTML =
  ...
  public void testRequestBuilderConfigure() {
    ...
    verify(mockRequestBuilder)
      .setHeader(WebConstants.CONTENT_TYPE, TEXT_HTML_CHARSET_UTF8);
  }
  ...
  public void testMaxFileSizeExceeded() {
    when(mockFileHandle.getContentSize())
      .thenReturn(
        new Double(HtmlPreviewWidget.MAX_HTML_FILE_SIZE + 10).longValue()
      );
