...
public class NbConvertPreviewWidgetTest {
	...
	public void before() throws Exception {
		...
		previewWidget = new NbConvertPreviewWidget(mockView, mockPresignedURLAsyncHandler,
				mockSynapseJSNIUtils, mockRequestBuilder, mockSynapseAlert, mockSynapseClient,
				mockPopupUtils, mockSynapseProperties, mockGwt);
