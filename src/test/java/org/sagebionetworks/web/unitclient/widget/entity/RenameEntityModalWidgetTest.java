...
public class RenameEntityModalWidgetTest {
	...
	public void testOnRename() {
		...
		verify(mockView).configureAndShow(eq(TITLE_PREFIX + entityDispalyType),
				eq(entityDispalyType + LABLE_SUFFIX), eq(startName), any(CallbackP.class));
	}
	...
	public void testNullName() {
		...
		verify(mockView).configureAndShow(anyString(), anyString(), anyString(),
	...
	public void testRenameHappy() {
		...
		widget.onRename(entity, mockCallback);
		AsyncMockStubber.callSuccessWith(new TableEntity()).when(mockJsClient)
