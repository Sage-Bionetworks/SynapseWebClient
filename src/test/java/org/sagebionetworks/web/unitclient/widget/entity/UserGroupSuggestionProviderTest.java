...
public class UserGroupSuggestionProviderTest {
	...
	public void testGetSuggestions() {
		ArgumentCaptor<SynapseSuggestionBundle> captor =
				ArgumentCaptor.forClass(SynapseSuggestionBundle.class);
		...
		verify(mockSynapseJavascriptClient).getUserGroupHeadersByPrefix(anyString(),
				eq(TypeFilter.TEAMS_ONLY), anyLong(), anyLong(), any(AsyncCallback.class));
	...
	public void testGetSuggestionsFailure() {
		...
		verify(mockSynapseJavascriptClient).getUserGroupHeadersByPrefix(anyString(),
				any(TypeFilter.class), anyLong(), anyLong(), any(AsyncCallback.class));
