...
public class WikiMarkdownEditorTest {
  ...
  public void before() throws JSONObjectAdapterException {
    ...
    when(mockMarkdownEditorWidget.getMarkdown())
      .thenReturn(testPageMarkdownText);
  ...
  public void testSave() {
    ...
    verify(mockSynapseClient)
      .updateV2WikiPageWithV1(
        eq(wikiPageKey.getOwnerObjectId()),
        eq(wikiPageKey.getOwnerObjectType()),
        eq(testPage),
        any(AsyncCallback.class)
      );
  }
  ...
  public void testAddAttachments()
    ...
    List<String> currentFileHandleIds = presenter
      .getWikiPage()
