...
public class AnnotationEditorTest {
  ...
  public void setUp() throws Exception {
    ...
    when(mockAnnotationCellFactory.createEditor(any(AnnotationsValue.class)))
      .thenReturn(mockCellEditor, mockCellEditor2, mockCellEditor3);
  ...
  public void testConfigureSingleValue() {
    ...
    verify(mockView)
      .configure(
        ANNOTATION_KEY,
        editor.getAnnotationTypes().indexOf(AnnotationsValueType.STRING)
      );
  }
  ...
  public void testConfigureManyValues() {
    ...
    editor.configure(ANNOTATION_KEY, annotation, null);
    verify(mockAnnotationCellFactory, times(2))
      .createEditor(any(AnnotationsValue.class));
  ...
  public void testOnTypeChange() {
    ...
    int dateIndex = editor
      .getAnnotationTypes()
      .indexOf(AnnotationsValueType.TIMESTAMP_MS);
