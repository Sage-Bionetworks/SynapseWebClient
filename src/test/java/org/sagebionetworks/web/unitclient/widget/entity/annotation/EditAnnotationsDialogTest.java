...
public class EditAnnotationsDialogTest {
  ...
  public void setUp() throws Exception {
    ...
    dialog =
      new EditAnnotationsDialog(mockView, mockJsClient, mockPortalGinInjector);
  ...
  public void testCreateAnnotationEditorAnnotationDeleteCallback() {
    ...
    ArgumentCaptor<Callback> deletedCallbackCaptor = ArgumentCaptor.forClass(
      Callback.class
    );
  ...
  public void testOnClickPasteNewValues() {
    when(mockPortalGinInjector.getCommaSeparatedValuesParser())
