...
public class EditAnnotationsDialogTest {
	...
	public void setUp() throws Exception {
		...
		AsyncMockStubber.callSuccessWith(null).when(mockJsClient).updateAnnotations(anyString(),
				any(Annotations.class), any(AsyncCallback.class));
	}
	...
	public void testOnSaveServiceCallFailure() {
		...
		AsyncMockStubber.callFailureWith(new Exception(errorMessage)).when(mockJsClient)
				.updateAnnotations(anyString(), any(Annotations.class), any(AsyncCallback.class));
