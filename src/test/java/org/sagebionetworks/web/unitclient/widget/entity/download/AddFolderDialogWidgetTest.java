...
public class AddFolderDialogWidgetTest {
	...
	public void setUp() throws Exception {
		...
		w = new AddFolderDialogWidget(mockView, mockSharingAndDataUseWidget,
				mockSynapseJavascriptClient, mockGlobalAppState, mockPopupUtils, mockSynAlert);
		when(mockFolder.getId()).thenReturn(NEW_FOLDER_ID);
		AsyncMockStubber.callSuccessWith(mockFolder).when(mockSynapseJavascriptClient)
