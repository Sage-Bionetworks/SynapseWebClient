...
public class QuizInfoDialogTest {
  ...
  public void before() throws Exception {
    ...
    widget =
      new QuizInfoDialog(mockModal, mockQuizInfo, mockGlobalApplicationState);
  }
  ...
  public void testShowAndBecomeCertifiedClick() {
    ...
    ArgumentCaptor<Dialog.Callback> callbackCaptor = ArgumentCaptor.forClass(
      Dialog.Callback.class
    );
