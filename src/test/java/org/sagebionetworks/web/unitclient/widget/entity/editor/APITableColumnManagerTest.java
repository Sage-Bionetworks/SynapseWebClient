...
public class APITableColumnManagerTest {
  ...
  public void setup() {
    ...
    when(mockGinInjector.getAPITableColumnConfigView())
      .thenReturn(mockColumnConfigEditor);
  ...
  private APITableColumnConfigView setupColumnEditor(boolean isSelected) {
    APITableColumnConfigView mockSourceEditor = mock(
      APITableColumnConfigView.class
    );
