...
public class APITableConfigTest {
  ...
  public void testTableColumnConfigsHappyCase() {
    ...
    String displayColumnName =
      "Column Name with " +
      APITableConfig.FIELD_DELIMITER +
      " delimiters" +
      APITableConfig.COLUMN_NAMES_DELIMITER;
    ...
    sb.append(APITableConfig.COLUMN_NAMES_DELIMITER);
    descriptor.put(
      WidgetConstants.API_TABLE_WIDGET_COLUMN_CONFIG_PREFIX + 0,
      sb.toString()
    );
    ...
    sb.append(APITableConfig.COLUMN_NAMES_DELIMITER);
    descriptor.put(
      WidgetConstants.API_TABLE_WIDGET_COLUMN_CONFIG_PREFIX + 1,
      sb.toString()
    );

    List<APITableColumnConfig> configs = APITableConfig.parseTableColumnConfigs(
      descriptor
    );
    ...
    assertEquals(
      ...
      firstColumn.getRendererFriendlyName()
    );
    ...
    assertEquals(
      WidgetConstants.API_TABLE_COLUMN_RENDERER_DATE,
      secondColumn.getRendererFriendlyName()
    );
  ...
  public void testTableColumnConfigsBadPartCount() {
    ...
    try {
      ...
      assertTrue(
        e
          .getMessage()
          .indexOf(WidgetConstants.API_TABLE_WIDGET_COLUMN_CONFIG_PREFIX + 0) >
        -1
      );
      throw e;
    }
  ...
  public void testUpdateDescriptorWithColumnConfigsCleanup() {
    ...
    assertNotSame(
      oldDefinition,
      descriptor.get(WidgetConstants.API_TABLE_WIDGET_COLUMN_CONFIG_PREFIX + 0)
    );
