...
public class APITableConfigTest {
	...
	public void testTableColumnConfigsHappyCase() {
		...
		String displayColumnName = "Column Name with " + APITableConfig.FIELD_DELIMITER + " delimiters"
		...
		assertEquals(WidgetConstants.API_TABLE_COLUMN_RENDERER_DATE,
	...
	public void testTableColumnConfigsBadPartCount() {
		...
		try {
			...
			assertTrue(
					e.getMessage().indexOf(WidgetConstants.API_TABLE_WIDGET_COLUMN_CONFIG_PREFIX + 0) > -1);
			throw e;
		}
	}
