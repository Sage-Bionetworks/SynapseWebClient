...
public class EntityListConfigEditorTest {
	...
	public void setup() throws Exception {
		...
		editor = new EntityListConfigEditor(mockView, mockAuthenticationController,
				mockEntityListWidget, mockEntityFinder, mockPromptForNoteModal);
	}
	...
	public void testConfigure() {
		...
		// by editing a widget, it always attempts to hide the description. but you have to touch the
		// entity list to get the update.
		assertFalse(Boolean
				.parseBoolean(descriptor.get(WidgetConstants.ENTITYLIST_WIDGET_SHOW_DESCRIPTION_KEY)));
	...
	public void testAddRecord() throws Exception {
		...
		ArgumentCaptor<EntityGroupRecord> recordCaptor =
				ArgumentCaptor.forClass(EntityGroupRecord.class);
	...
	public void testUpdateNote() {
		...
		verify(mockPromptForNoteModal).configureAndShow(eq(EntityListConfigEditor.NOTE),
				eq(EntityListConfigEditor.PROMPT_ENTER_NOTE), eq(existingNote),
