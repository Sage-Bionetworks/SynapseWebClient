...
public class QueryTableConfigEditorTest {
  ...
  public void setup() throws JSONObjectAdapterException {
    ...
    descriptor.put(
      WidgetConstants.API_TABLE_WIDGET_PATH_KEY,
  ...
  public void testConfigure() {
    ...
    ArgumentCaptor<APITableConfig> captor = ArgumentCaptor.forClass(
      APITableConfig.class
    );
  ...
  public void testUpdateDescriptorFromView() {
    ...
    editor.updateDescriptorFromView();
    assertEquals(
      ClientProperties.QUERY_SERVICE_PREFIX + newQuery,
      descriptor.get(WidgetConstants.API_TABLE_WIDGET_PATH_KEY)
    );
    assertEquals(
      isPaging.toString(),
      descriptor.get(WidgetConstants.API_TABLE_WIDGET_PAGING_KEY)
    );
    assertEquals(
      QueryTableConfigEditor.DEFAULT_PAGE_SIZE,
  ...
  public void testAutoAddColumns() {
    ...
    String columnConfig1Name = columnConfig1
      .getInputColumnNames()
      .iterator()
      .next();
    String columnConfig2Name = columnConfig2
      .getInputColumnNames()
      .iterator()
      .next();
    assertTrue(
      columnConfig1Name.equals(col1Name) || columnConfig1Name.equals(col2Name)
    );
    assertTrue(
      columnConfig2Name.equals(col1Name) || columnConfig2Name.equals(col2Name)
    );
