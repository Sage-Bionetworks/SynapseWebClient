...
public class QueryTableConfigEditorTest {
	...
	public void setup() throws JSONObjectAdapterException {
		...
		fillInResult(result1, new String[] {col1Name, col2Name},
				new String[] {"result1 value 1", "result1 value 2"});
		JSONObjectAdapter result2 = testReturnJSONObject.createNew();
		fillInResult(result2, new String[] {col1Name, col2Name},
		...
		descriptor.put(WidgetConstants.API_TABLE_WIDGET_PATH_KEY,
				ClientProperties.QUERY_SERVICE_PREFIX + testQuery);
	...
	public void testUpdateDescriptorFromView() {
		...
		editor.updateDescriptorFromView();
		assertEquals(ClientProperties.QUERY_SERVICE_PREFIX + newQuery,
				descriptor.get(WidgetConstants.API_TABLE_WIDGET_PATH_KEY));
		assertEquals(isPaging.toString(), descriptor.get(WidgetConstants.API_TABLE_WIDGET_PAGING_KEY));
		assertEquals(QueryTableConfigEditor.DEFAULT_PAGE_SIZE,
				descriptor.get(WidgetConstants.API_TABLE_WIDGET_PAGESIZE_KEY));
	}
	...
	public void testAutoAddColumns() {
		...
		assertTrue(columnConfig1Renderer.equals(WidgetConstants.API_TABLE_COLUMN_RENDERER_USER_ID)
				|| columnConfig1Renderer.equals(WidgetConstants.API_TABLE_COLUMN_RENDERER_EPOCH_DATE));
		assertTrue(columnConfig2Renderer.equals(WidgetConstants.API_TABLE_COLUMN_RENDERER_USER_ID)
				|| columnConfig2Renderer.equals(WidgetConstants.API_TABLE_COLUMN_RENDERER_EPOCH_DATE));
	}
}
