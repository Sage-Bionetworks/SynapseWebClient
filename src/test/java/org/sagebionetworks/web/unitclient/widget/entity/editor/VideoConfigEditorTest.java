...
public class VideoConfigEditorTest {
	...
	public void setup() {
		...
		AsyncMockStubber.callSuccessWith(mockBundle).when(mockSynapseJavascriptClient)
	...
	public void testValidateSelectionMP4() {
		...
		verify(mockSynapseJavascriptClient).getEntityBundle(eq(selectedEntityId),
