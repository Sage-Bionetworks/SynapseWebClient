...
public class VideoConfigEditorTest {
  ...
  public void setup() {
    ...
    when(mockSelectedEntityReference.getTargetId())
      .thenReturn(selectedEntityId);
  }
  ...
  public void testValidateSelectionInvalidType() {
    ...
    verify(mockView).setVideoFormatWarningVisible(true);
    verify(mockView)
      .showFinderError(VideoConfigEditor.UNRECOGNIZED_VIDEO_FORMAT_MESSAGE);
  ...
  public void testConfigureVimeo() {
    ...
    when(mockView.getVimeoVideoUrl())
      .thenReturn("https://player.vimeo.com/video/9730308");
    Map<String, String> descriptor = new HashMap<String, String>();
    ...
    verify(mockView)
      .setVimeoVideoUrl(VideoConfigEditor.VIMEO_URL_PREFIX + videoId);
  ...
  public void testConfigureYouTube() {
    when(mockView.getYouTubeVideoUrl())
      .thenReturn("http://www.youtube.com/watch?v=G0k3kHtyoqc");
    Map<String, String> descriptor = new HashMap<String, String>();
    String videoId = "my test video id";
    descriptor.put(WidgetConstants.YOUTUBE_WIDGET_VIDEO_ID_KEY, videoId);
    editor.configure(wikiKey, descriptor, null);
    verify(mockView)
      .setYouTubeVideoUrl(VideoConfigEditor.YOUTUBE_URL_PREFIX + videoId);
