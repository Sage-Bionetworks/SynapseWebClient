...
public class FileHandleAssociationTableTest {
	...
	public void testConfigure() {
		...
		verify(mockRow1).configure(eq(mockFha1), callbackCaptor.capture(),
				eq(mockAddToPackageSizeCallback), eq(mockOnRemoveCallback));
		verify(mockRow2).configure(eq(mockFha2), callbackCaptor.capture(),
				eq(mockAddToPackageSizeCallback), eq(mockOnRemoveCallback));
