...
public class WidgetEncodingUtilTest {
  ...
  public void testRoundTripEncodeDecode() {
    ...
    assertEquals(
      "hi",
      WidgetEncodingUtil.decodeValue(WidgetEncodingUtil.encodeValue("hi"))
    );
    assertEquals(
      "123",
      WidgetEncodingUtil.decodeValue(WidgetEncodingUtil.encodeValue("123"))
    );
    assertEquals(
      "1234",
      WidgetEncodingUtil.decodeValue(WidgetEncodingUtil.encodeValue("1234"))
    );
    assertEquals(
      "123$",
      WidgetEncodingUtil.decodeValue(WidgetEncodingUtil.encodeValue("123$"))
    ...
    assertEquals(
      "$1$2$",
      WidgetEncodingUtil.decodeValue(WidgetEncodingUtil.encodeValue("$1$2$"))
    );
    assertEquals(
      "$1$2$3",
    ...
    assertEquals(
      "$1$2$3456",
      WidgetEncodingUtil.decodeValue(
        WidgetEncodingUtil.encodeValue("$1$2$3456")
      )
    );
    assertEquals(
      "syn1234/version/5",
      WidgetEncodingUtil.decodeValue(
        WidgetEncodingUtil.encodeValue("syn1234/version/5")
      )
    ); // regression test
  }
