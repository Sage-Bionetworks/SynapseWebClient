...
public class WidgetRegistrarImplTest {
  ...
  public void testCreateWidgets() {
    widgetRegistrar.getWidgetRendererForWidgetDescriptorAfterLazyLoad(
      WidgetConstants.YOUTUBE_CONTENT_TYPE
    );
    verify(mockGinInjector).getVideoWidget();
    widgetRegistrar.getWidgetRendererForWidgetDescriptorAfterLazyLoad(
      WidgetConstants.IMAGE_CONTENT_TYPE
    );
  ...
  public void testCreateInvalidWidget() {
    widgetRegistrar.getWidgetRendererForWidgetDescriptorAfterLazyLoadAndCodeSplit(
      "invalid wiki widget type",
      mockRendererAsyncCallback
    );
  ...
  public void testCreateWidgetEditors() {
    widgetRegistrar.getWidgetEditorForWidgetDescriptor(
      null,
      WidgetConstants.YOUTUBE_CONTENT_TYPE,
      null,
      null
  ...
  public void testGetWidgetDescriptorWithNull()
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testGetWidgetDescriptorWithEmpty()
    throws JSONObjectAdapterException {
    // from MD representation, verify that various widget descriptors can be constructed
  ...
  @Test
  public void testGetWidgetDescriptorNoParams()
    throws JSONObjectAdapterException {
    // from MD representation, verify that various widget descriptors can be constructed
  ...
  @Test
  public void testGetMDRepresentationDecoded()
    throws JSONObjectAdapterException {
    String aTestFilename = "getMDRepresentationDecodedTest.png";
    testImageWidgetDescriptor.put(
      WidgetConstants.IMAGE_WIDGET_FILE_NAME_KEY,
      aTestFilename
    );
    String actualResult = widgetRegistrar.getMDRepresentation(
      WidgetConstants.IMAGE_CONTENT_TYPE,
    ...
    Assert.assertEquals(
      WidgetConstants.IMAGE_CONTENT_TYPE +
      "?fileName=getMDRepresentationDecodedTest%2Epng",
      actualResult
    );
  }
}
