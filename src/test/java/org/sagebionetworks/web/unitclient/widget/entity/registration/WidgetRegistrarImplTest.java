...
public class WidgetRegistrarImplTest {
	...
	public void testCreateWidgets() {
		widgetRegistrar
				.getWidgetRendererForWidgetDescriptorAfterLazyLoad(WidgetConstants.YOUTUBE_CONTENT_TYPE);
		verify(mockGinInjector).getVideoWidget();
		widgetRegistrar
				.getWidgetRendererForWidgetDescriptorAfterLazyLoad(WidgetConstants.IMAGE_CONTENT_TYPE);
		...
		widgetRegistrar.getWidgetRendererForWidgetDescriptorAfterLazyLoad(
				WidgetConstants.IMAGE_LINK_EDITOR_CONTENT_TYPE);
		verify(mockGinInjector).getImageRenderer();
		widgetRegistrar
				.getWidgetRendererForWidgetDescriptorAfterLazyLoad(WidgetConstants.PROVENANCE_CONTENT_TYPE);
		verify(mockGinInjector).getProvenanceRenderer();
		widgetRegistrar
				.getWidgetRendererForWidgetDescriptorAfterLazyLoad(WidgetConstants.API_TABLE_CONTENT_TYPE);
		widgetRegistrar.getWidgetRendererForWidgetDescriptorAfterLazyLoad(
				WidgetConstants.QUERY_TABLE_CONTENT_TYPE);
		widgetRegistrar.getWidgetRendererForWidgetDescriptorAfterLazyLoad(
	...
	public void testCreateInvalidWidget() {
		widgetRegistrar.getWidgetRendererForWidgetDescriptorAfterLazyLoadAndCodeSplit(
				"invalid wiki widget type", mockRendererAsyncCallback);
		verify(mockRendererAsyncCallback).onFailure(any(NotFoundException.class));
	}

	@Test
	public void testCreateWidgetEditors() {
		widgetRegistrar.getWidgetEditorForWidgetDescriptor(null, WidgetConstants.YOUTUBE_CONTENT_TYPE,
				null, null);
		verify(mockGinInjector).getVideoConfigEditor();
		widgetRegistrar.getWidgetEditorForWidgetDescriptor(null, WidgetConstants.IMAGE_CONTENT_TYPE,
				null, null);
		verify(mockGinInjector).getImageConfigEditor();
		widgetRegistrar.getWidgetEditorForWidgetDescriptor(null,
				WidgetConstants.IMAGE_LINK_EDITOR_CONTENT_TYPE, null, null);
		verify(mockGinInjector).getImageLinkConfigEditor();
		widgetRegistrar.getWidgetEditorForWidgetDescriptor(null,
				WidgetConstants.PROVENANCE_CONTENT_TYPE, null, null);
	...
	public void testGetWidgetDescriptor() throws JSONObjectAdapterException {
		...
		Map<String, String> actualWidgetDescriptor = widgetRegistrar
				.getWidgetDescriptor(WidgetConstants.IMAGE_CONTENT_TYPE + "?fileName=" + testFileName);
		Assert.assertEquals(testFileName,
	...
	public void testGetMDRepresentationDecoded() throws JSONObjectAdapterException {
		...
		String actualResult = widgetRegistrar.getMDRepresentation(WidgetConstants.IMAGE_CONTENT_TYPE,
				testImageWidgetDescriptor);
		...
		Assert.assertEquals(
				WidgetConstants.IMAGE_CONTENT_TYPE + "?fileName=getMDRepresentationDecodedTest%2Epng",
				actualResult);
	}
