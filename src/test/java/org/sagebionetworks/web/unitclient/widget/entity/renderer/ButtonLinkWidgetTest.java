...
public class ButtonLinkWidgetTest {
  ...
  public void setup() {
    ...
    widget =
      new ButtonLinkWidget(
        mockView,
        mockGwt,
        mockAuthController,
        mockAppPlaceHistoryMapper,
        mockJsClient
      );
  ...
  public void testOverrideOpenNewWindowTrue() {
    Map<String, String> descriptor = getDefaultDescriptor();
    descriptor.put(
      ButtonLinkWidget.LINK_OPENS_NEW_WINDOW,
  ...
  public void testConfigureLoggedInIncludePrincipalIdTrueWithoutOtherParams() {
    ...
    verify(mockView)
      .configure(
        ...
        eq(buttonText),
        eq(
          validExternalUrl + "?" + SYNAPSE_USER_ID_QUERY_PARAM + currentUserId
        ),
        eq(false),
        eq(true)
      );
  ...
  public void testConfigureLoggedInIncludePrincipalIdTrueWithOtherParams() {
    ...
    verify(mockView)
      .configure(
        eq(wikiKey),
        eq(buttonText),
        eq(originalUrl + "&" + SYNAPSE_USER_ID_QUERY_PARAM + currentUserId),
        eq(false),
        eq(true)
      );
  }
