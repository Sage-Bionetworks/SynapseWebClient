...
public class ChallengeParticipantsWidgetTest {
	...
	public void before() throws RestServiceException, JSONObjectAdapterException {
		...
		AsyncMockStubber.callSuccessWith(getTestUserProfilePagedResults()).when(mockChallengeClient)
				.getChallengeParticipants(anyBoolean(), anyString(), anyInt(), anyInt(),
	...
	public void testHappyCaseConfigure() throws Exception {
		...
		verify(mockChallengeClient).getChallengeParticipants(anyBoolean(), anyString(), anyInt(),
	...
	public void testHappyCaseNoParticipants() throws Exception {
		AsyncMockStubber.callSuccessWith(getEmptyUserProfilePagedResults()).when(mockChallengeClient)
				.getChallengeParticipants(anyBoolean(), anyString(), anyInt(), anyInt(),
						any(AsyncCallback.class));
		widget.configure(new WikiPageKey(entityId, ObjectType.ENTITY.toString(), null), descriptor,
				null, null);
