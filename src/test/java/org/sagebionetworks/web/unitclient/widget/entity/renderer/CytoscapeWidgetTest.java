...
public class CytoscapeWidgetTest {
	...
	public void setup() throws RequestException {
		...
		widget = new CytoscapeWidget(mockView, mockAuthenticationController, mockRequestBuilder,
				mockSynAlert, mockSynapseJsniUtils);
	...
	public void testConfigureFailure() throws RequestException {
		...
		RequestBuilderMockStubber.callOnError(null, e).when(mockRequestBuilder).sendRequest(anyString(),
