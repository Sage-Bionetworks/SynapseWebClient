...
public class PDFPreviewWidgetTest {
	...
	public void testConfigure() {
		...
		verify(mockView).configure(PDFPreviewWidget.PDF_JS_VIEWER_PREFIX + encodedPresignedUrl,
				parentOffsetHeight);
	}
	...
	public void testMaxFileSizeExceeded() {
		...
		when(mockFileHandle.getContentSize())
				.thenReturn(new Double(PDFPreviewWidget.MAX_PDF_FILE_SIZE + 10).longValue());
