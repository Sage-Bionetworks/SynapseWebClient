...
public class RegisterChallengeTeamWidgetTest {
  ...
  public static final String CUSTOM_BUTTON_TEXT =
    "register a team for this challenge";
  ...
  public void before() throws RestServiceException, JSONObjectAdapterException {
    ...
    when(mockPortalGinInjector.getRegisterTeamDialog())
      .thenReturn(mockRegisterTeamDialog);
    ...
    widget =
      new RegisterChallengeTeamWidget(
        mockView,
  ...
  public void testHappyCaseConfigureDefaultButtonText() throws Exception {
    ...
    verify(mockView)
      .setButtonText(RegisterChallengeTeamWidget.DEFAULT_BUTTON_TEXT);
  }
