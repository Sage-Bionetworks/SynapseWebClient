...
public class SynapseTableFormWidgetTest {
	...
	public void setup() throws RequestException {
		...
		widget = new SynapseTableFormWidget(mockView, mockSynAlert, mockRowFormWidget,
				mockAsynchronousJobTracker, mockUserBadge, mockSynapseJavascriptClient);
	...
	public void testConfigure() {
		...
		verify(mockSynapseJavascriptClient).getColumnModelsForTableEntity(eq(TABLE_ID),
	...
	public void testConfigureFailure() throws RequestException {
		...
		AsyncMockStubber.callFailureWith(e).when(mockSynapseJavascriptClient)
				.getColumnModelsForTableEntity(anyString(), any(AsyncCallback.class));
		widget.configure(wikiKey, descriptor, null, null);
	...
	public void testOnSubmitInvalid() throws RequestException {
		...
		verify(mockAsynchronousJobTracker, never()).startAndTrack(any(AsynchType.class),
				any(AsynchronousRequestBody.class), anyInt(), any(UpdatingAsynchProgressHandler.class));
	}
	...
	public void testOnSubmitOnFailure() throws RequestException {
		...
		verify(mockAsynchronousJobTracker).startAndTrack(any(AsynchType.class),
				any(AsynchronousRequestBody.class), anyInt(), captor.capture());
	...
	public void testOnSubmitAndReset() {
		...
		verify(mockSynapseJavascriptClient, times(2)).getColumnModelsForTableEntity(eq(TABLE_ID),
				any(AsyncCallback.class));
