...
public class WikiSubpageNavigationTreeTest {
  ...
  public void testConfigure() {
    ...
    WikiPageKey aWikiPageKey = new WikiPageKey(
      currentWikiKey.getOwnerObjectId(),
      currentWikiKey.getOwnerObjectType(),
      "0",
      currentWikiKey.getVersion()
    );
    WikiPageKey bWikiPageKey = new WikiPageKey(
      currentWikiKey.getOwnerObjectId(),
      currentWikiKey.getOwnerObjectType(),
      "1",
      currentWikiKey.getVersion()
    );
    WikiPageKey cWikiPageKey = new WikiPageKey(
      currentWikiKey.getOwnerObjectId(),
      currentWikiKey.getOwnerObjectType(),
      "2",
      currentWikiKey.getVersion()
    );
    WikiPageKey dWikiPageKey = new WikiPageKey(
      currentWikiKey.getOwnerObjectId(),
      currentWikiKey.getOwnerObjectType(),
      "3",
      currentWikiKey.getVersion()
    );
    WikiPageKey eWikiPageKey = new WikiPageKey(
      currentWikiKey.getOwnerObjectId(),
      currentWikiKey.getOwnerObjectType(),
      "4",
      currentWikiKey.getVersion()
    ...
    assertEquals(
      ...
      Arrays.asList(
        aNode.getWikiPageKey(),
        bNode.getWikiPageKey(),
        cNode.getWikiPageKey(),
        dNode.getWikiPageKey(),
        eNode.getWikiPageKey()
      )
    );
  ...
  private void testReloadWikiForNode(
    SubpageNavTreeNode aNode,
    SubpageNavTreeNode root,
    int time
  ) {
  ...
  private void testTreeStructure(
    SubpageNavTreeNode aNode,
    SubpageNavTreeNode bNode,
    SubpageNavTreeNode cNode,
    SubpageNavTreeNode dNode,
    SubpageNavTreeNode eNode
  ) {
