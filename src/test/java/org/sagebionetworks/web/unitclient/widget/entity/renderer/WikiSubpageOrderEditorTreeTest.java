...
public class WikiSubpageOrderEditorTreeTest {
  ...
  public void before() {
    ...
    tree =
      new WikiSubpageOrderEditorTree(
        mockView,
        mockSynAlert,
    ...
    AsyncMockStubber
      ...
      .updateV2WikiOrderHint(
        any(WikiPageKey.class),
        any(V2WikiOrderHint.class),
        any(AsyncCallback.class)
      );
    AsyncMockStubber
      .callSuccessWith(mockV2WikiPage)
      .when(mockSynapseJavascriptClient)
      .updateV2WikiPage(
        any(WikiPageKey.class),
        any(V2WikiPage.class),
        any(AsyncCallback.class)
      );
    AsyncMockStubber
      .callSuccessWith(mockV2WikiPage)
  ...
  public void testSelectTreeItem() {
    ...
    SubpageOrderEditorTreeNode c = tree
      .getOverallRoot()
      .getChildren()
      .get(0)
      .getChildren()
  ...
  public void testMoveSelectedItemLeft() {
    ...
    verify(mockSynapseJavascriptClient)
      .getV2WikiPage(wikiPageKeyCaptor.capture(), any(AsyncCallback.class));
