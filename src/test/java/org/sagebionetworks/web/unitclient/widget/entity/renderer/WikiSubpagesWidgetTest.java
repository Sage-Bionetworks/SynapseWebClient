...
public class WikiSubpagesWidgetTest {
  ...
  public void before() throws JSONObjectAdapterException {
    ...
    AsyncMockStubber
      .callSuccessWith(wikiHeadersList)
      .when(mockSynapseJavascriptClient)
      .getV2WikiHeaderTree(anyString(), anyString(), any(AsyncCallback.class));
    AsyncMockStubber
      .callSuccessWith(mockV2WikiOrderHint)
      .when(mockSynapseJavascriptClient)
  ...
  public void testGetLinkPlaceSynapse() throws Exception {
    ...
    Place targetPlace = WikiSubpagesWidget.getLinkPlace(
      targetEntityId,
      targetEntityVersion,
      targetWikiId,
      embeddedInOwnerPage
  ...
  public void testConfigureDifferentEntity() throws Exception {
    ...
    widget.configure(
      new WikiPageKey(entityId2, ObjectType.ENTITY.toString(), null),
      false,
      null,
      mockActionMenuWidget
    );
  ...
  public void testConfigureSameEntityViewContainsWikiPageId() throws Exception {
    ...
    widget.configure(
      new WikiPageKey(entityId, ObjectType.ENTITY.toString(), wikiPageId),
      false,
      null,
      mockActionMenuWidget
    );
  ...
  @Test
  public void testConfigureViewContainsWikiPageIdChangeEntityName()
    throws Exception {
    widget.configure(
      new WikiPageKey(entityId, ObjectType.ENTITY.toString(), null),
      false,
  ...
  @Test
  public void testConfigureViewContainsWikiPageAndTreeChanged()
    throws Exception {
    widget.configure(
      new WikiPageKey(entityId, ObjectType.ENTITY.toString(), null),
      false,
    ...
    when(mockView.contains(eq(wikiPageId))).thenReturn(true);
    AsyncMockStubber
      .callSuccessWith(Collections.singletonList(mockWikiHeader))
      .when(mockSynapseJavascriptClient)
      .getV2WikiHeaderTree(anyString(), anyString(), any(AsyncCallback.class));
