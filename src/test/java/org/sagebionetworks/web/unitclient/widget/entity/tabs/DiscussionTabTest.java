...
public class DiscussionTabTest {
	...
	public void setUp() {
		...
		when(mockSynapseProperties.getSynapseProperty(WebConstants.FORUM_SYNAPSE_ID_PROPERTY))
	...
	public void testConfigure() {
		...
		verify(mockForumWidget).configure(anyString(), any(ParameterizedToken.class), anyBoolean(),
				eq(mockActionMenuWidget), paramCaptor.capture(), any(Callback.class));
