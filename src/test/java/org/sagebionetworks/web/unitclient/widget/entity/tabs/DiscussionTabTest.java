...
public class DiscussionTabTest {
  ...
  public void testConfigure() {
    ...
    ArgumentCaptor<CallbackP> paramCaptor = ArgumentCaptor.forClass(
      CallbackP.class
    );
    ...
    verifyNoInteractions(mockPlaceChanger);
  }
  ...
  public void testConfigureSynapseForum() {
    ...
    ArgumentCaptor<SynapseForumPlace> captor = ArgumentCaptor.forClass(
