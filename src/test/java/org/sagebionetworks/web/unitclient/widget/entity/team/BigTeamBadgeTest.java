...
public class BigTeamBadgeTest {
	...
	public void setUp() throws Exception {
		presenter = new BigTeamBadge(mockView, mockJsClient, mockAuthenticationController,
	...
	public void testGetTeamEmail() {
		...
		assertEquals("StandardCaseHere@synapse.org",
				presenter.getTeamEmail("Standard Case Here", canSendEmail));
		assertEquals("unlikelycase@synapse.org",
				presenter.getTeamEmail(" \n\r unlikely\t case ", canSendEmail));
		assertEquals("Another_UnlikelyCase@synapse.org",
				presenter.getTeamEmail(" %^$##* Another_Unlikely\t &*#$)(!!@~Case ", canSendEmail));
