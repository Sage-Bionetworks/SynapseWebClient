...
public class JoinTeamWidgetTest {
  ...
  public void before() throws JSONObjectAdapterException {
    ...
    joinWidget.configure(
      teamId,
      false,
      status,
      mockTeamUpdatedCallback,
      null,
      null,
      null,
      null,
  ...
  public void testJoinRequestStep1() throws Exception {
    ...
    verify(mockWikiPageWidget)
      .loadMarkdownFromWikiPage(any(WikiPageKey.class), eq(false));
  ...
  public void testJoinRequestStep2WithNullRestrictionText() throws Exception {
    ...
    verify(mockView).setCurrentWizardContent(mockWikiPageWidget);
    verify(mockWikiPageWidget)
      .loadMarkdownFromWikiPage(any(WikiPageKey.class), eq(true));
  }

  @Test
  public void testJoinRequestStep2WithNullActRestrictionText()
    throws Exception {
  ...
  @Test
  public void testJoinRequestStep2WithManagedActRestrictionText()
    throws Exception {
  ...
  public void testJoinRequestStep2NoRestriction() throws Exception {
    ...
    verify(mockWizardProgress, never())
  ...
  public void testShowChallengeInfoParam() throws Exception {
    ...
    descriptor.put(
      WebConstants.JOIN_WIDGET_IS_CHALLENGE_KEY,
      Boolean.TRUE.toString()
    );
    joinWidget.configure(null, descriptor, mockWidgetRefreshRequired, null);
    Assert.assertTrue(joinWidget.isChallengeSignup());
  ...
  public void testSetLicenseAccepted() throws Exception {
    ...
    ArgumentCaptor<Callback> callbackArg = ArgumentCaptor.forClass(
      Callback.class
    );
  ...
  public void testIsRecognizedSite() {
    if (JoinTeamWidget.EXTRA_INFO_URL_WHITELIST.length > 0) {
      ...
      // but not other sites
      assertFalse(
        JoinTeamWidget.isRecognizedSite(
          "http://mpmdev.ondemand.sas.com/projectdatasphere/html/registration/challenge"
        )
      ); // not https
      assertFalse(
        JoinTeamWidget.isRecognizedSite(
          "https://www.jayhodgson.com/projectdatasphere/"
        )
      );
    }
  }
  ...
  public void testGetEncodedParamValueIfDefined() {
    ...
    assertEquals(
      WebConstants.USER_ID_PARAM + "=encodedbar&",
