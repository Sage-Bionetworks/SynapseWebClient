...
public class OpenMembershipRequestsWidgetTest {
  ...
  public void before() {
    ...
    widget =
      new OpenMembershipRequestsWidget(
        mockView,
        mockSynapseClient,
    ...
    AsyncMockStubber
      .callSuccessWith(membershipRequests)
    ...
    when(mockJsClient.deleteMembershipRequest(anyString()))
  ...
  public void testConfigure() {
    ...
    verify(mockSynapseClient)
      .getOpenRequests(eq(TEAM_ID), any(AsyncCallback.class));
  ...
  public void testConfigureFailure() {
    ...
    verify(mockView, never())
      .configure(anyList(), anyList(), anyList(), anyList());
  ...
  public void testAcceptRequest() {
    ...
    verify(mockPopupUtils)
      .showInfo(OpenMembershipRequestsWidget.ACCEPTED_REQUEST_MESSAGE);
  ...
  public void testDeleteRequest() {
    ...
    verify(mockPopupUtils)
      .showInfo(OpenMembershipRequestsWidget.DELETED_REQUEST_MESSAGE);
    verify(mockCallback).invoke();
  }
