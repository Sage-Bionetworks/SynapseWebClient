...
public class OpenUserInvitationsWidgetTest {
	...
	public void before() throws JSONObjectAdapterException {
		...
		widget = new OpenUserInvitationsWidget(mockView, mockSynapseClient, mockGlobalApplicationState,
				mockSynapseAlert, mockGWT, mockDateTimeUtils, mockJsClient, mockPopupUtils,
				mockGinInjector);
		...
		AsyncMockStubber.callSuccessWith(testReturn).when(mockSynapseClient)
				.getOpenTeamInvitations(anyString(), anyInt(), anyInt(), any(AsyncCallback.class));
		AsyncMockStubber.callSuccessWith(null).when(mockJsClient)
				.deleteMembershipInvitation(anyString(), any(AsyncCallback.class));
		AsyncMockStubber.callSuccessWith(null).when(mockSynapseClient).resendTeamInvitation(anyString(),
	...
	public void testConfigure() throws Exception {
		...
		verify(mockSynapseClient).getOpenTeamInvitations(anyString(), anyInt(), anyInt(),
				any(AsyncCallback.class));
		verify(mockView, times(1)).addInvitation(eq(mockUserBadge), eq(null), eq(testInvite.getId()),
				eq(testInvite.getMessage()), anyString());
	...
	public void testEmptyResults() {
		AsyncMockStubber.callSuccessWith(new ArrayList<>()).when(mockSynapseClient)
				.getOpenTeamInvitations(anyString(), anyInt(), anyInt(), any(AsyncCallback.class));
		widget.configure(teamId, mockTeamUpdatedCallback);
	...
	public void testConfigureMultipleInvitations() {
		...
		verify(mockSynapseClient).getOpenTeamInvitations(anyString(), anyInt(), anyInt(),
				any(AsyncCallback.class));
		verify(mockView, times(invitationCount)).addInvitation(eq(mockUserBadge), eq(null),
				eq(testInvite.getId()), eq(testInvite.getMessage()), anyString());
		verify(mockGWT).restoreWindowPosition();
	}
	...
	public void testConfigureMultipleEmailInvitations() {
		...
		verify(mockSynapseClient).getOpenTeamInvitations(anyString(), anyInt(), anyInt(),
				any(AsyncCallback.class));
		verify(mockView, times(emailInvitationCount)).addInvitation(eq(mockEmailInvitationBadge),
				eq(null), eq(testEmailInvite.getId()), eq(testEmailInvite.getMessage()), anyString());
		verify(mockGWT).restoreWindowPosition();
	}
	...
	public void testConfigureMixedInvitations() {
		...
		verify(mockSynapseClient).getOpenTeamInvitations(anyString(), anyInt(), anyInt(),
				any(AsyncCallback.class));
		verify(mockView, times(userInvitationCount)).addInvitation(eq(mockUserBadge),
				eq(testInvite.getInviteeEmail()), eq(testInvite.getId()), eq(testInvite.getMessage()),
				anyString());
		verify(mockView, times(emailInvitationCount)).addInvitation(eq(mockEmailInvitationBadge),
				eq(null), eq(testEmailInvite.getId()), eq(testEmailInvite.getMessage()), anyString());
		verify(mockGWT).restoreWindowPosition();
	...
	public void testConfigureFailure() throws Exception {
		...
		AsyncMockStubber.callFailureWith(ex).when(mockSynapseClient).getOpenTeamInvitations(anyString(),
	...
	public void testDeleteOpenInvite() throws Exception {
		...
		verify(mockSynapseClient).getOpenTeamInvitations(anyString(), anyInt(), eq(expectedOffset),
				any(AsyncCallback.class));
		...
		verify(mockSynapseClient, times(2)).getOpenTeamInvitations(anyString(), anyInt(),
				eq(expectedOffset), any(AsyncCallback.class));
	}
	...
	public void testDeleteOpenInviteFailure() throws Exception {
		String invitationId = "123";
		Exception ex = new Exception("unhandled exception");
		AsyncMockStubber.callFailureWith(ex).when(mockJsClient).deleteMembershipInvitation(anyString(),
				any(AsyncCallback.class));
		widget.configure(teamId, mockTeamUpdatedCallback);
		widget.removeInvitation(invitationId);
		verify(mockJsClient).deleteMembershipInvitation(eq(invitationId), any(AsyncCallback.class));
	...
	public void testMoreResultsAvailableGetNextBatch() throws Exception {
		...
		verify(mockSynapseClient).getOpenTeamInvitations(anyString(),
				eq(OpenUserInvitationsWidget.INVITATION_BATCH_LIMIT), eq(0), any(AsyncCallback.class));
		...
		verify(mockSynapseClient).getOpenTeamInvitations(anyString(),
				eq(OpenUserInvitationsWidget.INVITATION_BATCH_LIMIT),
				eq(OpenUserInvitationsWidget.INVITATION_BATCH_LIMIT), any(AsyncCallback.class));
	}
	...
	public void testResendOpenInvite() throws Exception {
		...
		verify(mockGWT).saveWindowPosition();
		verify(mockSynapseClient).resendTeamInvitation(eq(invitationId), anyString(),
				any(AsyncCallback.class));
	...
	public void testResendOpenInviteFailure() throws Exception {
		String invitationId = "123";
		Exception ex = new Exception("unhandled exception");
		AsyncMockStubber.callFailureWith(ex).when(mockSynapseClient).resendTeamInvitation(anyString(),
				anyString(), any(AsyncCallback.class));
		widget.configure(teamId, mockTeamUpdatedCallback);
