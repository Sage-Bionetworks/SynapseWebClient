...
public class TeamEditModalWidgetTest {
  ...
  public static final String FILE_HANDLE_ASSOCIATION_URL =
    "http://file.handle.association/";
  ...
  public void setup() {
    ...
    when(mockPortalGinInjector.getCroppedImageUploadView())
      .thenReturn(mockImageUploadView);
    when(
    ...
    ArgumentCaptor<Callback> startedUploadingCaptor = ArgumentCaptor.forClass(
      Callback.class
    );
    ...
    ArgumentCaptor<CallbackP> finishedUploadingCaptor = ArgumentCaptor.forClass(
      CallbackP.class
    );
    ...
    when(
      ...
      .thenReturn(FILE_HANDLE_ASSOCIATION_URL);
  }
  ...
  public static void addCanMessageTeam(
    Long principalId,
    ...
    ra.setAccessType(
      AclUtils.getACCESS_TYPEs(PermissionLevel.CAN_MESSAGE_TEAM)
    );
