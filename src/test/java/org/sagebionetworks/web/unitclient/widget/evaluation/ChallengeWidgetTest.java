...
public class ChallengeWidgetTest {
	...
	public void setup() throws Exception {
		widget = new ChallengeWidget(mockView, mockChallengeClient, mockSynAlert, mockTeamBadge,
				mockSelectTeamModal, submitToChallengeWidget);

		AsyncMockStubber.callSuccessWith(mockChallenge).when(mockChallengeClient)
