...
public class FooterTest {
	...
	public void setup() {
		...
		AsyncMockStubber.callSuccessWith(versionState).when(mockGlobalAppState)
	...
	public void testOnReportAbuse() {
		...
		verify(mockJsniUtils).showJiraIssueCollector("", // summary
				...
				DisplayUtils.getDisplayName(FIRST_NAME, LAST_NAME, USERNAME), EMAIL, null, // Synapse data
																																										// object ID
