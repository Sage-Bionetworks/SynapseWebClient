...
public class LazyLoadHelperTest {
	...
	public void testHappyCase() {
		// in before, simulated the view is not yet attached, or in viewport, and underlying widget is
		// not yet configured
		...
		// simulate the view is now attached and in the viewport, and widget is configure, so it's time
		// to load data
		...
		// verify calling attach again does not cause viewport callback to invoke a second time (only
		// load the data once)
	...
	/**
	 * This tests the case when the widget is attached to the dom and remains outside the viewport,
	 * and is eventually detached
	 */
	@Test
