...
public class LayoutResultTestImpl implements LayoutResult {
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
      prime * result + ((nodeToPoints == null) ? 0 : nodeToPoints.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (nodeToPoints == null) {
      if (other.nodeToPoints != null) return false;
    } else if (!nodeToPoints.equals(other.nodeToPoints)) return false;
    return true;
  }
}
