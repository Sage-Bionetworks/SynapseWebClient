...
public class NChartUtilTest {
	...
	public void testCreateLayersSimple() {
		...
		NChartLayerNodeTestImpl lnA = (NChartLayerNodeTestImpl) NChartUtil
				.createActivityLayerNode(jsoProvider, a, aConnectedNodes);
	...
	public void testCreateLayersDifferentStarts() {
		...
		aConnectedNodes.add(d2);
		aConnectedNodes.add(d3);
		NChartLayerNodeTestImpl lnB = (NChartLayerNodeTestImpl) NChartUtil
				.createActivityLayerNode(jsoProvider, b, bConnectedNodes);

		List<ProvGraphNode> cConnectedNodes = new ArrayList<ProvGraphNode>();
		aConnectedNodes.add(d3);
		aConnectedNodes.add(d4);
		aConnectedNodes.add(d6);
		NChartLayerNodeTestImpl lnC = (NChartLayerNodeTestImpl) NChartUtil
				.createActivityLayerNode(jsoProvider, c, cConnectedNodes);

		List<ProvGraphNode> dConnectedNodes = new ArrayList<ProvGraphNode>();
		aConnectedNodes.add(d5);
		aConnectedNodes.add(d4);
		NChartLayerNodeTestImpl lnD = (NChartLayerNodeTestImpl) NChartUtil
				.createActivityLayerNode(jsoProvider, d, dConnectedNodes);
		...
		assertEquals(2, layerNodes.size());
		Integer lnAidx =
				((NChartLayerNodeTestImpl) layerNodes.get(0)).getEvent().equals(lnA.getEvent()) ? 0 : 1;
	...
	public void testCreateNChartCharacters() {
		...
		ActivityGraphNode a =
				new ActivityGraphNode("A", "1", "Step A", ActivityType.MANUAL, "1", new Date(), false);
