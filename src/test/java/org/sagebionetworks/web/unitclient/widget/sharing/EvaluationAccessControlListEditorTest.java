...
public class EvaluationAccessControlListEditorTest {
	...
	public void setUp() throws JSONObjectAdapterException {
		...
		AsyncMockStubber
				.callSuccessWith(new PublicPrincipalIds(TEST_PUBLIC_PRINCIPAL_ID,
						TEST_AUTHENTICATED_PRINCIPAL_ID, TEST_ANONYMOUS_PRINCIPAL_ID))
		...
		AsyncMockStubber
				.callSuccessWith(acl.writeToJSONObject(adapterFactory.createNew()).toJSONString())
				.when(mockChallengeClient).getEvaluationAcl(anyString(), any(AsyncCallback.class));

		AsyncMockStubber
				.callSuccessWith(uep.writeToJSONObject(adapterFactory.createNew()).toJSONString())
				.when(mockChallengeClient)
				.getUserEvaluationPermissions(anyString(), any(AsyncCallback.class));
		...
		acle = new EvaluationAccessControlListEditor(mockACLEView, mockSynapseJavascriptClient,
				mockAuthenticationController, mockSynapseProperties, new JSONObjectAdapterImpl(),
				mockChallengeClient, mockSynAlert);
	...
	public void addAccessTest() throws Exception {
		...
		// configure mocks
		AsyncMockStubber.callSuccessWith(acl).when(mockChallengeClient)
				.updateEvaluationAcl(any(AccessControlList.class), any(AsyncCallback.class));
