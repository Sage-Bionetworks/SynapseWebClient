...
public class EvaluationAccessControlListEditorTest {
  ...
  public void setUp() throws JSONObjectAdapterException {
    ...
    AsyncMockStubber
      ...
      .getEvaluationAcl(anyString(), any(AsyncCallback.class));

    AsyncMockStubber
      .callSuccessWith(
        uep.writeToJSONObject(adapterFactory.createNew()).toJSONString()
      )
      .when(mockChallengeClient)
    ...
    acle =
      new EvaluationAccessControlListEditor(
        mockACLEView,
    ...
    mockHasChangesHandler =
      mock(EvaluationAccessControlListEditor.HasChangesHandler.class);
  ...
  public void addAccessTest() throws Exception {
    ...
    verify(mockChallengeClient)
      .updateEvaluationAcl(captor.capture(), any(AsyncCallback.class));
  ...
  public void changeAccessTest() throws Exception {
    ...
    for (ResourceAccess resourceAccess : acl.getResourceAccess()) if (
