...
public class SharingPermissionsGridTest {
	...
	public void testAdd() {
		...
		verify(mockView, times(2)).add(any(AclEntry.class), eq((PermissionLevel[]) null),
				eq((Map<PermissionLevel, String>) null), eq(true));
		verify(mockView, times(1)).add(any(AclEntry.class), eq((PermissionLevel[]) null),
				eq((Map<PermissionLevel, String>) null), eq(false));
	}
	...
	public void testInsert() {
		...
		verify(mockView).insert(entry2, 1, (PermissionLevel[]) null,
				(Map<PermissionLevel, String>) null, deleteButtonVisible);
