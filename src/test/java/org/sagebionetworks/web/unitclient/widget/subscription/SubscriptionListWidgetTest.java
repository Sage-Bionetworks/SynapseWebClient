...
public class SubscriptionListWidgetTest {
  ...
  public void setUp() throws Exception {
    ...
    widget =
      new SubscriptionListWidget(
        mockView,
        mockJsClient,
        mockPortalGinInjector,
        mockSynAlert,
        mockAuthenticationController,
        mockDetailedPaginationWidget
      );
    AsyncMockStubber
      .callSuccessWith(mockSubscriptionPagedResults)
      .when(mockJsClient)
      .getAllSubscriptions(
        any(SubscriptionObjectType.class),
        anyLong(),
        anyLong(),
        any(SortByType.class),
        any(SortDirection.class),
        any(AsyncCallback.class)
      );
    when(mockAuthenticationController.isLoggedIn()).thenReturn(true);
    when(mockPortalGinInjector.getTopicRowWidget())
      .thenReturn(mockTopicRowWidget);
  }
  ...
  public void testConfigure() {
    ...
    when(mockSubscriptionPagedResults.getTotalNumberOfResults())
    ...
    verify(mockJsClient)
      .getAllSubscriptions(
        eq(expectedFilter),
        eq(SubscriptionListWidget.LIMIT),
        eq(expectedOffset),
        any(SortByType.class),
        any(SortDirection.class),
        any(AsyncCallback.class)
    ...
    verify(mockDetailedPaginationWidget)
      .configure(
        SubscriptionListWidget.LIMIT,
        expectedOffset,
        expectedTotalCount,
        widget
      );
  ...
  public void testOnFilter() {
    ...
    when(mockSubscriptionPagedResults.getResults())
