...
public class TopicWidgetTest {
  ...
  public void setUp() throws Exception {
    ...
    when(mockDiscussionThreadBundle.getProjectId())
      .thenReturn(THREAD_PROJECT_ID);
  ...
  public void testConfigureSupportedTypesTest() {
    ...
    widget.configure(
      SubscriptionObjectType.DATA_ACCESS_SUBMISSION,
      TEST_OBJECT_ID
    );
  ...
  public void testConfigureDataAccessSubmission() {
    ...
    verify(mockView)
      .setTopicText(TopicWidget.DATA_ACCESS_SUBMISSION_TOPIC_TEXT);
  ...
  public void testConfigureDiscussionThread() {
    ...
    String expectedHref = TopicUtils.buildThreadLink(
      THREAD_PROJECT_ID,
      TEST_OBJECT_ID
    );
  ...
  public void testConfigureForum() {
    AsyncMockStubber
      .callSuccessWith(mockProject)
      .when(mockForumClient)
