...
public class TableListWidgetTest {
	...
	public void before() {
		...
		widget = new TableListWidget(mockView, mockSynapseJavascriptClient, mockLoadMoreWidgetContainer,
				mockSynAlert);
	...
	public void testConfigureFailure() {
		...
		AsyncMockStubber.callFailureWith(th).when(mockSynapseJavascriptClient)
				.getEntityChildren(any(EntityChildrenRequest.class), any(AsyncCallback.class));
		widget.configure(parentBundle);
