...
public class CreateTableViewWizardStep1Test {
	...
	public void before() {
		...
		widget = new CreateTableViewWizardStep1(mockView, mockJsClient, mockEntityContainerListWidget,
				mockStep2);
	...
	public void testNullName() {
		...
		verify(mockWizardPresenter)
				.setErrorMessage(CreateTableViewWizardStep1.NAME_MUST_INCLUDE_AT_LEAST_ONE_CHARACTER);
	...
	public void testCreateFileFolderTableView() {
		...
		assertEquals(scopeIds, capturedFileView.getScopeIds());
		assertNull(capturedFileView.getType());
		assertEquals(new Long(TableType.files_folders_tables.getViewTypeMask()),
