...
public class ContentTypeDelimiterTest {
  ...
  public void testAllTypes() {
    ...
    for (ContentTypeDelimiter ctd : ContentTypeDelimiter.values()) {
      assertEquals(
        ctd,
        ContentTypeDelimiter.findByContentType(
          ctd.getContentType().toUpperCase(),
          null
        )
      );
    }
  ...
  public void testFindNull() {
    assertEquals(
      ContentTypeDelimiter.TEXT,
      ContentTypeDelimiter.findByContentType(null, null)
    );
  }
