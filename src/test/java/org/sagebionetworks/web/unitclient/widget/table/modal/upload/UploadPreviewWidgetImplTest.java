...
public class UploadPreviewWidgetImplTest {
  ...
  public void testTruncateString() {
    ...
    assertEquals(
      "not so sm...",
      UploadPreviewWidgetImpl.truncateValues("not so small")
    );
  }
  ...
  public void testConfigureNullPreivew() {
    ...
    verify(mockView)
      .showEmptyPreviewMessage(
        UploadPreviewWidgetImpl.NO_DATA_WAS_FOUND_IN_THE_FILE
      );
  ...
  public void testConfigureNullColumnName() {
    ...
    verify(mockView)
      .setPreviewMessage(
        UploadPreviewWidgetImpl.PREVIEW_MESSAGE_PREFIX +
        preview.getRowsScanned() +
        UploadPreviewWidgetImpl.PREVIEW_MESSAGE_SUFFIX
      );
  ...
  public void testConfigureNullNoValues() {
    ...
    verify(mockView)
      .showEmptyPreviewMessage(
        UploadPreviewWidgetImpl.NO_ROWS_WERE_FOUND_IN_THE_FILE
      );
    verify(mockView).setEmptyMessageVisible(true);
    verify(mockView, never()).addRow(any(List.class));
  }
