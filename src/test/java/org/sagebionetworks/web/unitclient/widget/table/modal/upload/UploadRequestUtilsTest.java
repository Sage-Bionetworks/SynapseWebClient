...
public class UploadRequestUtilsTest {
  ...
  public void before() {
    ...
    sampleUploadToTablePreviewRequest.setCsvTableDescriptor(
      sampleCsvTableDescriptor
    );
    sampleUploadToTablePreviewRequest.setDoFullFileScan(Boolean.TRUE);
    sampleUploadToTablePreviewRequest.setLinesToSkip(
      sampleUploadToTableRequest.getLinesToSkip()
    );
    sampleUploadToTablePreviewRequest.setUploadFileHandleId(
      sampleUploadToTableRequest.getUploadFileHandleId()
    );
  }
  ...
  public void testCloneUploadToTableRequestNull() {
    ...
    UploadToTableRequest clone = UploadRequestUtils.cloneUploadToTableRequest(
      in
    );
    assertEquals(in, clone);
  }
  ...
  public void testCreateFromPreview() {
    UploadToTableRequest clone = UploadRequestUtils.createFromPreview(
      sampleUploadToTablePreviewRequest
    );
    ...
    assertFalse(
      "The clone should be a new object",
      sampleUploadToTableRequest == clone
    );
  }
}
