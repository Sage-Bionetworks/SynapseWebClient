...
public class UploadRequestUtilsTest {
	...
	public void before() {
		...
		sampleUploadToTablePreviewRequest
				.setUploadFileHandleId(sampleUploadToTableRequest.getUploadFileHandleId());
	}
	...
	public void testCreateFromPreview() {
		UploadToTableRequest clone =
				UploadRequestUtils.createFromPreview(sampleUploadToTablePreviewRequest);
