...
public class QueryBundleUtilsTest {
	...
	public void testGetTableIdFromQuerySql() {
		assertEquals("syn456",
				QueryBundleUtils.getTableIdFromSql("SELECT syn123, BAR FROM SYN456 where id='syn789'"));
		assertEquals(null,
				QueryBundleUtils.getTableIdFromSql("SELECT syn123, foo FROM 456 where id='syn789'"));
	}
