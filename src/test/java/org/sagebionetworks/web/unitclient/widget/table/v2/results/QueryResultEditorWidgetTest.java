...
public class QueryResultEditorWidgetTest {
	...
	public void testOnCancelWithChangesConfirmOkay() {
		...
		AsyncMockStubber.callWithInvoke().when(mockView).showConfirmDialog(anyString(),
				any(Callback.class));
	...
	public void testOnCancelWithChangesConfirmCanceld() {
		...
		updates.get(0).setValues(Arrays.asList("update1", "update2"));
		// no invoke
		AsyncMockStubber.callNoInvovke().when(mockView).showConfirmDialog(anyString(),
				any(Callback.class));
	...
	public void testGetEntityUpdateResultsSingleValue() {
		...
		assertEquals(mockEntityUpdateResults,
				QueryResultEditorWidget.getEntityUpdateResults(mockTableUpdateTransactionResponse));
	}
	...
	public void testGetEntityUpdateResultsFailureSuccessIndex() {
		...
		assertEquals("<p>syn29292 (NOT_FOUND): Not there, buddy</p>",
				QueryResultEditorWidget.getEntityUpdateResultsFailures(mockTableUpdateTransactionResponse));
		assertEquals(1, QueryResultEditorWidget
				.getFirstIndexOfEntityUpdateResultSuccess(mockTableUpdateTransactionResponse));
	}
