...
public class FileCellEditorImplTest {
  ...
  public void before() {
    ...
    when(mockGinInjector.getFileHandleUploadWidget())
  ...
  public void testUploadSuccess() {
    // show upload UI
    editor.onToggleCollapse();
    ArgumentCaptor<CallbackP> argumentCaptor = ArgumentCaptor.forClass(
      CallbackP.class
    );
    verify(mockFileInputWidget)
      .configure(anyString(), argumentCaptor.capture());
