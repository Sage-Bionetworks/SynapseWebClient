...
public class FileCellRendererImplTest {
  ...
  public void testCreateAnchorHrefView() {
    ...
    String expectedHref =
      ...
      rowId +
      "&associatedObjectType=FileEntity&fileHandleId=" +
      fileHandleId;
    assertEquals(expectedHref, renderer.createAnchorHref());
  }
  ...
  public void testCreateAnchorHrefFileViewMissingRowId() {
    ...
    renderer.setCellAddresss(address);
    renderer.setValue(fileHandleId);
    verify(mockFileHandleAsyncHandler, never())
      .getFileResult(
        any(FileHandleAssociation.class),
        any(AsyncCallback.class)
      );
  ...
  public void testSetValueSuccessAttached() {
    ...
    verify(mockView).setLoadingVisible(false);
    verify(mockView)
      .setAnchor(fileHandle.getFileName(), renderer.createAnchorHref());
  }
  ...
  public void testSetValueSuccessUnauthorized() {
    ...
    verify(mockView)
      .setErrorText(
        FileCellRenderer.UNABLE_TO_LOAD_FILE_DATA +
        ": " +
  ...
  public void testSetValueFailureAttached() {
    ...
    verify(mockView)
      .setErrorText(
        FileCellRenderer.UNABLE_TO_LOAD_FILE_DATA + ": " + errorMessage
      );
  }
