...
public class FacetsWidgetTest {
	...
	public void testConfigureFromQuery() {
		...
		assertEquals(new Long(TableQueryResultWidget.BUNDLE_MASK_QUERY_FACETS
				| TableQueryResultWidget.BUNDLE_MASK_QUERY_COLUMN_MODELS), request.getPartMask());
		...
		verify(mockFacetColumnResultValuesWidget).configure(mockFacetColumnResultValues,
				ColumnType.ENTITYID, mockFacetChangedHandler);
	...
	public void testConfigureResultUserIdsValuesFacet() {
		...
		verify(mockView, times(2)).add(any(IsWidget.class));
		verify(mockFacetColumnResultValuesWidget).configure(mockFacetColumnResultValues,
				ColumnType.USERID, mockFacetChangedHandler);
	}
	...
	public void testRangeFacetColumnValuesInteger() {
		...
		verify(mockView).clear();
		verify(mockView, times(2)).add(any(IsWidget.class));
		verify(mockFacetColumnResultRangeWidget).configure(mockFacetColumnResultSliderView,
				mockFacetColumnResultRange, mockFacetChangedHandler);
	}
	...
	public void testRangeFacetColumnValuesDouble() {
		...
		verify(mockView).clear();
		verify(mockView, times(2)).add(any(IsWidget.class));
		verify(mockFacetColumnResultRangeWidget).configure(mockFacetColumnResultRangeView,
				mockFacetColumnResultRange, mockFacetChangedHandler);
	}
	...
	public void testRangeFacetColumnValuesDate() {
		...
		verify(mockView).clear();
		verify(mockView, times(2)).add(any(IsWidget.class));
		verify(mockFacetColumnResultRangeWidget).configure(mockFacetColumnResultDateView,
				mockFacetColumnResultRange, mockFacetChangedHandler);
	}
