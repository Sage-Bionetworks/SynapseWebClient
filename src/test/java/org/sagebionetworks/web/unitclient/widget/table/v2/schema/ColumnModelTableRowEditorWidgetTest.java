...
public class ColumnModelTableRowEditorWidgetTest {
	...
	public void testCanHaveSize() {
		Set<ColumnTypeViewEnum> expectedTrue = new HashSet<ColumnTypeViewEnum>(
				Arrays.asList(ColumnTypeViewEnum.String, ColumnTypeViewEnum.Link));
		for (ColumnTypeViewEnum type : ColumnTypeViewEnum.values()) {
			assertEquals("Unexpected for type: " + type, expectedTrue.contains(type),
	...
	public void testCanHaveRestricted() {
		Set<ColumnTypeViewEnum> expectedTrue = new HashSet<ColumnTypeViewEnum>(Arrays
				.asList(ColumnTypeViewEnum.String, ColumnTypeViewEnum.Integer, ColumnTypeViewEnum.Entity));
		for (ColumnTypeViewEnum type : ColumnTypeViewEnum.values()) {
			assertEquals("Unexpected for type: " + type, expectedTrue.contains(type),
