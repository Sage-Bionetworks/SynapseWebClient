...
public class ColumnModelTableRowStub implements ColumnModelTableRow {
  ...
  public int hashCode() {
    ...
    result =
      prime * result + ((columnType == null) ? 0 : columnType.hashCode());
    result =
      prime * result + ((defaultValue == null) ? 0 : defaultValue.hashCode());
    result =
      prime * result + ((enumValues == null) ? 0 : enumValues.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (enumValues == null) {
      if (other.enumValues != null) return false;
    } else if (!enumValues.equals(other.enumValues)) return false;
    if (id == null) {
      if (other.id != null) return false;
    } else if (!id.equals(other.id)) return false;
    if (isSelected != other.isSelected) return false;
    if (maxSize == null) {
      if (other.maxSize != null) return false;
    } else if (!maxSize.equals(other.maxSize)) return false;
    if (selectionPresenter == null) {
      if (other.selectionPresenter != null) return false;
    } else if (
      !selectionPresenter.equals(other.selectionPresenter)
    ) return false;
    return true;
  }
