...
public class FileHandleListTest {
	...
	public void testConfigure() {
		...
		verify(mockUploadWidget).configure(eq(WebConstants.DEFAULT_FILE_HANDLE_WIDGET_TEXT),
				any(CallbackP.class));
	}
	...
	public void testDeleteSelected() {
		...
		verify(mockView).setToolbarVisible(false);
		// SWC-2789: reset upload widget when a file is deleted from the list (user may want to
