...
public class UserTeamBadgeTest {
	...
	public void before() throws JSONObjectAdapterException {
		...
		badge = new UserTeamBadge(mockGinInjector, mockUserGroupHeaderFromIdAsyncHandler,
				mockUserGroupHeaderAsyncHandler, mockDiv);
		...
		AsyncMockStubber.callSuccessWith(mockUserGroupHeader).when(mockUserGroupHeaderAsyncHandler)
				.getUserGroupHeader(anyString(), any(AsyncCallback.class));
		AsyncMockStubber.callSuccessWith(mockUserGroupHeader)
	...
	public void testConfigureWithUsername() {
		...
		badge.configure(null, widgetDescriptor, null, null);
		verify(mockUserGroupHeaderAsyncHandler).getUserGroupHeader(eq(username),
