...
public class UserTeamBadgeTest {
  ...
  public void before() throws JSONObjectAdapterException {
    ...
    widgetDescriptor.put(
      WidgetConstants.USER_TEAM_BADGE_WIDGET_IS_INDIVIDUAL_KEY,
      "true"
    );
    widgetDescriptor.put(
      WidgetConstants.USER_TEAM_BADGE_WIDGET_ID_KEY,
      principalId
    );
    AsyncMockStubber
      .callSuccessWith(mockUserGroupHeader)
      .when(mockUserGroupHeaderAsyncHandler)
      .getUserGroupHeader(anyString(), any(AsyncCallback.class));
    AsyncMockStubber
      .callSuccessWith(mockUserGroupHeader)
      .when(mockUserGroupHeaderFromIdAsyncHandler)
      .getUserGroupHeader(anyString(), any(AsyncCallback.class));
  }
  ...
  public void testConfigureWithUsername() {
    ...
    widgetDescriptor.put(
      WidgetConstants.USER_TEAM_BADGE_WIDGET_USERNAME_KEY,
      username
    );
    ...
    badge.configure(null, widgetDescriptor, null, null);
    verify(mockUserGroupHeaderAsyncHandler)
      .getUserGroupHeader(eq(username), any(AsyncCallback.class));
  ...
  public void testConfigureFromUsernameAlias() {
    ...
    badge.configure(null, widgetDescriptor, null, null);
    verify(mockUserGroupHeaderAsyncHandler)
      .getUserGroupHeader(eq(alias), any(AsyncCallback.class));
    verify(mockUserBadge).configure(ownerId);
  }
