...
public class ChallengeClientImplTest {
	...
	public void testCreateIndividualSubmission() throws RestServiceException, SynapseException {
		...
		verify(mockSynapse).createIndividualSubmission(mockSubmission, etag,
				TEST_HOME_PAGE_BASE + "#!Synapse:", TEST_HOME_PAGE_BASE + "#!SignedToken:");
	}
	...
	public void testGetTeamsSorted() throws SynapseException {
		...
		List<Team> returnedTeams =
				synapseClient.getTeams(Collections.singletonList("1234"), true, mockSynapse);
	...
	public void testGetTeamsUnSorted() throws SynapseException {
		setupTeams("z team", "A team");
		List<Team> returnedTeams =
				synapseClient.getTeams(Collections.singletonList("1234"), false, mockSynapse);
	...
	@Test
	public void testGetAvailableEvaluations() throws SynapseException, RestServiceException,
	...
	public void setupGetEvaluationsForEntity(String sharedEntityId) throws SynapseException {
		org.sagebionetworks.reflection.model.PaginatedResults<Evaluation> testResults =
				getTestEvaluations(sharedEntityId);
		when(mockSynapse.getEvaluationByContentSource(anyString(), anyInt(), anyInt()))
				.thenReturn(getEmptyPaginatedResults());
		when(mockSynapse.getEvaluationByContentSource(eq(sharedEntityId), anyInt(), anyInt()))
	...
	public void setupChallengeParticipants() throws SynapseException {
		...
		when(mockSynapse.listChallengeParticipants(anyString(), anyBoolean(), anyLong(), anyLong()))
	...
	public void setupListChallengesForParticipant() throws SynapseException {
		when(mockSynapse.listChallengesForParticipant(anyString(), anyLong(), anyLong()))
				.thenReturn(getTestChallengePagedResults());
		org.sagebionetworks.reflection.model.PaginatedResults<EntityHeader> headers =
				new org.sagebionetworks.reflection.model.PaginatedResults<EntityHeader>();
