...
public class ChallengeClientImplTest {
  ...
  public void before() throws SynapseException, JSONObjectAdapterException {
    ...
    testChallengeTeam2 =
      getTestChallengeTeam("join the second team", testTeam2);
  ...
  @Test
  public void testCreateTeamSubmission()
    throws RestServiceException, SynapseException {
    Submission mockSubmission = mock(Submission.class);
    String etag = "test etag";
    String memberStateHash = "1244458373";
    synapseClient.createTeamSubmission(
      mockSubmission,
      etag,
      memberStateHash,
      TEST_HOME_PAGE_BASE
  ...
  public void testGetTeamsSorted() throws SynapseException {
    ...
    List<Team> returnedTeams = synapseClient.getTeams(
  ...
  @Test
  public void testUnRegisterChallengeTeam()
    throws SynapseException, RestServiceException {
    // pass through
  ...
  @Test
  public void testUpdateRegisteredChallengeTeam()
    throws SynapseException, RestServiceException {
    // pass through
    ChallengeTeam challengeTeam = mock(ChallengeTeam.class);
  ...
  @Test
  public void testGetChallengeForProject()
    throws SynapseException, RestServiceException {
    // pass through
  ...
  @Test
  public void testGetChallengeTeamsAnonymous()
    throws SynapseException, RestServiceException {
    ChallengeTeamPagedResults results = synapseClient.getChallengeTeams(
      null,
      "2",
      10,
      0
    ...
    assertEquals(
      testChallengeTeam1,
      results.getResults().get(0).getChallengeTeam()
    );
    assertFalse(results.getResults().get(0).isAdmin());
    assertEquals(
      testChallengeTeam2,
      results.getResults().get(1).getChallengeTeam()
    );
    assertFalse(results.getResults().get(1).isAdmin());
  }

  @Test
  public void testGetChallengeTeamsLoggedIn()
    throws SynapseException, RestServiceException {
  ...
  @Test
  public void testGetChallengeTeamsLoggedInNotFound()
    throws SynapseException, RestServiceException {
    when(mockSynapse.getTeamMember(anyString(), anyString()))
  ...
  public void testGetChallengeParticipants()
    ...
    UserProfilePagedResults results = synapseClient.getChallengeParticipants(
      false,
      "12",
      10,
      0
  ...
  public void testGetRegistratableTeamsNotMember()
    throws SynapseException, RestServiceException {
  ...
  @Test
  public void testGetRegistratableTeamsIsMember()
    throws SynapseException, RestServiceException {
    // asks for team membership status. if not member, returns notfoundexception
    TeamMembershipStatus status = new TeamMembershipStatus();
    ...
    when(mockSynapse.listRegistratableTeams(anyString(), anyLong(), anyLong()))
      .thenReturn(teamIds);
    List<Team> results = synapseClient.getRegistratableTeams(
      "userid",
      "challengeId"
    );
    ...
    verify(mockSynapse)
      .listRegistratableTeams(anyString(), anyLong(), anyLong());
  ...
  @Test
  public void testGetChallengeEvaluationIds()
    throws SynapseException, RestServiceException {
    setupGetEvaluationsForEntity(testChallengeProject);

    Set<String> results = synapseClient.getChallengeEvaluationIds(
      testChallengeId
    );
  ...
  public void setupGetEvaluationsForEntity(String sharedEntityId)
    ...
    when(
      ...
      .thenReturn(getEmptyPaginatedResults());
    when(
      mockSynapse.getEvaluationByContentSource(
        eq(sharedEntityId),
        anyInt(),
        anyInt()
      )
  ...
  @Test
  public void testGetSharableEvaluations()
    ...
    List<Evaluation> sharableEvaluations = synapseClient.getSharableEvaluations(
      myEntityId
    );
  ...
  public static ChallengeTeam getTestChallengeTeam(
    String message,
    String teamId
  ) {
  ...
  public void setupChallengeteamPagedResults() throws SynapseException {
    ...
    when(mockSynapse.listChallengeTeams(anyString(), anyLong(), anyLong()))
      .thenReturn(results);
  }
  ...
  public void setupChallengeParticipants() throws SynapseException {
    ...
    when(
      mockSynapse.listChallengeParticipants(
        anyString(),
        anyBoolean(),
        anyLong(),
        anyLong()
    ...
    when(mockSynapse.listUserProfiles(anyList()))
      .thenReturn(Collections.singletonList(mockUserProfile));
  }
  ...
  public void setupListChallengesForParticipant() throws SynapseException {
    when(
      mockSynapse.listChallengesForParticipant(
        anyString(),
        anyLong(),
        anyLong()
      )
