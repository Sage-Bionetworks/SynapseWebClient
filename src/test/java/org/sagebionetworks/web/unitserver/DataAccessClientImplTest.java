...
public class DataAccessClientImplTest {
  ...
  @Test
  public void testSubmitDataAccessRequest()
    ...
    when(mockCreateSubmissionRequest.getSubjectType())
      .thenReturn(RestrictableObjectType.TEAM);
    dataAccessClient.submitDataAccessRequest(
      mockCreateSubmissionRequest,
      AR_ID
    );
  ...
  @Test
  public void testSubmitDataAccessRequestNoTargetSubject()
    throws RestServiceException, SynapseException {
