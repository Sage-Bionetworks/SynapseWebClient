...
public class ServerMarkdownUtilsTest {
	...
	public void testAddWidgetDivs(){
		...
		String expectedResult = "<html>\n <head></head>\n <body>\n  <p>Line of widgets: </p>\n  <ul>\n   <li>\n    <div>\n     <span id=\"widget_0\" class=\"widgetContainer\" widgetparams=\"type1:aWidgetParam=1\"></span>\n    </div></li>\n   <li>\n    <div>\n     <span id=\"widget_1\" class=\"widgetContainer\" widgetparams=\"type2:aWidgetParam=2\"></span>\n    </div></li>\n  </ul>\n </body>\n</html>";
		Document htmlDoc = Jsoup.parse(testString);
