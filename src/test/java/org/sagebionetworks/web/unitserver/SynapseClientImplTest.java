...
public class SynapseClientImplTest {
  ...
  public void before() throws SynapseException, JSONObjectAdapterException {
    ...
    when(mockSynapse.getUserEvaluationPermissions(EVAL_ID_1))
    ...
    pgugs =
      new org.sagebionetworks.reflection.model.PaginatedResults<UserGroup>();
    ...
    pgups =
      new org.sagebionetworks.reflection.model.PaginatedResults<UserProfile>();
    ...
    when(mockSynapse.updateTeamACL(any(AccessControlList.class)))
      .thenReturn(acl);
    ...
    when(
      mockSynapse.getEntityBundleV2(anyString(), any(EntityBundleRequest.class))
    )
      .thenReturn(bundle);
    ...
    when(
      mockSynapse.getAccessRequirements(
    ...
    when(mockSynapse.sendMessage(any(MessageToUser.class)))
      .thenReturn(sentMessage);
    when(mockSynapse.sendMessage(any(MessageToUser.class), anyString()))
      .thenReturn(sentMessage);

    testUserProfile = new UserProfile();
    testUserProfile.setUserName("Test User");
    when(mockSynapse.getUserProfile(eq(testUserId)))
    ...
    encodedJoinTeamToken =
      SerializationUtils.serializeAndHexEncode(joinTeamToken);
  ...
  private AccessRequirement createAccessRequirement(ACCESS_TYPE type) {
    ...
    accessRequirement.setConcreteType(
      TermsOfUseAccessRequirement.class.getName()
    );
    RestrictableObjectDescriptor descriptor =
      new RestrictableObjectDescriptor();
    descriptor.setId("101");
    descriptor.setType(RestrictableObjectType.ENTITY);
    accessRequirement.setSubjectIds(
      Arrays.asList(new RestrictableObjectDescriptor[] { descriptor })
    );
  ...
  @Test
  public void testGetEntityBundleAll()
  ...
  public void testDeleteV2WikiPage() throws Exception {
    synapseClient.deleteV2WikiPage(
      new WikiPageKey("syn123", ObjectType.ENTITY.toString(), "20")
    );
    verify(mockSynapse)
      .deleteV2WikiPage(
  ...
  public void testRestoreV2WikiPage() throws Exception {
    ...
    Mockito
      ...
      .thenReturn(v2Page);
    synapseClient.restoreV2WikiPage(
      "ownerId",
  ...
  public void testGetV2WikiHistory() throws Exception {
    ...
    synapseClient.getV2WikiHistory(
      new WikiPageKey("syn123", ObjectType.ENTITY.toString(), "20"),
      new Long(10),
      new Long(0)
    );
  ...
  public void testCreateV2WikiPageWithV1() throws Exception {
    Mockito
      ...
      .thenReturn(page);
    synapseClient.createV2WikiPageWithV1(
      "testId",
      ObjectType.ENTITY.toString(),
      page
    );
    verify(mockSynapse)
      .createWikiPage(anyString(), any(ObjectType.class), any(WikiPage.class));
  }
  ...
  public void testUpdateV2WikiPageWithV1() throws Exception {
    Mockito
      ...
      .thenReturn(page);
    synapseClient.updateV2WikiPageWithV1(
      "testId",
      ObjectType.ENTITY.toString(),
      page
    );
    verify(mockSynapse)
      .updateWikiPage(anyString(), any(ObjectType.class), any(WikiPage.class));
  }
  ...
  public void testUpdateExternalFileHandle() throws Exception {
    ...
    ArgumentCaptor<ExternalFileHandle> captor = ArgumentCaptor.forClass(
  ...
  /**
   * Direct upload tests. Most of the methods are simple pass-throughs to the Java Synapse client, but
   * completeUpload has additional logic
   *
  ...
  public void testRequestMemberOpenRequests()
    ...
    synapseClient.requestMembership(
      "123",
      "a team",
      "let me join",
      TEST_HOME_PAGE_BASE,
    ...
    verify(mockSynapse, Mockito.times(0))
      .createMembershipRequest(captor.capture(), anyString(), anyString());
  }
  ...
  public void testGetOpenRequests()
    ...
    String teamId = "132";
    List<MembershipRequestBundle> bundles = synapseClient.getOpenRequests(
      teamId
    );
    verify(mockSynapse)
  ...
  public void testGetTeamBundle()
    ...
    when(mockSynapse.getTeamMember(anyString(), anyString()))
      .thenReturn(testTeamMember);

    // make the call
    TeamBundle bundle = synapseClient.getTeamBundle(
      "myUserId",
      "myTeamId",
      true
    );
  ...
  public void testSendMessage()
    throws SynapseException, RestServiceException, JSONObjectAdapterException {
    ArgumentCaptor<MessageToUser> arg = ArgumentCaptor.forClass(
      MessageToUser.class
    );
    ...
    when(
      mockSynapse.sendStringMessage(any(MessageToUser.class), eq(messageBody))
    )
    ...
    assertTrue(
      toSendMessage
        .getNotificationUnsubscribeEndpoint()
        .startsWith(hostPageBaseURL)
    );
  }
  ...
  public void testSendMessageToEntityOwner()
    ...
    when(
      mockSynapse.sendStringMessage(
        any(MessageToUser.class),
        eq(entityId),
        eq(messageBody)
      )
    )
    ...
    verify(mockSynapse)
      .sendStringMessage(arg.capture(), eq(entityId), eq(messageBody));
    MessageToUser toSendMessage = arg.getValue();
    assertEquals(subject, toSendMessage.getSubject());
    assertTrue(
      toSendMessage
  ...
  public void testGetCertifiedUserPassingRecord()
    ...
    String passingRecordJson = passingRecord
    ...
    String returnedPassingRecordJson =
  ...
  @Test(expected = NotFoundException.class)
  public void testUserFailedCertification()
    throws RestServiceException, SynapseException {
    PassingRecord passingRecord = new PassingRecord();
  ...
  @Test
  public void testGetCertificationQuiz()
    throws RestServiceException, SynapseException {
  ...
  public void testFilterAccessRequirements() throws Exception {
    ...
    filteredAccessRequirements =
      AccessRequirementUtils.filterAccessRequirements(
        unfilteredAccessRequirements,
        ACCESS_TYPE.UPDATE
      );
    assertTrue(filteredAccessRequirements.isEmpty());

    unfilteredAccessRequirements.add(
      createAccessRequirement(ACCESS_TYPE.DOWNLOAD)
    );
    unfilteredAccessRequirements.add(
      createAccessRequirement(ACCESS_TYPE.SUBMIT)
    );
    unfilteredAccessRequirements.add(
      createAccessRequirement(ACCESS_TYPE.SUBMIT)
    );
  ...
  public void testAddEmail() throws Exception {
    ...
    verify(mockSynapse)
      .addEmail(any(EmailValidationSignedToken.class), anyBoolean());
  }
  ...
  @Test
  public void testHandleSignedTokenJoinTeam()
    throws RestServiceException, SynapseException {
    SignedTokenInterface token = synapseClient.hexDecodeAndDeserialize(
      encodedJoinTeamToken
    );
  ...
  @Test(expected = BadRequestException.class)
  public void testHandleSignedTokenInvalidJoinTeam()
    throws RestServiceException, SynapseException {
    SignedTokenInterface token = synapseClient.hexDecodeAndDeserialize(
      "invalid token"
    );
  ...
  private void setupGetMyLocationSettings()
    ...
    ((ExternalStorageLocationSetting) storageLocation).setUrl(
        "sftp://www.jayhodgson.com"
      );
    existingStorageLocations.add(storageLocation);
    ...
    when(mockSynapse.getMyStorageLocationSettings())
      .thenReturn(existingStorageLocations);
  }
  ...
  public void testCreateStorageLocationSettingFoundStorageAndProjectSetting()
    ...
    UploadDestinationListSetting projectSetting =
      new UploadDestinationListSetting();
    ...
    ExternalStorageLocationSetting setting =
      new ExternalStorageLocationSetting();
    setting.setBanner(BANNER_2);
    setting.setUrl("sftp://www.jayhodgson.com");

    ExternalStorageLocationSetting foundSetting =
      new ExternalStorageLocationSetting();
    ...
    when(
      mockSynapse.createStorageLocationSetting(
        any(StorageLocationSetting.class)
      )
    )
      .thenReturn(foundSetting);
    ...
    // storage location)
    ArgumentCaptor<ProjectSetting> captor = ArgumentCaptor.forClass(
  ...
  @Test
  public void testSetDefaultStorageLocationSetting()
    throws SynapseException, RestServiceException {
    setupGetMyLocationSettings();
  ...
  public void testCreateStorageLocationSettingNewStorageAndProjectSetting()
    ...
    ExternalStorageLocationSetting createdSetting =
      new ExternalStorageLocationSetting();
    ...
    verify(mockSynapse)
      .createStorageLocationSetting(any(StorageLocationSetting.class));
    // verify creates new project setting, and the new location list is a single value (id of the new
    // storage location)
    ArgumentCaptor<ProjectSetting> captor = ArgumentCaptor.forClass(
      ProjectSetting.class
    );
    ...
    assertEquals(
      ...
      updatedProjectSetting.getSettingsType()
    );
  ...
  public void testCreateStorageLocationSettingFailure()
    throws SynapseException, RestServiceException {
    when(mockSynapse.getMyStorageLocationSetting(anyLong()))
  ...
  private void setupVersionedEntityBundle(
    String entityId,
    ...
    when(
      ...
      .thenReturn(eb);
    PaginatedResults<VersionInfo> versionInfoPaginatedResults =
      new PaginatedResults<VersionInfo>();
  ...
  public void testGetTableUpdateTransactionRequestNoChange()
    ...
    when(mockSynapse.getColumnModelsForTableEntity(tableId))
      .thenReturn(oldColumnModels);
  ...
  public void testGetTableUpdateTransactionRequestNewColumn()
    ...
    List<ColumnModel> newColumnModels = Collections.singletonList(
      mockNewColumnModel
    );
    TableUpdateTransactionRequest request =
      synapseClient.getTableUpdateTransactionRequest(
    ...
    TableSchemaChangeRequest schemaChange =
      (TableSchemaChangeRequest) tableUpdates.get(0);
  ...
  private ColumnChange getColumnChange(
    String oldColumnId,
  ...
  public void testGetTableUpdateTransactionRequestFullTest()
    ...
    List<ColumnModel> proposedNewSchema = Arrays.asList(
      colAModified,
      colC,
      colD
    );
    List<ColumnModel> newSchemaAfterUpdate = Arrays.asList(
      colAAfterSave,
      colC,
      colDAfterSave
    );
    when(mockSynapse.createColumnModels(anyList()))
      .thenReturn(newSchemaAfterUpdate);
  ...
  @Test(expected = NotFoundException.class)
  public void testUpdateFileEntityNotFound()
    throws RestServiceException, SynapseException {
    batchCopyResultsList.add(mockFileHandleCopyResult);
    when(mockFileHandleCopyResult.getFailureCode())
      .thenReturn(FileResultFailureCode.NOT_FOUND);
    synapseClient.updateFileEntity(mockFileEntity, mockFileHandleCopyRequest);
  }

  @Test(expected = UnauthorizedException.class)
  public void testUpdateFileEntityUnauthorized()
    throws RestServiceException, SynapseException {
    batchCopyResultsList.add(mockFileHandleCopyResult);
    when(mockFileHandleCopyResult.getFailureCode())
  ...
  public void testGetFileNameFromLocationPath() {
    ...
    assertEquals(
      name,
      SynapseClientImpl.getFileNameFromExternalUrl(
    ...
    assertEquals(
      name,
      SynapseClientImpl.getFileNameFromExternalUrl("/root/" + name)
    );
    assertEquals(
      name,
      SynapseClientImpl.getFileNameFromExternalUrl("http://google.com/" + name)
    );
  }
  ...
  @Test
  public void testResendTeamInvitation()
    throws RestServiceException, SynapseException {
    String membershipInvitationId = "1212";
    String hostPageBaseURL = "http://localhost/Portal.html";
    when(mockSynapse.getMembershipInvitation(anyString()))
      .thenReturn(mockMembershipInvitation);
    // SWC-4360: if the email and principal ID are set, then the email should be cleared)
    when(mockMembershipInvitation.getInviteeEmail())
      .thenReturn("something@gmail.com");
  ...
  // SWC-4645
  @Test
  public void testResendEmailBasedTeamInvitation()
    throws RestServiceException, SynapseException {
    String membershipInvitationId = "1212";
    String hostPageBaseURL = "http://localhost/Portal.html";
    when(mockSynapse.getMembershipInvitation(anyString()))
