...
//	}
	...
	public void testFilterAccessRequirements() throws Exception {
		...
		filteredAccessRequirements = AccessRequirementsTransport.filterAccessRequirements(unfilteredAccessRequirements, ACCESS_TYPE.UPDATE);
		...
		assertTrue(filteredAccessRequirements.isEmpty());
		//1 download
		filteredAccessRequirements = AccessRequirementsTransport.filterAccessRequirements(unfilteredAccessRequirements, ACCESS_TYPE.DOWNLOAD);
		assertEquals(1, filteredAccessRequirements.size());
		//2 submit
		filteredAccessRequirements = AccessRequirementsTransport.filterAccessRequirements(unfilteredAccessRequirements, ACCESS_TYPE.SUBMIT);
		assertEquals(2, filteredAccessRequirements.size());
		
		//finally, filter null list - result will be an empty list
		filteredAccessRequirements = AccessRequirementsTransport.filterAccessRequirements(null, ACCESS_TYPE.SUBMIT);
