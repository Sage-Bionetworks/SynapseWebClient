...
//	}
	...
	@Test
	public void testGetPagedResults() throws JSONObjectAdapterException {
		List<JSONEntity> projects = new ArrayList<JSONEntity>();
		Project project1 = new Project();
		project1.setId("42");
		project1.setName("Answer Key");
		projects.add(project1);
		
		int totalNumberOfResults = 9938;
		
		PagedResults pagedResults = synapseClient.getPagedResults(projects, totalNumberOfResults);
		assertEquals(totalNumberOfResults, pagedResults.getTotalNumberOfResults());
		assertEquals(1, pagedResults.getResults().size());
		Project roundTripProject1 = new Project(adapterFactory.createNew(pagedResults.getResults().get(0)));
		assertEquals(project1, roundTripProject1);
	}
