...
public class DiscussionMessageServletTest {
  ...
  public void testDoGetThreadMessage() throws Exception {
    ...
    when(mockRequest.getParameter(WebConstants.MESSAGE_KEY_PARAM))
      .thenReturn("key");
    when(mockRequest.getParameter(WebConstants.TYPE_PARAM))
      .thenReturn(WebConstants.THREAD_TYPE);
  ...
  public void testDoGetReplyMessage() throws Exception {
    ...
    when(mockRequest.getParameter(WebConstants.MESSAGE_KEY_PARAM))
      .thenReturn("key");
    when(mockRequest.getParameter(WebConstants.TYPE_PARAM))
      .thenReturn(WebConstants.REPLY_TYPE);
    servlet.doGet(mockRequest, mockResponse);
  ...
  public void testDoGetError() throws Exception {
    ...
    when(mockRequest.getParameter(WebConstants.TYPE_PARAM))
      .thenReturn(WebConstants.THREAD_TYPE);
    when(mockSynapse.getThreadUrl(anyString()))
