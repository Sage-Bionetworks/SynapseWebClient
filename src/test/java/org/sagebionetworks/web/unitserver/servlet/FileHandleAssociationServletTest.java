...
public class FileHandleAssociationServletTest {
	...
	public void setup() throws IOException, SynapseException, JSONObjectAdapterException {
		...
		when(mockRequest.getParameter(WebConstants.ASSOCIATED_OBJECT_ID_PARAM_KEY))
				.thenReturn(objectId);
		when(mockRequest.getParameter(WebConstants.ASSOCIATED_OBJECT_TYPE_PARAM_KEY))
	...
	public void testDoGet() throws Exception {
		...
		ArgumentCaptor<FileHandleAssociation> fhaCaptor =
				ArgumentCaptor.forClass(FileHandleAssociation.class);
		...
		verify(mockResponse).setHeader(WebConstants.CACHE_CONTROL_KEY,
