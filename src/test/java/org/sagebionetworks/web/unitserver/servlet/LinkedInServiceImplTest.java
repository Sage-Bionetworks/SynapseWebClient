...
public class LinkedInServiceImplTest {
  ...
  private static final String MOCK_LINKEDIN_RESPONSE =
    "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><person>  <id>rddsf8JYI9</id>  <first-name>" +
    TEST_FIRST_NAME +
    "</first-name>  <last-name>" +
    TEST_LAST_NAME +
    "</last-name>  <summary>" +
    TEST_SUMMARY +
    "</summary>  <industry>Computer Software</industry>  <location>    <name>" +
    TEST_LOCATION +
    "</name>  </location>  <positions total=\"1\">    <position>      <title>Database Wizard</title>      <is-current>true</is-current>      <company>        <name>" +
    TEST_COMPANY_NAME +
    "</name>      </company>    </position>  </positions>  <picture-url>http://m3.licdn.com/mpr/mprx/0_yq555BbiTHqTxRbrCe5m9mTo_8xZ7MYKlV5zqxYuBK8pZJr-vWIv8l7FixpxmvgcbUEt6YY3sM</picture-url></person>";

  @Test
  public void testLinkedInParsing() throws JSONObjectAdapterException {
    UserProfile userProfile = LinkedInServiceImpl.parseLinkedInResponse(
