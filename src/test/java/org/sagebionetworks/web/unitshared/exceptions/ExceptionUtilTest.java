...
public class ExceptionUtilTest {
	...
	public static Collection<Object[]> data() {
		return Arrays
				.asList(new Object[][] {{ForbiddenException.class, new SynapseForbiddenException(message)},
						...
						{UnknownErrorException.class, new UnknownSynapseServerException(500, message)},
						...
						{ConflictException.class,
								new UnknownSynapseServerException(409,
	...
	public ExceptionUtilTest(Class<? extends RestServiceException> restServiceException,
			Exception synapseException) {
		super();
