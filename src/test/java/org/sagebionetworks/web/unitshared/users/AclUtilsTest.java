...
public class AclUtilsTest {
  ...
  public void testGetPermissionLevel() {
    assertEquals(
      ...
      AclUtils.getPermissionLevel(getReadAccessTypeSet())
    );
    assertEquals(
    ...
    assertEquals(
      ...
      AclUtils.getPermissionLevel(getEditAccessTypeSet())
    );
    assertEquals(
    ...
    assertEquals(
      PermissionLevel.CAN_MESSAGE_TEAM,
  ...
  public void testGetPermissionLevels() {
    ...
    assertEquals(
      new HashSet<PermissionLevel>(
        Arrays.asList(
          new PermissionLevel[] { PermissionLevel.CAN_ADMINISTER_EVALUATION }
        )
      ),
  ...
  public void testGetPrincipalIds() {
    ...
    Set<Long> principalIds = AclUtils.getPrincipalIds(
      mockACL,
      targetAccessType
    );
