...
public class FieldComparator<T> implements Comparator<T> {
	...
	/**
	 * The provided field name will determine how the two objects will be compared. Note: The field
	 * does not need to be accessible. The resulting FieldComparator will then compare the two objects
	 * based on the value of the given field. a getName() method.
	 * 
	 * @param fieldName
	 */
